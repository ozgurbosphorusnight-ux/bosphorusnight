    ...
    pills: [
      {
        ...
        desc: { en: 'Night departure from Kabataş Pier at 20:30', tr: 'Kabataş İskelesi\'nden 20:30\'de gece kalkışı', de: 'Nachtabfahrt vom Kabataş Pier um 20:30', es: 'Salida nocturna del muelle de Kabataş a las 20:30', ru: 'Ночное отправление с причала Кабаташ в 20:30', ar: 'مغادرة ليلية من رصيف كاباتاش الساعة 20:30', fa: 'حرکت شبانه از اسکله کاباتاش ساعت 20:30', fr: 'Départ nocturne depuis l\'embarcadère de Kabataş à 20h30', it: 'Partenza notturna dal molo di Kabataş alle 20:30', zh: '20:30从卡巴塔什码头夜间出发', id: 'Keberangkatan malam dari Dermaga Kabataş pukul 20:30', ms: 'Perlepasan malam dari Jeti Kabataş pada 20:30', pl: 'Wieczorny odjazd z przystani Kabataş o 20:30', bg: 'Вечерно отплаване от кейа Кабаташ в 20:30', ro: 'Plecare nocturnă de la debarcaderul Kabataş la 20:30' }
      },
      {
        label: { en: '3 Hours', tr: '3 Saat', de: '3 Std.', es: '3 Horas', ru: '3 часа', ar: '3 ساعات', fa: '3 ساعت', fr: '3 Heures', it: '3 Ore', zh: '3 小时', id: '3 Jam', ms: '3 Jam', pl: '3 Godziny', bg: '3 Часа', ro: '3 Ore' },
