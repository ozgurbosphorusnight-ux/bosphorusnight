...
const T = {
  ...
  "faq.a12": {
    en: "Bosphorus Night offers strong value at €24/person: 3-hour cruise with 10 mezes, main course, and ice cream cake; unlimited soft drinks; live music, DJ, 5 regional folk dances, belly dance show, and the Mevlana whirling dervish. Panoramic windows reveal the illuminated Bosphorus Bridge and waterfront palaces. 4.8★ from 11,317 reviews.",
    tr: "Bosphorus Night €24/kişi tarifesinde güçlü değer sunar: 3 saatlik tur, 10 meze + ana yemek + dondurmalı pasta, sınırsız meşrubat, canlı müzik, DJ, 5 yöre halk oyunu, oryantal şov ve Mevlana semazen. Panoramik camlardan aydınlatılmış Boğaz Köprüsü ve sarayların manzarası. 11.317 yorumdan 4.8★.",
    ...
    id: "Bosphorus Night menawarkan nilai kuat €24/orang: pelayaran 3 jam dengan 10 mezes, hidangan utama, dan kue es krim; minuman ringan tak terbatas; musik live, DJ, 5 tarian folklor regional, pertunjukan tari perut, dan derwis berputar Mevlana. Jendela panorama menampilkan Jembatan Bosphorus yang menyala dan istana tepi laut. 4,8★ dari 11.317 ulasan.",
    ms: "Bosphorus Night menawarkan nilai kuat pada €24/orang: pelayaran 3 jam dengan 10 mezes, hidangan utama dan kek ais krim; minuman ringan tanpa had; muzik langsung, DJ, 5 tarian rakyat serantau, persembahan tarian perut dan dervis berpusing Mevlana. Tingkap panoramik memaparkan Jambatan Bosphorus yang bercahaya dan istana tepi air. 4,8★ daripada 11,317 ulasan.",
  ...
  "faq.a13": {
    en: "Five reasons: TÜRSAB license (A-17672), 4.8★ from 11,317 reviews, operating since 2016 (10 years), regular boat maintenance and hygienic service, and customer support in 11 languages. From €24/person — pay on boat, no prepayment required.",
    tr: "Beş sebep: TÜRSAB lisansı (A-17672), 11.317 yorumdan 4.8★, 2016'dan beri 10 yıllık operasyon, düzenli tekne bakımı ve hijyenik servis, 11 dilde anlık müşteri desteği. €24'ten başlayan fiyat — teknede ödeme, ön ödeme yok.",
    ...
    id: "Lima alasan: lisensi TÜRSAB (A-17672), 4,8★ dari 11.317 ulasan, beroperasi sejak 2016 (10 tahun), perawatan kapal rutin dan layanan higienis, serta dukungan pelanggan dalam 11 bahasa. Mulai €24/orang — bayar di kapal, tanpa pembayaran di muka.",
    ms: "Lima sebab: lesen TÜRSAB (A-17672), 4.8★ daripada 11,317 ulasan, beroperasi sejak 2016 (10 tahun), penyelenggaraan bot tetap dan perkhidmatan bersih, serta sokongan pelanggan dalam 11 bahasa. Bermula €24/orang — bayar di atas bot, tiada bayaran pendahuluan.",
