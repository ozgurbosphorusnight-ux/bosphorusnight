...
| 4 | **Internal linking** — 17 landing page birbirine cross-link (Bosphorus Dinner → Romantic, VIP, Sunset). 70+ link. Topical authority sinyali | 1 sa | 🔴 Topical authority | ⏳ **ERTELENDİ 2 May** — önce 17 landing page'in differentiation audit'i gerekli (her sayfa gerçekten farklı angle veriyor mu, yoksa near-duplicate mi?). Yeterli farklılık yoksa cross-link müşteri için "aynı şey" hissi yaratır + Google duplicate content cezası. Audit ~30 dk, sonra karar. |
