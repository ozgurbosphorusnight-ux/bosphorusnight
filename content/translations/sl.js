...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Kako rezerviram VIP plovbo po Bosporju?', a: 'Uporabi obrazec za rezervacijo na tej strani — v 1. koraku izberi "VIP", nastavi datum, vnesi število gostov, nato kontaktne podatke. Tvoja zahteva pride prek WhatsAppa / Telegrama / WeChata in takoj potrdimo. Plačaš na ladji, ne zdaj.' },
  ...
  'bosphorus-night-tour': {
    ...
    faq: [
      ...
      { q: 'Ne govorim turško — ali je tura v angleščini?', a: 'Posadka govori angleško. Zabava (sema, ljudski plesi, glasba) ne zahteva jezika. Večerni meni je v angleščini. Rezervacija prek WhatsAppa / Telegrama / WeChata deluje v več jezikih (angleški, arabski, ruski, nemški, francoski, španski). Turščina ni potrebna.' }
    ],
    cta: {
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
      ...
      { q: 'Od kod odpluje večerna plovba v Istanbulu?', a: 'Pomol Kabataş, Istanbul — na evropski obali, blizu palače Dolmabahçe. Točno mesto srečanja je sporočeno prek WhatsAppa / Telegrama / WeChata po rezervaciji. Video poti peš od tramvajske postaje Dolmabahçe in tramvajske postaje Kabataş sta v zgornjem razdelku mesta srečanja.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    intro: [
      ...
      'Postopek za **vstopnice za plovbo po Bosporju**: izpolni obrazec na tej strani v manj kot 1 minuti (datum, število gostov, paket, kontakt), takoj potrdimo prek WhatsAppa / Telegrama / WeChata, pridi na pomol Kabataş ob 19:30, plačaš na ladji, uživaj v 3-urni večerni plovbi. Brez fizične vstopnice za tisk, brez kupona za prejem po elektronski pošti — potrditev je tvoja vstopnica.',
    ...
    highlights: [
      ...
      { title: 'Potrditev v manj kot 1 minuti', desc: 'Izpolni obrazec → potrdimo prek WhatsAppa / Telegrama / WeChata. Brez PDF kupona za tiskanje iz elektronske pošte. Naše sporočilo je tvoja vstopnica. Pridi na pomol ob 19:30.' },
    ...
    faq: [
      ...
      { q: 'Kje lahko kupim vstopnice za plovbo po Bosporju?', a: 'Neposredno s te strani — izpolni obrazec za rezervacijo, takoj potrdimo prek WhatsAppa / Telegrama / WeChata. Plačaš na ladji. Tretje platforme (Viator, GetYourGuide, Klook) prav tako prodajajo vstopnice, vendar običajno zaračunajo €30–80+ — to je doplačilo posrednikov. Neposredno je najceneje in najhitreje.' },
      { q: 'Ali moram natisniti vstopnico za plovbo po Bosporju?', a: 'Ne — fizična vstopnica ali kupon ni potreben. Po rezervaciji ti pošljemo potrditev prek WhatsAppa (ali Telegrama/WeChata) z mestom srečanja, časom in imenom rezervacije. Le pokaži telefon na pomolu. To je vse.' },
  ...
  'last-minute-bosphorus': {
    ...
    highlights: [
      ...
      { title: 'Potrditev v manj kot 5 minutah', desc: 'Izpolni obrazec → WhatsApp/Telegram/WeChat sporočilo o potrditvi → končano. Brez čakanja na elektronski kupon, brez tiskanja QR kode. Naše sporočilo je tvoja vstopnica.' },
