...
module.exports = {
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Koliko stane plovba po Bosporju ob sončnem zahodu?', a: 'Od €{p.dinnerStd}/osebo za standardno plovbo (3 ure, popolna večerja, zabava v živo). VIP možnost s sedeži ob odru in premium meze stane €{p.dinnerVip}/osebo. Plačaš na ladji — brez predplačila. Otroci 0–3 let brezplačno, 4–8 let polovična cena.' },
