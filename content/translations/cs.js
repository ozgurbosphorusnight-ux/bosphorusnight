...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    meta: {
      ...
      description: 'Plavba s večeří 3 hodiny po Bosporu: turecké vícechodové menu a živá folklorní show. Odjezd 21:00 z Kabataşe. Bezplatné storno, platba na palubě.'
    },
    hero: {
      ...
      badge: '4,9★ · 11.317+ hostů'
    },
    intro: [
      '**Plavba s večeří po Bosporu** je nejikoničtějším večerním zážitkem Istanbulu. Naše túra odjíždí v 20:00 z přístaviště Kabataş a pluje pod osvětlenými mosty Bospor a Fatih Sultan Mehmet, nabízí vám tureckou vícechodovou večeři, živé lidové tance, orientální tanec a DJ set, který udržuje palubu živou až do 23:45.',
      'Na rozdíl od běžných turistických lodí, které zaplňují noční krajinu Istanbulu, je **naše plavba s večeří po Bosporu** licencována TÜRSAB (A-17672) a hodnocena 4,9★ více než 11.317 cestovateli. Skupiny udržujeme malé a obsluhu vřelou — a protože platíte na palubě, není žádné riziko v rezervaci předem.',
    ...
    highlights: [
      { title: 'Turecká vícechodová večeře', desc: '10 variant studených mezze, teplý předkrm (börek), hlavní chod na výběr (losos / mořský vlk / kuřecí špíz / hovězí špíz / vegetariánské), speciální krupicový dezert jako dezert, neomezené nealkoholické nápoje.' },
  ...
  'bosphorus-with-kids': {
    meta: {
      ...
      description: 'Plavba s večeří po Bosporu rodinně přátelská. Děti 0-3 zdarma, 4-9 €5 sleva. Bezpečný vnitřní prostor, dětské menu.'
    },
    hero: {
    ...
    intro: [
      ...
      'Ať už přijíždíte do Istanbulu na prodloužený víkend s batoletem, nebo vezete teenagery na jejich první evropskou cestu — toto je túra doporučená rodinami v Istanbulu. Bezpečná, halal certifikovaná, licencovaná TÜRSAB a hodnocená 4,9★ více než 11.317 cestovateli.'
    ],
    highlights: [
      { title: '0-3 roky zcela zdarma', desc: 'Žádné poplatky za miminka a batolata. 4-9 let platí €5 z ceny pro dospělé. Od 10 let host s plnou cenou. Transparentní, bez překvapení.' },
    ...
    faq: [
      ...
      { q: 'Jaká je cena pro děti na plavbě po Bosporu?', a: 'Děti **0-3 roky: ZDARMA** (žádné poplatky, žádné skryté náklady). **4-9 let: €5 sleva** z ceny pro dospělé — tedy €19.30/dítě na Standardu (€{p.dinnerStd} − €5). **10+ let: plná cena pro dospělé.** Transfer z hotelu je zdarma pro 0-3 roky, standardní pro 4+ (€{p.transfer}/osoba).' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    intro: [
      ...
      'Naše romantické uspořádání stolu (+€{p.romantic}/stůl) promění každé místo ve zvláštní okamžik: červené růže, zářící svíčky, ručně psaný uvítací lístek. Přidejte balíček 2 sklenic alkoholu pro víno pod hvězdami (+€{p.alcohol2}/osoba) nebo to udržujte jednoduché s nápoji zahrnutými. Ať si vyberete cokoli, posádka se diskrétně postará o zbytek.',
      'Ať už slavíte výročí, plánujete překvapení pro svého partnera nebo prostě chcete nezapomenutelný večer v nejromantičtějším městě Evropy — toto je túra, kterou preferují páry v Istanbulu. Hodnocení 4,9★, licencováno TÜRSAB a — nejdůležitější — platba na palubě, takže slibujete pouze samotný večer.'
    ],
    highlights: [
    ...
    faq: [
      ...
      { q: 'Kolik stojí romantická plavba pro 2 osoby?', a: '2 osoby: 2 × €{p.dinnerStd} = €48.60. Přidejte romantické uspořádání +€{p.romantic} = €63,60. Bez platby předem — platba na palubě. Balíček 2 sklenic alkoholu pro dva: další 2 × €{p.alcohol2} = €20.' },
  ...
  'halal-bosphorus-cruise': {
    ...
    intro: [
      '**Halal plavba po Bosporu** je nejuctivější plavba s večeří v Istanbulu pro muslimské cestovatele. Veškeré maso podávané na naší lodi — losos, mořský vlk, kuřecí špíz, hovězí špíz — je **halal certifikované** od schválených dodavatelů. Servírujeme stejné menu každému hostovi; žádná samostatná "halal sekce", protože celá loď je standardně halal.',
      'Alkohol je **volitelný doplněk** — nikdy nevnucovaný hostům a uspořádání stolů přirozeně odděluje hosty, kteří preferují jídlo bez alkoholu. Pro hosty, kteří chtějí balíček 2 sklenic alkoholu (+€{p.alcohol2}/osoba), je k dispozici, ale zahrnuté neomezené nealkoholické nápoje (voda, kola, džus) jsou pro většinu muslimských rodin dostačující. Naše posádka je vyškolena respektovat vaše preference bez předpokladů.',
      '**Halal přátelská plavba po Bosporu** záleží pro cestovatele ze Saúdské Arábie, SAE, Kuvajtu, Kataru, Íránu, Malajsie, Indonésie, Pákistánu a Maroka, kteří chtějí nejikoničtější večer Istanbulu bez kompromisů. Licencováno TÜRSAB, 4,9★ a platba na palubě — neslibujte nic, dokud si nejste jisti, že zážitek splňuje vaše standardy.'
    ],
    highlights: [
      { title: '100% halal certifikované menu', desc: 'Veškeré maso (losos, mořský vlk, kuřecí špíz, hovězí špíz) je halal certifikované od schválených dodavatelů. Kuchyně dodržuje halal přípravu. Žádné vepřové produkty ani neHalal přísady. Vegetariánské možnosti jsou vždy k dispozici.' },
      ...
      { title: 'Respekt k modlitebním hodinám', desc: 'Pokud nalodění připadne na maghrib nebo isha (20:00-21:00), naše posádka vás může nasměrovat do tiché modlitební zóny na přístavišti Kabataş před odjezdem. Stačí nám dát vědět při rezervaci.' }
    ],
    faq: [
      { q: 'Je plavba po Bosporu 100% halal?', a: 'Ano — každý masný produkt v menu (losos, mořský vlk, kuřecí špíz, hovězí špíz) je halal certifikovaný od schválených dodavatelů. Kuchyně dodržuje halal standardy přípravy. Vepřové se na palubě nikde nepodává. Není to "halal možnost" — celé menu je halal.' },
  ...
  'bosphorus-vip': {
    meta: {
      title: 'VIP zážitek na Bosporu od €{p.dinnerStd} — prémiová večeře na Bosporu',
      description: 'Plavba s večeří po Bosporu na VIP úrovni: kompletní turecké menu, živá show, možnost stolu u pódia, pozorná obsluha. €{p.dinnerStdOriginal} → €{p.dinnerStd}. Platba na lodi, bezplatné storno.'
    },
    hero: {
      h1: 'VIP zážitek na Bosporu — plavba s večeří',
      subtitle: 'Jedno menu, jeden standard: prémiové pro všechny. Tříhodinový večer na Bosporu na palubě lodi Bosphorus Night — bohatá turecká večeře, živá show na pódiu a na přání soukromý stůl u pódia. Neprodáváme oddělenou „VIP třídu“ — to nejlepší servírujeme každému hostu.',
      badge: 'SLEVA 40% · Jedno menu, prémiový standard · Platba na lodi'
    },
    intro: [
      'Mnoho lodí na Bosporu dělí hosty na „standardní“ a „VIP“. My ne. Na palubě lodi **Bosphorus Night** je jediné večeřové menu, připravené se stejnou péčí pro všechny: 10 druhů tureckých meze, teplý předkrm, hlavní chod dle výběru (losos, mořský vlk, kuřecí špíz nebo hovězí špíz), speciální krupicový dezert a neomezené nealkoholické nápoje. Celý osmidílný zábavní program je rovněž v ceně — Oba Dombra, obřad vířících dervišů, anatolské a ázerbájdžánské lidové tance, břišní tanec, kavkazský tanec s noži, živá hudba a finále se saxofonem a DJ — vše v ceně €{p.dinnerStd}/osobu.',
      ...
      'Bosphorus Night je moderní loď: 42 metrů, 3 paluby, až 400 hostů, v zimě vytápěná a v létě klimatizovaná. Tříhodinová trasa vyplouvá z Kabataşe (nástup od 20:00, odjezd 21:00, návrat 00:00) kolem Dolmabahçe, mešity Ortaköy, pevnosti Rumeli a světel mostu přes Bospor. Licence TÜRSAB (A-17672), 4,9★ na Google. Bez platby předem — platíte na lodi a storno je zdarma až do 2 hodin před odplutím.'
    ],
    highlights: [
      { title: 'Jedno menu, prémiový standard', desc: 'Žádné oddělené „VIP menu“ neexistuje — protože naše jediné menu už na této úrovni je. 10 druhů meze, teplý předkrm, 4 hlavní chody na výběr, dezert a neomezené nealkoholické nápoje, servírované se stejnou péčí u každého stolu.' },
      { title: 'Soukromý stůl u pódia (+€{p.romantic}/stůl)', desc: 'Stoly nejblíže dervišům, lidovým tancům a břišnímu tanci rezervujeme předem. Skvělý výhled na pódium i na Bospor. Váš stůl je soukromý, nikoli sdílený.' },
      { title: 'Pozorná obsluha u stolu', desc: 'Náš tým vás obslouží přímo u stolu: chody, doporučení z menu, nápoje navíc, zvláštní přání. Žádné fronty v davu.' },
      { title: 'SLEVA 40% — dříve €{p.dinnerStdOriginal}, nyní €{p.dinnerStd}', desc: 'Cena při přímé rezervaci: €{p.dinnerStd}/osobu (ceníková cena €{p.dinnerStdOriginal}). Platba na lodi, bez zálohy. Bezplatné storno až do 2 hodin před odplutím.' }
    ],
    faq: [
      ...
      { q: 'Jaká je to loď?', a: 'Bosphorus Night — moderní osobní loď dlouhá 42 metrů se 3 palubami a kapacitou 400 hostů, v zimě vytápěná a v létě klimatizovaná. Odplutí z mola Kabataş: nástup 20:00, odplutí 21:00, návrat 00:00. Trasa: Dolmabahçe, Ortaköy, pevnost Rumeli, Beylerbeyi a světla mostu přes Bospor.' }
    ],
    cta: {
      primary: 'Rezervujte si stůl · Platba na lodi',
      secondary: 'Dříve €{p.dinnerStdOriginal}, nyní €{p.dinnerStd} · Bezplatné storno 2 hodiny předem',
      tertiary: 'Přidat soukromý stůl u pódia (+€{p.romantic})'
    }
  },
  ...
  'private-bosphorus-cruise': {
    ...
    intro: [
      ...
      'Ať už organizujete firemní akci pro klienty, oslavu 50. narozenin nebo svatební hostinu pod nejikoničtějšími mosty Istanbulu, toto je **soukromá plavba, kterou důvěřují organizátoři akcí v Istanbulu**. Hodnocení 4,9★, licencováno TÜRSAB, plně anglicky mluvící posádka a plná flexibilita — trasa, menu, hudba, program.'
    ],
    highlights: [
      ...
      { title: 'Flexibilní doba a odjezd', desc: '3 standardní hodiny lze prodloužit na 4-5 hodin. Vyberte si denní odjezd ve 12:00, západ slunce v 17:30 nebo večer ve 21:00. Chcete pracovní den místo víkendu? Žádný problém — přizpůsobíme se vašemu programu.' },
    ...
    faq: [
      { q: 'Kolik stojí soukromá plavba po Bosporu?', a: 'Pro skupiny 25+, obvykle od €{p.dinnerStd}/osoba + poplatek za pronájem lodi v závislosti na velikosti skupiny, datu a době. Napište nám přes WhatsApp s velikostí skupiny, datem a požadavky — cenu poskytneme do hodiny. Většina akcí se vejde do celkového rozmezí €2.000-€6.000.' },
      { q: 'Jaká je minimální velikost skupiny pro soukromou plavbu po Bosporu?', a: 'Technicky 25 hostů činí soukromou plavbu ekonomicky proveditelnou. Menší skupiny (10-24) mohou pronajímat soukromě, ale platí minimální cenu odpovídající ~25 osobám. Pro skutečně malé skupiny (2-10) zvažte běžnou plavbu s večeří — váš stůl je již soukromý, sdílena je pouze loď.' },
  ...
  'bosphorus-for-couples': {
    ...
    intro: [
      ...
      'Ať už jste v Istanbulu 3 dny se svým partnerem, slavíte skromnou událost nebo plánujete průzkumnou cestu pro budoucí žádost o ruku — **plavba po Bosporu pro páry** vám nabízí 3 hodiny večera společně v jednom z nejfotografovanějších měst světa. 4,9★, platba na palubě, bezplatné storno.'
    ],
    highlights: [
      ...
      { title: 'Pomalá vícechodová večeře', desc: '10 variant tureckých mezze, teplý předkrm, hlavní chod (losos, mořský vlk, kuřecí špíz, hovězí špíz nebo vegetariánské), speciální krupicový dezert jako dezert. Podáváno pomalu po dobu 3 hodin — nespěcháte.' },
    ...
    faq: [
      ...
      { q: 'Kolik stojí plavba po Bosporu pro 2 osoby?', a: '2 osoby: 2 × €{p.dinnerStd} = €48.60. Přidejte transfer z hotelu pro dva: +€{p.transfer}×2 = €10. Přidejte balíček 2 sklenic alkoholu pro dva: +€{p.alcohol2}×2 = €20. Bez platby předem — platba na palubě.' },
      { q: 'Mohou si páry přivézt vlastní víno nebo šampaňské?', a: 'Nepovolujeme externí alkohol (z důvodů provozní licence). Ale máme balíček 2 sklenic místního vína nebo piva (+€{p.alcohol2}/osoba) a můžeme zařídit dovážená prémiová vína nebo šampaňské za poplatek — zeptejte se při rezervaci. Prosecco, Chianti a Cabernet jsou oblíbené prémiové požadavky.' },
      ...
      { q: 'Kdy je plavba po Bosporu pro páry nejlepší — západ slunce nebo večer?', a: 'Plavba vyplouvá každý večer ve 21:00 — a v létě (květen–srpen) tento jediný odjezd pokrývá obojí: nalodění od 20:00 během zlaté hodiny, západ slunce přímo kolem odjezdu a poté osvětlené mosty a zářící paláce. V zimě jde o čistě noční plavbu se světly města. Tak či tak, jediná rezervace dává párům tu nejikoničtější podobu Bosporu.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      title: 'Plavba při Západu Slunce s Večeří po Bosporu od €{p.dinnerStd}',
      description: 'Zachyťte západ slunce nad Bosporem a pak večeřte pod osvětlenými mosty. Nalodění 20:00 na Kabataşi, odjezd 21:00. 3 hodiny, plná večeře. Platba na palubě.'
    },
    hero: {
      h1: 'Plavba při Západu Slunce s Večeří po Bosporu',
      subtitle: 'Nastupte v 20:00, když nebe nad minarety zlátne — a pak večeřte na vodě, zatímco se Dolmabahçe, mešita Ortaköy a most Bospor rozsvěcují do noci.',
      badge: 'Nalodění 20:00 · Odjezd 21:00 · Od Západu Slunce k Světlům Města'
    },
    intro: [
      '**Plavba při západu slunce po Bosporu** je v Istanbulu především o jednom: o přechodu. Naše plavba nalodí hosty na přístavišti Kabataş od 20:00 — a během dlouhých večerů od května do srpna se zlatá hodina odehrává, zatímco se usazujete na palubě. Slunce zapadá za minarety evropského břehu přesně kolem odjezdu ve 21:00, takže ho sledujete z vody: Palác Dolmabahçe zalitý zlatem, mešita Ortaköy jako silueta proti zářícímu nebi.',
      'Naše **plavba po Bosporu od západu slunce do noci** zahrnuje plnou tureckou večeři — 10 variant mezze, teplý předkrm, hlavní chod dle výběru, dezert — servírovanou ve chvíli, kdy město rozsvěcuje svá světla. Než přijde dezert, plujete pod osvětleným mostem Bospor s 30 miliony světel odrážejícími se v tmavé vodě. Proměna ze soumraku do plné noci, celá v rámci jedné 3hodinové plavby, je přesně to, o co tu jde.',
      'Ať už jste fotograf honící poslední světlo, pár toužící po "istanbulské vzpomínkové fotografii", nebo návštěvník, který chce klasický večer na vodě — toto je **plavba s večeří při západu slunce po Bosporu**, kterou místní doporučují návštěvníkům. Od €{p.dinnerStd}/osoba, hodnocení 4,9★, licencováno TÜRSAB, platba na palubě — bez platby předem.'
    ],
    highlights: [
      { title: 'Letní západy slunce přesně při odjezdu', desc: 'Od května do srpna zapadá slunce v Istanbulu zhruba mezi 20:15–20:45 — nalodění v 20:00 vám dopřeje zlatou hodinu na palubě a odjezd ve 21:00 vás dostane na vodu přesně na samotný západ slunce. Fotoaparát připravený — tohle je ta fotografie.' },
      { title: 'Modrá hodina přecházející do plné noci', desc: 'Nejen západ slunce — plavba proplouvá soumrakem až do plně osvětleného Bosporu. Zlaté světlo, modrá hodina a pak 30 milionů světel mostu na tmavé vodě: tři fáze světla v jediném večeru.' },
      { title: 'Plná večeře během plavby', desc: '10 variant tureckých mezze, teplý předkrm, hlavní chod (losos, mořský vlk, kuřecí špíz, hovězí špíz, vegetariánské), speciální krupicový dezert, neomezené nealkoholické nápoje — servírováno, zatímco se rozsvěcují světla města.' },
      { title: 'Dolmabahçe, Ortaköy, most Bospor — vše září', desc: 'Trasa prochází kolem Paláce Dolmabahçe, mešity Ortaköy, mostu Bospor, Rumeli Hisarı a Paláce Beylerbeyi právě ve chvíli, kdy se rozsvěcují jejich světla. Každý památník ve svém nejlepším světle.' }
    ],
    faq: [
      ...
      { q: 'Kolik stojí plavba při západu slunce po Bosporu?', a: 'Od €{p.dinnerStd}/osoba za plavbu (3 hodiny, plná večeře, živá zábava). Platba na palubě — bez platby předem. Děti 0-3 roky zdarma, 4-9 let €5 sleva.' },
      ...
      { q: 'V kolik hodin zapadá slunce v Istanbulu?', a: 'V létě (červen–červenec) zapadá slunce v Istanbulu kolem 21:00–20:45. V zimě kolem 16:30–17:00. Pro zážitek západu slunce i noci zachytí plavba s večeří Bospor v noci ve 21:00 z Kabataşe v létě pozdní zlatou hodinu a modrou hodinu, a osvětlené památky po celý rok.' },
      { q: 'Stojí plavba při západu slunce po Bosporu za to?', a: 'Ano — západ slunce nad mostem Bospor patří k charakteristickým výhledům Istanbulu. Plavba s večeří Bospor v noci ve 21:00 (€{p.dinnerStd}/osoba) zachytí modrou hodinu po západu slunce i osvětlené paláce, s plnou večeří a živými show během 3 hodin.' }
    ],
    cta: {
      primary: 'Rezervovat Plavbu při Západu Slunce · Platba na Palubě',
      secondary: 'Nalodění 20:00 · Odjezd 21:00 · Večeře zahrnuta · Bezplatné storno 2 hodiny předem',
      tertiary: 'Zobrazit Kompletní Detaily Plavby s Večeří'
    }
  },
  ...
  'bosphorus-night-tour': {
    meta: {
      ...
      description: 'Noční túra 3 hodiny po Bosporu s večeří a živou show. Odjezd 21:00 z Kabataşe, osvětlené mosty. Bezplatné storno, platba na palubě.'
    },
    hero: {
    ...
    intro: [
      ...
      'Ať už je to vaše první návštěva Istanbulu a hledáte "jedinou věc, kterou musíte v noci dělat", nebo jste tu byli dříve a chcete nejfotogeničtějších 3 hodin města, toto je **noční túra po Bosporu** hodnocená 4,9★ více než 11.317 cestovateli. Licencováno TÜRSAB, platba na palubě, bez platby předem.'
    ],
    highlights: [
      ...
      { title: 'Plná vícechodová večeře', desc: '10 variant tureckých mezze, teplý předkrm (börek), hlavní chod (losos, mořský vlk, kuřecí špíz, hovězí špíz, vegetariánské — vaše volba), dezert (speciální krupicový dezert), neomezené nealkoholické nápoje. Halal certifikováno.' },
    ...
    faq: [
      ...
      { q: 'Kolik stojí noční túra po Bosporu?', a: 'Noční túra (3 hodiny, večeře, show): €{p.dinnerStd}/osoba (dříve €{p.dinnerStdOriginal}). 0-3 roky zdarma, 4-9 let €5 sleva. Platba na palubě.' },
      ...
      { q: 'Nemluvím turecky — je túra v angličtině?', a: 'Posádka mluví anglicky. Zábava (sema, lidové tance, hudba) nevyžaduje jazyk. Menu večeře je v angličtině. Rezervace přes WhatsApp / Telegram funguje v několika jazycích (angličtina, arabština, ruština, němčina, francouzština, španělština). Turečtinu není třeba.' }
    ],
    cta: {
      primary: 'Rezervovat Noční Túru · Platba na Palubě',
      secondary: 'Odjezd 21:00 · 3 hodiny · Večeře + show zahrnuty · Bezplatné storno 2 hodiny předem',
      tertiary: 'Dostupnost Dnes Večer'
    }
  },
  ...
  'dinner-cruise-istanbul': {
    meta: {
      ...
      description: 'Plavba s večeří 3 hodiny v Istanbulu po Bosporu. Turecké vícechodové menu, živý folklór, osvětlené mosty. Bezplatné storno, platba na palubě. 11.317+ hostů.'
    },
    hero: {
      ...
      badge: '4,9★ · 11.317+ hostů · TÜRSAB A-17672'
    },
    intro: [
      'Hledáte **plavbu s večeří v Istanbulu**? Našli jste to, co většina cestovatelů doporučuje. Náš 3hodinový večer po Bosporu kombinuje plnou tureckou vícechodovou večeři, živé lidové tance a nejfotogeničtější výhledy města — vše z pohodlné lodi, která odjíždí ve 21:00 z přístaviště Kabataş.',
      'Zážitek **plavby s večeří v Istanbulu**: nastupte v 20:00, posaďte se, sledujte Palác Dolmabahçe, zatímco odjíždíme, večeře začíná, když se přibližujeme k mešitě Ortaköy, show začíná (sema, lidové tance, orientální), a do dezertu jste pod osvětleným mostem Bospor. O půlnoci se vracíte do Kabataşe s ikonickou kolážou fotografií a plným žaludkem.',
      '€{p.dinnerStd}/osoba (dříve €{p.dinnerStdOriginal}). Platba na palubě — bez platby předem, bez rizika. Licencováno TÜRSAB A-17672, hodnoceno 4,9★ více než 11.317 cestovateli.'
    ],
    highlights: [
      { title: 'Plná turecká vícechodová večeře', desc: '10 variant mezze, teplý předkrm, hlavní chod (losos/mořský vlk/kuřecí špíz/hovězí špíz/vegetariánské), speciální krupicový dezert. Halal certifikováno. Neomezené nealkoholické nápoje zahrnuty.' },
    ...
    cta: {
      ...
      secondary: '4,9★ · Licencováno TÜRSAB · Bezplatné storno 2 hodiny předem',
      tertiary: 'Dostupnost Dnes Večer'
    }
  },
  ...
  'istanbul-night-tour': {
    meta: {
      ...
      description: 'Plavba 3 hodiny po Bosporu s večeří a živou show. Odjezd 21:00 z Kabataşe. Bezplatné storno, platba na palubě. 11.317+ hostů. Transfer z hotelu volitelný.'
    },
    hero: {
    ...
    intro: [
      ...
      'Večeře je zahrnuta (turecké vícechodové menu), živá show tureckých lidových tanců, sema, orientální tanec a DJ set. Pokud jste v Istanbulu 2-3 dny, je to jediný večer, který dává nejsilnější úder. 4,9★ z více než 11.317 cestovatelů, platba na palubě, bez platby předem.'
    ],
    highlights: [
      ...
      { title: 'Plná turecká večeře zahrnuta', desc: '10 mezze, teplý předkrm, hlavní chod (losos/mořský vlk/kuřecí špíz/hovězí špíz/vegetariánské), dezert, neomezené nealkoholické nápoje. Halal certifikováno. Cena €{p.dinnerStd}/osoba — vše zahrnuto.' },
    ...
    faq: [
      ...
      { q: 'Kolik stojí túra po Istanbulu v noci?', a: 'Naše noční túra s večeří po Bosporu: €{p.dinnerStd}/osoba. Zahrnuje túru, večeři, zábavu, nealkoholické nápoje. Volitelně: alkohol (2 sklenice) +€{p.alcohol2}/osoba, transfer z hotelu +€{p.transfer}/osoba. Platba na palubě — bez platby předem.' },
      ...
      { q: 'Jaký je nejlepší čas na noční túru v Istanbulu?', a: 'Naše plavba s večeří po Bosporu je 21:00-00:00 (3 hodiny). Toto je vrcholný čas osvětlení pro všechny památníky Istanbulu — mosty plně osvětlené, paláce září, měsíc na vodě. Pokud chcete i zlatou hodinu, přijeďte v létě: nalodění začíná v 20:00 a od května do srpna slunce zapadá přímo kolem odjezdu ve 21:00 — jedna a tatáž plavba pokryje obojí.' },
  ...
  'istanbul-boat-tour': {
    meta: {
      ...
      description: 'Lodní túra 3 hodiny: plavba po Bosporu, plná turecká večeře, živý folklór, osvětlené noční krajiny. Bezplatné storno, platba na palubě. 11.317+ hostů.'
    },
    hero: {
      ...
      badge: '4,9★ · TÜRSAB A-17672 · Platba na Palubě'
    },
    intro: [
      ...
      'Na rozdíl od mnoha 1hodinových turistických trajektů, které pokrývají méně z Bosporu a vynechávají večeři a zábavu, je **naše lodní túra v Istanbulu** kompletní večerní zážitek: nalodění v 20:00 na přístavišti Kabataş, túra do půlnoci, 10 mezze, hlavní chod, dezert, sema, lidové tance, orientální tanec a DJ. Dostanete také večerní výlet jako součást túry.',
      'Ať už máte večer nebo celý týden v Istanbulu, tato **lodní túra v Istanbulu** dělá svou práci. 4,9★ z více než 11.317 cestovatelů, licencováno TÜRSAB (A-17672), halal certifikované menu a platba na palubě — žádný finanční závazek, dokud nejste spokojeni se zážitkem.'
    ],
    highlights: [
      ...
      { title: 'Večerní odjezd (nejlepší osvětlení)', desc: 'Odjezd ve 21:00 zachycuje osvětlený Bospor v plné záři — mosty, paláce, mešity vše osvětlené. Dramatičtější než denní túry, které ukazují stejné památníky v plochém světle.' },
    ...
    faq: [
      ...
      { q: 'Kolik stojí lodní túra v Istanbulu?', a: 'Naše lodní túra s večeří: €{p.dinnerStd}/osoba (dříve €{p.dinnerStdOriginal}). 0-3 roky zdarma, 4-9 let €5 sleva. Platba na palubě. Alkohol a transfer z hotelu jsou volitelné doplňky.' },
  ...
  'bosphorus-trip': {
    meta: {
      ...
      description: 'Výlet 3 hodiny po Bosporu: turecká večeře, živý folklór, osvětlené noční krajiny. Odjezd 21:00 z Kabataşe. Bezplatné storno, platba na palubě.'
    },
    hero: {
      h1: 'Výlet po Bosporu',
    ...
    intro: [
      ...
      'Ať už jste v Istanbulu 24 hodin nebo týden, toto je **výlet po Bosporu**, který vám dává nejvíce za jeden večer. Hodnocení 4,9★ z více než 11.317 cestovatelů, licencováno TÜRSAB A-17672, halal přátelské menu, platba na palubě — žádné riziko platby předem.'
    ],
    highlights: [
      ...
      { title: 'Od €{p.dinnerStd} — platba na palubě', desc: 'Není vyžadována platba předem. Platba na palubě (hotovost nebo karta). Bezplatné storno až 2 hodiny před odjezdem. 0-3 roky zdarma, 4-9 let €5 sleva. Transparentní ceny.' }
    ],
    faq: [
  ...
  'bosphorus-cruise-tickets': {
    meta: {
      ...
      description: 'Přímé vstupenky na plavbu po Bosporu od €{p.dinnerStd}/osoba. Bez platby předem, platba na palubě. Bezplatné storno až 2h předem.'
    },
    hero: {
    ...
    intro: [
      'Hledáte **vstupenky na plavbu po Bosporu**? Kupte přímo. Naše vstupenka stojí €{p.dinnerStd}/osoba — 40% sleva oproti běžné ceně (€{p.dinnerStdOriginal}). Třetí strany rezervačních stránek obvykle přidávají 20-40% provize. Rezervací přímo ušetříte — a stále platíte na palubě.',
      'Náš proces **vstupenek na plavbu po Bosporu**: vyplňte formulář na této stránce za méně než 1 minutu (datum, počet hostů, kontakt), okamžitě potvrdíme přes WhatsApp / Telegram, dostavíte se na přístaviště Kabataş v 20:00, platíte na palubě, užíváte si 3hodinovou plavbu s večeří. Žádná fyzická vstupenka k tisku, žádný kupón k přijetí e-mailem — potvrzení je vaše vstupenka.',
      'Ať už rezervujete plavbu s večeří na dnes večer nebo rezervujete na konkrétní datum příští týden, **přímé vstupenky na plavbu po Bosporu** jsou nejrychlejším způsobem. Hodnocení 4,9★, licencováno TÜRSAB (A-17672), halal certifikované menu a podporuje doplňky transfer z hotelu a alkohol.'
    ],
    highlights: [
      { title: 'Přímá rezervace — bez poplatků zprostředkovatelů', desc: '€{p.dinnerStd}/osoba — jedna transparentní cena. Stránky třetích stran účtují €30-80+ za stejnou túru. Ušetřete rezervací přímo u nás. Žádné skryté poplatky, žádný příplatek provize.' },
      ...
      { title: 'Potvrzení za méně než 1 minutu', desc: 'Vyplňte formulář → potvrzujeme přes WhatsApp / Telegram. Žádný kupón PDF k e-mailu k tisku. Naše zpráva je vaše vstupenka. Přijďte na přístaviště v 20:00.' },
    ...
    faq: [
      ...
      { q: 'Jsou vstupenky pro děti na plavbu po Bosporu zdarma?', a: 'Děti **0-3 roky zcela zdarma** (žádné poplatky, žádné skryté náklady, transfer zahrnut). **4-9 let €5 sleva** (€{p.dinnerStd} − €5 = €19.30). **10+ let plná cena pro dospělé.** Pevné a transparentní ceny — žádné triky "příplatku pro miminko".' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    meta: {
      ...
      description: 'Rezervace plavby po Bosporu ve stejný den. Potvrzení WhatsApp za minuty. Odjezd 21:00 z Kabataşe. Bezplatné storno, platba na palubě. 11.317+ hostů.'
    },
    hero: {
    ...
    intro: [
      'Přistáli jste v Istanbulu dnes odpoledne a chcete krásný večer dnes? **Plavba po Bosporu na poslední chvíli** funguje. Speciálně rezervujeme místa pro rezervace ve stejný den, protože víme, že mnoho cestovatelů se rozhoduje ráno. Vyplňte formulář zde, potvrzujeme přes WhatsApp za několik minut, dostavíte se na přístaviště Kabataş v 20:00, platíte na palubě, užíváte si.',
      '**Naše plavba po Bosporu na poslední chvíli** má stejný večerní program jako předběžné rezervace: 3 hodiny na vodě (21:00-00:00), turecká vícechodová večeře, živá show lidových tanců, sema, orientální tanec, DJ. Osvětlený Palác Dolmabahçe, mešita Ortaköy, most Bospor — stejné ikonické výhledy. Stejná cena: €{p.dinnerStd}/osoba.',
    ...
    highlights: [
      ...
      { title: 'Potvrzení za méně než 5 minut', desc: 'Vyplňte formulář → potvrzovací zpráva WhatsApp/Telegram → hotovo. Žádný e-mail s kupónem, na který čekat, žádný QR kód k tisku. Naše zpráva je vaše vstupenka.' },
      ...
      { title: 'Transfer z hotelu ve stejný den často k dispozici', desc: 'Transfer z hotelu obvykle vyžaduje 24hodinové oznámení, ale pro rezervace ve stejný den mezi 14:00-18:30 můžeme často zařídit vyzvednutí s +€{p.transfer}/osoba. Pro naléhavé požadavky na transfer, WhatsApp.' }
    ],
    faq: [
      { q: 'Mohu skutečně rezervovat plavbu po Bosporu na dnes večer?', a: 'Ano — často. Rezervujeme místa pro rezervace ve stejný den. Zkontrolujte formulář výše pro dostupnost dnes večer. Pokud jsou místa k dispozici, můžete rezervovat do 21:00. Víkendy jsou rušnější — rezervujte dříve v den, pokud je to možné.' },
      { q: 'Jak last minute mohu rezervovat?', a: 'Rezervace zůstávají otevřené do 21:00 — až do samotného odjezdu. Pokud je to opravdu těsně před odjezdem, napište nám přímo na WhatsApp +90 532 244 29 22 — pokud jsou místa volná, potvrdíme ručně.' },
      { q: 'Je plavba po Bosporu na poslední chvíli dražší?', a: 'Ne — stejná cena jako předběžná rezervace. €{p.dinnerStd}/osoba. Neděláme "dynamické ceny" ani příplatky za poslední chvíli. Stejná loď, stejná večeře, stejná show, stejná cena.' },
      ...
      { q: 'Můžete zařídit transfer z hotelu na poslední chvíli?', a: 'Transfer ve stejný den je možný do ~18:30 pro túru ve 21:00. Po 18:30 nemusíme mít k dispozici řidiče — v tomto případě si můžete vzít taxi na přístaviště Kabataş (15 min z Taksimu, 10 min ze Sultanahmetu, ~€10-15). Centrální a snadné.' },
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Ceny plavby po Bosporu Istanbul: €{p.dinnerStd}/osoba. Děti 0-3 zdarma, 4-9 €5 sleva. Transparentní doplňky.'
    },
    hero: {
      h1: 'Cena Plavba Istanbul',
      subtitle: 'Transparentní ceny, žádné skryté poplatky. €{p.dinnerStd}/osoba — a platíte na palubě, ne nyní.',
    ...
    highlights: [
      ...
      { title: 'Cena pro děti: 0-3 zdarma, 4-9 €5 sleva', desc: '0-3 zcela zdarma (žádné poplatky). 4-9 s €5 slevou z ceny pro dospělé. 10+ plná cena pro dospělé. Transparentní, bez triků rodinných cen. Transfer je také zdarma pro 0-3.' },
    ...
    faq: [
      { q: 'Kolik stojí túra v Istanbulu?', a: 'Plavba s večeří: €{p.dinnerStd}/osoba (běžně €{p.dinnerStdOriginal}, 40% sleva). 0-3 roky zdarma, 4-9 let €5 sleva. Platba na palubě — bez platby předem. Bezplatné storno až 2 hodiny před odjezdem.' },
      ...
      { q: 'Musím cenu túry v Istanbulu platit předem?', a: 'Ne — **platba na palubě**. Rezervujte nyní (1minutový formulář), potvrzujeme přes WhatsApp, přijďte v 20:00 a platte na palubě (hotovost nebo karta). Bezplatné storno až 2 hodiny předem. Nulový finanční závazek, dokud nejste spokojeni.' },
