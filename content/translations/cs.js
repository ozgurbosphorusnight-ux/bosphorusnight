...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Jak rezervovat VIP plavbu po Bosporu?', a: 'Použijte rezervační formulář na této stránce — vyberte "VIP" v Kroku 1, nastavte datum, zadejte počet hostů, pak kontaktní údaje. Váš požadavek přijde přes WhatsApp / Telegram a okamžitě potvrdíme. Platba na palubě, ne nyní.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Kolik stojí plavba při západu slunce po Bosporu?', a: 'Od €{p.dinnerStd}/osoba za standardní plavbu (3 hodiny, plná večeře, živá zábava). VIP možnost s místem před pódiem a prémiovými mezze stojí €{p.dinnerVip}/osoba. Platba na palubě — bez platby předem. Děti 0-3 roky zdarma, 4-8 let poloviční cena.' },
