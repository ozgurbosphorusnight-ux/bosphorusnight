...
module.exports = {
  ...
  'romantic-bosphorus-cruise': {
    ...
    faq: [
      ...
      { q: 'Kolik stojí romantická plavba pro 2 osoby?', a: '2 osoby: 2 × €{p.dinnerStd} = €48.60,60. Přidejte romantické uspořádání +€{p.romantic} = €63,60. Bez platby předem — platba na palubě. Balíček 2 sklenic alkoholu pro dva: další 2 × €{p.alcohol2} = €20.' },
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      ...
      { q: 'Jaké jsou ceny pro muslimskou rodinu 4 osob (2 dospělí, 2 děti)?', a: 'Plavba s večeří: 2 × €{p.dinnerStd} + 2 × €12.15 (poloviční cena 4-8 let) = €72.90,60. Pokud jsou děti mladší 3 let, zdarma: 2 × €{p.dinnerStd} = €48.60,60. Přidejte €{p.transfer} transfer z hotelu na dospělého. Celkem: €48.60–€92.90 pro rodinu 4, bez platby předem, platba na palubě.' },
  ...
  'bosphorus-for-couples': {
    ...
    faq: [
      ...
      { q: 'Kolik stojí plavba po Bosporu pro 2 osoby?', a: '2 osoby: 2 × €{p.dinnerStd} = €48.60,60. Přidejte transfer z hotelu pro dva: +€{p.transfer}×2 = €10. Přidejte balíček 2 sklenic alkoholu pro dva: +€{p.alcohol2}×2 = €20. Bez platby předem — platba na palubě.' },
  ...
  'last-minute-bosphorus': {
    ...
    faq: [
      ...
      { q: 'Jak last minute mohu rezervovat?', a: 'Rezervace zůstávají otevřené do 18:00 pro loď v 21:00. Po 18:00 nám napište přímo přes WhatsApp na +90 532 244 29 22 — pokud jsou volná místa, můžeme potvrdit ručně. Po 20:00 je to velmi těsné, pokud již nejste na přístavišti Kabataş a nemůžete rychle nastoupit.' },
      ...
      { q: 'Můžete zařídit transfer z hotelu na poslední chvíli?', a: 'Transfer ve stejný den je možný do ~18:00 pro túru ve 21:00. Po 18:00 nemusíme mít k dispozici řidiče — v tomto případě si můžete vzít taxi na přístaviště Kabataş (15 min z Taksimu, 10 min ze Sultanahmetu, ~€10-15). Centrální a snadné.' },
