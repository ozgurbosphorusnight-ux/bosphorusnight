...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Ako rezervovať VIP plavbu po Bospore?', a: 'Použite rezervačný formulár na tejto stránke — vyberte "VIP" v Kroku 1, nastavte dátum, zadajte počet hostí, potom kontaktné údaje. Vaša požiadavka príde cez WhatsApp / Telegram / WeChat a okamžite potvrdíme. Platba na palube, nie teraz.' },
  ...
  'bosphorus-night-tour': {
    ...
    faq: [
      ...
      { q: 'Nehovorím po turecky — je túra v angličtine?', a: 'Posádka hovorí anglicky. Zábava (sema, ľudové tance, hudba) nevyžaduje jazyk. Menu večere je v angličtine. Rezervácia cez WhatsApp / Telegram / WeChat funguje vo viacerých jazykoch (angličtina, arabčina, ruština, nemčina, francúzština, španielčina). Tureckú nepotrebujete.' }
    ],
    cta: {
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
      ...
      { q: 'Odkiaľ odchádza plavba s večerou v Istanbule?', a: 'Prístavisko Kabataş, Istanbul — na európskom brehu, blízko Paláca Dolmabahçe. Presné miesto stretnutia je oznámené po rezervácii cez WhatsApp / Telegram / WeChat. Pešie videá zo zastávky električky Dolmabahçe a zastávky električky Kabataş sa nachádzajú v sekcii miesta stretnutia vyššie.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    highlights: [
      ...
      { title: 'Potvrdenie za menej ako 1 minútu', desc: 'Vyplňte formulár → potvrdíme cez WhatsApp / Telegram / WeChat. Žiadny kupón PDF na e-mail na tlač. Naša správa je váš lístok. Príďte na prístavisko o 19:30.' },
    ...
    faq: [
      ...
      { q: 'Kde môžem kúpiť lístky na plavbu po Bospore?', a: 'Priamo z tejto stránky — vyplňte rezervačný formulár, okamžite potvrdíme cez WhatsApp / Telegram / WeChat. Platba na palube. Platformy tretích strán (Viator, GetYourGuide, Klook) tiež predávajú lístky, ale zvyčajne účtujú €30-80+ — toto je príplatok sprostredkovateľa. Priamo je najlacnejšie a najrýchlejšie.' },
      { q: 'Musím vytlačiť lístok na plavbu po Bospore?', a: 'Nie — nie je potrebný fyzický lístok alebo kupón. Po rezervácii vám pošleme potvrdenie cez WhatsApp (alebo Telegram/WeChat) s miestom stretnutia, časom a názvom rezervácie. Stačí ukázať telefón na prístavisku. Hotovo.' },
  ...
  'last-minute-bosphorus': {
    ...
    highlights: [
      ...
      { title: 'Potvrdenie za menej ako 5 minút', desc: 'Vyplňte formulár → potvrdzovacia správa WhatsApp/Telegram/WeChat → hotovo. Žiadny e-mailový kupón na čakanie, žiadny QR kód na tlač. Naša správa je váš lístok.' },
