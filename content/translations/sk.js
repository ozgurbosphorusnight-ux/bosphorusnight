...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    highlights: [
      { title: 'Turecká viacchodová večera', desc: '10 variantov studených mezze, teplý predjedlo (paçanga böreği), hlavný chod na výber (losos / morský vlk / kura / mäsové guľôčky / vegetariánske), zmrzlinová torta ako dezert, neobmedzené nealkoholické nápoje.' },
    ...
    faq: [
      ...
      { q: 'Koľko stojí plavba s večerou po Bospore?', a: 'Plavba s večerou €{p.dinnerStd}/osoba (bežná cena €{p.dinnerStdOriginal}). 0-3 roky zadarmo, 4-9 rokov €5 zľava. Platba na palube — bez platby vopred.' },
      { q: 'Je alkohol zahrnutý v plavbe s večerou?', a: 'Neobmedzené nealkoholické nápoje (voda, kola, džús) sú zahrnuté v cene. Alkoholový balíček je voliteľný: 2 poháre (víno, pivo, rakı, vodka, whisky, gin a ďalšie) +€{p.alcohol2}/osoba. Ďalšie a dovážané nápoje sa účtujú zvlášť na palube.' },
      { q: 'Existuje transfer z hotela?', a: 'Áno — služba vyzdvihnutia a odvozu späť je +€{p.transfer}/osoba. Obsluhované zóny: Beşiktaş, Taksim, Sultanahmet, Sirkeci, Eminönü, Ortaköy, Beyoğlu, Fatih, Laleli, Topkapı, Kağıthane, Yenikapı, Sütlüce a Şişli. Túto možnosť si môžete vybrať v rezervačnom formulári.' },
  ...
  'bosphorus-with-kids': {
    meta: {
      ...
      description: 'Plavba s večerou po Bospore rodinne priateľská. Deti 0-3 zadarmo, 4-9 €5 zľava. Bezpečný vnútorný priestor, detské menu.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Bezpečná rodinná zábava', desc: 'Predstavenie sema (fascinujúce pre deti), Oba Dombra a ľudové tance z Anatólie, Azerbajdžanu a Kaukazu — vrátane veľkolepého tanca s nožmi — a k tomu živá turecká hudba a saxofónový DJ set. Všetko je rodinne priateľské — žiadny obsah pre dospelých. Deti sa často pripájajú k tancu.' }
    ],
    faq: [
      ...
      { q: 'Aká je cena pre deti na plavbe po Bospore?', a: 'Deti **0-3 roky: ZADARMO** (žiadne poplatky, žiadne skryté náklady). **4-9 rokov: €5 zľava** z ceny pre dospelých — teda €19.30/dieťa na Štandarde (€{p.dinnerStd} − €5). **10+ rokov: plná cena pre dospelých.** Transfer z hotela je zadarmo pre 0-3 roky, štandardný pre 4+ (€{p.transfer}/osoba).' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Víno, šampanské, prémiové páry', desc: 'Pridajte balíček 2 pohárov alkoholu (+€{p.alcohol2}/osoba) — víno, pivo, rakı, vodka, whisky, gin a ďalšie. Dovážané šampanské a prémiové páry na požiadanie — opýtajte sa pri rezervácii.' }
    ],
    faq: [
  ...
  'halal-bosphorus-cruise': {
    ...
    intro: [
      '**Halal plavba po Bospore** je najúctivejšia plavba s večerou v Istanbule pre moslimských cestovateľov. Všetko mäso podávané na našej lodi — losos, morský vlk, kura, jahňacie mäsové guľôčky, hovädzia sviečková, rib eye — je **halal certifikované** od schválených dodávateľov. Servírujeme rovnaké menu každému hosťovi; žiadna samostatná "halal sekcia", pretože celá loď je štandardne halal.',
    ...
    highlights: [
      { title: '100% halal certifikované menu', desc: 'Všetko mäso (losos, morský vlk, kura, mäsové guľôčky, hovädzie, rib eye) je halal certifikované od schválených dodávateľov. Kuchyňa dodržiava halal prípravu. Žiadne bravčové produkty ani neHalal prísady. Vegetariánske možnosti sú vždy k dispozícii.' },
  ...
  'bosphorus-for-couples': {
    ...
    highlights: [
      ...
      { title: 'Pomalá viacchodová večera', desc: '10 variantov tureckých mezze, teplý predjedlo, hlavný chod (losos, morský vlk, kura, mäsové guľôčky alebo vegetariánske), zmrzlinová torta ako dezert. Podávaná pomaly počas 3 hodín — neponáhľate sa.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Koľko stojí plavba pri západe slnka po Bospore?', a: 'Od €{p.dinnerStd}/osoba za plavbu (3 hodiny, plná večera, živá zábava). Platba na palube — bez platby vopred. Deti 0-3 roky zadarmo, 4-9 rokov €5 zľava.' },
  ...
  'bosphorus-night-tour': {
    ...
    highlights: [
      ...
      { title: 'Plná viacchodová večera', desc: '10 variantov tureckých mezze, teplý predjedlo (paçanga böreği), hlavný chod (losos, morský vlk, kura, mäsové guľôčky, vegetariánske — vaša voľba), dezert (zmrzlinová torta), neobmedzené nealkoholické nápoje. Halal certifikované.' },
    ...
    faq: [
      ...
      { q: 'Koľko stojí nočná túra po Bospore?', a: 'Nočná túra (3 hodiny, večera, šou): €{p.dinnerStd}/osoba (predtým €{p.dinnerStdOriginal}). 0-3 roky zadarmo, 4-9 rokov €5 zľava. Platba na palube.' },
  ...
  'dinner-cruise-istanbul': {
    ...
    highlights: [
      { title: 'Plná turecká viacchodová večera', desc: '10 variantov mezze, teplý predjedlo, hlavný chod (losos/morský vlk/kura/mäsové guľôčky/vegetariánske), zmrzlinová torta. Halal certifikované. Neobmedzené nealkoholické nápoje zahrnuté.' },
    ...
    faq: [
    {
      ...
      { q: 'Koľko stojí plavba s večerou v Istanbule?', a: 'Naša plavba s večerou stojí €{p.dinnerStd}/osoba (bežná cena €{p.dinnerStdOriginal}). 0-3 roky zadarmo, 4-9 rokov €5 zľava. Platba na palube — bez platby vopred.' },
  ...
  'istanbul-night-tour': {
    ...
    highlights: [
      ...
      { title: 'Plná turecká večera zahrnutá', desc: '10 mezze, teplý predjedlo, hlavný chod (losos/morský vlk/kura/mäsové guľôčky/vegetariánske), dezert, neobmedzené nealkoholické nápoje. Halal certifikované. Cena €{p.dinnerStd}/osoba — všetko zahrnuté.' },
      { title: 'Živé ľudové tance + sema + orientálny', desc: 'Osemdielny živý program: Oba Dombra, Mevlana sema predstavenie, Sarı Gelin, azerbajdžanské potpourri, orientálny tanec, anatolské potpourri, gruzínsko-kaukazský tanec s nožmi, potom živý saxofón a DJ. 40 minút šou, hudba v pozadí celý večer.' },
  ...
  'istanbul-boat-tour': {
    ...
    faq: [
      ...
      { q: 'Koľko stojí loďná túra v Istanbule?', a: 'Naša loďná túra s večerou: €{p.dinnerStd}/osoba (predtým €{p.dinnerStdOriginal}). 0-3 roky zadarmo, 4-9 rokov €5 zľava. Platba na palube. Alkohol a transfer z hotela sú voliteľné doplnky.' },
      ...
      { q: 'Je táto loďná túra vhodná pre rodiny s deťmi?', a: 'Áno — veľmi rodinne priateľská. Deti 0-3 roky zadarmo, 4-9 rokov €5 zľava. Zastrešený vnútorný priestor, detské menu na požiadanie a zábava (sema, ľudové tance) pútavé pre deti. Mnoho rodín z celého sveta rezervuje túto túru.' },
  ...
  'bosphorus-trip': {
    ...
    highlights: [
      ...
      { title: 'Od €{p.dinnerStd} — platba na palube', desc: 'Nie je potrebná platba vopred. Platba na palube (hotovosť alebo karta). Bezplatné storno až 2 hodiny pred odchodom. 0-3 roky zadarmo, 4-9 rokov €5 zľava. Transparentné ceny.' }
    ],
    faq: [
      ...
      { q: 'Je výlet po Bospore vhodný pre deti?', a: 'Áno — veľmi priateľský k deťom. Deti 0-3 roky zadarmo (transfer zahrnutý), 4-9 rokov €5 zľava. Zastrešený vnútorný priestor, detské menu na požiadanie a jemná a pútavá zábava. Mnoho rodín rezervuje tento výlet ako vrchol svojej cesty do Istanbulu.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    faq: [
      { q: 'Koľko stoja lístky na plavbu po Bospore?', a: '€{p.dinnerStd}/osoba (bežne €{p.dinnerStdOriginal}). Zahŕňa 3-hodinovú túru, tureckú viacchodovú večeru, živú šou ľudových tancov, neobmedzené nealkoholické nápoje. 0-3 roky zadarmo, 4-9 rokov €5 zľava. Platba na palube — bez platby vopred.' },
      ...
      { q: 'Sú lístky pre deti na plavbu po Bospore zadarmo?', a: 'Deti **0-3 roky úplne zadarmo** (žiadne poplatky, žiadne skryté náklady, transfer zahrnutý). **4-9 rokov €5 zľava** (€{p.dinnerStd} − €5 = €19.30). **10+ rokov plná cena pre dospelých.** Pevné a transparentné ceny — žiadne triky "príplatku pre bábätko".' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    ...
    faq: [
      { q: 'Môžem skutočne rezervovať plavbu po Bospore na dnes večer?', a: 'Áno — často. Rezervujeme miesta pre rezervácie v rovnaký deň. Skontrolujte formulár vyššie pre dostupnosť dnes večer. Ak sú miesta k dispozícii, môžete rezervovať do 21:00. Víkendy sú rušnejšie — rezervujte skôr v deň, ak je to možné.' },
      { q: 'Ako last minute môžem rezervovať?', a: 'Rezervácie zostávajú otvorené do 21:00 — až do samotného odchodu. Ak je to naozaj tesne pred odchodom, napíšte nám priamo na WhatsApp +90 532 244 29 22 — ak sú miesta voľné, potvrdíme ručne.' },
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Ceny plavby po Bospore Istanbul: €{p.dinnerStd}/osoba. Deti 0-3 zadarmo, 4-9 €5 zľava. Transparentné doplnky.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Cena pre deti: 0-3 zadarmo, 4-9 €5 zľava', desc: '0-3 úplne zadarmo (žiadne poplatky). 4-9 s €5 zľavou z ceny pre dospelých. 10+ plná cena pre dospelých. Transparentné, žiadne triky rodinných cien. Transfer je tiež zadarmo pre 0-3.' },
    ...
    faq: [
      { q: 'Koľko stojí túra v Istanbule?', a: 'Plavba s večerou: €{p.dinnerStd}/osoba (bežne €{p.dinnerStdOriginal}, 40% zľava). 0-3 roky zadarmo, 4-9 rokov €5 zľava. Platba na palube — bez platby vopred. Bezplatné storno až 2 hodiny pred odchodom.' },
