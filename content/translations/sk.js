...
module.exports = {
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      { q: 'Je plavba po Bospore 100% halal?', a: 'Áno — každý mäsový produkt v menu (losos, morský vlk, kurací špíz, hovädzí špíz) je halal certifikovaný od schválených dodávateľov. Kuchyňa dodržiava halal štandardy prípravy. Bravčové sa na palube nikde nepodáva. Nie je to "halal možnosť" — celé menu je halal.' },
