...
module.exports = {
  ...
  'bosphorus-for-couples': {
    ...
    faq: [
      ...
      { q: "Quand est le meilleur moment pour la croisière en couple — coucher de soleil ou nuit ?", a: "La nuit (départ 20h30) est la plus emblématique — ponts illuminés, reflets sur l'eau, palais éclairés. Le coucher de soleil (départ 17h30) est plus tôt et offre la beauté de l'heure dorée, mais la croisière dîner est spécifiquement à 20h30. Si vous voulez les deux, beaucoup de couples réservent coucher de soleil et nuit à des jours différents." },
  ...
  'bosphorus-sunset-cruise': {
    ...
    cta: {
      ...
      tertiary: "Voir la croisière dîner (20h30)"
    }
  },
  ...
  'istanbul-night-tour': {
    ...
    faq: [
      ...
      { q: "Quel est le meilleur moment pour une visite nocturne d'Istanbul ?", a: "Notre dîner-croisière sur le Bosphore 20h30-23h30 (3 heures). C'est l'heure d'éclairage maximal pour tous les monuments d'Istanbul — ponts entièrement illuminés, palais qui brillent, lune sur l'eau. Si vous voulez plus tôt (heure dorée), envisagez plutôt la croisière coucher de soleil à 17h30." },
