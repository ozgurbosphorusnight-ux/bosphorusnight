...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: "Comment réserver la croisière VIP sur le Bosphore ?", a: "Utilisez l'assistant de réservation sur cette page — sélectionnez « VIP » à l'étape 1, indiquez votre date, entrez le nombre de convives, puis vos coordonnées. Votre demande passe par WhatsApp / Telegram et nous confirmons instantanément. Paiement à bord, pas maintenant." },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Quel est le prix de la croisière coucher de soleil sur le Bosphore ?', a: 'Dès €{p.dinnerStd}/pers. pour la croisière Standard (3 heures, dîner complet, divertissement live). L\'option VIP avec places face à la scène et mezzés premium est à €{p.dinnerVip}/pers. Paiement à bord — aucun prépaiement. 0-3 ans gratuit, 4-8 ans moitié prix.' },
