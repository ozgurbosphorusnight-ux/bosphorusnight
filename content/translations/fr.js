...
module.exports = {
  ...
  'bosphorus-cruise-tickets': {
    ...
    intro: [
      ...
      "Notre processus de **billet croisière Bosphore** : remplissez l'assistant sur cette page en moins d'1 minute (date, nombre de convives, forfait, contact), nous confirmons instantanément via WhatsApp / Telegram / WeChat, vous vous présentez à l'embarcadère de Kabataş à 19h30, vous payez à bord, vous profitez de la dîner-croisière de 3 heures. Aucun billet physique à imprimer, aucun coupon à envoyer par e-mail — notre confirmation est votre billet.",
    ...
    highlights: [
      ...
      { title: "Confirmation en moins d'1 minute", desc: "Remplissez l'assistant → nous confirmons via WhatsApp / Telegram / WeChat. Aucun coupon PDF à imprimer. Notre message est votre billet. Venez à l'embarcadère à 19h30." },
