...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    intro: [
      "La **croisière dîner sur le Bosphore** est l'expérience nocturne la plus emblématique d'Istanbul. Notre croisière part de l'embarcadère de Kabataş à 19h30 et glisse sous les ponts illuminés du Bosphore et Fatih Sultan Mehmet, tout en proposant un festin turc varié, des danses folkloriques en direct, une danse orientale et un set DJ qui anime le pont jusqu'à 23h00.",
    ...
    faq: [
      { q: "Quand commence la croisière dîner sur le Bosphore ?", a: "L'embarquement commence à 19h30 à l'embarcadère de Kabataş. Le bateau part à 20h30 et revient vers 23h30. Nous vous recommandons d'arriver 15 à 20 minutes en avance pour vous installer confortablement." },
      { q: "Combien coûte la croisière dîner sur le Bosphore ?", a: "La croisière dîner est à €{p.dinnerStd}/pers. (tarif habituel €{p.dinnerStdOriginal}). 0-3 ans gratuit, 4-8 ans à 50 %. Le paiement s'effectue à bord — aucun prépaiement." },
  ...
  'halal-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: "Respect des horaires de prière", desc: "Si l'embarquement coïncide avec la prière du maghrib ou de l'isha (19h30-20h30), notre personnel peut vous indiquer un espace de prière calme à l'embarcadère de Kabataş avant le départ. Signalez-le simplement à la réservation." }
    ],
    faq: [
      ...
      { q: "Puis-je prier à bord ?", a: "Il n'y a pas de salle de prière dédiée à bord, mais nous recommandons de prier avant l'embarquement à 19h30 (la prière du maghrib tombe généralement dans cette fenêtre). Des installations de prière existent à l'embarcadère de Kabataş. Si vous devez prier pendant la navigation (isha), parlez à l'équipage — nous pouvons organiser un coin calme sur le pont." },
      { q: "Quels sont les tarifs pour une famille musulmane de 4 personnes (2 adultes, 2 enfants) ?", a: "Croisière dîner : 2 × €{p.dinnerStd} + 2 × €12.15 (4-8 ans moitié prix) = €72.90. Si les enfants ont moins de 3 ans, c'est gratuit : 2 × €{p.dinnerStd} = €48.60. Ajoutez €5 de transfert hôtel par adulte. Total : €48.60–€92.90 pour une famille de 4, aucun prépaiement, paiement à bord." },
  ...
  'bosphorus-vip': {
    ...
    intro: [
      'Beaucoup de bateaux du Bosphore séparent leurs invités entre "Standard" et "VIP". Pas nous. À bord de l\'**AMOR**, il y a un seul menu, préparé avec le même soin pour tous : 10 variétés de meze turcs, une entrée chaude, un plat principal au choix (saumon, bar, poulet ou köfte), un gâteau glacé et des boissons sans alcool à volonté. Le programme de spectacles est également inclus — cérémonie des derviches tourneurs, 5 danses folkloriques, danse orientale, musique live et DJ — le tout compris dans le prix de €{p.dinnerStd}/personne.',
      ...
      'L\'AMOR est un bateau moderne de 42 mètres, 3 ponts, jusqu\'à 400 invités, chauffé en hiver et climatisé en été. La route de 3 heures part de Kabataş (embarquement dès 19h30, départ 20h30, retour 23h30) et longe Dolmabahçe, la mosquée d\'Ortaköy, la forteresse de Rumeli et les lumières du pont du Bosphore. Licence TÜRSAB (A-17672), 4,9★ sur Google. Aucun prépaiement : vous payez à bord, avec annulation gratuite jusqu\'à 2 heures avant le départ.'
    ],
    highlights: [
    ...
    faq: [
      ...
      { q: 'Que contient le menu ?', a: '10 variétés de meze turcs, une entrée chaude, un plat principal au choix (saumon, bar, poulet ou köfte) et un gâteau glacé en dessert, avec boissons sans alcool à volonté. Le programme est inclus : cérémonie des derviches, 5 danses folkloriques, danse orientale, musique live et DJ.' },
      ...
      { q: 'Quel type de bateau est-ce ?', a: 'L\'AMOR — un bateau de passagers moderne de 42 mètres, 3 ponts, d\'une capacité de 400 invités, chauffé en hiver et climatisé en été. Départ du quai de Kabataş : embarquement 19h30, départ 20h30, retour 23h30. Itinéraire : Dolmabahçe, Ortaköy, forteresse de Rumeli, Beylerbeyi et les lumières du pont du Bosphore.' }
    ],
    cta: {
  ...
  'private-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: "Durée et départ flexibles", desc: "La durée standard de 3 heures peut s'étendre à 4-5 heures. Choisissez le départ de jour à 12h00, coucher de soleil à 17h30 ou nuit à 20h30. Vous voulez un jour de semaine au lieu du week-end ? Aucun problème — nous nous adapterons à votre agenda." },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      ...
      description: 'Admirez le coucher de soleil sur le Bosphore, puis dînez sous les ponts illuminés. Embarquement 19:30 à Kabataş, départ 20:30. 3 heures, dîner complet. Paiement à bord.'
    },
    hero: {
      h1: 'Croisière coucher de soleil & dîner sur le Bosphore',
      subtitle: 'Embarquez à 19:30 tandis que le ciel se dore au-dessus des minarets — puis dînez sur l\'eau pendant que Dolmabahçe, la mosquée d\'Ortaköy et le pont du Bosphore s\'illuminent pour la nuit.',
      badge: 'Embarquement 19:30 · Départ 20:30 · Du coucher de soleil aux lumières de la ville'
    },
    intro: [
      'L\'expérience de la **croisière coucher de soleil sur le Bosphore** à Istanbul tient en un mot : la transition. Notre croisière embarque à l\'embarcadère de Kabataş dès 19:30 — et lors des longues soirées de mai à août, l\'heure dorée se déploie pendant que vous vous installez sur le pont. Le soleil se couche derrière les minarets de la rive européenne juste autour du départ de 20:30, et vous l\'admirez depuis l\'eau : le palais de Dolmabahçe baigné d\'or, la mosquée d\'Ortaköy silhouettée contre le ciel flamboyant.',
    ...
    highlights: [
      { title: 'Couchers de soleil d\'été pile au départ', desc: 'De mai à août, le soleil se couche à Istanbul entre environ 20:15 et 20:45 — l\'embarquement à 19:30 vous offre l\'heure dorée sur le pont, et le départ de 20:30 vous place sur l\'eau pour le coucher de soleil lui-même. Caméra prête — c\'est la photo.' },
    ...
    faq: [
      { q: 'À quelle heure part la croisière coucher de soleil sur le Bosphore ?', a: 'L\'embarquement commence à 19:30 à l\'embarcadère de Kabataş, le bateau part à 20:30 et revient vers 23:30. En été (mai–août), le soleil se couche entre environ 20:15 et 20:45 — l\'heure dorée a lieu pendant l\'embarquement, et le coucher de soleil lui-même juste autour du départ, admiré depuis l\'eau.' },
      { q: 'La croisière coucher de soleil sur le Bosphore est-elle la même que la croisière dîner ?', a: 'Oui — c\'est une seule et même croisière. Il y a un seul départ quotidien à 20:30, avec dîner complet et spectacles live à bord. Lors des longues soirées d\'été, elle fait aussi office de croisière coucher de soleil : vous embarquez pendant l\'heure dorée et naviguez à travers l\'heure bleue jusqu\'à la nuit illuminée. En hiver, la même croisière devient une pure expérience de lumières nocturnes.' },
      { q: 'Quel est le prix de la croisière coucher de soleil sur le Bosphore ?', a: 'Dès €{p.dinnerStd}/pers. pour la croisière (3 heures, dîner complet, divertissement live). Paiement à bord — aucun prépaiement. 0-3 ans gratuit, 4-8 ans moitié prix.' },
      { q: 'Quelle est la meilleure période de l\'année pour une croisière coucher de soleil sur le Bosphore ?', a: 'De mai à août. Les couchers de soleil tardifs d\'Istanbul (20:15–20:45) coïncident avec le départ de 20:30 : vous profitez de l\'heure dorée, du coucher de soleil et des ponts illuminés en une seule soirée. En automne et en hiver, le soleil se couche plus tôt et la même croisière devient une expérience complète de lumières nocturnes — tout aussi photogénique, ambiance différente.' },
  ...
  'bosphorus-night-tour': {
    ...
    intro: [
      ...
      "Notre **croisière nocturne avec dîner sur le Bosphore** rassemble la soirée emblématique complète : 3 heures sur l'eau (20h30-23h30), festin turc varié, danses folkloriques en direct (derviches, 5 danses folkloriques, danse orientale), musique live et set DJ qui anime le pont jusqu'à la fin de la nuit. Chaque convive reçoit le même programme — aucune option « basique » qui saute les meilleures parties.",
    ...
    highlights: [
      { title: "Bosphore illuminé à son apogée", desc: "Le pont du Bosphore change de couleur (bleu, violet, or), les palais brillent en jaune, la mosquée d'Ortaköy se reflète dans l'eau noire. 20h30-23h30, éclairage maximal de tous les monuments d'Istanbul." },
    ...
    faq: [
      { q: "Quand est la croisière nocturne sur le Bosphore ?", a: "Embarquement à partir de 19h30 à l'embarcadère de Kabataş. Le bateau part à 20h30, revient vers 23h30. Nous recommandons d'arriver 20 minutes à l'avance pour vous installer et choisir votre place." },
      { q: "Combien coûte la croisière nocturne sur le Bosphore ?", a: "Croisière nocturne (3 heures, dîner, spectacle) : €{p.dinnerStd}/pers. (ancien €{p.dinnerStdOriginal}). 0-3 ans gratuit, 4-8 ans moitié prix. Paiement à bord." },
    ...
    cta: {
      ...
      secondary: "Départ 20h30 · 3 heures · Dîner + spectacle inclus · Annulation gratuite 2h avant",
      tertiary: "Disponibilités ce soir"
    }
  },
  ...
  'dinner-cruise-istanbul': {
    ...
    intro: [
      "Vous cherchez une **dîner-croisière à Istanbul** ? Vous avez trouvé celle que la plupart des voyageurs recommandent. Notre soirée de 3 heures sur le Bosphore combine un repas turc varié complet, des danses folkloriques en direct et les vues les plus photogéniques de la ville — tout cela depuis un bateau confortable partant de l'embarcadère de Kabataş à 20h30.",
      "L'expérience **dîner-croisière Istanbul** : embarquez à 19h30, installez-vous, regardez le palais de Dolmabahçe défiler au départ, le dîner commence en approchant de la mosquée d'Ortaköy, le spectacle démarre (derviches, danses folkloriques, danse orientale), au moment du dessert vous êtes sous le pont du Bosphore illuminé. Vers minuit, retour à Kabataş avec un collage de photos emblématiques et l'estomac plein.",
    ...
    faq: [
      ...
      { q: "Combien de temps dure la dîner-croisière — et quand commence-t-elle ?", a: "3 heures au total. Embarquement à partir de 19h30, le bateau part à 20h30 précises, revient vers 23h30. Nous recommandons d'arriver 15-20 minutes en avance pour vous installer et choisir votre place." },
  ...
  'istanbul-night-tour': {
    ...
    faq: [
      ...
      { q: "Quel est le meilleur moment pour une visite nocturne d'Istanbul ?", a: "Notre dîner-croisière sur le Bosphore a lieu de 20h30 à 23h30 (3 heures). C'est l'heure d'éclairage maximal pour tous les monuments d'Istanbul — ponts entièrement illuminés, palais qui brillent, lune sur l'eau. Si vous voulez aussi l'heure dorée, venez en été : l'embarquement commence à 19h30, et de mai à août le soleil se couche juste au moment du départ de 20h30 — la même croisière combine les deux." },
  ...
  'istanbul-boat-tour': {
    ...
    intro: [
      ...
      "Contrairement aux nombreux ferries touristiques d'1 heure qui couvrent moins du Bosphore et sautent le dîner et le divertissement, notre **tour en bateau Istanbul** est l'expérience complète de soirée : embarquement à 19h30 à l'embarcadère de Kabataş, départ 20h30, retour vers 23h30, 10 mezzés, plat principal, dessert, derviches, danses folkloriques, danse orientale et DJ. Vous obtenez le tour ET la sortie nocturne en une seule fois.",
    ...
    highlights: [
      ...
      { title: "Départ en soirée (meilleur éclairage)", desc: "Le départ à 20h30 capture le Bosphore illuminé à son apogée — ponts, palais, mosquées tous éclairés. Plus spectaculaire que les tours de jour qui montrent les mêmes monuments en lumière plate." },
    ...
    faq: [
      ...
      { q: "Combien de temps dure le tour en bateau à Istanbul ?", a: "3 heures. Embarquement à partir de 19h30 à l'embarcadère de Kabataş, départ à 20h30, retour ~23h30. Couvre tout le Bosphore de Dolmabahçe à Rumeli Hisarı et retour. Assez de temps pour un dîner + spectacle complet sans être fatiguant." },
      { q: "Combien coûte le tour en bateau à Istanbul ?", a: "Notre tour en bateau avec dîner : €{p.dinnerStd}/pers. (ancien €{p.dinnerStdOriginal}). 0-3 ans gratuit, 4-8 ans moitié prix. Paiement à bord. L'alcool et le transfert hôtel sont des suppléments optionnels." },
  ...
  'bosphorus-trip': {
    ...
    faq: [
      ...
      { q: "Combien de temps dure une excursion sur le Bosphore ?", a: "Notre excursion sur le Bosphore dure 3 heures au total (départ 20h30, retour 23h30). Des options plus courtes existent (ferries touristiques d'1 heure, circuits de 90 min) mais ils sautent dîner et divertissement. Pour une expérience de soirée complète, 3 heures est idéal — assez pour tout voir sans se fatiguer." },
  ...
  'bosphorus-cruise-tickets': {
    ...
    intro: [
      ...
      "Notre processus de **billet croisière Bosphore** : remplissez l'assistant sur cette page en moins d'1 minute (date, nombre de convives, forfait, contact), nous confirmons instantanément via WhatsApp / Telegram, vous vous présentez à l'embarcadère de Kabataş à 19h30, vous payez à bord, vous profitez de la dîner-croisière de 3 heures. Aucun billet physique à imprimer, aucun coupon à envoyer par e-mail — notre confirmation est votre billet.",
    ...
    highlights: [
      ...
      { title: "Confirmation en moins d'1 minute", desc: "Remplissez l'assistant → nous confirmons via WhatsApp / Telegram. Aucun coupon PDF à imprimer. Notre message est votre billet. Venez à l'embarcadère à 19h30." },
    ...
    faq: [
      { q: "Combien coûtent les billets croisière Bosphore ?", a: "€{p.dinnerStd}/pers. (habituel €{p.dinnerStdOriginal}). Inclut croisière de 3 heures, dîner turc varié, spectacle de danses folkloriques live, boissons non alcoolisées à volonté. 0-3 ans gratuit, 4-8 ans 50 %. Paiement à bord — aucun prépaiement." },
      ...
      { q: "Les billets croisière Bosphore sont-ils disponibles le jour même ?", a: "Souvent oui, surtout en semaine. Les week-ends et vacances se remplissent plus vite. Vérifiez les disponibilités via l'assistant de réservation — il se met à jour en temps réel. Les réservations du jour même sont généralement possibles jusqu'à quelques heures avant le départ de 20h30. Pour les demandes urgentes, WhatsApp." },
      { q: "Les billets enfants pour la croisière Bosphore sont-ils gratuits ?", a: "Les enfants **0-3 ans sont entièrement gratuits** (aucun frais, aucun frais caché, transfert inclus). **4-8 ans à 50 %** (€{p.dinnerStd}/2 = €12.15). **9+ ans tarif adulte plein.** Les prix sont plafonnés et transparents — pas d'astuces « supplément bébé »." }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    ...
    intro: [
      "Vous avez atterri à Istanbul cet après-midi et vous voulez une belle soirée ce soir ? La **croisière Bosphore dernière minute** fonctionne. Nous réservons spécifiquement des places pour les réservations du jour même car nous savons que beaucoup de voyageurs décident le matin. Remplissez l'assistant ici, nous confirmons en quelques minutes sur WhatsApp, vous vous présentez à l'embarcadère de Kabataş à 19h30, vous payez à bord, vous en profitez.",
      "Notre **croisière Bosphore dernière minute** a le même programme de soirée que les réservations anticipées : 3 heures sur l'eau (20h30-23h30), dîner turc varié, spectacle de danses folkloriques live, derviches, danse orientale, DJ. Palais de Dolmabahçe illuminé, mosquée d'Ortaköy, pont du Bosphore — mêmes vues emblématiques. Même tarif : €{p.dinnerStd}/pers.",
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Prix croisière Bosphore Istanbul : dîner-croisière €{p.dinnerStd}/pers. Enfants 0-3 gratuits, 4-8 demi-tarif. Suppléments transparents.'
    },
    hero: {
    ...
    faq: [
      { q: "Combien coûte la croisière à Istanbul ?", a: "Dîner-croisière : €{p.dinnerStd}/pers. (habituel €{p.dinnerStdOriginal}, -40 %). 0-3 ans gratuit, 4-8 ans moitié prix. Paiement à bord — aucun prépaiement. Annulation gratuite jusqu'à 2 heures avant le départ." },
      ...
      { q: "Dois-je prépayer le prix de la croisière Istanbul ?", a: "Non — **paiement à bord**. Vous réservez maintenant (assistant 1 minute), nous confirmons sur WhatsApp, vous venez à 19h30 et payez à bord (espèces ou carte). Annulation gratuite jusqu'à 2 heures avant. Zéro engagement financier jusqu'à votre satisfaction." },
