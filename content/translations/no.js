...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    meta: {
      ...
      description: '3-timers middagscruise på Bosporos: tyrkisk flerrettsmeny og live folkeshow. Avgang 21:00 fra Kabataş. Gratis avbestilling, betal om bord.'
    },
    hero: {
      ...
      badge: '4,9★ · 11 317+ gjester'
    },
    intro: [
      '**Middagscruiset på Bosporos** er Istanbuls mest ikoniske kveldsopplevelse. Turen starter kl. 20:00 ved Kabataş-kaia og seiler under de opplyste Bosporos- og Fatih Sultan Mehmet-broene, og byr på en tyrkisk flerrettsmiddag, live folkedans, orientalsk dans og et DJ-sett som fyller dekket til kl. 23:45.',
      'I motsetning til vanlige fartøyer som preger Istanbuls kveldsbilde er **vårt middagscruise på Bosporos** TÜRSAB-lisensiert (A-17672) og gitt 4,9★ av over 11 317 reisende. Vi holder gruppene små og servicen varm — og fordi du betaler om bord, er det ingen risiko ved å reservere på forhånd.',
    ...
    highlights: [
      { title: 'Tyrkisk middag med flere retter', desc: '10 mezesorter, varm forrett (börek), valg av hovedrett (laks / havabbor / kyllingspyd / oksespyd / vegetar), spesiell semuledessert til dessert, ubegrenset leskedrikk.' },
    ...
    faq: [
      ...
      { q: 'Er alkohol inkludert i middagscruiset?', a: 'Ubegrenset leskedrikk (vann, cola, juice) er inkludert i prisen. Alkoholpakken er valgfri: 2 glass (vin, øl, rakı, vodka, whisky, gin og mer) +€{p.alcohol2}/person. Ytterligere drikke og importsprit faktureres separat om bord.' },
      { q: 'Finnes det hotellhenting?', a: 'Ja — henting og kjøring tilbake er +€{p.transfer}/person. Betjente soner: Beşiktaş, Taksim, Sultanahmet, Sirkeci, Eminönü, Ortaköy, Beyoğlu, Fatih, Laleli, Topkapı, Kağıthane, Yenikapı, Sütlüce og Şişli. Du kan velge dette alternativet i reservasjonsskjemaet.' },
  ...
  'bosphorus-with-kids': {
    meta: {
      ...
      description: 'Familievennlig middagscruise på Bosporos. Barn 0–3 gratis, 4–9 med €5 rabatt. Trygt innendørs område, barnemeny.'
    },
    hero: {
    ...
    intro: [
      ...
      'Enten du er i Istanbul i en langhelg med småbarn, eller tar tenåringene med på sin første europareise — dette er turen som Istanbuls familier anbefaler. Trygg, halalsertifisert, TÜRSAB-lisensiert og gitt 4,9★ av over 11 317 reisende.'
    ],
    highlights: [
      { title: '0–3 år helt gratis', desc: 'Ingen avgifter for babyer og småbarn. 4–9 år betaler €5 av voksenpris. Fra 10 år er det full voksengjestepris. Transparent, ingen overraskelser.' },
    ...
    faq: [
      ...
      { q: 'Hva er barneprisene på Bosporos-cruiset?', a: 'Barn **0–3 år: GRATIS** (ingen avgifter, ingen skjulte kostnader). **4–9 år: €5 rabatt** av voksenprisen — altså €19.30/barn på Standard (€{p.dinnerStd} − €5). **10+ år: full voksenpris.** Hotelloverføring er gratis for 0–3 år, standard for 4+ (€{p.transfer}/person).' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    intro: [
      ...
      'Vår romantiske bordoppsett (+€{p.romantic}/bord) gjør ethvert sete til et spesielt øyeblikk: røde roser, glødende stearinlys, et håndskrevet velkomstbrev. Legg til 2-glass alkoholpakken for vin under stjernene (+€{p.alcohol2}/person) eller hold det enkelt med de inkluderte lesedrikker. Uansett valg tar mannskapet diskret hånd om resten.',
      'Enten du feirer et jubileum, planlegger en overraskelse for partneren eller bare vil ha en uforglemmelig kveld i Europas mest romantiske by — dette er turen som Istanbuls par elsker. Rangert 4,9★, TÜRSAB-lisensiert og — viktigst av alt — betal om bord, så lover du bare selve kvelden.'
    ],
    highlights: [
      ...
      { title: 'Vin, champagne, premiumkombinasjoner', desc: 'Legg til 2-glass alkoholpakken (+€{p.alcohol2}/person) — vin, øl, rakı, vodka, whisky, gin og mer. Importchampagne og premiumkombinasjoner på forespørsel — spør ved bestilling.' }
    ],
    faq: [
      ...
      { q: 'Hva koster det romantiske cruiset for 2 personer?', a: '2 personer: 2 × €{p.dinnerStd} = €48.60. Legg til romantisk oppsett +€{p.romantic} = €63. Ingen forskuddsbetaling — betal om bord. 2-glass alkoholpakke for to: ytterligere 2 × €{p.alcohol2} = €20.' },
  ...
  'bosphorus-vip': {
    meta: {
      title: 'VIP-opplevelse på Bosporos fra €{p.dinnerStd} — premium middag på Bosporos',
      description: 'Middagscruise på Bosporos i VIP-klasse: komplett tyrkisk meny, liveshow, bord nær scenen som tillegg, oppmerksom servering. €{p.dinnerStdOriginal} → €{p.dinnerStd}. Betal om bord, gratis avbestilling.'
    },
    hero: {
      h1: 'VIP-opplevelse på Bosporos — middagscruise',
      subtitle: 'Én meny, én standard: premium for alle. En kveld på tre timer på Bosporos om bord på Bosphorus Night — solid tyrkisk middag, liveshow på scenen og, om du ønsker det, et privat bord nær scenen. Vi selger ingen egen "VIP-klasse" — vi serverer vårt beste til hver eneste gjest.',
      badge: '40% RABATT · Én meny, premium standard · Betal om bord'
    },
    intro: [
      'Mange båter på Bosporos deler gjestene sine inn i "Standard" og "VIP". Det gjør ikke vi. Om bord på **Bosphorus Night** finnes det én middagsmeny, tilberedt med samme omtanke for alle: 10 typer tyrkiske meze, en varm forrett, hovedrett etter eget valg (laks, havabbor, kyllingspyd eller oksespyd), spesiell semuledessert og ubegrenset med brus. Hele underholdningsprogrammet på åtte numre er også inkludert — Oba Dombra, de virvlende dervisjenes seremoni, anatolske og aserbajdsjanske folkedanser, magedans, kaukasisk knivdans, livemusikk og en saksofon-og-DJ-finale — alt innenfor prisen på €{p.dinnerStd}/person.',
      ...
      'Bosphorus Night er et moderne skip: 42 meter, 3 dekk, opptil 400 gjester, oppvarmet om vinteren og med klimaanlegg om sommeren. Den tre timer lange ruten går fra Kabataş (ombordstigning fra 20:00, avgang 21:00, retur 00:00) forbi Dolmabahçe, Ortaköy-moskeen, Rumeli-festningen og lysene på Bosporos-broen. TÜRSAB-lisens (A-17672), 4,9★ på Google. Ingen forhåndsbetaling — du betaler om bord, med gratis avbestilling frem til 2 timer før avgang.'
    ],
    highlights: [
      { title: 'Én meny, premium standard', desc: 'Det finnes ingen egen "VIP-meny" — for vår eneste meny ligger allerede på det nivået. 10 typer meze, varm forrett, 4 hovedretter å velge mellom, dessert og ubegrenset med brus, servert med samme omtanke ved hvert bord.' },
      { title: 'Privat bord nær scenen (+€{p.romantic}/bord)', desc: 'Bordene nærmest dervisjene, folkedansene og magedansen reserveres på forhånd. Utmerket utsikt mot scenen og Bosporos. Bordet ditt er privat, ikke delt.' },
      { title: 'Oppmerksom bordservering', desc: 'Teamet vårt serverer deg ved bordet: rettene, tips fra menyen, ekstra drikke, spesielle ønsker. Ingen kø i trengselen.' },
      { title: '40% RABATT — var €{p.dinnerStdOriginal}, nå €{p.dinnerStd}', desc: 'Pris ved direkte booking: €{p.dinnerStd}/person (veiledende pris €{p.dinnerStdOriginal}). Betal om bord, ingen forskudd. Gratis avbestilling frem til 2 timer før avgang.' }
    ],
    faq: [
      ...
      { q: 'Hva står på menyen?', a: '10 typer tyrkiske meze, en varm forrett, hovedrett etter eget valg (laks, havabbor, kyllingspyd eller oksespyd) og spesiell semuledessert til dessert, med ubegrenset med brus. Programmet på åtte numre er inkludert: Oba Dombra, dervisjenes seremoni, anatolske og aserbajdsjanske folkedanser, magedans, kaukasisk knivdans, livemusikk og en saksofon-og-DJ-finale.' },
      { q: 'Er alkohol inkludert?', a: 'Nei — alkohol er et eget tillegg: 2 glass vin, øl, rakı, vodka, whisky, gin og mer for +€{p.alcohol2}/person. Brus er inkludert ubegrenset og gratis. Importert premiumbrennevin faktureres separat om bord.' },
      ...
      { q: 'Hva slags båt er det?', a: 'Bosphorus Night — et moderne passasjerskip på 42 meter med 3 dekk og plass til 400 gjester, oppvarmet om vinteren og med klimaanlegg om sommeren. Avgang fra Kabataş-kaien: ombordstigning 20:00, avgang 21:00, retur 00:00. Rute: Dolmabahçe, Ortaköy, Rumeli-festningen, Beylerbeyi og lysene på Bosporos-broen.' }
    ],
    cta: {
      primary: 'Book bordet ditt · Betal om bord',
      secondary: 'Var €{p.dinnerStdOriginal}, nå €{p.dinnerStd} · Gratis avbestilling frem til 2 timer før',
      tertiary: 'Legg til privat bord nær scenen (+€{p.romantic})'
    }
  },
  ...
  'private-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Fleksibel varighet og avgang', desc: 'Standard 3 timer kan utvides til 4–5 timer. Velg dagsavgang kl. 12:00, solnedgangsavgang kl. 17:30 eller kveldsavgang kl. 21:00. Ønsker du ukedag i stedet for helg? Ingen problem — vi tilpasser oss programmet ditt.' },
    ...
    faq: [
      { q: 'Hva koster et privat Bosporos-cruise?', a: 'For grupper 25+, vanligvis fra €{p.dinnerStd}/person + fartøyleieavgift avhengig av gruppestørrelse, dato og varighet. Skriv til oss på WhatsApp med gruppestørrelse, dato og krav — vi gir pris innen én time. De fleste arrangementer faller i intervallet €2 000–€6 000 totalt.' },
      { q: 'Hva er minimum gruppestørrelse for et privat Bosporos-cruise?', a: 'Teknisk sett gjør 25 gjester privat cruise økonomisk gjennomførbart. Mindre grupper (10–24) kan leie privat, men betaler en minstepris tilsvarende ~25 personer. For virkelig små grupper (2–10) bør du vurdere det ordinære middagscruiset — bordet ditt er allerede privat, bare fartøyet er delt.' },
  ...
  'bosphorus-for-couples': {
    ...
    intro: [
      ...
      'Enten du er i Istanbul i 3 dager med partneren, feirer noe rolig eller planlegger en utforskningsreise for et fremtidig frieri — **Bosporos-cruiset for par** gir deg 3 timer kveldstur i en av verdens mest fotograferte byer. 4,9★, betal om bord, gratis avbestilling.'
    ],
    highlights: [
      ...
      { title: 'Langsom flerrettsmiddag', desc: '10 tyrkiske mezevarianter, varm forrett, hovedrett (laks, havabbor, kyllingspyd, oksespyd eller vegetar), spesiell semuledessert til dessert. Servert langsomt over 3 timer — du har ikke hastverk.' },
    ...
    faq: [
      ...
      { q: 'Hva koster Bosporos-cruiset for 2 personer?', a: '2 personer: 2 × €{p.dinnerStd} = €48.60. Legg til hotelloverføring for to: +€{p.transfer}×2 = €10. Legg til 2-glass alkoholpakken for to: +€{p.alcohol2}×2 = €20. Ingen forskuddsbetaling — betal om bord.' },
      { q: 'Kan par ta med sin egen vin eller champagne?', a: 'Vi tillater ikke alkohol utenfra (av lisensårsaker). Men vi har 2-glass pakken med vin, øl, rakı, vodka, whisky, gin og mer (+€{p.alcohol2}/person) og kan arrangere premium importviner eller champagne mot en avgift — spør ved bestilling. Prosecco, Chianti og Cabernet er populære premiumbestillinger.' },
      ...
      { q: 'Når er Bosporos-cruiset best for par — solnedgang eller kveld?', a: 'Cruiset avgår kl. 21:00 hver kveld — og om sommeren (mai–august) dekker den ene avgangen begge deler: ombordstigning fra kl. 20:00 i gyldentimen, solnedgangen rett rundt avgang, og deretter de opplyste broene og palassene. Om vinteren er det et rent nattlys-cruise. Uansett gir én bestilling par den mest ikoniske versjonen av Bosporos.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      title: 'Solnedgangs- og middagscruise på Bosporos fra €{p.dinnerStd}',
      description: 'Opplev solnedgangen over Bosporos og spis middag under de opplyste broene. Ombordstigning 20:00 ved Kabataş, avgang 21:00. 3 timer, komplett middag. Betal om bord.'
    },
    hero: {
      h1: 'Solnedgangs- og middagscruise på Bosporos',
      subtitle: 'Gå om bord kl. 20:00 mens himmelen farges gyllen over minaretene — og spis middag på vannet mens Dolmabahçe, Ortaköy-moskeen og Bosporosbroen tennes for natten.',
      badge: 'Ombordstigning 20:00 · Avgang 21:00 · Fra solnedgang til bylys'
    },
    intro: [
      '**Solnedgangscruiset på Bosporos** i Istanbul handler om én ting: overgangen. Cruiset vårt har ombordstigning ved Kabataş-kaia fra kl. 20:00 — og i de lange kveldene fra mai til august utfolder gyldentime seg mens du finner deg til rette på dekk. Solen går ned over minaretene på den europeiske bredden akkurat rundt avgangen kl. 21:00, så du ser den fra vannet: Dolmabahçe-palasset badet i gull, Ortaköy-moskeen i silhuett mot den glødende himmelen.',
      '**Vårt solnedgang-til-natt-cruise på Bosporos** inkluderer en komplett tyrkisk middag — 10 mezesorter, varm forrett, valg av hovedrett, dessert — servert mens byen tenner lysene sine. Når desserten kommer, seiler du under den opplyste Bosporosbroen med 30 millioner lys som reflekteres i det mørke vannet. Skiftet fra skumring til full natt, alt i løpet av ett 3-timers cruise, er hele poenget.',
      'Enten du er fotograf på jakt etter det siste lyset, et par som vil ha "det minnebildet fra Istanbul", eller førstegangsbesøkende som ønsker den klassiske kvelden på vannet — dette er **solnedgangs- og middagscruiset på Bosporos** som Istanbuls lokale anbefaler besøkende. Fra €{p.dinnerStd}/person, rangert 4,9★, TÜRSAB-lisensiert, betal om bord — ingen forskuddsbetaling.'
    ],
    highlights: [
      { title: 'Sommersolnedganger rett ved avgang', desc: 'Fra mai til august går solen i Istanbul ned mellom cirka 20:15 og 20:45 — ombordstigning kl. 20:00 gir deg gyldentime på dekk, og avgangen kl. 21:00 plasserer deg på vannet under selve solnedgangen. Kamera klart — dette er bildet.' },
      { title: 'Blå time inn i full natt', desc: 'Ikke bare solnedgang — cruiset seiler gjennom skumringen og inn i det fullt opplyste Bosporos. Gyllent lys, blå time, deretter 30 millioner brolys over mørkt vann: tre lysfaser på én kveld.' },
      { title: 'Komplett middag under cruiset', desc: '10 tyrkiske mezesorter, varm forrett, hovedrett (laks, havabbor, kyllingspyd, oksespyd, vegetar), spesiell semuledessert, ubegrenset leskedrikk — servert mens bylysene tennes.' },
      { title: 'Dolmabahçe, Ortaköy, Bosporosbroen — alle skinner', desc: 'Ruten passerer Dolmabahçe-palasset, Ortaköy-moskeen, Bosporosbroen, Rumeli Hisarı og Beylerbeyi-palasset mens lysene deres tennes. Hvert landemerke i sitt beste lys.' }
    ],
    faq: [
      ...
      { q: 'Hva koster solnedgangscruiset på Bosporos?', a: 'Fra €{p.dinnerStd}/person for cruiset (3 timer, komplett middag, live underholdning). Betal om bord — ingen forskuddsbetaling. 0–3 år gratis, 4–9 år med €5 rabatt.' },
      ...
      { q: 'Når går solen ned i Istanbul?', a: 'Om sommeren (juni–juli) går solen i Istanbul ned rundt 21:00–20:45. Om vinteren rundt 16:30–17:00. For en solnedgangs- og nattopplevelse fanger Bosphorus Nights middagscruise kl. 21:00 fra Kabataş den sene gyldentimen og den blå timen om sommeren, og de opplyste landemerkene hele året.' },
      { q: 'Er solnedgangscruiset på Bosporos verdt det?', a: 'Ja — solnedgangen over Bosporosbroen er en av Istanbuls signaturutsikter. Bosphorus Nights middagscruise kl. 21:00 (€{p.dinnerStd}/person) fanger den blå timen etter solnedgang pluss de opplyste palassene, med komplett middag og live show over 3 timer.' }
    ],
    cta: {
      primary: 'Bestill solnedgangscruiset · Betal om bord',
      secondary: 'Ombordstigning 20:00 · Avgang 21:00 · Middag inkludert · Gratis avbestilling 2 timer før',
      tertiary: 'Se alle detaljer om middagscruiset'
    }
  },
  ...
  'bosphorus-night-tour': {
    meta: {
      ...
      description: '3-timers natttur på Bosporos med middag og live show. Avgang 21:00 fra Kabataş, opplyste broer. Gratis avbestilling, betal om bord.'
    },
    hero: {
    ...
    intro: [
      ...
      'Enten det er ditt første besøk i Istanbul og du leter etter "det eneste du må gjøre om natten", eller du har vært her før og vil ha byens mest fotogene 3 timer, er dette **nattturen på Bosporos** gitt 4,9★ av over 11 317 reisende. TÜRSAB-lisensiert, betal om bord, ingen forskuddsbetaling.'
    ],
    highlights: [
      ...
      { title: 'Komplett flerrettsmiddag', desc: '10 tyrkiske mezevarianter, varm forrett (börek), hovedrett (laks, havabbor, kyllingspyd, oksespyd, vegetar — ditt valg), dessert (spesiell semuledessert), ubegrenset lesedrikk. Halalsertifisert.' },
    ...
    faq: [
      ...
      { q: 'Jeg snakker ikke tyrkisk — er turen på engelsk?', a: 'Mannskapet snakker engelsk. Underholdningen (sema, folkedanser, musikk) krever ikke språk. Middagsmenyen er på engelsk. Bestilling via WhatsApp / Telegram fungerer på flere språk (engelsk, arabisk, russisk, tysk, fransk, spansk). Tyrkisk er ikke nødvendig.' }
    ],
    cta: {
      primary: 'Bestill nattturen · Betal om bord',
      secondary: 'Avgang 21:00 · 3 timer · Middag + show inkludert · Gratis avbestilling 2 timer før',
      tertiary: 'Tilgjengelighet i kveld'
    }
  },
  ...
  'dinner-cruise-istanbul': {
    meta: {
      ...
      description: '3-timers middagscruise i Istanbul på Bosporos. Tyrkisk flerrettsmeny, live folkeshow, opplyste broer. Gratis avbestilling, betal om bord. 11 317+ gjester.'
    },
    hero: {
      ...
      badge: '4,9★ · 11 317+ gjester · TÜRSAB A-17672'
    },
    intro: [
      'Leter du etter et **middagscruise i Istanbul**? Du har funnet det som de fleste reisende anbefaler. Vår 3-timers kveld på Bosporos kombinerer en komplett tyrkisk flerrettsmiddag, live folkedanser og byens mest fotogene utsikter — alt fra et komfortabelt fartøy som avgår kl. 21:00 fra Kabataş-kaia.',
      'Opplevelsen av **middagscruiset i Istanbul**: gå om bord kl. 20:00, sett deg til rette, se Dolmabahçe-palasset mens vi avgår, middagen starter når vi nærmer oss Ortaköy-moskeen, showet begynner (sema, folkedanser, orientalsk), og til desserten er du under den opplyste Bosporosbroen. Til midnatt er du tilbake ved Kabataş med et ikonisk bildekollasj og full mage.',
      '€{p.dinnerStd}/person (fra €{p.dinnerStdOriginal}). Betal om bord — ingen forskuddsbetaling, ingen risiko. TÜRSAB-lisensiert A-17672, rangert 4,9★ av over 11 317 reisende.'
    ],
    highlights: [
      { title: 'Komplett tyrkisk flerrettsmiddag', desc: '10 mezevarianter, varm forrett, hovedrett (laks/havabbor/kyllingspyd/oksespyd/vegetar), spesiell semuledessert. Halalsertifisert. Ubegrenset lesedrikk inkludert.' },
    ...
    cta: {
      ...
      secondary: '4,9★ · TÜRSAB-lisensiert · Gratis avbestilling 2 timer før',
      tertiary: 'Tilgjengelighet i kveld'
    }
  },
  ...
  'istanbul-night-tour': {
    meta: {
      ...
      description: '3-timers cruise på Bosporos med middag og live show. Avgang 21:00 fra Kabataş. Gratis avbestilling, betal om bord. 11 317+ gjester. Valgfri hotelloverføring.'
    },
    hero: {
    ...
    intro: [
      ...
      'Middag er inkludert (tyrkisk flerrettsmeny), live tyrkisk folkedansshow, sema, orientalsk dans og DJ-sett. Er du i Istanbul i 2–3 dager, er dette den ene kvelden som gir sterkest inntrykk. 4,9★ av over 11 317 reisende, betal om bord, ingen forskuddsbetaling.'
    ],
    highlights: [
      ...
      { title: 'Komplett tyrkisk middag inkludert', desc: '10 meze, varm forrett, hovedrett (laks/havabbor/kyllingspyd/oksespyd/vegetar), dessert, ubegrenset lesedrikk. Halalsertifisert. Priset til €{p.dinnerStd}/person — alt inkludert.' },
    ...
    faq: [
      ...
      { q: 'Hva koster nattturen i Istanbul?', a: 'Vår natttur med middag på Bosporos: €{p.dinnerStd}/person. Inkludert tur, middag, underholdning, lesedrikker. Valgfritt: alkohol (2 glass) +€{p.alcohol2}/person, hotelloverføring +€{p.transfer}/person. Betal om bord — ingen forskuddsbetaling.' },
      ...
      { q: 'Hva er beste tidspunkt for natttur i Istanbul?', a: 'Vårt middagscruise på Bosporos er 21:00–00:00 (3 timer). Dette er topp belysningstidspunkt for alle Istanbuls landemerker — broer fullt opplyst, glødende palasser, månen over vannet. Vil du også ha gyldentimen, kom om sommeren: ombordstigningen starter kl. 20:00, og i mai–august går solen ned rett rundt avgangen kl. 21:00 — samme cruise dekker begge deler.' },
  ...
  'istanbul-boat-tour': {
    meta: {
      ...
      description: '3-timers båttur: Bosporos-cruise, komplett tyrkisk middag, live folkeshow, opplyste nattutsikter. Gratis avbestilling, betal om bord. 11 317+ gjester.'
    },
    hero: {
      ...
      badge: '4,9★ · TÜRSAB A-17672 · Betal om bord'
    },
    intro: [
      ...
      'I motsetning til mange turistferger på 1 time som dekker mindre av Bosporos og hopper over middag og underholdning, er **vår båttur i Istanbul** en komplett kveldsopplevelse: ombordstigning kl. 20:00 ved Kabataş-kaia, tur til midnatt, 10 meze, hovedrett, dessert, sema, folkedanser, orientalsk dans og DJ. Du får også kveldsutgangen som del av turen.',
      'Enten du har én kveld eller en hel uke i Istanbul, gjør **denne båtturen i Istanbul** jobben. 4,9★ av over 11 317 reisende, TÜRSAB-lisensiert (A-17672), halalsertifisert meny og betal om bord — ingen finansiell forpliktelse til du er fornøyd med opplevelsen.'
    ],
    highlights: [
      ...
      { title: 'Kveldsavgang (best belysning)', desc: 'Avgang kl. 21:00 fanger Bosporos opplyst i full glans — broer, palasser, moskeer alle opplyst. Mer dramatisk enn dagsturer som viser de samme landemerkene i flatt lys.' },
  ...
  'bosphorus-trip': {
    meta: {
      ...
      description: '3-timers tur på Bosporos: tyrkisk middag, live folkeshow, opplyste nattutsikter. Avgang 21:00 fra Kabataş. Gratis avbestilling, betal om bord. 11 317+ gjester.'
    },
    hero: {
      h1: 'Tur på Bosporos',
    ...
    intro: [
      ...
      'Enten du er i Istanbul i 24 timer eller en uke, er dette **Bosporos-turen** som gir deg mest på én kveld. Rangert 4,9★ av over 11 317 reisende, TÜRSAB-lisensiert A-17672, halal-vennlig meny, betal om bord — ingen risiko for forskuddsbetaling.'
    ],
    highlights: [
  ...
  'bosphorus-cruise-tickets': {
    meta: {
      ...
      description: 'Direkte Bosporos-cruisebilletter fra €{p.dinnerStd}/person. Ingen forskudd, betal om bord. Gratis avbestilling inntil 2 timer før.'
    },
    hero: {
    ...
    intro: [
      'Leter du etter **Bosporos-cruisebilletter**? Kjøp direkte. Billetten vår er €{p.dinnerStd}/person — 40 % rabatt på ordinær pris (€{p.dinnerStdOriginal}). Tredjeparts bestillingssider legger vanligvis til 20–40 % provisjon. Ved å bestille direkte sparer du — og betaler fortsatt om bord.',
      'Prosessen for **Bosporos-cruisebilletter**: fyll ut skjemaet på denne siden på under 1 minutt (dato, antall gjester, kontakt), vi bekrefter umiddelbart via WhatsApp / Telegram, møt opp ved Kabataş-kaia kl. 20:00, betal om bord, nyt 3-timers middagscruise. Ingen fysisk billett å skrive ut, ingen kupong å motta på e-post — bekreftelsen er billetten din.',
      'Enten du bestiller kveldens middagscruise eller bestiller til en bestemt dato neste uke, er **direkte Bosporos-cruisebilletter** den raskeste måten. Rangert 4,9★, TÜRSAB-lisensiert (A-17672), halalsertifisert meny og støtter tillegg for hotelloverføring og alkohol.'
    ],
    highlights: [
      { title: 'Direktebestilling — ingen mellomledd-avgift', desc: '€{p.dinnerStd}/person — én transparent pris. Tredjeparts sider tar €30–80+ for samme tur. Spar ved å bestille direkte fra oss. Ingen skjulte avgifter, ingen provisjonstillegg.' },
      ...
      { title: 'Bekreftelse på under 1 minutt', desc: 'Fyll ut skjema → vi bekrefter via WhatsApp / Telegram. Ingen PDF-kupong å skrive ut fra e-post. Meldingen vår er billetten din. Møt opp ved kaia kl. 20:00.' },
    ...
    faq: [
      ...
      { q: 'Er barnebilletter til Bosporos-cruiset gratis?', a: 'Barn **0–3 år helt gratis** (ingen avgifter, ingen skjulte kostnader, transfer inkludert). **4–9 år €5 rabatt** (€{p.dinnerStd} − €5 = €19.30). **10+ år full voksenpris.** Transparente, tak-satte priser — ingen "babygebyr"-triks.' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    meta: {
      ...
      description: 'Bestill Bosporos-cruise samme dag. WhatsApp-bekreftelse på minutter. Avgang 21:00 fra Kabataş. Gratis avbestilling, betal om bord. 11 317+ gjester.'
    },
    hero: {
    ...
    intro: [
      'Landet du i Istanbul i ettermiddag og vil ha en flott kveld i kveld? **Bosporos-cruise i siste liten** fungerer. Vi reserverer spesielt plasser for siste-minutt-bestillinger, fordi vi vet at mange reisende bestemmer seg om morgenen. Fyll ut skjemaet her, vi bekrefter via WhatsApp på minutter, møt opp ved Kabataş-kaia kl. 20:00, betal om bord, nyt.',
      '**Vårt siste-minutt Bosporos-cruise** har samme kveldsplan som forhåndsbestillinger: 3 timer på vannet (21:00–00:00), tyrkisk flerrettsmiddag, live folkedansshow, sema, orientalsk dans, DJ. Dolmabahçe-palasset opplyst, Ortaköy-moskeen, Bosporosbroen — de samme ikoniske utsiktene. Samme pris: €{p.dinnerStd}/person.',
    ...
    highlights: [
      ...
      { title: 'Bekreftelse på under 5 minutter', desc: 'Fyll ut skjema → WhatsApp/Telegram-bekreftelsesmelding → ferdig. Ingen e-postkupong å vente på, ingen QR-kode å skrive ut. Meldingen vår er billetten din.' },
      ...
      { title: 'Hotelloverføring samme dag ofte tilgjengelig', desc: 'Hotelloverføring krever normalt 24 timers varsel, men for siste-minutt-bestillinger mellom kl. 14:00–18:30 kan vi ofte ordne henting for +€{p.transfer}/person. For hasteovertransportforespørsler, WhatsApp.' }
    ],
    faq: [
      { q: 'Kan jeg virkelig bestille Bosporos-cruiset for i kveld?', a: 'Ja — ofte. Vi reserverer plasser for siste-minutt-bestillinger. Sjekk skjemaet ovenfor for tilgjengelighet i kveld. Hvis det er ledige plasser, kan du bestille inntil kl. 21:00. Helger er mer travel — bestill tidligere på dagen om mulig.' },
      { q: 'Hvor siste minutt kan jeg bestille?', a: 'Booking er åpen frem til kl. 21:00 — helt frem til avgang. Er det svært kort tid til avgang, skriv direkte til oss på WhatsApp +90 532 244 29 22 — er det ledige plasser, bekrefter vi manuelt.' },
      { q: 'Er siste-minutt Bosporos-cruise dyrere?', a: 'Nei — samme pris som forhåndsbestilling. €{p.dinnerStd}/person. Vi har ingen "dynamisk prising" eller siste-minutt-tillegg. Samme fartøy, samme middag, samme show, samme pris.' },
      ...
      { q: 'Kan dere ordne hotelloverføring i siste liten?', a: 'Siste-minutt-overføring er mulig inntil ~kl. 18:30 for kl. 21:00-turen. Etter kl. 18:30 har vi kanskje ikke tilgjengelig sjåfør — i så fall kan du ta taxi til Kabataş-kaia (15 min fra Taksim, 10 min fra Sultanahmet, ~€10–15). Sentralt og enkelt.' },
  ...
  'istanbul-cruise-price': {
    ...
    hero: {
      ...
      subtitle: 'Transparente priser, ingen skjulte avgifter. €{p.dinnerStd}/person — og du betaler om bord, ikke nå.',
    ...
    faq: [
      ...
      { q: 'Trenger jeg å betale Istanbul-turprisen på forhånd?', a: 'Nei — **betal om bord**. Bestill nå (1-minutts skjema), vi bekrefter på WhatsApp, kom kl. 20:00 og betal om bord (kontanter eller kort). Gratis avbestilling inntil 2 timer før. Null finansiell forpliktelse til du er fornøyd.' },
