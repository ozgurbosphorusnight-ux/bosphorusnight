...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Hvordan bestiller jeg VIP-cruiset på Bosporos?', a: 'Bruk bestillingsskjemaet på denne siden — velg "VIP" i trinn 1, sett dato, oppgi antall gjester, deretter kontaktopplysninger. Forespørselen din kommer via WhatsApp / Telegram og vi bekrefter umiddelbart. Betal om bord, ikke nå.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Hva koster solnedgangscruiset på Bosporos?', a: 'Fra €{p.dinnerStd}/person for standardcruiset (3 timer, komplett middag, live underholdning). VIP-alternativet med scenenær plass og premiummeze er €{p.dinnerVip}/person. Betal om bord — ingen forskuddsbetaling. 0–3 år gratis, 4–8 år halv pris.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    intro: [
      ...
      'Prosessen for **Bosporos-cruisebilletter**: fyll ut skjemaet på denne siden på under 1 minutt (dato, antall gjester, pakke, kontakt), vi bekrefter umiddelbart via WhatsApp / Telegram, møt opp ved Kabataş-kaia kl. 19:30, betal om bord, nyt 3-timers middagscruise. Ingen fysisk billett å skrive ut, ingen kupong å motta på e-post — bekreftelsen er billetten din.',
