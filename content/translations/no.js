...
module.exports = {
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Vin, champagne, premiumkombinasjoner', desc: 'Legg til 2-glass alkoholpakken (+€{p.alcohol2}/person) — lokal vin, øl eller rakı. Importchampagne og premiumkombinasjoner på forespørsel — spør ved bestilling.' }
    ],
    faq: [
  ...
  'bosphorus-for-couples': {
    ...
    highlights: [
      ...
      { title: 'Tillegg for spesielle kvelder', desc: 'Romantisk bordoppsett (levende lys, roser): +€{p.romantic}. 2 glass alkohol (vin, øl eller rakı): +€{p.alcohol2}/person. Hotelloverføring (tur-retur): +€{p.transfer}/person. Velg hva som passer kvelden din.' }
    ],
    faq: [
      ...
      { q: 'Kan par ta med sin egen vin eller champagne?', a: 'Vi tillater ikke alkohol utenfra (av lisensårsaker). Men vi har 2-glass pakken med lokal vin eller øl (+€{p.alcohol2}/person) og kan arrangere premium importviner eller champagne mot en avgift — spør ved bestilling. Prosecco, Chianti og Cabernet er populære premiumbestillinger.' },
