...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    meta: {
      ...
      description: 'Croazieră cu cină 3 ore pe Bosfor: meniu turcesc multifel și spectacol folcloric live. Plecare 21:00 din Kabataş. Anulare gratuită, plată la bord.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: 'Cât costă croaziera cu cină pe Bosfor?', a: 'Croaziera cu cină €{p.dinnerStd}/persoană (preț normal €{p.dinnerStdOriginal}). 0-3 ani gratuit, 4-9 ani cu €5 reducere. Plata se face pe vapor — fără plată în avans.' },
      { q: 'Alcoolul este inclus în croaziera cu cină?', a: 'Băuturile răcoritoare nelimitate (apă, cola, suc) sunt incluse în preț. Pachetul cu alcool este opțional: 2 pahare (vin, bere, rachiu, vodcă, whisky, gin și altele) +€{p.alcohol2}/persoană. Băuturile suplimentare și cele de import se taxează separat pe vapor.' },
      { q: 'Există transfer de la hotel?', a: 'Da — serviciul de preluare și ducere înapoi este +€{p.transfer}/persoană. Zone deservite: Beșiktaș, Taksim, Sultanahmet, Sirkeci, Eminönü, Ortaköy, Beyoğlu, Fatih, Laleli, Topkapı, Kağıthane, Yenikapı, Sütlüce și Şişli. Puteți selecta această opțiune în formularul de rezervare.' },
  ...
  'bosphorus-with-kids': {
    meta: {
      ...
      description: 'Croazieră cu cină Bosfor prietenoasă cu familia. Copii 0-3 gratis, 4-9 €5 reducere. Sală interioară sigură, meniu pentru copii.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Divertisment sigur pentru familie', desc: 'Spectacol sema (fascinant pentru copii), Oba Dombra și dansuri populare din Anatolia, Azerbaidjan și Caucaz — inclusiv spectaculosul dans cu cuțite — plus muzică turcească live și set de saxofon și DJ. Totul este prietenos cu familia — fără conținut pentru adulți. Copiii se alătură adesea la dans.' }
    ],
    faq: [
      ...
      { q: 'Care este prețul pentru copii la croaziera pe Bosfor?', a: 'Copiii **0-3 ani: GRATUIT** (fără taxe, fără costuri ascunse). **4-9 ani: €5 reducere** din tariful pentru adulți — adică €19.30/copil la Standard (€{p.dinnerStd} − €5). **10+ ani: preț întreg pentru adulți.** Transferul de la hotel este gratuit pentru 0-3 ani, standard pentru 4+ (€{p.transfer}/persoană).' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Vin, șampanie, asocieri premium', desc: 'Adăugați pachetul de 2 pahare de alcool (+€{p.alcohol2}/persoană) — vin, bere, rachiu, vodcă, whisky, gin și altele local. Șampanie de import și asocieri premium la cerere — întrebați la rezervare.' }
    ],
    faq: [
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      { q: 'Croaziera pe Bosfor este 100% halal?', a: 'Da — fiecare produs din carne din meniu (pește, pui la frigărui, frigărui de vită, miel) este certificat halal de la furnizori aprobați. Bucătăria urmează standardele de pregătire halal. Pe vapor nu se servește nicăieri porc. Nu este o „opțiune halal" — întreg meniul este halal.' },
  ...
  'bosphorus-vip': {
    ...
    hero: {
      ...
      subtitle: 'Un singur meniu, un singur standard: premium pentru toți. O seară de 3 ore pe Bosfor la bordul navei Bosphorus Night — cină turcească consistentă, spectacole live pe scenă și, la cerere, o masă privată lângă scenă. Nu vindem o „clasă VIP“ separată — servim tot ce avem mai bun fiecărui oaspete.',
      badge: '40% REDUCERE · Un meniu, standard premium · Plata pe vas'
    },
    intro: [
      'Multe vase de pe Bosfor își împart oaspeții în „Standard“ și „VIP“. Noi nu. La bordul navei **Bosphorus Night** există un singur meniu de cină, pregătit cu aceeași grijă pentru toți: 10 sortimente de meze turcești, un aperitiv cald, fel principal la alegere (somon, biban de mare, pui la frigărui sau frigărui de vită), desert special din griș de gris și băuturi răcoritoare nelimitate. Întregul program de spectacole în opt numere este de asemenea inclus — Oba Dombra, ceremonia dervișilor rotitori, dansuri populare anatoliene și azere, dans din buric, dans cu cuțite caucazian, muzică live și un final cu saxofon și DJ — totul în prețul de €{p.dinnerStd}/persoană.',
    ...
    faq: [
      ...
      { q: 'Ce fel de vas este?', a: 'Bosphorus Night — o navă de pasageri modernă de 42 de metri, cu 3 punți și o capacitate de 400 de oaspeți, încălzită iarna și climatizată vara. Plecare din portul Kabataş: îmbarcare 20:00, plecare 21:00, întoarcere 00:00. Traseu: Dolmabahçe, Ortaköy, fortăreața Rumeli, Beylerbeyi și luminile podului peste Bosfor.' }
    ],
    cta: {
  ...
  'bosphorus-for-couples': {
    ...
    faq: [
      ...
      { q: 'Când este cel mai bine croaziera pe Bosfor pentru cupluri — apus sau seară?', a: 'Croaziera pleacă în fiecare seară la 21:00 — iar vara (mai–august) această plecare unică le acoperă pe amândouă: îmbarcare de la 20:00 în plină oră aurie, apusul chiar în jurul plecării, apoi podurile iluminate și palatele strălucitoare. Iarna este o croazieră pură a luminilor nocturne. Oricum ar fi, o singură rezervare le oferă cuplurilor cea mai iconică versiune a Bosforului.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      ...
      description: 'Prindeți apusul pe Bosfor, apoi luați cina sub podurile iluminate. Îmbarcare 20:00 la Kabataş, plecare 21:00. 3 ore, cină completă. Plata pe vapor.'
    },
    hero: {
      h1: 'Croazieră la Apus & Cină pe Bosfor',
      subtitle: 'Urcați la bord la 20:00, în timp ce cerul devine auriu deasupra minaretelor — apoi luați cina pe apă în timp ce Dolmabahçe, Moscheea Ortaköy și Podul Bosfor se aprind pentru noapte.',
      badge: 'Îmbarcare 20:00 · Plecare 21:00 · De la Apus la Luminile Orașului'
    },
    intro: [
    ...
    faq: [
      { q: 'La ce oră pleacă croaziera la apus pe Bosfor?', a: 'Îmbarcarea începe la 20:00 la debarcaderul Kabataş, vaporul pleacă la 21:00 și revine în jurul orei 00:00. Vara (mai–august), soarele apune între aproximativ 20:15 și 20:45 — ora de aur are loc în timp ce vă îmbarcați, iar apusul propriu-zis chiar în jurul plecării, văzut de pe apă.' },
      { q: 'Croaziera la apus pe Bosfor este aceeași cu croaziera cu cină?', a: 'Da — este una și aceeași croazieră. Există o singură plecare zilnică la 21:00, cu cină completă și spectacole live la bord. În serile lungi de vară funcționează și ca o croazieră la apus: vă îmbarcați în timpul orei de aur și navigați prin ora albastră până în noaptea iluminată. Iarna, aceeași croazieră devine o experiență pură a luminilor nocturne.' },
      { q: 'Cât costă croaziera la apus pe Bosfor?', a: 'De la €{p.dinnerStd}/persoană pentru croazieră (3 ore, cină completă, divertisment live). Plata pe vapor — fără plată în avans. Copiii 0-3 ani gratuit, 4-9 ani cu €5 reducere.' },
      { q: 'Care este cea mai bună perioadă a anului pentru o croazieră la apus pe Bosfor?', a: 'Din mai până în august. Apusurile târzii ale Istanbulului (20:15–20:45) se aliniază cu plecarea de la 21:00, așa că prindeți ora de aur, apusul și podurile iluminate într-o singură seară. Toamna și iarna soarele apune mai devreme, iar aceeași croazieră devine o experiență completă a luminilor nocturne — la fel de fotogenică, cu o atmosferă diferită.' },
      ...
      { q: 'Văd podurile iluminate noaptea pe această croazieră?', a: 'Da — aceasta este a doua jumătate a serii. Croaziera durează 21:00–00:00, deci după apus și ora albastră navigați sub Podul Bosfor complet iluminat, pe lângă palatele luminate și Turnul Fecioarei, și reveniți la Kabataş în jurul orei 00:00.' },
      { q: 'La ce oră apune soarele la Istanbul?', a: 'Vara (iunie–iulie), apusul la Istanbul este în jurul orei 20:30–20:45. Iarna, în jurul orei 16:30–17:00. Pentru o experiență de apus și noapte, croaziera cu cină Bosphorus Night de la 21:00 din Kabataş prinde vara ora de aur târzie și ora albastră, iar reperele iluminate — pe tot parcursul anului.' },
      { q: 'Merită croaziera la apus pe Bosfor?', a: 'Da — apusul deasupra Podului Bosfor este una dintre priveliștile emblematice ale Istanbulului. Croaziera cu cină Bosphorus Night de la 21:00 (€{p.dinnerStd}/persoană) prinde ora albastră de după apus plus palatele iluminate, cu cină completă și spectacole live pe parcursul a 3 ore.' }
    ],
    cta: {
      primary: 'Rezervați Croaziera la Apus · Plata pe Vapor',
      secondary: 'Îmbarcare 20:00 · Plecare 21:00 · Cină inclusă · Anulare gratuită cu 2 ore înainte',
  ...
  'bosphorus-night-tour': {
    meta: {
      ...
      description: 'Tur nocturn 3 ore pe Bosfor cu cină și spectacol live. Plecare 21:00 din Kabataş, poduri iluminate. Anulare gratuită, plată la bord.'
    },
    hero: {
    ...
    faq: [
      { q: 'Când este turul nocturn pe Bosfor?', a: 'Îmbarcarea de la ora 20:00 la debarcaderul Kabataș. Vaporul pleacă la 21:00, revine în jurul orei 00:00. Vă recomandăm să ajungeți cu 20 de minute mai devreme pentru a vă instala și alege locul.' },
      { q: 'Cât costă turul nocturn pe Bosfor?', a: 'Turul nocturn (3 ore, cină, spectacol): €{p.dinnerStd}/persoană (fost €{p.dinnerStdOriginal}). 0-3 ani gratuit, 4-9 ani cu €5 reducere. Plata pe vapor.' },
      ...
      { q: 'Turul nocturn pe Bosfor sau croaziera la apus — care e mai valoros?', a: 'Turul nocturn = Istanbul iluminat, dramatism maxim de lumină, program complet de divertisment, cele mai iconice fotografii ale podurilor iluminate. Și este o singură croazieră: vara (mai–august), îmbarcarea de la 20:00 prinde ora de aur, iar soarele apune chiar în jurul plecării de la 21:00 — astfel aceeași seară acoperă și apusul, și noaptea. Nu trebuie să alegeți sau să rezervați de două ori.' },
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
    {
      ...
      { q: 'Cât costă croaziera cu cină în Istanbul?', a: 'Croaziera noastră cu cină este €{p.dinnerStd}/persoană (preț normal €{p.dinnerStdOriginal}). 0-3 ani gratuit, 4-9 ani cu €5 reducere. Plata pe vapor — fără plată în avans.' },
      ...
      { q: 'Cât durează croaziera cu cină — și când începe?', a: 'Total 3 ore. Îmbarcare de la 20:00, vaporul pleacă exact la 21:00, revine în jurul orei 00:00. Vă recomandăm să ajungeți cu 15-20 de minute mai devreme pentru a vă instala și alege locul.' },
  ...
  'istanbul-night-tour': {
    ...
    faq: [
      ...
      { q: 'Care este cel mai bun moment pentru un tur nocturn în Istanbul?', a: 'Turul nostru cu cină pe Bosfor este 21:00-00:00 (3 ore). Acesta este momentul de iluminare de vârf pentru toate reperele Istanbulului — poduri complet iluminate, palate strălucitoare, luna pe apă. Dacă doriți și ora aurie, veniți vara: îmbarcarea începe la 20:00, iar în mai–august soarele apune chiar în jurul plecării de la 21:00 — aceeași croazieră le acoperă pe amândouă.' },
  ...
  'istanbul-boat-tour': {
    ...
    faq: [
      ...
      { q: 'Cât costă turul cu vaporul în Istanbul?', a: 'Turul nostru cu vaporul și cină: €{p.dinnerStd}/persoană (fost €{p.dinnerStdOriginal}). 0-3 ani gratuit, 4-9 ani cu €5 reducere. Plata pe vapor. Alcoolul și transferul de la hotel sunt suplimente opționale.' },
  ...
  'bosphorus-trip': {
    ...
    highlights: [
      ...
      { title: 'De la €{p.dinnerStd} — plata pe vapor', desc: 'Nu este necesară plata în avans. Plata pe vapor (numerar sau card). Anulare gratuită cu până la 2 ore înainte de plecare. 0-3 ani gratuit, 4-9 ani cu €5 reducere. Prețuri transparente.' }
    ],
    faq: [
  ...
  'bosphorus-cruise-tickets': {
    ...
    highlights: [
      ...
      { title: 'Confirmare în mai puțin de 1 minut', desc: 'Completați formularul → confirmăm prin WhatsApp / Telegram. Fără cupon PDF de email de imprimat. Mesajul nostru este biletul dumneavoastră. Ajungeți la debarcader la 20:00.' },
    ...
    faq: [
      { q: 'Cât costă biletele pentru croaziera pe Bosfor?', a: '€{p.dinnerStd}/persoană (normal €{p.dinnerStdOriginal}). Include turul de 3 ore, cină turcească cu multiple feluri, spectacol de dansuri populare live, băuturi răcoritoare nelimitate. 0-3 ani gratuit, 4-9 ani €5 reducere. Plata pe vapor — fără plată în avans.' },
      ...
      { q: 'Biletele pentru copii la croaziera pe Bosfor sunt gratuite?', a: 'Copiii **0-3 ani complet gratuit** (fără taxe, fără costuri ascunse, transfer inclus). **4-9 ani €5 reducere** (€{p.dinnerStd} − €5 = €19.30). **10+ ani preț întreg pentru adulți.** Prețuri plafonate și transparente — fără trucuri de „supliment pentru bebeluș".' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    ...
    highlights: [
      ...
      { title: 'Transfer de la hotel în aceeași zi adesea disponibil', desc: 'Transferul de la hotel necesită normal notificare de 24 de ore, dar pentru rezervările în aceeași zi între 14:00-18:30 putem aranja adesea preluarea cu +€{p.transfer}/persoană. Pentru cereri urgente de transfer, WhatsApp.' }
    ],
    faq: [
      { q: 'Chiar pot rezerva croaziera pe Bosfor pentru diseară?', a: 'Da — des. Rezervăm locuri pentru rezervările în aceeași zi. Verificați formularul de mai sus pentru disponibilitatea din seara aceasta. Dacă sunt locuri disponibile, puteți rezerva până la 21:00. Weekendurile sunt mai aglomerate — rezervați mai devreme în zi dacă este posibil.' },
      { q: 'Cât de în ultimul moment pot rezerva?', a: 'Rezervările rămân deschise până la ora 21:00 — chiar până la plecare. Dacă mai este foarte puțin până la plecare, scrieți-ne direct pe WhatsApp la +90 532 244 29 22 — dacă mai sunt locuri, confirmăm manual.' },
      ...
      { q: 'Puteți aranja transferul de la hotel în ultimul moment?', a: 'Transferul în aceeași zi este posibil până la ~18:30 pentru turul de la 21:00. După 18:30, s-ar putea să nu avem șofer disponibil — în acest caz, puteți lua un taxi la debarcaderul Kabataș (15 min din Taksim, 10 min din Sultanahmet, ~€10-15). Central și ușor.' },
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Prețuri croazieră Bosfor Istanbul: €{p.dinnerStd}/persoană. Copii 0-3 gratis, 4-9 €5 reducere. Suplimente transparente.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Preț pentru copii: 0-3 gratuit, 4-9 cu €5 reducere', desc: '0-3 complet gratuit (fără taxe). 4-9 cu €5 reducere din tariful adult. 10+ preț întreg adult. Transparent, fără trucuri de prețuri familiale. Transferul este și el gratuit pentru 0-3.' },
    ...
    faq: [
      { q: 'Cât costă un tur în Istanbul?', a: 'Croazieră cu cină: €{p.dinnerStd}/persoană (normal €{p.dinnerStdOriginal}, 40% reducere). 0-3 ani gratuit, 4-9 ani cu €5 reducere. Plata pe vapor — fără plată în avans. Anulare gratuită cu până la 2 ore înainte de plecare.' },
