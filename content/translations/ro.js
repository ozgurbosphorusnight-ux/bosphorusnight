...
module.exports = {
  ...
  'bosphorus-with-kids': {
    meta: {
      ...
      description: 'Croazieră cu cină Bosfor prietenoasă cu familia. Copii 0-3 gratis, 4-9 jumătate de preț. Sală interioară sigură, meniu pentru copii.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: 'Care este prețul pentru copii la croaziera pe Bosfor?', a: 'Copiii **0-3 ani: GRATUIT** (fără taxe, fără costuri ascunse). **4-9 ani: €5 reducere** din tariful pentru adulți — adică €12/copil la Standard (€{p.dinnerStd}/2). **10+ ani: preț întreg pentru adulți.** Transferul de la hotel este gratuit pentru 0-3 ani, standard pentru 4+ (€{p.transfer}/persoană).' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Cât costă croaziera la apus pe Bosfor?', a: 'De la €{p.dinnerStd}/persoană pentru croazieră (3 ore, cină completă, divertisment live). Plata pe vapor — fără plată în avans. Copiii 0-3 ani gratuit, 4-9 ani la jumătate de preț.' },
  ...
  'bosphorus-night-tour': {
    ...
    faq: [
      ...
      { q: 'Cât costă turul nocturn pe Bosfor?', a: 'Turul nocturn (3 ore, cină, spectacol): €{p.dinnerStd}/persoană (fost €{p.dinnerStdOriginal}). 0-3 ani gratuit, 4-9 ani la jumătate de preț. Plata pe vapor.' },
  ...
  'istanbul-boat-tour': {
    ...
    faq: [
      ...
      { q: 'Cât costă turul cu vaporul în Istanbul?', a: 'Turul nostru cu vaporul și cină: €{p.dinnerStd}/persoană (fost €{p.dinnerStdOriginal}). 0-3 ani gratuit, 4-9 ani la jumătate de preț. Plata pe vapor. Alcoolul și transferul de la hotel sunt suplimente opționale.' },
  ...
  'bosphorus-trip': {
    ...
    highlights: [
      ...
      { title: 'De la €{p.dinnerStd} — plata pe vapor', desc: 'Nu este necesară plata în avans. Plata pe vapor (numerar sau card). Anulare gratuită cu până la 2 ore înainte de plecare. 0-3 ani gratuit, 4-9 ani la jumătate de preț. Prețuri transparente.' }
    ],
    faq: [
  ...
  'bosphorus-cruise-tickets': {
    ...
    faq: [
      ...
      { q: 'Biletele pentru copii la croaziera pe Bosfor sunt gratuite?', a: 'Copiii **0-3 ani complet gratuit** (fără taxe, fără costuri ascunse, transfer inclus). **4-9 ani €5 reducere** (€{p.dinnerStd}/2 = €12,15). **10+ ani preț întreg pentru adulți.** Prețuri plafonate și transparente — fără trucuri de „supliment pentru bebeluș".' }
    ],
    cta: {
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Prețuri croazieră Bosfor Istanbul: €{p.dinnerStd}/persoană. Copii 0-3 gratis, 4-9 jumătate de preț. Suplimente transparente.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Preț pentru copii: 0-3 gratuit, 4-9 la jumătate de preț', desc: '0-3 complet gratuit (fără taxe). 4-9 cu €5 reducere din tariful adult. 10+ preț întreg adult. Transparent, fără trucuri de prețuri familiale. Transferul este și el gratuit pentru 0-3.' },
    ...
    faq: [
      { q: 'Cât costă un tur în Istanbul?', a: 'Croazieră cu cină: €{p.dinnerStd}/persoană (normal €{p.dinnerStdOriginal}, 40% reducere). 0-3 ani gratuit, 4-9 ani la jumătate de preț. Plata pe vapor — fără plată în avans. Anulare gratuită cu până la 2 ore înainte de plecare.' },
