...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Cum rezerv croaziera VIP pe Bosfor?', a: 'Folosiți formularul de rezervare de pe această pagină — selectați „VIP" la Pasul 1, stabiliți data, introduceți numărul de oaspeți, apoi datele de contact. Cererea dumneavoastră vine prin WhatsApp / Telegram și confirmăm instant. Plata pe vapor, nu acum.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Cât costă croaziera la apus pe Bosfor?', a: 'De la €{p.dinnerStd}/persoană pentru croaziera Standard (3 ore, cină completă, divertisment live). Opțiunea VIP cu loc în față la scenă și mezeluri premium este €{p.dinnerVip}/persoană. Plata pe vapor — fără plată în avans. Copiii 0-3 ani gratuit, 4-8 ani la jumătate de preț.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    intro: [
      ...
      'Procesul nostru de **bilete pentru croaziera pe Bosfor**: completați formularul de pe această pagină în mai puțin de 1 minut (data, număr de oaspeți, pachet, contact), confirmăm instant prin WhatsApp / Telegram, apăreți la debarcaderul Kabataș la 19:30, plătiți pe vapor, vă bucurați de croaziera cu cină de 3 ore. Fără bilet fizic de imprimat, fără cupon de primit pe email — confirmarea este biletul dumneavoastră.',
