...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    meta: {
      ...
      description: 'Cruzeiro com jantar de 3 horas no Bósforo: menu turco de vários pratos e show folclórico ao vivo. Partida às 21:00 de Kabataş. Cancelamento gratuito, pagamento a bordo.'
    },
    hero: {
    ...
    faq: [
      { q: 'A que horas começa o cruzeiro com jantar no Bósforo?', a: 'O embarque começa às 20:00 no cais de Kabataş. O barco parte às 21:00 e regressa por volta das 00:00. Recomendamos chegar 15-20 minutos mais cedo para se acomodar e relaxar.' },
      { q: 'Quanto custa o cruzeiro com jantar no Bósforo?', a: 'Cruzeiro com jantar €{p.dinnerStd}/pessoa (preço normal €{p.dinnerStdOriginal}). 0-3 anos grátis, 4-9 anos com €5 de desconto. O pagamento é feito a bordo — sem pagamento antecipado.' },
      { q: 'O álcool está incluído no cruzeiro com jantar?', a: 'Os refrigerantes ilimitados (água, cola, sumo) estão incluídos no preço. O pacote de álcool é opcional: 2 copos (vinho, cerveja, rakı, vodka ou gin) +€{p.alcohol2}/pessoa. As bebidas adicionais e importadas são cobradas separadamente a bordo.' },
      { q: 'Existe transfer do hotel?', a: 'Sim — o serviço de recolha e regresso é +€{p.transfer}/pessoa. Zonas servidas: Beşiktaş, Taksim, Sultanahmet, Sirkeci, Eminönü, Ortaköy, Beyoğlu, Fatih, Laleli, Topkapı, Kağıthane, Yenikapı, Sütlüce e Şişli. Pode selecionar esta opção no formulário de reserva.' },
  ...
  'bosphorus-with-kids': {
    ...
    highlights: [
      ...
      { title: 'Entretenimento seguro para a família', desc: 'Espetáculo sema (fascinante para crianças), Oba Dombra e danças folclóricas da Anatólia, do Azerbaijão e do Cáucaso — incluindo a espetacular dança das facas — além de música turca ao vivo e set de saxofone e DJ. Tudo amigo da família — sem conteúdo para adultos. As crianças muitas vezes juntam-se à dança.' }
    ],
    faq: [
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Vinho, champanhe, harmonizações premium', desc: 'Adicione o pacote de 2 copos de álcool (+€{p.alcohol2}/pessoa) — vinho, cerveja ou rakı local. Champanhe importado e harmonizações premium a pedido — pergunte na reserva.' }
    ],
    faq: [
      ...
      { q: 'Quanto custa o cruzeiro romântico para 2 pessoas?', a: '2 pessoas: 2 × €{p.dinnerStd} = €48.60. Adicione o arranjo romântico +€{p.romantic} = €63,60. Sem pagamento antecipado — pagamento a bordo. Pacote de 2 copos de álcool para dois: mais 2 × €{p.alcohol2} = €20.' },
  ...
  'halal-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Respeito pelas horas de oração', desc: 'Se o embarque coincide com maghrib ou isha (20:00-21:00), a nossa equipa pode encaminhá-lo para a zona de oração tranquila no cais de Kabataş antes da partida. Apenas avise-nos na reserva.' }
    ],
    faq: [
  ...
  'bosphorus-vip': {
    meta: {
      title: 'Experiência VIP no Bósforo a partir de €{p.dinnerStd} — jantar premium no Bósforo',
      description: 'Cruzeiro com jantar no Bósforo de nível VIP: menu turco completo, espetáculos ao vivo, opção de mesa junto ao palco, serviço atencioso. €{p.dinnerStdOriginal} → €{p.dinnerStd}. Pagamento a bordo, cancelamento grátis.'
    },
    hero: {
      h1: 'Experiência VIP no Bósforo — cruzeiro com jantar',
      subtitle: 'Um menu, um padrão: premium para todos. Uma noite de 3 horas no Bósforo a bordo do AMOR — jantar turco farto, espetáculos ao vivo no palco e, se quiser, uma mesa privativa junto ao palco. Não vendemos uma "classe VIP" separada: servimos o melhor a cada hóspede.',
      badge: '40% DE DESCONTO · Um menu, padrão premium · Pagamento a bordo'
    },
    intro: [
      'Muitos barcos do Bósforo dividem os hóspedes em "Standard" e "VIP". Nós não. A bordo do **AMOR** há um único menu de jantar, preparado com o mesmo cuidado para todos: 10 variedades de meze turcos, uma entrada quente, prato principal à escolha (salmão, robalo, frango ou köfte), bolo gelado e refrigerantes ilimitados. Todo o programa de espetáculos em oito números também está incluído — Oba Dombra, cerimónia dos dervixes rodopiantes, danças folclóricas da Anatólia e do Azerbaijão, dança do ventre, dança das facas caucasiana, música ao vivo e um final com saxofone e DJ — tudo no preço de €{p.dinnerStd}/pessoa.',
    ...
    highlights: [
      { title: 'Um menu, padrão premium', desc: 'Não existe um "menu VIP" separado, porque o nosso único menu já está nesse nível. 10 variedades de meze, entrada quente, 4 pratos principais à escolha, sobremesa e refrigerantes ilimitados, servidos com o mesmo cuidado em todas as mesas.' },
      { title: 'Mesa privativa junto ao palco (+€{p.romantic}/mesa)', desc: 'As mesas mais próximas dos dervixes, das danças folclóricas e da dança do ventre são reservadas com antecedência. Vista privilegiada do palco e do Bósforo. A sua mesa é privativa, não partilhada.' },
      { title: 'Serviço de mesa atencioso', desc: 'A nossa equipa serve-o à mesa: os pratos, sugestões do menu, bebidas adicionais, pedidos especiais. Sem filas no meio da multidão.' },
      { title: '40% DE DESCONTO — antes €{p.dinnerStdOriginal}, agora €{p.dinnerStd}', desc: 'Preço de reserva direta: €{p.dinnerStd}/pessoa (preço de tabela €{p.dinnerStdOriginal}). Pagamento a bordo, sem adiantamento. Cancelamento grátis até 2 horas antes da partida.' }
    ],
    faq: [
      ...
      { q: 'O que inclui o menu?', a: '10 variedades de meze turcos, uma entrada quente, prato principal à escolha (salmão, robalo, frango ou köfte) e bolo gelado de sobremesa, com refrigerantes ilimitados. O programa em oito números está incluído: Oba Dombra, cerimónia dos dervixes, danças folclóricas da Anatólia e do Azerbaijão, dança do ventre, dança das facas caucasiana, música ao vivo e um final com saxofone e DJ.' },
      { q: 'O álcool está incluído?', a: 'Não — o álcool é um extra separado: 2 copos de vinho ou cerveja local por +€{p.alcohol2}/pessoa. Os refrigerantes estão incluídos de forma ilimitada e gratuita. As bebidas premium importadas são cobradas à parte a bordo.' },
    ...
    cta: {
      primary: 'Reserve a sua mesa · Pagamento a bordo',
      secondary: 'Antes €{p.dinnerStdOriginal}, agora €{p.dinnerStd} · Cancelamento grátis até 2 h antes',
      tertiary: 'Adicionar mesa privativa junto ao palco (+€{p.romantic})'
    }
  },
  ...
  'private-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Duração e partida flexíveis', desc: 'As 3 horas standard podem ser estendidas para 4-5 horas. Escolha a partida diurna às 12:00, pôr-do-sol às 17:30 ou noturna às 21:00. Quer um dia útil em vez de fim-de-semana? Sem problema — adaptamo-nos ao seu programa.' },
    ...
    faq: [
      { q: 'Quanto custa um cruzeiro privado no Bósforo?', a: 'Para grupos 25+, geralmente desde €{p.dinnerStd}/pessoa + taxa de aluguer do barco em função do tamanho do grupo, data e duração. Escreva-nos pelo WhatsApp com o tamanho do grupo, data e requisitos — fornecemos preço numa hora. A maioria dos eventos encaixa-se no intervalo total €2.000-€6.000.' },
      { q: 'Qual é o tamanho mínimo do grupo para um cruzeiro privado no Bósforo?', a: 'Tecnicamente, 25 hóspedes tornam o cruzeiro privado economicamente viável. Grupos mais pequenos (10-24) podem alugar privadamente, mas pagam um preço mínimo equivalente a ~25 pessoas. Para grupos verdadeiramente pequenos (2-10), considere o cruzeiro com jantar normal — a sua mesa já é privada, apenas o barco é partilhado.' },
  ...
  'bosphorus-for-couples': {
    ...
    highlights: [
      ...
      { title: 'Suplementos para noites especiais', desc: 'Arranjo de mesa romântica (velas, rosas): +€{p.romantic}. 2 copos de álcool (vinho, cerveja ou rakı): +€{p.alcohol2}/pessoa. Transfer do hotel (ida e volta): +€{p.transfer}/pessoa. Escolha o que combina com a sua noite.' }
    ],
    faq: [
      ...
      { q: 'Quanto custa o cruzeiro no Bósforo para 2 pessoas?', a: '2 pessoas: 2 × €{p.dinnerStd} = €48.60. Adicione transfer do hotel para dois: +€{p.transfer}×2 = €10. Adicione o pacote de 2 copos de álcool para dois: +€{p.alcohol2}×2 = €20. Sem pagamento antecipado — pagamento a bordo.' },
      { q: 'Os casais podem trazer o seu próprio vinho ou champanhe?', a: 'Não permitimos álcool do exterior (por motivos de licença operacional). Mas temos o pacote de 2 copos de vinho ou cerveja local (+€{p.alcohol2}/pessoa) e podemos organizar vinhos premium importados ou champanhe por uma taxa — pergunte na reserva. Prosecco, Chianti e Cabernet são os pedidos premium populares.' },
      ...
      { q: 'Quando é melhor o cruzeiro no Bósforo para casais — pôr-do-sol ou noite?', a: 'O cruzeiro parte todas as noites às 21:00 — e no verão (maio–agosto) essa única partida cobre ambos: embarque a partir das 20:00 durante a hora dourada, o pôr-do-sol mesmo à hora da partida e, depois, as pontes iluminadas e os palácios acesos. No inverno é um cruzeiro puramente de luzes noturnas. De qualquer forma, uma única reserva dá aos casais a versão mais icónica do Bósforo.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      title: 'Cruzeiro Pôr-do-Sol + Jantar no Bósforo desde €{p.dinnerStd}',
      description: 'Apanhe o pôr-do-sol no Bósforo e jante sob as pontes iluminadas. Embarque 20:00 em Kabataş, partida 21:00. 3 horas, jantar completo. Pagamento a bordo.'
    },
    hero: {
      h1: 'Cruzeiro Pôr-do-Sol e Jantar no Bósforo',
      subtitle: 'Embarque às 20:00 enquanto o céu se pinta de dourado sobre os minaretes — e jante sobre a água enquanto Dolmabahçe, a Mesquita de Ortaköy e a Ponte do Bósforo se acendem para a noite.',
      badge: 'Embarque 20:00 · Partida 21:00 · Do Pôr-do-Sol às Luzes da Cidade'
    },
    intro: [
    ...
    highlights: [
      ...
      { title: 'Jantar completo durante o cruzeiro', desc: '10 variedades de mezze turcos, entrada quente, prato principal (salmão, dourada, frango, köfte, vegetariano), bolo gelado, refrigerantes ilimitados — servidos enquanto as luzes da cidade se acendem.' },
    ...
    faq: [
      ...
      { q: 'A que horas se põe o sol em Istambul?', a: 'No verão (junho–julho), o sol põe-se em Istambul por volta das 21:00–20:45. No inverno, por volta das 16:30–17:00. Para uma experiência de pôr-do-sol e noite, o cruzeiro com jantar das 21:00 da Bosphorus Night, a partir de Kabataş, apanha a hora dourada tardia e a hora azul no verão, e os monumentos iluminados durante todo o ano.' },
      { q: 'O cruzeiro ao pôr-do-sol no Bósforo vale a pena?', a: 'Sim — o pôr-do-sol sobre a Ponte do Bósforo é uma das vistas emblemáticas de Istambul. O cruzeiro com jantar das 21:00 da Bosphorus Night (€{p.dinnerStd}/pessoa) apanha a hora azul pós-pôr-do-sol e os palácios iluminados, com jantar completo e shows ao vivo ao longo de 3 horas.' }
    ],
    cta: {
      primary: 'Reserve o Cruzeiro ao Pôr-do-Sol · Pagamento a Bordo',
      secondary: 'Embarque 20:00 · Partida 21:00 · Jantar incluído · Cancelamento gratuito 2 horas antes',
      tertiary: 'Ver Todos os Detalhes do Cruzeiro com Jantar'
    }
  },
  ...
  'bosphorus-night-tour': {
    meta: {
      ...
      description: 'Passeio noturno de 3 horas no Bósforo com jantar e show ao vivo. Partida 21:00 de Kabataş, pontes iluminadas. Cancelamento gratuito, pagamento a bordo.'
    },
    hero: {
    ...
    cta: {
      ...
      secondary: 'Partida 21:00 · 3 horas · Jantar + show incluídos · Cancelamento gratuito 2 horas antes',
      tertiary: 'Disponibilidade Esta Noite'
    }
  },
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
    {
      ...
      { q: 'Quanto custa o cruzeiro com jantar em Istambul?', a: 'O nosso cruzeiro com jantar é €{p.dinnerStd}/pessoa (preço normal €{p.dinnerStdOriginal}). 0-3 anos grátis, 4-9 anos com €5 de desconto. Pagamento a bordo — sem pagamento antecipado.' },
      ...
      { q: 'Quanto dura o cruzeiro com jantar — e quando começa?', a: 'Total 3 horas. Embarque a partir das 20:00, o barco parte exatamente às 21:00, regressa por volta das 00:00. Recomendamos chegar 15-20 minutos mais cedo para se instalar e escolher o lugar.' },
  ...
  'istanbul-night-tour': {
    ...
    highlights: [
      ...
      { title: 'Danças folclóricas ao vivo + sema + oriental', desc: 'Programa ao vivo de oito números: Oba Dombra, espetáculo Mevlana sema, Sarı Gelin, potpourri azerbaijano, dança oriental, potpourri anatólio, dança das facas georgiana e caucasiana, depois saxofone ao vivo e DJ. 40 minutos de espetáculo, música de fundo toda a noite.' },
    ...
    faq: [
      ...
      { q: 'Quanto custa o passeio em Istambul à noite?', a: 'O nosso passeio noturno com jantar no Bósforo: €{p.dinnerStd}/pessoa. Incluído o passeio, o jantar, o entretenimento, os refrigerantes. Opcional: álcool (2 copos) +€{p.alcohol2}/pessoa, transfer do hotel +€{p.transfer}/pessoa. Pagamento a bordo — sem pagamento antecipado.' },
      ...
      { q: 'Qual é a melhor altura para um passeio noturno em Istambul?', a: 'O nosso passeio com jantar no Bósforo é 21:00-00:00 (3 horas). Este é o momento de iluminação de pico para todos os marcos de Istambul — pontes totalmente iluminadas, palácios brilhantes, a lua na água. Se também quer a hora dourada, venha no verão: o embarque começa às 20:00 e, de maio a agosto, o sol põe-se mesmo por volta da partida das 21:00 — o mesmo cruzeiro cobre ambos.' },
  ...
  'istanbul-boat-tour': {
    ...
    highlights: [
      ...
      { title: 'Partida noturna (a melhor iluminação)', desc: 'A partida das 21:00 capta o Bósforo iluminado em pleno brilho — pontes, palácios, mesquitas todos iluminados. Mais dramático do que os passeios diurnos que mostram os mesmos marcos em luz plana.' },
  ...
  'bosphorus-trip': {
    ...
    faq: [
      ...
      { q: 'Quanto dura uma excursão no Bósforo?', a: 'A nossa excursão no Bósforo dura 3 horas no total (partida 21:00, regresso 00:00). Existem opções mais curtas (ferries turísticos de 1 hora, passeios de 90 minutos), mas saltam o jantar e o entretenimento. Para a experiência noturna completa, 3 horas são ideais — suficiente para ver tudo sem cansaço.' },
      ...
      { q: 'A excursão no Bósforo é adequada para crianças?', a: 'Sim — muito amiga das crianças. Crianças 0-3 anos grátis (transfer incluído), 4-9 anos €5 de desconto. Zona interior coberta, menu infantil a pedido e entretenimento delicado e cativante. Muitas famílias reservam esta excursão como ponto alto da sua viagem a Istambul.' },
  ...
  'bosphorus-cruise-tickets': {
    meta: {
      ...
      description: 'Bilhetes diretos para o cruzeiro no Bósforo desde €{p.dinnerStd}/pessoa. Sem pagamento antecipado, pagamento a bordo. Cancelamento gratuito até 2h antes.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Confirmação em menos de 1 minuto', desc: 'Preencha o formulário → confirmamos via WhatsApp / Telegram. Sem cupão PDF de e-mail para imprimir. A nossa mensagem é o seu bilhete. Chegue ao cais às 20:00.' },
      { title: 'Preço atual de lançamento 40% DESCONTO', desc: 'Antes €{p.dinnerStdOriginal}, agora €{p.dinnerStd}. 40% de desconto porque reserva diretamente. Não é um truque com prazo limitado — é o nosso preço standard de reserva direta.' }
    ],
    faq: [
      { q: 'Quanto custam os bilhetes para o cruzeiro no Bósforo?', a: '€{p.dinnerStd}/pessoa (normal €{p.dinnerStdOriginal}). Inclui o passeio de 3 horas, jantar turco de vários pratos, show de danças folclóricas ao vivo, refrigerantes ilimitados. 0-3 anos grátis, 4-9 anos €5 de desconto. Pagamento a bordo — sem pagamento antecipado.' },
      ...
      { q: 'Os bilhetes para o cruzeiro no Bósforo estão disponíveis no próprio dia?', a: 'Frequentemente sim, especialmente em dias úteis. Os fins-de-semana e feriados enchem-se mais depressa. Verifique a disponibilidade através do formulário de reserva — atualiza-se em tempo real. A reserva no próprio dia é geralmente possível com algumas horas antes da partida das 21:00. Para pedidos urgentes, WhatsApp.' },
      { q: 'Os bilhetes para crianças no cruzeiro no Bósforo são grátis?', a: 'Crianças **0-3 anos completamente grátis** (sem taxas, sem custos escondidos, transfer incluído). **4-9 anos €5 de desconto** (€{p.dinnerStd} − €5 = €19.30). **10+ anos preço inteiro de adulto.** Preços fixos e transparentes — sem truques de "suplemento para bebé".' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    ...
    highlights: [
      ...
      { title: 'Transfer do hotel no próprio dia frequentemente disponível', desc: 'O transfer do hotel requer normalmente notificação de 24 horas, mas para reservas no próprio dia entre as 14:00-18:30 podemos frequentemente organizar a recolha com +€{p.transfer}/pessoa. Para pedidos urgentes de transfer, WhatsApp.' }
    ],
    faq: [
      { q: 'Posso mesmo reservar o cruzeiro no Bósforo para esta noite?', a: 'Sim — frequentemente. Reservamos lugares para reservas no próprio dia. Verifique o formulário acima para a disponibilidade desta noite. Se houver lugares disponíveis, pode reservar até às 21:00. Os fins-de-semana são mais movimentados — reserve mais cedo no dia se possível.' },
      { q: 'Quão last minute posso reservar?', a: 'As reservas mantêm-se abertas até às 21:00 — mesmo até à partida. Se faltar muito pouco para a partida, escreva-nos diretamente no WhatsApp para +90 532 244 29 22 — se houver lugares, confirmamos manualmente.' },
      { q: 'O cruzeiro no Bósforo no último momento é mais caro?', a: 'Não — mesmo preço que a reserva antecipada. €{p.dinnerStd}/pessoa. Não fazemos "preços dinâmicos" ou sobretaxas para o último momento. Mesmo barco, mesmo jantar, mesmo show, mesmo preço.' },
      ...
      { q: 'Podem organizar o transfer do hotel no último momento?', a: 'O transfer no próprio dia é possível até cerca das 18:30 para o passeio das 21:00. Após as 18:30, podemos não ter motorista disponível — neste caso, pode apanhar um táxi para o cais de Kabataş (15 min de Taksim, 10 min de Sultanahmet, ~€10-15). Central e fácil.' },
  ...
  'istanbul-cruise-price': {
    ...
    hero: {
      ...
      subtitle: 'Preços transparentes, sem taxas escondidas. €{p.dinnerStd}/pessoa — e paga a bordo, não agora.',
      badge: 'Transparente · 40% DESCONTO Direto · 0-3 Anos Grátis'
    },
    intro: [
      '**Os preços dos cruzeiros em Istambul** variam muito — desde ferries económicos de €15 que saltam o jantar até iates resort de €150+. O nosso preço está no meio e oferece o melhor valor: €{p.dinnerStd}/pessoa para o cruzeiro completo com jantar e show de 3 horas. Sem taxas escondidas, sem suplementos surpresa.',
      'Uma decomposição detalhada do **preço do cruzeiro em Istambul**, porque a transparência importa:\n\n- **Cruzeiro com Jantar**: €{p.dinnerStd}/pessoa (antes €{p.dinnerStdOriginal}, 40% de desconto). Inclui passeio de 3 horas, 10 mezze, prato principal, sobremesa, refrigerantes ilimitados, show ao vivo.\n- **0-3 anos**: Grátis. 4-9 anos: €5 de desconto. 10+ anos: preço inteiro.\n\nSuplementos (opcionais):\n- 2 copos álcool: +€{p.alcohol2}/pessoa\n- Transfer do hotel ida e volta: +€{p.transfer}/pessoa\n- Arranjo de mesa romântica: +€{p.romantic}/mesa',
    ...
    faq: [
      ...
      { q: 'Tenho de pagar antecipadamente o preço do passeio em Istambul?', a: 'Não — **pagamento a bordo**. Reserve agora (formulário de 1 minuto), confirmamos via WhatsApp, venha às 20:00 e pague a bordo (dinheiro ou cartão). Cancelamento gratuito até 2 horas antes. Zero compromisso financeiro até estar satisfeito.' },
