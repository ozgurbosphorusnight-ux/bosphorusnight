...
module.exports = {
  ...
  'halal-bosphorus-cruise': {
    ...
    highlights: [
      { title: 'Menu 100% certificado halal', desc: 'Toda a carne (salmão, robalo, frango em espetada, espetada de vaca, vaca, entrecosto) é certificada halal de fornecedores aprovados. A cozinha segue a preparação halal. Sem produtos de porco ou aditivos não-halal. Opções vegetarianas estão sempre disponíveis.' },
    ...
    faq: [
      { q: 'O cruzeiro no Bósforo é 100% halal?', a: 'Sim — cada produto de carne no menu (peixe, frango em espetada, espetada de vaca, borrego) é certificado halal de fornecedores aprovados. A cozinha segue os padrões de preparação halal. Não se serve porco em lado nenhum a bordo. Não é uma "opção halal" — todo o menu é halal.' },
