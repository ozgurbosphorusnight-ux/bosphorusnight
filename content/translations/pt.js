...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    faq: [
      ...
      { q: 'O álcool está incluído no cruzeiro com jantar?', a: 'Os refrigerantes ilimitados (água, cola, sumo) estão incluídos no preço. O pacote de álcool é opcional: 2 copos (vinho, cerveja, rakı, vodka, whisky, gin e mais) +€{p.alcohol2}/pessoa. As bebidas adicionais e importadas são cobradas separadamente a bordo.' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Vinho, champanhe, harmonizações premium', desc: 'Adicione o pacote de 2 copos de álcool (+€{p.alcohol2}/pessoa) — vinho, cerveja, rakı, vodka, whisky, gin e mais local. Champanhe importado e harmonizações premium a pedido — pergunte na reserva.' }
    ],
    faq: [
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      { q: 'O cruzeiro no Bósforo é 100% halal?', a: 'Sim — cada produto de carne no menu (salmão, robalo, frango em espetada, espetada de vaca) é certificado halal de fornecedores aprovados. A cozinha segue os padrões de preparação halal. Não se serve porco em lado nenhum a bordo. Não é uma "opção halal" — todo o menu é halal.' },
  ...
  'istanbul-night-tour': {
    ...
    highlights: [
      ...
      { title: 'Jantar turco completo incluído', desc: '10 mezze, entrada quente, prato principal (salmão/robalo/frango em espetada/espetada de vaca/vegetariano), sobremesa, refrigerantes ilimitados. Certificado halal. Avaliado a €{p.dinnerStd}/pessoa — tudo incluído.' },
