...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    faq: [
      ...
      { q: 'Existe transfer do hotel?', a: 'Sim — o serviço de recolha e regresso é +€{p.transfer}/pessoa. Zonas servidas: Beşiktaş, Taksim, Sultanahmet, Sirkeci, Eminönü, Ortaköy, Beyoğlu, Fatih, Laleli, Topkapı, Kağıthane e Sütlüce. Pode selecionar esta opção no formulário de reserva.' },
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Como reservo o cruzeiro VIP no Bósforo?', a: 'Use o formulário de reserva nesta página — selecione "VIP" no Passo 1, defina a data, introduza o número de hóspedes, depois os dados de contacto. O seu pedido chega via WhatsApp / Telegram / WeChat e confirmamos instantaneamente. Pagamento a bordo, não agora.' },
  ...
  'bosphorus-night-tour': {
    ...
    faq: [
      ...
      { q: 'Não falo turco — o passeio é em inglês?', a: 'A tripulação fala inglês. O entretenimento (sema, danças folclóricas, música) não requer linguagem. O menu do jantar está em inglês. A reserva via WhatsApp / Telegram / WeChat funciona em vários idiomas (inglês, árabe, russo, alemão, francês, espanhol). Não é necessário turco.' }
    ],
    cta: {
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
      ...
      { q: 'De onde parte o cruzeiro com jantar em Istambul?', a: 'Cais de Kabataş, Istambul — na costa europeia, perto do Palácio de Dolmabahçe. O local exato de encontro é comunicado via WhatsApp / Telegram / WeChat após a reserva. Os vídeos de caminhada da estação de elétrico de Dolmabahçe e da estação de elétrico de Kabataş encontram-se na secção do ponto de encontro acima.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    highlights: [
      ...
      { title: 'Confirmação em menos de 1 minuto', desc: 'Preencha o formulário → confirmamos via WhatsApp / Telegram / WeChat. Sem cupão PDF de e-mail para imprimir. A nossa mensagem é o seu bilhete. Chegue ao cais às 19:30.' },
    ...
    faq: [
      ...
      { q: 'Onde posso comprar bilhetes para o cruzeiro no Bósforo?', a: 'Diretamente nesta página — preencha o formulário de reserva, confirmamos instantaneamente via WhatsApp / Telegram / WeChat. Pagamento a bordo. As plataformas de terceiros (Viator, GetYourGuide, Klook) também vendem bilhetes, mas geralmente cobram €30-80+ — é o acréscimo do intermediário. Direto é o mais barato e mais rápido.' },
      { q: 'Tenho de imprimir o bilhete para o cruzeiro no Bósforo?', a: 'Não — não é necessário bilhete físico ou cupão. Após a reserva, enviamos-lhe uma confirmação via WhatsApp (ou Telegram/WeChat) com o ponto de encontro, hora e nome da reserva. Apenas mostre o telefone no cais. Pronto.' },
  ...
  'last-minute-bosphorus': {
    ...
    highlights: [
      ...
      { title: 'Confirmação em menos de 5 minutos', desc: 'Preencha o formulário → mensagem de confirmação WhatsApp/Telegram/WeChat → pronto. Sem cupão de e-mail para esperar, sem código QR para imprimir. A nossa mensagem é o seu bilhete.' },
