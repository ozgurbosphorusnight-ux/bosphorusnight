...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    hero: {
      ...
      subtitle: 'Viena ēdienkarte, viens standarts: premium ikvienam. Trīs stundu vakars Bosforā uz kuģa Bosphorus Night — bagātīgas turku vakariņas, dzīvie šovi uz skatuves un, ja vēlies, privāts galds pie skatuves. Mēs nepārdodam atsevišķu „VIP klasi“ — labāko pasniedzam katram viesim.',
      badge: '40% ATLAIDE · Viena ēdienkarte, premium standarts · Maksā uz kuģa'
    },
    intro: [
      'Daudzi kuģi Bosforā sadala viesus „standarta“ un „VIP“ grupās. Mēs to nedarām. Uz kuģa **Bosphorus Night** ir viena vakariņu ēdienkarte, gatavota ar vienādu rūpību visiem: 10 veidu turku meze, silta uzkoda, galvenais ēdiens pēc tavas izvēles (lasis, jūrasasaris, vistas šašliks vai liellopu šašliks), īpašs mannas deserts un neierobežoti bezalkoholiskie dzērieni. Iekļauta arī visa astoņu priekšnesumu izklaides programma — Oba Dombra, virpuļojošo dervišu ceremonija, Anatolijas un Azerbaidžānas tautas dejas, austrumu deja, kaukāziešu deja ar nažiem, dzīvā mūzika un fināls ar saksofonu un DJ — viss par €{p.dinnerStd}/personai.',
