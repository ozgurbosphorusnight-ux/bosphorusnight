...
module.exports = {
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Vīns, šampanietis, premium kombinācijas', desc: 'Pievieno 2 alkohola glāzes (+€{p.alcohol2}/personai) — vīnu, alu vai vietējo rakı. Importētais šampanietis un premium kombinācijas pēc pieprasījuma — pajautā rezervējot.' }
    ],
    faq: [
  ...
  'bosphorus-vip': {
    ...
    intro: [
      ...
      'AMOR ir moderns kuģis: 42 metri, 3 klāji, līdz 400 viesiem, ziemā apsildāms un vasarā ar gaisa kondicionieri. Trīs stundu maršruts sākas Kabatašā (iekāpšana no 19:30, izbraukšana 20:30, atgriešanās 23:30) garām Dolmabahčei, Ortakojas mošejai, Rumeli cietoksnim un Bosfora tilta gaismām. TÜRSAB licence (A-17672), 4,9★ Google. Bez priekšapmaksas — maksā uz kuģa, un atcelšana ir bez maksas līdz 2 stundām pirms izbraukšanas.'
    ],
    highlights: [
  ...
  'bosphorus-for-couples': {
    ...
    highlights: [
      ...
      { title: 'Papildinājumi īpašiem vakariem', desc: 'Romantiskais galda klājums (sveces, rozes): +€{p.romantic}. 2 glāzes vietējā alkohola (vīns, rakı): +€{p.alcohol2}/personai. Viesnīcas transfērs (turp un atpakaļ): +€{p.transfer}/personai. Izvēlies to, kas der tavam vakaram.' }
    ],
    faq: [
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      ...
      description: 'Noķer saulrietu pār Bosforu un vakariņo zem izgaismotajiem tiltiem. Iekāpšana 19:30 pie Kabataş, atiešana 20:30. 3 stundas, pilnas vakariņas. Maksā uz kuģa.'
    },
    hero: {
      h1: 'Saulrieta un vakariņu kruīzs pa Bosforu',
      subtitle: 'Iekāp plkst. 19:30, kad debesis virs minaretiem kļūst zeltainas — un vakariņo uz ūdens, kamēr Dolmabahçe, Ortaköy mošeja un Bosfora tilts iedegas naktij.',
      badge: 'Iekāpšana 19:30 · Atiešana 20:30 · No saulrieta līdz pilsētas gaismām'
    },
    intro: [
      '**Saulrieta kruīzs pa Bosforu** Stambulā ir par vienu lietu: pāreju. Mūsu kruīza iekāpšana pie Kabataş piestātnes sākas plkst. 19:30 — un garajos vakaros no maija līdz augustam zelta stunda risinās, kamēr tu iekārtojies uz klāja. Saule riet aiz Eiropas krasta minaretiem tieši ap atiešanu plkst. 20:30, tāpēc to vēro no ūdens: Dolmabahçe pils zeltā, Ortaköy mošeja kā siluets pret mirdzošajām debesīm.',
    ...
    highlights: [
      { title: 'Vasaras saulrieti tieši pie atiešanas', desc: 'No maija līdz augustam saule Stambulā riet aptuveni starp 20:15 un 20:45 — iekāpšana plkst. 19:30 dāvā zelta stundu uz klāja, un atiešana plkst. 20:30 nozīmē, ka pašu saulrietu redzi jau no ūdens. Kamera gatava — šī ir bilde.' },
      ...
      { title: 'Pilnas vakariņas kruīza laikā', desc: '10 turku meze veidi, silta uzkoda, galvenais ēdiens (lasis, jūras karūsa, vista, frikadeles, veģetārais), saldējuma kūka, neierobežoti bezalkoholiskie dzērieni — pasniegts, kamēr iedegas pilsētas gaismas.' },
    ...
    faq: [
      { q: 'Kad atiet saulrieta kruīzs pa Bosforu?', a: 'Iekāpšana sākas plkst. 19:30 pie Kabataş piestātnes, kuģis atiet plkst. 20:30 un atgriežas ap plkst. 23:30. Vasarā (maijs–augusts) saule riet aptuveni starp 20:15 un 20:45 — zelta stunda notiek iekāpšanas laikā, un pats saulriets tieši ap atiešanu, vērojams no ūdens.' },
      { q: 'Vai saulrieta kruīzs pa Bosforu ir tas pats, kas vakariņu kruīzs?', a: 'Jā — tas ir viens kruīzs. Ir viena ikdienas atiešana plkst. 20:30 ar pilnām vakariņām un dzīviem šoviem uz kuģa. Garajos vasaras vakaros tas vienlaikus ir arī saulrieta kruīzs: iekāp zelta stundas laikā un kuģo cauri zilajai stundai līdz izgaismotajai naktij. Ziemā tas pats kruīzs ir tīra nakts gaismu pieredze.' },
      ...
      { q: 'Kurš gadalaiks ir labākais saulrieta kruīzam pa Bosforu?', a: 'No maija līdz augustam. Stambulas vēlie saulrieti (20:15–20:45) sakrīt ar atiešanu plkst. 20:30, tāpēc vienā vakarā iegūsti zelta stundu, saulrietu un izgaismotos tiltus. Rudenī un ziemā saule riet agrāk, un tas pats kruīzs kļūst par pilnu nakts gaismu pieredzi — tikpat fotogēnisku, tikai citā noskaņā.' },
      ...
      { q: 'Vai šajā kruīzā redzēšu izgaismotos tiltus naktī?', a: 'Jā — tā ir vakara otrā puse. Kruīzs notiek 20:30–23:30, tāpēc pēc saulrieta un zilās stundas tu kuģo zem pilnībā izgaismotā Bosfora tilta, garām izgaismotajām pilīm un Jaunavas tornim, un atgriezies Kabataş ap plkst. 23:30.' },
      { q: 'Cikos Stambulā riet saule?', a: 'Vasarā (jūnijs–jūlijs) saule Stambulā riet ap 20:30–20:45. Ziemā — ap 16:30–17:00. Saulrieta un nakts pieredzei Bosphorus Night vakariņu kruīzs plkst. 20:30 no Kabataş vasarā noķer vēlo zelta stundu un zilo stundu, bet izgaismotos orientierus — visu gadu.' },
      { q: 'Vai saulrieta kruīzs pa Bosforu ir tā vērts?', a: 'Jā — saulriets pār Bosfora tiltu ir viens no Stambulas vizītkartes skatiem. Bosphorus Night vakariņu kruīzs plkst. 20:30 (€{p.dinnerStd}/personai) noķer zilo stundu pēc saulrieta un izgaismotās pilis, ar pilnām vakariņām un dzīviem šoviem 3 stundu garumā.' }
    ],
    cta: {
      primary: 'Rezervē saulrieta kruīzu · Maksā uz kuģa',
      secondary: 'Iekāpšana 19:30 · Atiešana 20:30 · Vakariņas iekļautas · Bezmaksas atcelšana 2 stundas iepriekš',
  ...
  'istanbul-night-tour': {
    ...
    faq: [
      ...
      { q: 'Kad ir labākais laiks nakts tūrei Stambulā?', a: 'Mūsu Bosfora vakariņu kruīzs ir 20:30–23:30 (3 stundas). Tas ir maksimālais izgaismojuma laiks visiem Stambulas orientieriem — pilnībā izgaismoti tilti, mirdzošas pilis, mēness uz ūdens. Ja vēlies arī zelta stundu, brauc vasarā: uzkāpšana uz klāja sākas plkst. 19:30, un no maija līdz augustam saule riet tieši ap plkst. 20:30 atiešanu — viens un tas pats kruīzs aptver abus.' },
  ...
  'last-minute-bosphorus': {
    ...
    intro: [
      ...
      '**Mūsu pēdējā brīža Bosfora kruīzam** ir tā pati vakara programma kā iepriekšējām rezervācijām: 3 stundas uz ūdens (20:30–23:30), turku vairāku ēdienu vakariņas, dzīvs tautas deju šovs, sema, austrumu deja, DJ. Dolmabahçe pils izgaismota, Ortaköy mošeja, Bosfora tilts — tie paši ikoniskie skati. Tā pati cena €{p.dinnerStd}/personai.',
