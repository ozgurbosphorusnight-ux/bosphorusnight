...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    faq: [
      ...
      { q: 'Vai ir pieejama paņemšana no viesnīcas?', a: 'Jā — paņemšana un nogādāšana atpakaļ ir +€{p.transfer}/personai. Apkalpotās zonas: Beşiktaş, Taksim, Sultanahmet, Sirkeci, Eminönü, Ortaköy, Beyoğlu, Fatih, Laleli, Topkapı, Kağıthane un Sütlüce. Šo iespēju vari izvēlēties rezervācijas veidlapā.' },
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Kā rezervēt VIP Bosfora kruīzu?', a: 'Izmanto rezervācijas veidlapu šajā lapā — izvēlies "VIP" 1. solī, iestati datumu, norādi viesu skaitu, pēc tam kontaktinformāciju. Tava pieprasījums nonāks pa WhatsApp / Telegram / WeChat, un mēs apstiprināsim nekavējoties. Maksā uz kuģa, ne tagad.' },
  ...
  'bosphorus-night-tour': {
    ...
    faq: [
      ...
      { q: 'Es nerunāju turku valodā — vai tūre ir angliski?', a: 'Komanda runā angliski. Izklaidei (sema, tautas dejas, mūzika) nav nepieciešama valoda. Vakariņu ēdienkarte ir angļu valodā. Rezervācija pa WhatsApp / Telegram / WeChat strādā vairākās valodās (angļu, arābu, krievu, vācu, franču, spāņu). Turku valoda nav nepieciešama.' }
    ],
    cta: {
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
      ...
      { q: 'No kurienes atiet vakariņu kruīzs Stambulā?', a: 'Kabataş piestātne, Stambula — Eiropas krastā, netālu no Dolmabahçe pils. Precīzais tikšanās punkts tiek paziņots pa WhatsApp / Telegram / WeChat pēc rezervācijas. Gājēju video no Dolmabahçe tramvaja pieturas un Kabataş tramvaja pieturas atrodami tikšanās vietas sadaļā augstāk.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    highlights: [
      ...
      { title: 'Apstiprinājums mazāk nekā 1 minūtes laikā', desc: 'Aizpildi veidlapu → apstiprināsim pa WhatsApp / Telegram / WeChat. Bez PDF kupona, kas jādrukā no e-pasta. Mūsu ziņojums ir tava biļete. Ierodies pie piestātnes plkst. 19:30.' },
    ...
    faq: [
      ...
      { q: 'Kur varu nopirkt Bosfora kruīza biļetes?', a: 'Tieši no šīs lapas — aizpildi rezervācijas veidlapu, mēs apstiprināsim nekavējoties pa WhatsApp / Telegram / WeChat. Maksā uz kuģa. Trešo pušu platformas (Viator, GetYourGuide, Klook) arī pārdod biļetes, bet parasti ņem €30–80+ — tas ir starpnieku pievienojums. Tiešais ir lētāks un ātrāks.' },
      { q: 'Vai man jāizdrukā Bosfora kruīza biļete?', a: 'Nē — nav nepieciešama fiziska biļete vai kupons. Pēc rezervācijas nosūtīsim apstiprinājumu pa WhatsApp (vai Telegram/WeChat) ar tikšanās vietu, laiku un rezervācijas vārdu. Vienkārši parādi telefonu pie piestātnes. Tas ir viss.' },
  ...
  'last-minute-bosphorus': {
    ...
    highlights: [
      ...
      { title: 'Apstiprinājums mazāk nekā 5 minūtēs', desc: 'Aizpildi veidlapu → WhatsApp/Telegram/WeChat apstiprinājuma ziņojums → gatavs. Bez e-pasta kupona, ko gaidīt, bez QR koda, ko drukāt. Mūsu ziņojums ir tava biļete.' },
