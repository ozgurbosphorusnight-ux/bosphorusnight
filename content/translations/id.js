...
module.exports = {
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      { q: 'Apakah pelayaran Bosphorus 100% halal?', a: 'Ya — setiap produk daging di menu (ikan, sate ayam, sate sapi, domba) bersertifikat halal dari pemasok resmi. Dapur mengikuti standar persiapan halal. Tidak ada babi yang disajikan di mana pun di kapal. Ini bukan "pilihan halal" — seluruh menunya halal.' },
