...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    meta: {
      ...
      description: 'Pelayaran makan malam 3 jam di Bosphorus: menu Turki multi-hidangan dan pertunjukan folklor langsung. Berangkat 21:00 dari Kabataş.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: 'Apakah alkohol termasuk dalam pelayaran makan malam?', a: 'Minuman ringan tanpa batas (air, cola, jus buah) termasuk dalam harga. Paket alkohol bersifat opsional: 2 gelas (anggur, bir, rakı, vodka, wiski, gin, dan lainnya, atau gin) +€{p.alcohol2}/orang. Minuman tambahan dan minuman impor dikenakan harga terpisah di kapal.' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Anggur, sampanye, pasangan premium', desc: 'Tambahkan 2 gelas alkohol — anggur, bir, rakı, vodka, wiski, gin, dan lainnya lokal (+€{p.alcohol2}/orang). Sampanye impor dan pasangan premium tersedia sesuai permintaan — tanyakan saat pemesanan.' }
    ],
    faq: [
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      { q: 'Apakah pelayaran Bosphorus 100% halal?', a: 'Ya — setiap produk daging di menu (salmon, sea bass, sate ayam, sate sapi) bersertifikat halal dari pemasok resmi. Dapur mengikuti standar persiapan halal. Tidak ada babi yang disajikan di mana pun di kapal. Ini bukan "pilihan halal" — seluruh menunya halal.' },
  ...
  'bosphorus-vip': {
    ...
    hero: {
      ...
      subtitle: 'Satu menu, satu standar: premium untuk semua. Malam 3 jam di Bosphorus bersama Bosphorus Night — makan malam Turki yang melimpah, pertunjukan panggung langsung, dan meja pribadi dekat panggung bila Anda inginkan. Kami tidak menjual "kelas VIP" terpisah; kami menyajikan yang terbaik untuk setiap tamu.',
      badge: 'DISKON 40% · Satu Menu, Standar Premium · Bayar di Kapal'
    },
    intro: [
      'Banyak kapal di Bosphorus membagi tamunya menjadi "Standar" dan "VIP". Kami tidak. Di atas **Bosphorus Night** hanya ada satu menu makan malam, disiapkan dengan perhatian yang sama untuk semua: 10 jenis meze Turki, hidangan pembuka hangat, hidangan utama pilihan Anda (salmon, kakap, sate ayam, atau sate sapi), hidangan penutup semolina spesial, dan minuman ringan tanpa batas. Seluruh program hiburan delapan penampilan juga termasuk — Oba Dombra, upacara darwis berputar, tarian rakyat Anatolia dan Azerbaijan, tari perut, tarian pisau Kaukasus, musik langsung, dan penutup dengan saksofon dan DJ — semuanya dalam harga €{p.dinnerStd}/orang.',
    ...
    faq: [
      ...
      { q: 'Kapal seperti apa ini?', a: 'Bosphorus Night — kapal penumpang modern sepanjang 42 meter, 3 dek, berkapasitas 400 tamu, dengan pemanas di musim dingin dan AC di musim panas. Berangkat dari Dermaga Kabataş: naik kapal 20:00, berangkat 21:00, kembali 00:00. Rute: Dolmabahçe, Ortaköy, Benteng Rumeli, Beylerbeyi, dan lampu-lampu Jembatan Bosphorus.' }
    ],
    cta: {
  ...
  'bosphorus-for-couples': {
    ...
    faq: [
      ...
      { q: 'Bisakah pasangan membawa anggur atau sampanye sendiri?', a: 'Kami tidak mengizinkan alkohol dari luar (alasan lisensi bisnis). Tetapi kami memiliki paket alkohol 2 gelas (anggur, bir, rakı, vodka, wiski, gin, dan lainnya) (+€{p.alcohol2}/orang), dan kami dapat mengatur anggur impor premium atau sampanye dengan biaya — tanyakan saat pemesanan. Prosecco, Chianti, dan Cabernet adalah permintaan premium populer.' },
      ...
      { q: 'Kapan waktu terbaik pelayaran Bosphorus untuk pasangan — matahari terbenam atau malam?', a: 'Pelayaran berangkat pukul 21:00 setiap malam — dan di musim panas (Mei–Agustus) satu keberangkatan itu mencakup keduanya: naik kapal mulai 20:00 saat golden hour, matahari terbenam tepat di sekitar waktu keberangkatan, lalu jembatan bermandikan cahaya dan istana yang menyala. Di musim dingin, ini murni pelayaran lampu malam. Apa pun musimnya, satu pemesanan memberi pasangan versi Bosphorus yang paling ikonik.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      ...
      description: 'Saksikan matahari terbenam di Bosphorus, lalu makan malam di bawah jembatan bermandikan cahaya. Naik kapal 20:00 di Kabataş, berangkat 21:00. 3 jam, makan malam lengkap. Bayar di kapal.'
    },
    hero: {
      h1: 'Pelayaran Matahari Terbenam & Makan Malam Bosphorus',
      subtitle: 'Naik kapal pukul 20:00 saat langit berubah keemasan di atas menara-menara masjid — lalu makan malam di atas air sementara Dolmabahçe, Masjid Ortaköy, dan Jembatan Bosphorus menyala untuk malam.',
      badge: 'Naik Kapal 20:00 · Berangkat 21:00 · Dari Senja ke Gemerlap Kota'
    },
    intro: [
    ...
    faq: [
      { q: 'Kapan pelayaran matahari terbenam Bosphorus berangkat?', a: 'Naik kapal dimulai pukul 20:00 di Dermaga Kabataş, kapal berangkat pukul 21:00 dan kembali sekitar pukul 00:00. Di musim panas (Mei–Agustus) matahari terbenam antara sekitar 20:15 dan 20:45 — golden hour berlangsung saat Anda naik kapal, dan matahari terbenam itu sendiri tepat sekitar keberangkatan, disaksikan dari air.' },
      { q: 'Apakah pelayaran matahari terbenam Bosphorus sama dengan pelayaran makan malam?', a: 'Ya — ini satu pelayaran yang sama. Ada satu keberangkatan harian pukul 21:00 dengan makan malam lengkap dan pertunjukan langsung di kapal. Di malam-malam panjang musim panas, pelayaran ini sekaligus menjadi pelayaran matahari terbenam: Anda naik kapal selama golden hour dan berlayar melewati blue hour menuju malam yang bermandikan cahaya. Di musim dingin, pelayaran yang sama menjadi pengalaman lampu malam murni.' },
      { q: 'Berapa harga pelayaran matahari terbenam Bosphorus?', a: 'Mulai €{p.dinnerStd}/orang untuk pelayaran (3 jam, makan malam lengkap, hiburan langsung). Bayar di kapal — tanpa pembayaran di muka. Usia 0-3 gratis, usia 4-9 diskon €5.' },
      { q: 'Kapan waktu terbaik dalam setahun untuk pelayaran matahari terbenam Bosphorus?', a: 'Mei hingga Agustus. Matahari terbenam yang larut di Istanbul (20:15–20:45) bertepatan dengan keberangkatan pukul 21:00, jadi Anda mendapatkan golden hour, matahari terbenam, dan jembatan bermandikan cahaya dalam satu malam. Di musim gugur dan dingin matahari terbenam lebih awal dan pelayaran yang sama menjadi pengalaman lampu malam penuh — sama fotogeniknya, suasananya berbeda.' },
      ...
      { q: 'Apakah saya melihat jembatan bermandikan cahaya di malam hari dalam pelayaran ini?', a: 'Ya — itulah paruh kedua malam. Pelayaran berlangsung 21:00–00:00, jadi setelah matahari terbenam dan blue hour Anda berlayar di bawah Jembatan Bosphorus yang menyala penuh, melewati istana-istana bermandikan cahaya dan Menara Gadis, lalu kembali ke Kabataş sekitar pukul 00:00.' },
      { q: 'Jam berapa matahari terbenam di Istanbul?', a: 'Di musim panas (Juni–Juli), matahari terbenam di Istanbul sekitar pukul 21:00–20:45. Di musim dingin, sekitar pukul 16:30–17:00. Untuk pengalaman matahari terbenam sekaligus malam, pelayaran makan malam Bosphorus Night pukul 21:00 dari Kabataş menangkap golden hour larut dan blue hour di musim panas, serta landmark bermandikan cahaya sepanjang tahun.' },
      { q: 'Apakah pelayaran matahari terbenam Bosphorus sepadan?', a: 'Ya — matahari terbenam di atas Jembatan Bosphorus adalah salah satu pemandangan khas Istanbul. Pelayaran makan malam Bosphorus Night pukul 21:00 (€{p.dinnerStd}/orang) menangkap blue hour setelah matahari terbenam plus istana-istana bermandikan cahaya, dengan makan malam lengkap dan pertunjukan langsung selama 3 jam.' }
    ],
    cta: {
      primary: 'Pesan Pelayaran Matahari Terbenam · Bayar di Kapal',
      secondary: 'Naik kapal 20:00 · Berangkat 21:00 · Makan malam termasuk · Pembatalan gratis hingga 2 jam sebelumnya',
  ...
  'bosphorus-night-tour': {
    meta: {
      ...
      description: 'Tur malam 3 jam Bosphorus dengan makan malam dan show langsung. Berangkat 21:00 dari Kabataş, jembatan bercahaya. Pembatalan gratis, bayar di kapal.'
    },
    hero: {
    ...
    faq: [
      { q: 'Kapan tur malam Bosphorus?', a: 'Naik kapal dari pukul 20:00 di Dermaga Kabataş. Kapal berangkat pukul 21:00, kembali sekitar pukul 00:00. Kami sarankan datang 20 menit lebih awal untuk menetap dan memilih tempat duduk.' },
      { q: 'Berapa harga tur malam Bosphorus?', a: 'Tur malam (3 jam, makan malam, pertunjukan): €{p.dinnerStd}/orang (sebelumnya €{p.dinnerStdOriginal}). Usia 0-3 gratis, usia 4-9 diskon €5. Bayar di kapal.' },
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
    {
      ...
      { q: 'Berapa harga pelayaran makan malam di Istanbul?', a: 'Pelayaran makan malam kami €{p.dinnerStd}/orang (harga normal €{p.dinnerStdOriginal}). Usia 0-3 gratis, usia 4-9 diskon €5. Bayar di kapal — tanpa pembayaran di muka.' },
      ...
      { q: 'Berapa lama pelayaran makan malam — dan kapan dimulai?', a: 'Total 3 jam. Naik kapal dari pukul 20:00, kapal berangkat penuh pukul 21:00, kembali sekitar pukul 00:00. Kami sarankan datang 15-20 menit lebih awal untuk menetap dan memilih tempat duduk.' },
  ...
  'istanbul-boat-tour': {
    ...
    faq: [
      ...
      { q: 'Berapa harga tur perahu Istanbul?', a: 'Tur perahu makan malam kami: €{p.dinnerStd}/orang (sebelumnya €{p.dinnerStdOriginal}). Usia 0-3 gratis, usia 4-9 diskon €5. Bayar di kapal. Alkohol dan antar-jemput hotel adalah tambahan opsional.' },
      ...
      { q: 'Apakah tur perahu ini cocok untuk keluarga dengan anak-anak?', a: 'Ya — sangat ramah keluarga. Anak usia 0-3 tahun gratis, usia 4-9 diskon €5. Tempat duduk dalam ruangan, menu anak sesuai permintaan, dan hiburan (sema, tarian rakyat) menarik bagi anak-anak. Menu halal. Banyak keluarga dari seluruh dunia memesan tur ini.' },
  ...
  'bosphorus-trip': {
    meta: {
      ...
      description: 'Perjalanan 3 jam di Bosphorus: makan malam Turki, folklor langsung, pemandangan malam bercahaya. Berangkat 21:00 dari Kabataş.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Mulai €{p.dinnerStd} — bayar di kapal', desc: 'Tidak perlu pembayaran di muka. Bayar di kapal (tunai atau kartu). Pembatalan gratis hingga 2 jam sebelum keberangkatan. Usia 0-3 gratis, usia 4-9 diskon €5. Harga transparan.' }
    ],
    faq: [
  ...
  'bosphorus-cruise-tickets': {
    ...
    highlights: [
      ...
      { title: 'Konfirmasi dalam kurang dari 1 menit', desc: 'Isi wizard → kami konfirmasi via WhatsApp / Telegram. Tanpa voucher PDF yang dikirim email untuk dicetak. Pesan kami adalah tiket Anda. Datang pukul 20:00 ke dermaga.' },
    ...
    faq: [
      { q: 'Berapa harga tiket pelayaran Bosphorus?', a: 'Tiket €{p.dinnerStd}/orang (normal €{p.dinnerStdOriginal}). Termasuk tur 3 jam, makan malam Turki berlimpah (semua halal), pertunjukan tarian rakyat langsung, minuman ringan tanpa batas. Usia 0-3 gratis, usia 4-9 diskon €5. Bayar di kapal — tanpa pembayaran di muka.' },
      ...
      { q: 'Apakah tiket pelayaran Bosphorus anak gratis?', a: 'Anak **usia 0-3 tahun sepenuhnya gratis** (tanpa biaya, tanpa biaya tersembunyi, termasuk antar-jemput). **Usia 4-9 tahun diskon €5** (€{p.dinnerStd} − €5 = €19.30). **Usia 10+ harga dewasa penuh.** Harga tetap dan transparan — tanpa trik "biaya tambahan bayi".' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    ...
    highlights: [
      ...
      { title: 'Antar-jemput hotel hari yang sama sering tersedia', desc: 'Antar-jemput hotel biasanya memerlukan pemberitahuan 24 jam, tetapi untuk pemesanan hari yang sama antara pukul 14:00-18:30, kami biasanya dapat mengatur penjemputan dengan +€{p.transfer}/orang. Untuk permintaan antar-jemput mendesak, WhatsApp.' }
    ],
    faq: [
      { q: 'Bisakah saya benar-benar memesan pelayaran Bosphorus untuk malam ini?', a: 'Ya — sering. Kami menyisihkan kursi untuk pemesanan hari yang sama. Periksa wizard di atas untuk ketersediaan malam ini. Jika kursi tersedia, Anda dapat memesan hingga pukul 21:00. Akhir pekan lebih ketat — pesan lebih awal di hari itu jika mungkin.' },
      { q: 'Seberapa menit terakhir saya bisa memesan?', a: 'Pemesanan tetap terbuka hingga pukul 21:00 — tepat sampai keberangkatan. Jika sudah sangat dekat dengan keberangkatan, kirim pesan langsung ke WhatsApp kami di +90 532 244 29 22 — jika masih ada kursi, kami konfirmasi secara manual.' },
  ...
  'istanbul-cruise-price': {
    ...
    faq: [
      { q: 'Berapa harga pelayaran Istanbul?', a: 'Pelayaran Makan Malam: €{p.dinnerStd}/orang (normal €{p.dinnerStdOriginal}, diskon 40%). Usia 0-3 gratis, usia 4-9 diskon €5. Bayar di kapal — tanpa pembayaran di muka. Pembatalan gratis hingga 2 jam sebelum keberangkatan.' },
