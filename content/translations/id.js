...
module.exports = {
  ...
  'bosphorus-vip': {
    meta: {
      ...
      description: 'Pelayaran makan malam VIP Bosphorus: meze premium, pilihan steak, meja depan panggung, layanan prioritas.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: 'Bagaimana cara memesan pelayaran Bosphorus VIP?', a: 'Gunakan wizard pemesanan di halaman ini — pilih "VIP" di Langkah 1, tetapkan tanggal Anda, masukkan jumlah tamu, lalu detail kontak. Permintaan Anda dikirim melalui WhatsApp / Telegram dan kami konfirmasi secara instan. Bayar di kapal, bukan sekarang.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Berapa harga pelayaran matahari terbenam Bosphorus?', a: 'Mulai €{p.dinnerStd}/orang untuk pelayaran Standar (3 jam, makan malam lengkap, hiburan langsung). Pilihan VIP dengan tempat duduk depan panggung dan meze premium €{p.dinnerVip}/orang. Bayar di kapal — tanpa pembayaran di muka. Usia 0-3 gratis, usia 4-8 setengah harga.' },
  ...
  'bosphorus-cruise-tickets': {
    meta: {
      ...
      description: 'Tiket langsung pelayaran Bosphorus. Standar €{p.dinnerStd}, VIP €{p.dinnerVip}. Tanpa uang muka, bayar di kapal. Pembatalan gratis hingga 2 jam sebelumnya.'
    },
    hero: {
