...
module.exports = {
  ...
  "halal-bosphorus-cruise": {
    ...
    highlights: [
      { title: "Menu 100% certificato halal", desc: "Tutta la carne (salmone, branzino, pollo allo spiedo, spiedino di manzo, manzo, costata) è certificata halal da fornitori approvati. La cucina segue la preparazione halal. Nessun prodotto a base di maiale o additivo non halal. Opzioni vegetariane sempre disponibili." },
    ...
    faq: [
      { q: "La crociera sul Bosforo è 100% halal?", a: "Sì — ogni prodotto a base di carne nel menu (pesce, pollo a la brocheta, spiedino di manzo, agnello) è certificato halal da fornitori approvati. La cucina segue gli standard di preparazione halal. Nessun maiale viene servito da nessuna parte sulla barca. Non è un'\"opzione halal\" — l'intero menu è halal." },
