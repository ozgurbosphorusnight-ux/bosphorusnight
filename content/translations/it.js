...
module.exports = {
  ...
  "bosphorus-dinner-cruise": {
    meta: {
      ...
      description: 'Crociera cena 3 ore sul Bosforo: menu turco multi-portate e spettacolo folkloristico dal vivo. Partenza 21:00 da Kabataş.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: "L'alcol è incluso nella crociera con cena?", a: "Le bevande analcoliche illimitate (acqua, cola, succhi) sono incluse nel prezzo. Il pacchetto alcolico è opzionale: 2 bicchieri (vino, birra, rakı, vodka, whisky, gin e altro) +€{p.alcohol2}/persona. Le bevande aggiuntive e i distillati d'importazione sono a prezzo separato a bordo." },
  ...
  "romantic-bosphorus-cruise": {
    ...
    highlights: [
      ...
      { title: "Vino, champagne, abbinamenti premium", desc: "Aggiunga 2 bicchieri di alcol — vino, birra, rakı, vodka, whisky, gin e altro e rakı locali (+€{p.alcohol2}/persona). Champagne d'importazione e abbinamenti premium su richiesta — chieda alla prenotazione." }
    ],
    faq: [
  ...
  "halal-bosphorus-cruise": {
    ...
    faq: [
      { q: "La crociera sul Bosforo è 100% halal?", a: "Sì — ogni prodotto a base di carne nel menu (salmone, branzino, spiedino di pollo, spiedino di manzo) è certificato halal da fornitori approvati. La cucina segue gli standard di preparazione halal. Nessun maiale viene servito da nessuna parte sulla barca. Non è un'\"opzione halal\" — l'intero menu è halal." },
  ...
  "bosphorus-sunset-cruise": {
    meta: {
      ...
      description: 'Il tramonto sul Bosforo, poi cena sotto i ponti illuminati. Imbarco 20:00 a Kabataş, partenza 21:00. 3 ore, cena completa. Pagamento a bordo.'
    },
    hero: {
      h1: "Crociera Tramonto e Cena sul Bosforo",
      subtitle: "Si imbarchi alle 20:00 mentre il cielo si tinge d'oro sopra i minareti — poi ceni sull'acqua mentre Dolmabahçe, la Moschea di Ortaköy e il Ponte del Bosforo si accendono per la notte.",
      badge: "Imbarco 20:00 · Partenza 21:00 · Dal Tramonto alle Luci della Città"
    },
    intro: [
    ...
    faq: [
      { q: "A che ora parte la crociera al tramonto sul Bosforo?", a: "L'imbarco inizia alle 20:00 al molo di Kabataş, la barca parte alle 21:00 e rientra intorno alle 00:00. In estate (maggio–agosto) il sole tramonta all'incirca tra le 20:15 e le 20:45 — l'ora dorata avviene durante l'imbarco, e il tramonto stesso proprio intorno alla partenza, visto dall'acqua." },
      { q: "La crociera al tramonto sul Bosforo è la stessa della crociera con cena?", a: "Sì — è un'unica crociera. C'è una sola partenza giornaliera alle 21:00 con cena completa e spettacoli dal vivo a bordo. Nelle lunghe serate estive funziona anche come crociera al tramonto: si imbarca durante l'ora dorata e naviga attraverso l'ora blu fino alla notte illuminata. In inverno, la stessa crociera diventa un'esperienza puramente notturna tra le luci." },
      { q: "Qual è il prezzo della crociera al tramonto sul Bosforo?", a: "Da €{p.dinnerStd}/persona per la crociera (3 ore, cena completa, intrattenimento dal vivo). Pagamento a bordo — nessun anticipo. 0-3 anni gratis, 4-9 anni €5 di sconto." },
      { q: "Qual è il periodo migliore dell'anno per una crociera al tramonto sul Bosforo?", a: "Da maggio ad agosto. I tramonti tardivi di Istanbul (20:15–20:45) coincidono con la partenza delle 21:00, quindi ottiene l'ora dorata, il tramonto e i ponti illuminati in un'unica serata. In autunno e inverno il sole tramonta prima e la stessa crociera diventa un'esperienza interamente dedicata alle luci notturne — altrettanto fotogenica, atmosfera diversa." },
  ...
  "bosphorus-night-tour": {
    meta: {
      ...
      description: 'Tour notturno 3 ore sul Bosforo con cena e spettacolo dal vivo. Partenza 21:00 da Kabataş, ponti illuminati. Cancellazione gratuita, pagamento a bordo.'
    },
    hero: {
    ...
    faq: [
      { q: "Quando è il tour notturno sul Bosforo?", a: "Imbarco dalle 20:00 al molo di Kabataş. La barca parte alle 21:00, rientra intorno alle 00:00. Raccomandiamo di arrivare 20 minuti prima per sistemarsi e scegliere il posto." },
      { q: "Quanto costa il tour notturno sul Bosforo?", a: "Tour notturno (3 ore, cena, spettacolo): €{p.dinnerStd}/persona (prima €{p.dinnerStdOriginal}). 0-3 anni gratis, 4-9 anni €5 di sconto. Pagamento a bordo." },
  ...
  "dinner-cruise-istanbul": {
    ...
    faq: [
    {
      ...
      { q: "Quanto costa una crociera con cena a Istanbul?", a: "La nostra crociera con cena costa €{p.dinnerStd}/persona (prezzo pieno €{p.dinnerStdOriginal}). 0-3 anni gratis, 4-9 anni al €5. Pagamento a bordo — nessun anticipo." },
      ...
      { q: "Quanto dura la crociera con cena — e quando inizia?", a: "3 ore totali. Imbarco dalle 20:00, la barca parte puntuale alle 21:00, rientra intorno alle 00:00. Raccomandiamo di arrivare 15-20 minuti prima per sistemarsi e scegliere il posto." },
  ...
  "istanbul-night-tour": {
    ...
    highlights: [
      ...
      { title: "Cena turca completa inclusa", desc: "10 meze, antipasto caldo, secondo (salmone/branzino/pollo allo spiedo/spiedino di manzo/vegetariano), dolce, bevande analcoliche illimitate. Certificato halal. Prezzo a €{p.dinnerStd}/persona — tutto incluso." },
      { title: "Folklore dal vivo + Sema + orientale", desc: "Programma dal vivo in otto numeri: Oba Dombra, cerimonia Sema Mevlana, Sarı Gelin, potpourri azero, danza orientale, potpourri anatolico, danza dei coltelli georgiana e caucasica, poi sassofono dal vivo e DJ. 40 minuti di esibizioni, musica d'atmosfera per tutta la serata." },
    ...
    faq: [
      ...
      { q: "Qual è il momento migliore per un tour notturno a Istanbul?", a: "La nostra crociera con cena sul Bosforo è dalle 21:00 alle 00:00 (3 ore). Questo è l'orario di illuminazione di picco per tutti i monumenti di Istanbul — ponti pienamente illuminati, palazzi brillanti, luna sull'acqua. Se desidera anche l'ora dorata, venga in estate: l'imbarco inizia alle 20:00 e da maggio ad agosto il sole tramonta proprio intorno alla partenza delle 21:00 — la stessa crociera copre entrambe le cose." },
  ...
  "istanbul-boat-tour": {
    ...
    faq: [
      ...
      { q: "Quanto costa un tour in barca a Istanbul?", a: "Il nostro tour in barca con cena: €{p.dinnerStd}/persona (prima €{p.dinnerStdOriginal}). 0-3 anni gratis, 4-9 anni €5 di sconto. Pagamento a bordo. Alcol e transfer hotel sono extra opzionali." },
  ...
  "bosphorus-trip": {
    meta: {
      ...
      description: 'Gita 3 ore sul Bosforo: cena turca, folklore dal vivo, viste notturne illuminate. Partenza 21:00 da Kabataş. Cancellazione gratuita, pagamento a bordo.'
    },
    hero: {
      h1: "Gita sul Bosforo",
    ...
    highlights: [
      ...
      { title: "Da €{p.dinnerStd} — pagamento a bordo", desc: "Nessun anticipo richiesto. Pagamento a bordo (contanti o carta). Cancellazione gratuita fino a 2 ore prima della partenza. 0-3 anni gratis, 4-9 anni €5 di sconto. Prezzi trasparenti." }
    ],
    faq: [
  ...
  "bosphorus-cruise-tickets": {
    ...
    highlights: [
      ...
      { title: "Conferma in meno di 1 minuto", desc: "Compili la procedura guidata → confermiamo via WhatsApp / Telegram. Nessun voucher PDF da aspettare via email. Il nostro messaggio è il Suo biglietto. Si presenti al molo alle 20:00." },
    ...
    faq: [
      { q: "Quanto costano i biglietti per la crociera sul Bosforo?", a: "€{p.dinnerStd}/persona (prezzo pieno €{p.dinnerStdOriginal}). Include tour di 3 ore, cena turca a più portate, spettacolo di folklore dal vivo, bevande analcoliche illimitate. 0-3 anni gratis, 4-9 anni €5 di sconto. Pagamento a bordo — nessun anticipo." },
  ...
  "last-minute-bosphorus": {
    meta: {
      ...
      description: 'Prenotazione crociera Bosforo stesso giorno. Conferma WhatsApp in minuti. Partenza 21:00 da Kabataş. Cancellazione gratuita, pagamento a bordo.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: "Transfer hotel nello stesso giorno spesso disponibile", desc: "Il transfer hotel richiede normalmente 24 ore di preavviso, ma per prenotazioni nello stesso giorno tra le 14:00-18:30 di solito possiamo organizzare il ritiro a +€{p.transfer}/persona. Per richieste urgenti di transfer, WhatsApp." }
    ],
    faq: [
      { q: "Posso davvero prenotare la crociera sul Bosforo per stasera?", a: "Sì — spesso. Riserviamo posti per prenotazioni nello stesso giorno. Verifichi la procedura guidata sopra per la disponibilità di stasera. Se ci sono posti disponibili, può prenotare fino alle 21:00. I weekend sono più stretti — prenoti prima durante il giorno se possibile." },
      { q: "Quanto last minute posso prenotare?", a: "Le prenotazioni restano aperte fino alle 21:00, fino al momento della partenza. Se manca pochissimo alla partenza, ci scriva direttamente su WhatsApp al +90 532 244 29 22 — se ci sono posti liberi, confermiamo manualmente." },
      ...
      { q: "Può organizzare il transfer hotel last minute?", a: "Il transfer nello stesso giorno è possibile fino a ~18:30 per il tour delle 21:00. Dopo le 18:30, potremmo non avere un autista disponibile — in tal caso può prendere un taxi per il molo di Kabataş (15 min da Taksim, 10 min da Sultanahmet, ~€10-15). Centrale e facile." },
  ...
  "istanbul-cruise-price": {
    ...
    faq: [
      { q: "Quanto costa una crociera a Istanbul?", a: "Crociera con Cena: €{p.dinnerStd}/persona (pieno €{p.dinnerStdOriginal}, 40% di sconto). 0-3 anni gratis, 4-9 anni €5 di sconto. Pagamento a bordo — nessun anticipo. Cancellazione gratuita fino a 2 ore prima della partenza." },
