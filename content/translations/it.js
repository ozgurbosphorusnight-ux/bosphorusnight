...
module.exports = {
  ...
  "bosphorus-vip": {
    ...
    faq: [
      ...
      { q: "Come prenoto il tour VIP sul Bosforo?", a: "Usi la procedura guidata di prenotazione su questa pagina — selezioni \"VIP\" al Passo 1, imposti la data, inserisca il numero di ospiti, poi i dettagli di contatto. La Sua richiesta arriva via WhatsApp / Telegram e confermiamo immediatamente. Pagamento a bordo, non ora." },
  ...
  "bosphorus-sunset-cruise": {
    ...
    faq: [
      ...
      { q: "Qual è il prezzo della crociera al tramonto sul Bosforo?", a: "Da €{p.dinnerStd}/persona per la crociera Standard (3 ore, cena completa, intrattenimento dal vivo). L'opzione VIP con posti vicino al palco e meze premium costa €{p.dinnerVip}/persona. Pagamento a bordo — nessun anticipo. 0-3 anni gratis, 4-8 anni metà prezzo." },
