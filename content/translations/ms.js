...
module.exports = {
  ...
  'bosphorus-with-kids': {
    meta: {
      ...
      description: 'Pelayaran makan malam Bosphorus mesra keluarga. Anak 0-3 percuma, 4-9 separuh harga. Ruang dalam selamat, menu kanak-kanak. Pembatalan percuma, bayar di kapal.'
    },
    hero: {
    ...
    highlights: [
      { title: 'Umur 0-3 tahun percuma sepenuhnya', desc: 'Tiada bayaran untuk bayi dan kanak-kanak kecil. 4-9 tahun €5 daripada harga dewasa. Dari 9 tahun ke atas dikira tetamu penuh. Telus, tiada kejutan.' },
    ...
    faq: [
      ...
      { q: 'Apakah harga kanak-kanak untuk pelayaran Bosphorus?', a: 'Kanak-kanak **0-3 tahun: PERCUMA** (tiada bayaran, tiada caj tersembunyi). **4-9 tahun: diskaun €5** daripada harga dewasa — iaitu €{p.dinnerStd}/2 = €12 setiap kanak-kanak untuk pelayaran Standard. **10+ tahun: harga dewasa penuh.** Pemindahan hotel percuma untuk umur 0-3, standard untuk 4+ (€{p.transfer}/orang).' },
  ...
  'bosphorus-vip': {
    ...
    intro: [
      'Banyak bot di Bosphorus membahagikan tetamu kepada "Standard" dan "VIP". Kami tidak. Di atas **AMOR** hanya ada satu menu makan malam, disediakan dengan penjagaan yang sama untuk semua: 10 jenis meze Turki, pembuka selera panas, hidangan utama pilihan anda (salmon, siakap, ayam atau köfte), kek ais krim, dan minuman ringan tanpa had. Program persembahan lapan bahagian turut disertakan — Oba Dombra, upacara darwis berpusing, tarian rakyat Anatolia dan Azerbaijan, tarian perut, tarian pisau Kaukasus, muzik secara langsung dan penutup dengan saksofon dan DJ — semuanya dalam harga €{p.dinnerStd}/orang.',
    ...
    faq: [
      ...
      { q: 'Apa yang ada dalam menu?', a: '10 jenis meze Turki, pembuka selera panas, hidangan utama pilihan (salmon, siakap, ayam atau köfte) dan kek ais krim sebagai pencuci mulut, dengan minuman ringan tanpa had. Program persembahan lapan bahagian disertakan: Oba Dombra, upacara darwis, tarian rakyat Anatolia dan Azerbaijan, tarian perut, tarian pisau Kaukasus, muzik secara langsung dan penutup dengan saksofon dan DJ.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Berapakah harga pelayaran matahari terbenam Bosphorus?', a: 'Dari €{p.dinnerStd}/orang untuk pelayaran (3 jam, makan malam penuh, hiburan langsung). Bayar di atas bot — tiada bayaran pendahuluan. Kanak-kanak 0-3 percuma, 4-9 separuh harga.' },
  ...
  'bosphorus-night-tour': {
    ...
    faq: [
      ...
      { q: 'Berapakah harga pelayaran malam Bosphorus?', a: 'Pelayaran malam (3 jam, makan malam, persembahan): €{p.dinnerStd}/orang (asalnya €{p.dinnerStdOriginal}). Umur 0-3 percuma, 4-9 separuh harga. Bayar di atas bot.' },
  ...
  'istanbul-boat-tour': {
    ...
    faq: [
      ...
      { q: 'Berapakah harga pelayaran bot Istanbul?', a: 'Pelayaran bot makan malam kami: €{p.dinnerStd}/orang (asalnya €{p.dinnerStdOriginal}). Umur 0-3 percuma, 4-9 separuh harga. Bayar di atas bot. Alkohol dan pemindahan hotel adalah tambahan pilihan.' },
  ...
  'bosphorus-trip': {
    ...
    highlights: [
      ...
      { title: 'Dari €{p.dinnerStd} — bayar di atas bot', desc: 'Tiada bayaran pendahuluan diperlukan. Bayar di atas bot (tunai atau kad). Pembatalan percuma sehingga 2 jam sebelum bertolak. Umur 0-3 percuma, 4-9 separuh harga. Harga telus.' }
    ],
    faq: [
  ...
  'last-minute-bosphorus': {
    ...
    faq: [
      { q: 'Bolehkah saya benar-benar menempah pelayaran Bosphorus untuk malam ini?', a: 'Ya — selalunya. Kami mengekalkan tempat duduk untuk tempahan hari yang sama. Semak wizard di atas untuk kekosongan malam ini. Jika tempat duduk tersedia, anda boleh tempah sehingga 20:00. Hujung minggu lebih ketat — tempah awal hari itu jika boleh.' },
      { q: 'Berapa lambatkah saat akhir saya boleh tempah?', a: 'Tempahan kekal terbuka sehingga 20:00 untuk bot 21:00. Selepas 20:00, hantar mesej WhatsApp terus di +90 532 244 29 22 — kami boleh sahkan secara manual jika tempat duduk terbuka.' },
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Harga pelayaran Bosphorus Istanbul: pelayaran makan malam €{p.dinnerStd}/orang. Anak 0-3 percuma, 4-9 separuh harga. Tambahan telus. Pembatalan percuma.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Harga kanak-kanak: 0-3 percuma, 4-9 separuh harga', desc: '0-3 percuma sepenuhnya (tiada bayaran). 4-9 diskaun €5 daripada harga dewasa. 10+ harga dewasa penuh. Telus, tiada tipu muslihat harga keluarga. Pemindahan juga percuma untuk 0-3.' },
    ...
    faq: [
      { q: 'Berapakah kos pelayaran Istanbul?', a: 'Pelayaran Makan Malam: €{p.dinnerStd}/orang (biasa €{p.dinnerStdOriginal}, diskaun 40%). Umur 0-3 percuma, 4-9 separuh harga. Bayar di atas bot — tiada bayaran pendahuluan. Pembatalan percuma sehingga 2 jam sebelum bertolak.' },
