...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    faq: [
      ...
      { q: 'Is alcohol inbegrepen in de dinercruise?', a: 'Onbeperkt frisdrank (water, cola, sap) is inbegrepen in de prijs. Het alcoholpakket is optioneel: 2 glazen (wijn, bier, rakı, wodka, whisky, gin en meer) +€{p.alcohol2}/persoon. Extra en geïmporteerde dranken worden apart in rekening gebracht aan boord.' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Wijn, champagne, premium pairings', desc: 'Voeg het 2-glazen-alcoholpakket toe (+€{p.alcohol2}/persoon) — wijn, bier, rakı, wodka, whisky, gin en meer. Geïmporteerde champagne en premium pairings op verzoek — vraag bij de reservering.' }
    ],
    faq: [
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      { q: 'Is de Bosporuscruise 100% halal?', a: 'Ja — elk vleesproduct in het menu (zalm, zeebaars, kipspies, runderspies) is halal-gecertificeerd van goedgekeurde leveranciers. De keuken volgt halal-bereidingsnormen. Er wordt nergens varkensvlees aan boord geserveerd. Het is geen "halal-optie" — het hele menu is halal.' },
  ...
  'bosphorus-vip': {
    ...
    hero: {
      ...
      subtitle: 'Één menu, één standaard: premium voor iedereen. Een avond van 3 uur op de Bosporus aan boord van de Bosphorus Night — een rijk Turks diner, liveshows op het podium en desgewenst een privétafel bij het podium. We verkopen geen aparte "VIP-klasse" — we serveren ons beste aan elke gast.',
      badge: '40% KORTING · Één menu, premium standaard · Betalen aan boord'
    },
    intro: [
      'Veel boten op de Bosporus verdelen hun gasten in "Standaard" en "VIP". Wij niet. Aan boord van de **Bosphorus Night** is er één dinermenu, met dezelfde zorg bereid voor iedereen: 10 soorten Turkse meze, een warm voorgerecht, hoofdgerecht naar keuze (zalm, zeebaars, kipspies of runderspies), speciaal griesmeeldessert en onbeperkt frisdrank. Het volledige entertainmentprogramma van acht acts is ook inbegrepen — Oba Dombra, de ceremonie van de draaiende derwisjen, Anatolische en Azerbeidzjaanse volksdansen, buikdans, Kaukasische messendans, livemuziek en een saxofoon-en-dj-finale — allemaal binnen de prijs van €{p.dinnerStd}/persoon.',
    ...
    faq: [
      ...
      { q: 'Wat voor schip is het?', a: 'De Bosphorus Night — een modern passagiersschip van 42 meter met 3 dekken en een capaciteit van 400 gasten, verwarmd in de winter en geklimatiseerd in de zomer. Vertrek vanaf de pier van Kabataş: inschepen 20:00, vertrek 21:00, terugkomst 00:00. Route: Dolmabahçe, Ortaköy, fort Rumeli, Beylerbeyi en de lichten van de Bosporusbrug.' }
    ],
    cta: {
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
    {
      ...
      { q: 'Hoeveel kost de dinercruise in Istanbul?', a: 'Onze dinercruise is €{p.dinnerStd}/persoon (normale prijs €{p.dinnerStdOriginal}). 0-3 jaar gratis, 4-9 jaar €5 korting. Betaling aan boord — geen vooruitbetaling.' },
  ...
  'bosphorus-trip': {
    ...
    faq: [
      ...
      { q: 'Is de Bosporustrip geschikt voor kinderen?', a: 'Ja — zeer kindvriendelijk. Kinderen 0-3 jaar gratis (transfer inbegrepen), 4-9 jaar €5 korting. Overdekte binnenruimte, kindermenu op verzoek en delicaat en boeiend entertainment. Veel gezinnen reserveren deze trip als hoogtepunt van hun reis naar Istanbul.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    faq: [
      { q: 'Hoeveel kosten de Bosporuscruise tickets?', a: '€{p.dinnerStd}/persoon (normaal €{p.dinnerStdOriginal}). Inclusief de tour van 3 uur, Turks meergangendiner, live volksdans-show, onbeperkt frisdrank. 0-3 jaar gratis, 4-9 jaar €5 korting. Betaling aan boord — geen vooruitbetaling.' },
