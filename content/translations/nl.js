...
module.exports = {
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      { q: 'Is de Bosporuscruise 100% halal?', a: 'Ja — elk vleesproduct in het menu (vis, kipspies, runderspies, lam) is halal-gecertificeerd van goedgekeurde leveranciers. De keuken volgt halal-bereidingsnormen. Er wordt nergens varkensvlees aan boord geserveerd. Het is geen "halal-optie" — het hele menu is halal.' },
