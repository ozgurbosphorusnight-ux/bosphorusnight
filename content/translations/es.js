...
module.exports = {
  ...
  'bosphorus-for-couples': {
    ...
    faq: [
      ...
      { q: '¿Pueden las parejas llevar su propio vino o champán?', a: 'No permitimos alcohol del exterior (motivos de licencia comercial). Pero tenemos el paquete de alcohol de 2 copas — vino, cerveza, rakı, vodka, whisky, ginebra y más (+€{p.alcohol2}/persona) y podemos organizar vinos importados premium o champán a un coste — pregunte al reservar. Prosecco, Chianti y Cabernet son solicitudes premium populares.' },
