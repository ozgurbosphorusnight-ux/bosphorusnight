...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    meta: {
      ...
      description: 'Crucero con cena de 3 horas por el Bósforo: menú turco multiplato y espectáculo folklórico en vivo. Salida 20:30 desde Kabataş.'
    },
    hero: {
    ...
    faq: [
      { q: '¿A qué hora comienza el crucero con cena por el Bósforo?', a: 'El embarque comienza a las 19:30 en el muelle de Kabataş. El barco zarpa a las 20:30 y regresa aproximadamente a las 23:30. Recomendamos llegar 15-20 minutos antes para acomodarse.' },
  ...
  'halal-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Respeto por los horarios de oración', desc: 'Si el embarque coincide con el maghrib o el isha (19:30-20:30), nuestro personal puede indicar un lugar tranquilo de oración en el muelle de Kabataş antes de zarpar. Solo avise al reservar.' }
    ],
    faq: [
      ...
      { q: '¿Puedo rezar a bordo?', a: 'No hay una sala de oración específica a bordo, pero recomendamos rezar antes del embarque a las 19:30 (la oración del maghrib suele caer en esta ventana). El muelle de Kabataş tiene instalaciones de oración. Si necesita rezar durante la navegación de 20:30-23:30 (isha), hable con la tripulación — podemos organizar un rincón tranquilo en cubierta.' },
  ...
  'bosphorus-vip': {
    meta: {
      ...
      description: 'Crucero VIP con cena en el Bósforo: mezes premium, opciones de carne, mesa frente al escenario, servicio prioritario.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: '¿Cómo reservo el crucero VIP por el Bósforo?', a: 'Utilice el asistente de reservas en esta página — seleccione "VIP" en el Paso 1, elija su fecha, introduzca el número de huéspedes y luego los datos de contacto. Su solicitud llega por WhatsApp / Telegram y confirmamos de inmediato. Paga a bordo, no ahora.' },
  ...
  'private-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Duración y salida flexibles', desc: 'Las 3 horas estándar pueden ampliarse a 4-5 horas. Elija salida diurna a las 12:00, atardecer a las 17:30 o nocturna a las 20:30. ¿Prefiere entre semana en lugar del fin de semana? No hay problema — trabajaremos con su agenda.' },
  ...
  'bosphorus-for-couples': {
    ...
    faq: [
      ...
      { q: '¿Cuál es el mejor momento para el crucero por el Bósforo para parejas — atardecer o noche?', a: 'El crucero zarpa cada noche a las 20:30 — y en verano (mayo–agosto) esa única salida lo incluye todo: embarque desde las 19:30 durante la hora dorada, la puesta de sol justo en torno a la salida, y después los puentes iluminados y los palacios encendidos. En invierno es un crucero puramente de luces nocturnas. En cualquier caso, una sola reserva ofrece a las parejas la versión más icónica del Bósforo.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      ...
      description: 'Contemple el atardecer en el Bósforo y cene bajo los puentes iluminados. Embarque 19:30 en Kabataş, salida 20:30. 3 horas, cena completa. Pago a bordo.'
    },
    hero: {
      h1: 'Crucero al Atardecer con Cena por el Bósforo',
      subtitle: 'Embarque a las 19:30 mientras el cielo se tiñe de dorado sobre los minaretes — y cene sobre el agua mientras Dolmabahçe, la Mezquita de Ortaköy y el Puente del Bósforo se iluminan para la noche.',
      badge: 'Embarque 19:30 · Salida 20:30 · Del Atardecer a las Luces de la Ciudad'
    },
    intro: [
      'La experiencia del **crucero al atardecer por el Bósforo** en Estambul gira en torno a una cosa: la transición. Nuestro crucero embarca en el muelle de Kabataş a partir de las 19:30 — y en las largas tardes de mayo a agosto, la hora dorada se despliega mientras usted se acomoda en cubierta. El sol se pone tras los minaretes de la orilla europea justo en torno a la salida de las 20:30, así que lo contempla desde el agua: el Palacio de Dolmabahçe bañado en oro, la Mezquita de Ortaköy recortada contra un cielo resplandeciente.',
    ...
    highlights: [
      { title: 'Atardeceres de verano justo a la salida', desc: 'De mayo a agosto, el sol de Estambul se pone aproximadamente entre las 20:15–20:45 — el embarque a las 19:30 le regala la hora dorada en cubierta, y la salida de las 20:30 le sitúa en el agua para el atardecer mismo. Cámara lista — esta es la toma.' },
    ...
    faq: [
      { q: '¿A qué hora sale el crucero al atardecer por el Bósforo?', a: 'El embarque comienza a las 19:30 en el muelle de Kabataş, el barco zarpa a las 20:30 y regresa aproximadamente a las 23:30. En verano (mayo–agosto), el sol se pone aproximadamente entre las 20:15–20:45 — la hora dorada se vive durante el embarque, y el atardecer mismo justo en torno a la salida, contemplado desde el agua.' },
      { q: '¿El crucero al atardecer por el Bósforo es lo mismo que el crucero con cena?', a: 'Sí — es un único crucero. Hay una sola salida diaria a las 20:30 con cena completa y espectáculos en vivo a bordo. En las largas tardes de verano funciona también como crucero al atardecer: embarca durante la hora dorada y navega a través de la hora azul hasta la noche iluminada. En invierno, el mismo crucero es una experiencia pura de luces nocturnas.' },
      { q: '¿Cuál es el precio del crucero al atardecer por el Bósforo?', a: 'Desde €{p.dinnerStd}/persona para el crucero estándar (3 horas, cena completa, entretenimiento en vivo). La opción VIP con asientos frente al escenario y mezze premium es €{p.dinnerVip}/persona. Pago a bordo — sin prepago. Niños de 0-3 años gratis, 4-8 años a mitad de precio.' },
      { q: '¿Cuál es la mejor época del año para un crucero al atardecer por el Bósforo?', a: 'De mayo a agosto. Los atardeceres tardíos de Estambul (20:15–20:45) coinciden con la salida de las 20:30, así que disfruta de la hora dorada, el atardecer y los puentes iluminados en una sola velada. En otoño e invierno el sol se pone antes y el mismo crucero se convierte en una experiencia completa de luces nocturnas — igual de fotogénica, con otro ambiente.' },
      ...
      { q: '¿Veo los puentes iluminados de noche en este crucero?', a: 'Sí — esa es la segunda mitad de la velada. El crucero navega de 20:30–23:30, así que tras el atardecer y la hora azul pasa bajo el Puente del Bósforo completamente iluminado, junto a palacios encendidos y la Torre de la Doncella, y regresa a Kabataş hacia las 23:30.' },
      { q: '¿A qué hora se pone el sol en Estambul?', a: 'En verano (junio–julio), los atardeceres de Estambul son en torno a las 20:30–20:45. En invierno, en torno a las 16:30–17:00. Para una experiencia de atardecer y noche, el crucero con cena de las 20:30 de Bosphorus Night desde Kabataş captura la última hora dorada y la hora azul en verano, y los monumentos iluminados durante todo el año.' },
      { q: '¿Vale la pena el crucero al atardecer por el Bósforo?', a: 'Sí — el atardecer sobre el Puente del Bósforo es una de las vistas emblemáticas de Estambul. El crucero con cena de las 20:30 de Bosphorus Night (€{p.dinnerStd}/persona) captura la hora azul posterior al atardecer y los palacios iluminados, con cena completa y espectáculos en vivo durante 3 horas.' }
    ],
    cta: {
      primary: 'Reservar el Crucero al Atardecer · Pago a Bordo',
      secondary: 'Embarque 19:30 · Salida 20:30 · Cena incluida · Cancelación gratuita 2 horas antes',
  ...
  'bosphorus-night-tour': {
    meta: {
      ...
      description: 'Tour nocturno de 3 horas por el Bósforo con cena y show en vivo. Salida 20:30 desde Kabataş, puentes iluminados. Cancelación gratuita, pago a bordo.'
    },
    hero: {
    ...
    intro: [
      ...
      'Nuestro **tour nocturno por el Bósforo con cena** incluye la velada icónica completa: 3 horas en el agua (20:30-23:30), generoso banquete turco, danzas folclóricas en vivo (sema, 5 danzas folclóricas, danza oriental), música en vivo y set de DJ que mantiene la cubierta animada hasta el final de la noche. Cada huésped recibe el mismo programa — no hay una opción "básica" que se salte las mejores partes.',
    ...
    highlights: [
      { title: 'Bósforo iluminado en su máximo dramatismo', desc: 'El Puente del Bósforo cambia de color (azul, morado, dorado), los palacios brillan en amarillo, la Mezquita de Ortaköy se refleja en el agua negra. 20:30-23:30 es la iluminación máxima para todos los monumentos de Estambul.' },
    ...
    faq: [
      { q: '¿A qué hora es el tour nocturno por el Bósforo?', a: 'Embarque a partir de las 19:30 en el muelle de Kabataş. El barco zarpa a las 20:30, regresa aproximadamente a las 23:30. Recomendamos llegar 20 minutos antes para acomodarse y elegir asiento.' },
    ...
    cta: {
      ...
      secondary: 'Salida 20:30 · 3 horas · Cena + espectáculo incluidos · Cancelación gratuita 2 horas antes',
      tertiary: 'Disponibilidad para Esta Noche'
    }
  },
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
      ...
      { q: '¿Cuánto dura el crucero con cena — y cuándo empieza?', a: '3 horas en total. Embarque a partir de las 19:30, el barco zarpa completo a las 20:30, regresa aproximadamente a las 23:30. Recomendamos llegar 15-20 minutos antes para acomodarse y elegir asiento.' },
  ...
  'istanbul-night-tour': {
    ...
    faq: [
      ...
      { q: '¿Cuál es la mejor hora para un tour nocturno en Estambul?', a: 'Nuestro crucero con cena por el Bósforo es de 20:30 a 23:30 (3 horas). Es el momento de iluminación máxima para todos los monumentos de Estambul — puentes totalmente iluminados, palacios brillando, luna sobre el agua. Si también quiere la hora dorada, venga en verano: el embarque comienza a las 19:30, y de mayo a agosto el sol se pone justo en torno a la salida de las 20:30 — el mismo crucero cubre ambas cosas.' },
  ...
  'istanbul-boat-tour': {
    ...
    intro: [
      ...
      'A diferencia de muchos ferris turísticos de 1 hora que cubren menos del Bósforo y se saltan la cena y el entretenimiento, nuestro **tour en barco Estambul** es la experiencia nocturna completa: embarque a las 19:30 en el muelle de Kabataş, tour hasta la medianoche, 10 mezze, plato principal, postre, sema, danzas folclóricas, danza oriental y DJ. Obtiene el tour Y la salida nocturna.',
    ...
    highlights: [
      ...
      { title: 'Salida nocturna (la mejor iluminación)', desc: 'La salida de las 20:30 capta el Bósforo iluminado en su máximo esplendor — puentes, palacios, mezquitas todos encendidos. Más dramático que los tours diurnos que muestran los mismos monumentos con luz plana.' },
    ...
    faq: [
      ...
      { q: '¿Cuánto dura el tour en barco de Estambul?', a: '3 horas. Embarque a partir de las 19:30 en el muelle de Kabataş, salida a las 20:30, regreso ~23:30. Cubre el Bósforo completo desde Dolmabahçe hasta Rumeli Hisarı y de vuelta. Tiempo suficiente para cena completa + espectáculo sin agotarse.' },
  ...
  'bosphorus-trip': {
    meta: {
      ...
      description: 'Viaje de 3 horas por el Bósforo: cena turca, folklore en vivo, vistas nocturnas iluminadas. Salida 20:30 desde Kabataş. Cancelación gratuita, pago a bordo.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: '¿Cuánto dura una excursión por el Bósforo?', a: 'Nuestra excursión por el Bósforo dura 3 horas en total (salida 20:30, regreso 23:30). Hay opciones más cortas (ferris turísticos de 1 hora, tours de 90 minutos) pero omiten cena y entretenimiento. Para la experiencia nocturna completa, 3 horas es lo ideal — suficiente para verlo todo, no agotador.' },
  ...
  'bosphorus-cruise-tickets': {
    meta: {
      ...
      description: 'Tickets directos del crucero por el Bósforo. Estándar €{p.dinnerStd}, VIP €{p.dinnerVip}. Sin anticipo, pago a bordo.'
    },
    hero: {
    ...
    intro: [
      ...
      'Nuestro proceso de **entradas para el crucero por el Bósforo**: rellene el asistente de esta página en menos de 1 minuto (fecha, número de huéspedes, paquete, contacto), confirmamos al instante por WhatsApp / Telegram, aparece a las 19:30 en el muelle de Kabataş, paga a bordo, disfruta del crucero con cena de 3 horas. Sin entrada física para imprimir, sin cupón por correo — nuestra confirmación es su entrada.',
    ...
    highlights: [
      ...
      { title: 'Confirmación en menos de 1 minuto', desc: 'Rellene el asistente → confirmamos por WhatsApp / Telegram. Sin cupón PDF por correo para imprimir. Nuestro mensaje es su entrada. Venga al muelle a las 19:30.' },
    ...
    faq: [
      ...
      { q: '¿Hay entradas para el crucero por el Bósforo disponibles el mismo día?', a: 'Frecuentemente sí, especialmente entre semana. Los fines de semana y festivos se llenan más rápido. Compruebe la disponibilidad a través del asistente de reservas — se actualiza en tiempo real. La reserva el mismo día suele ser posible hasta pocas horas antes de la salida de las 20:30. Para solicitudes urgentes, WhatsApp.' },
  ...
  'last-minute-bosphorus': {
    ...
    intro: [
      '¿Aterrizó esta tarde en Estambul y quiere una gran noche esta misma velada? El **crucero por el Bósforo de última hora** funciona. Reservamos específicamente asientos para reservas del mismo día porque sabemos que muchos viajeros deciden por la mañana. Rellene el asistente aquí, confirmamos en minutos por WhatsApp, aparece a las 19:30 en el muelle de Kabataş, paga a bordo, disfruta.',
      'Nuestro **crucero por el Bósforo de última hora** tiene el mismo programa nocturno que las reservas anticipadas: 3 horas en el agua (20:30-23:30), cena turca generosa, espectáculo de danzas folclóricas en vivo, sema, danza oriental, DJ. Palacio de Dolmabahçe, Mezquita de Ortaköy, Puente del Bósforo iluminados — las mismas vistas icónicas. Mismo precio de €{p.dinnerStd} Estándar o €{p.dinnerVip} VIP.',
    ...
    highlights: [
      ...
      { title: 'Traslado al hotel el mismo día frecuentemente disponible', desc: 'El traslado al hotel normalmente requiere 24 horas de aviso, pero para reservas del mismo día entre 14:00-18:00 normalmente podemos organizar la recogida por +€{p.transfer}/persona. Para solicitudes urgentes de traslado, WhatsApp.' }
    ],
    faq: [
      ...
      { q: '¿Con cuánta antelación puedo reservar?', a: 'Para el barco de las 20:30, las reservas permanecen abiertas hasta las 18:00. Después de las 18:00, escríbanos directamente por WhatsApp al +90 532 244 29 22 — podemos confirmar manualmente si hay asientos. Después de las 19:30 está muy ajustado a menos que ya esté en el muelle de Kabataş y pueda embarcar rápidamente.' },
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Precios crucero Bósforo Estambul: Estándar €{p.dinnerStd}, VIP €{p.dinnerVip}. Niños 0-3 gratis, 4-8 mitad. Add-ons transparentes.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: '¿Necesito pagar por adelantado el precio del crucero de Estambul?', a: 'No — **pago a bordo**. Reserva ahora (asistente de 1 minuto), confirmamos por WhatsApp, viene a las 19:30 y paga a bordo (efectivo o tarjeta). Cancelación gratuita hasta 2 horas antes. Cero compromiso financiero hasta estar satisfecho.' },
