...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Hvordan booker jeg VIP Bosporuskrydstogtet?', a: 'Brug reservationsformularen på denne side — vælg "VIP" i Trin 1, indstil datoen, indtast antallet af gæster, derefter kontaktoplysningerne. Din forespørgsel kommer via WhatsApp / Telegram, og vi bekræfter med det samme. Betaling om bord, ikke nu.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Hvad koster Bosporus solnedgangskrydstogtet?', a: 'Fra €{p.dinnerStd}/person for standardkrydstogtet (3 timer, fuld middag, live underholdning). VIP-muligheden med plads foran scenen og premium mezze koster €{p.dinnerVip}/person. Betaling om bord — ingen forudbetaling. Børn 0-3 år gratis, 4-8 år halv pris.' },
