...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    meta: {
      ...
      description: 'Middagskrydstogt på 3 timer på Bosporus: tyrkisk flerretters menu og live folkloreshow. Afgang 21:00 fra Kabataş. Gratis afbestilling, betaling om bord.'
    },
    hero: {
      ...
      badge: '4,9★ · 11.317+ gæster'
    },
    intro: [
      '**Bosporus middagskrydstogtet** er den mest ikoniske aftenoplevelse i Istanbul. Vores tur afgår kl. 20:00 fra Kabataş-anløbsbroen og sejler under de oplyste Bosporus- og Fatih Sultan Mehmet-broer, med en tyrkisk flerretters middag, live folkedanse, orientalsk dans og et DJ-sæt, der holder dækket levende indtil kl. 23:45.',
      'I modsætning til de almindelige turistbåde, der fylder Istanbuls natlandskab, er **vores Bosporus middagskrydstogt** licenseret af TÜRSAB (A-17672) og bedømt med 4,9★ af mere end 11.317 rejsende. Vi holder grupperne små og servicen varm — og da du betaler om bord, er der ingen risiko ved at booke på forhånd.',
    ...
    highlights: [
      { title: 'Tyrkisk flerretters middag', desc: '10 varianter af koldt mezze, varm forret (börek), valg af hovedret (laks / havbars / kylling / oksespyd / vegetarisk), speciel semuljedessert til dessert, ubegrænsede sodavand.' },
      { title: 'Live folkedans, orientalsk dans og DJ', desc: 'Otte numre: Oba Dombra, Mevlana sema-forestilling, Sarı Gelin, aserbajdsjansk potpourri, klassisk orientalsk dans, anatolsk potpourri og den georgisk-kaukasiske knivdans — derefter live saxofon og et DJ-sæt under hele krydstogtet.' },
      ...
      { title: 'Fra €{p.dinnerStd}/person — betaling om bord', desc: 'Middagskrydstogt €{p.dinnerStd} (tidligere €{p.dinnerStdOriginal}). Ingen forudbetaling. Gratis afbestilling indtil 2 timer før afgang.' }
    ],
    faq: [
      { q: 'Hvornår starter Bosporus middagskrydstogtet?', a: 'Ombordstigning begynder kl. 20:00 ved Kabataş-anløbsbroen. Båden afgår kl. 21:00 og vender tilbage omkring kl. 00:00. Vi anbefaler at ankomme 15-20 minutter tidligere for at installere dig og slappe af.' },
      { q: 'Hvad koster Bosporus middagskrydstogtet?', a: 'Middagskrydstogt €{p.dinnerStd}/person (normal pris €{p.dinnerStdOriginal}). 0-3 år gratis, 4-9 år €5 rabat. Betaling om bord — ingen forudbetaling.' },
      { q: 'Er alkohol inkluderet i middagskrydstogtet?', a: 'Ubegrænsede sodavand (vand, cola, juice) er inkluderet i prisen. Alkoholpakken er valgfri: 2 glas (vin, øl, rakı, vodka, whisky, gin og mere) +€{p.alcohol2}/person. Yderligere og importerede drikkevarer faktureres separat om bord.' },
      { q: 'Er der hoteltransfer?', a: 'Ja — afhentnings- og afleveringsservice er +€{p.transfer}/person. Betjente zoner: Beşiktaş, Taksim, Sultanahmet, Sirkeci, Eminönü, Ortaköy, Beyoğlu, Fatih, Laleli, Topkapı, Kağıthane, Yenikapı, Sütlüce og Şişli. Du kan vælge denne mulighed i reservationsformularen.' },
  ...
  'bosphorus-with-kids': {
    meta: {
      ...
      description: 'Bosporus middagskrydstogt familievenligt. Børn 0-3 gratis, 4-9 med €5 rabat. Sikkert indendørs område, børnemenu.'
    },
    hero: {
    ...
    intro: [
      ...
      'I modsætning til både kun for voksne forbliver **vores Bosporus middagskrydstogt for familier** varmt og inkluderende. **Børn 0-3 år er gratis** (transfer inkluderet), 4-9 år får **€5 rabat**, 10+ år betaler fuld pris — ingen skjulte omkostninger. De live folkedanse, orientalsk dans og sema-forestillingen er delikat familieunderholdning, ikke en natklub.',
      'Uanset om du kommer til Istanbul for en forlænget weekend med din lille, eller tager teenagerne med på deres første europæiske rejse — dette er turen anbefalet af familierne i Istanbul. Sikker, halal-certificeret, licenseret af TÜRSAB og bedømt med 4,9★ af mere end 11.317 rejsende.'
    ],
    highlights: [
      { title: '0-3 år helt gratis', desc: 'Ingen omkostninger for babyer og småbørn. 4-9 år betaler €5 af voksenprisen. Fra 10 år gæst med fuld pris. Gennemsigtigt, ingen overraskelser.' },
      ...
      { title: 'Sikker familieunderholdning', desc: 'Sema-forestilling (fascinerende for børn), Oba Dombra og folkedanse fra Anatolien, Aserbajdsjan og Kaukasus — inklusive den spektakulære knivdans — plus live tyrkisk musik og et saxofon-og-DJ-sæt. Alt er familievenligt — intet voksenindhold. Børnene slutter sig ofte til dansen.' }
    ],
    faq: [
      ...
      { q: 'Hvad er prisen for børn på Bosporuskrydstogtet?', a: 'Børn **0-3 år: GRATIS** (ingen omkostninger, ingen skjulte omkostninger). **4-9 år: €5 rabat** på voksenprisen — det vil sige €19.30/barn på Standard (€{p.dinnerStd} − €5). **10+ år: fuld voksenpris.** Hoteltransfer er gratis for 0-3 år, standard for 4+ (€{p.transfer}/person).' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    intro: [
      ...
      'Vores romantiske bordopsætning (+€{p.romantic}/bord) gør hvert sted til et specielt øjeblik: røde roser, glødende stearinlys, en håndskrevet velkomstseddel. Tilføj 2-glas alkoholpakken for vin under stjernerne (+€{p.alcohol2}/person) eller hold det enkelt med de inkluderede sodavand. Uanset hvilket valg, tager mandskabet sig diskret af resten.',
      'Uanset om du fejrer en fødselsdag, planlægger en overraskelse til din partner eller blot ønsker en uforglemmelig aften i Europas mest romantiske by — dette er turen, der foretrækkes af par i Istanbul. Bedømmelse 4,9★, licenseret af TÜRSAB og — vigtigst af alt — betaling om bord, så du kun lover selve aftenen.'
    ],
    highlights: [
      ...
      { title: 'Vin, champagne, premium pairings', desc: 'Tilføj 2-glas alkoholpakken (+€{p.alcohol2}/person) — vin, øl, rakı, vodka, whisky, gin og mere. Importeret champagne og premium pairings efter forespørgsel — spørg ved reservation.' }
    ],
    faq: [
      ...
      { q: 'Hvad koster det romantiske krydstogt for 2 personer?', a: '2 personer: 2 × €{p.dinnerStd} = €48.60. Tilføj den romantiske opsætning +€{p.romantic} = €63,60. Ingen forudbetaling — betaling om bord. 2-glas alkoholpakke for to: yderligere 2 × €{p.alcohol2} = €20.' },
  ...
  'halal-bosphorus-cruise': {
    ...
    intro: [
      ...
      '**Det halal-venlige Bosporuskrydstogt** betyder noget for rejsende fra Saudi-Arabien, UAE, Kuwait, Qatar, Iran, Malaysia, Indonesien, Pakistan og Marokko, der ønsker Istanbuls mest ikoniske aften uden kompromiser. Licenseret af TÜRSAB, 4,9★ og betaling om bord — lov ikke noget, før du er sikker på, at oplevelsen opfylder dine standarder.'
    ],
    highlights: [
    ...
    faq: [
      ...
      { q: 'Hvad er priserne for en muslimsk familie på 4 personer (2 voksne, 2 børn)?', a: 'Middagskrydstogt: 2 × €{p.dinnerStd} + 2 × €19.30 (€5 rabat 4-9 år) = €87.20. Hvis børnene er under 3 år, gratis: 2 × €{p.dinnerStd} = €48.60. Tilføj €{p.transfer} hoteltransfer per voksen. I alt: €48.60–€92.90 for familien på 4, ingen forudbetaling, betaling om bord.' },
      { q: 'Er hoteltransferen også halal?', a: 'Hoteltransferen er bare en biltur — ingen mad eller drikke involveret, så ingen halal-bekymring. Vores chauffører er professionelle, respektfulde og punktlige. Transferzonerne dækker Sultanahmet, Taksim, Beşiktaş, Laleli, Fatih, Şişli og 8 andre centrale kvarterer, hvor muslimske rejsende normalt bor.' }
    ],
    cta: {
  ...
  'bosphorus-vip': {
    meta: {
      title: 'VIP-oplevelse på Bosporus fra €{p.dinnerStd} — premium middag på Bosporus',
      description: 'Middagskrydstogt på Bosporus i VIP-klasse: komplet tyrkisk menu, live shows, bord tæt på scenen som tilvalg, opmærksom betjening. €{p.dinnerStdOriginal} → €{p.dinnerStd}. Betaling om bord, gratis afbestilling.'
    },
    hero: {
      h1: 'VIP-oplevelse på Bosporus — middagskrydstogt',
      subtitle: 'Én menu, én standard: premium til alle. En aften på 3 timer på Bosporus om bord på Bosphorus Night — solid tyrkisk middag, live shows på scenen og, hvis du ønsker det, et privat bord tæt på scenen. Vi sælger ikke en separat "VIP-klasse" — vi serverer vores bedste til hver eneste gæst.',
      badge: '40% RABAT · Én menu, premium standard · Betaling om bord'
    },
    intro: [
      'Mange både på Bosporus deler deres gæster op i "Standard" og "VIP". Det gør vi ikke. Om bord på **Bosphorus Night** er der én middagsmenu, tilberedt med samme omhu til alle: 10 slags tyrkiske meze, en varm forret, hovedret efter eget valg (laks, havbars, kyllingespyd eller oksespyd), islagkage og ubegrænsede sodavand. Hele underholdningsprogrammet på otte numre er også inkluderet — Oba Dombra, de hvirvlende dervishers ceremoni, anatolske og aserbajdsjanske folkedanse, mavedans, kaukasisk knivdans, livemusik og en saxofon-og-DJ-finale — alt sammen inden for prisen på €{p.dinnerStd}/person.',
      'VIP-fornemmelsen begynder ved dit bord. Vil du sidde tættest muligt på scenen og udsigten, så tilføj **privat bord tæt på scenen** (+€{p.romantic}/bord), og din plads reserveres på forhånd — den bedste vinkel til dervisherne, folkedansene og det oplyste Bosporus. Det foretrukne valg for par, fejringer og fotoglade gæster.',
      'Bosphorus Night er et moderne skib: 42 meter, 3 dæk, op til 400 gæster, opvarmet om vinteren og klimaanlæg om sommeren. Den 3 timer lange rute afgår fra Kabataş (ombordstigning fra 20:00, afgang 21:00, retur 00:00) forbi Dolmabahçe, Ortaköy-moskeen, Rumeli-fæstningen og lysene på Bosporus-broen. TÜRSAB-licens (A-17672), 4,9★ på Google. Ingen forudbetaling — du betaler om bord, med gratis afbestilling indtil 2 timer før afgang.'
    ],
    highlights: [
      { title: 'Én menu, premium standard', desc: 'Der findes ingen separat "VIP-menu" — for vores eneste menu ligger allerede på det niveau. 10 slags meze, varm forret, 4 hovedretter at vælge imellem, dessert og ubegrænsede sodavand, serveret med samme omhu ved hvert bord.' },
      { title: 'Privat bord tæt på scenen (+€{p.romantic}/bord)', desc: 'Bordene tættest på dervisherne, folkedansene og mavedansen reserveres på forhånd. Fremragende udsigt til scenen og Bosporus. Dit bord er privat, ikke delt.' },
      { title: 'Opmærksom bordbetjening', desc: 'Vores team betjener dig ved bordet: retterne, vejledning i menuen, ekstra drikkevarer, særlige ønsker. Ingen kø i mylderet.' },
      { title: '40% RABAT — før €{p.dinnerStdOriginal}, nu €{p.dinnerStd}', desc: 'Pris ved direkte booking: €{p.dinnerStd}/person (vejledende pris €{p.dinnerStdOriginal}). Betaling om bord, ingen depositum. Gratis afbestilling indtil 2 timer før afgang.' }
    ],
    faq: [
      { q: 'Sælger I en "VIP-pakke"? Hvad er forskellen fra Standard?', a: 'Vi sælger ikke en separat VIP-pakke — der er én menu, som serveres til alle i samme premium standard. Det, vi kalder "VIP-oplevelsen", er at gøre aftenen til din: privat bord tæt på scenen (+€{p.romantic}/bord), opmærksom bordbetjening og valgfrie drikkevaretilvalg. Krydstogtet varer 3 timer, €{p.dinnerStd}/person.' },
      { q: 'Er €{p.dinnerStd} virkelig 40% rabat?', a: 'Ja — vores vejledende pris er €{p.dinnerStdOriginal}/person. €{p.dinnerStd} er prisen ved direkte booking uden mellemmænds provision. Du betaler om bord, og der er ingen forudbetaling.' },
      { q: 'Hvad er der på menuen?', a: '10 slags tyrkiske meze, en varm forret, hovedret efter eget valg (laks, havbars, kyllingespyd eller oksespyd) og islagkage til dessert, med ubegrænsede sodavand. Programmet på otte numre er inkluderet: Oba Dombra, dervishernes ceremoni, anatolske og aserbajdsjanske folkedanse, mavedans, kaukasisk knivdans, livemusik og en saxofon-og-DJ-finale.' },
      { q: 'Er alkohol inkluderet?', a: 'Nej — alkohol er et separat tilvalg: 2 glas vin, øl, rakı, vodka, whisky, gin og mere for +€{p.alcohol2}/person. Sodavand er inkluderet ubegrænset og gratis. Importerede premium-spiritusser afregnes separat om bord.' },
      { q: 'Hvordan sikrer jeg mig et bord tæt på scenen?', a: 'Vælg blot tilvalget "privat bord tæt på scenen" (+€{p.romantic}/bord), når du booker — bordet reserveres i dit navn. De bedste pladser går til forhåndsbookinger, så tilføj det gerne inden selve dagen.' },
      { q: 'Hvilken slags skib er det?', a: 'Bosphorus Night — et moderne passagerskib på 42 meter med 3 dæk og plads til 400 gæster, opvarmet om vinteren og med klimaanlæg om sommeren. Afgang fra Kabataş-molen: ombordstigning 20:00, afgang 21:00, retur 00:00. Rute: Dolmabahçe, Ortaköy, Rumeli-fæstningen, Beylerbeyi og lysene på Bosporus-broen.' }
    ],
    cta: {
      primary: 'Book dit bord · Betaling om bord',
      secondary: 'Før €{p.dinnerStdOriginal}, nu €{p.dinnerStd} · Gratis afbestilling indtil 2 timer før',
      tertiary: 'Tilføj privat bord tæt på scenen (+€{p.romantic})'
    }
  },
  ...
  'private-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Fleksibel varighed og afgang', desc: 'De 3 standard timer kan forlænges til 4-5 timer. Vælg dagafgang kl. 12:00, solnedgang kl. 17:30 eller aften kl. 21:00. Vil du have en hverdag i stedet for weekend? Intet problem — vi tilpasser os dit program.' },
  ...
  'bosphorus-for-couples': {
    ...
    intro: [
      ...
      'Uanset om du er i Istanbul i 3 dage med din partner, fejrer en beskeden begivenhed eller planlægger en udforskende rejse til et fremtidigt frieri — **Bosporuskrydstogtet for par** giver dig 3 timers aften sammen i en af verdens mest fotograferede byer. 4,9★, betaling om bord, gratis afbestilling.'
    ],
    highlights: [
      ...
      { title: 'Langsom flerretters middag', desc: '10 varianter af tyrkiske mezze, varm forret, hovedret (laks, havbars, kyllingespyd, oksespyd eller vegetarisk), speciel semuljedessert til dessert. Serveret langsomt over 3 timer — du har ikke travlt.' },
    ...
    faq: [
      ...
      { q: 'Hvad koster Bosporuskrydstogtet for 2 personer?', a: '2 personer: 2 × €{p.dinnerStd} = €48.60. Tilføj hoteltransfer for to: +€{p.transfer}×2 = €10. Tilføj 2-glas alkoholpakken for to: +€{p.alcohol2}×2 = €20. Ingen forudbetaling — betaling om bord.' },
      { q: 'Kan par medbringe deres egen vin eller champagne?', a: 'Vi tillader ikke ekstern alkohol (af licensgrunde). Men vi har 2-glas pakken med vin, øl, rakı, vodka, whisky, gin og mere (+€{p.alcohol2}/person) og kan arrangere importerede premiumvine eller champagne mod et gebyr — spørg ved reservation. Prosecco, Chianti og Cabernet er de populære premiumforespørgsler.' },
      ...
      { q: 'Hvornår er Bosporuskrydstogtet for par bedst — solnedgang eller aften?', a: 'Krydstogtet afgår kl. 21:00 hver aften — og om sommeren (maj–august) dækker den ene afgang begge dele: ombordstigning fra kl. 20:00 under den gyldne time, solnedgangen lige omkring afgangen og derefter de oplyste broer og strålende paladser. Om vinteren er det et rent natlys-krydstogt. Uanset hvad giver én booking par den mest ikoniske version af Bosporus.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      title: 'Bosporus Solnedgangs- & Middagskrydstogt fra €{p.dinnerStd}',
      description: 'Oplev solnedgangen over Bosporus, og spis middag under de oplyste broer. Ombordstigning kl. 20:00 ved Kabataş, afgang kl. 21:00. 3 timer, fuld middag. Betaling om bord.'
    },
    hero: {
      h1: 'Bosporus Solnedgangs- & Middagskrydstogt',
      subtitle: 'Gå om bord kl. 20:00, mens himlen bliver gylden over minareterne — og spis middag på vandet, mens Dolmabahçe, Ortaköy-moskeen og Bosporus-broen tændes til natten.',
      badge: 'Ombordstigning 20:00 · Afgang 21:00 · Fra Solnedgang til Bylys'
    },
    intro: [
      '**Bosporus solnedgangskrydstogtet** i Istanbul handler om én ting: overgangen. Vores krydstogt tager gæster om bord ved Kabataş-anløbsbroen fra kl. 20:00 — og i de lange aftener fra maj til august udfolder den gyldne time sig, mens du finder dig til rette på dækket. Solen går ned over minareterne på den europæiske kyst lige omkring afgangen kl. 21:00, så du ser den fra vandet: Dolmabahçe-paladset badet i guld, Ortaköy-moskeen i silhuet mod den glødende himmel.',
      '**Vores solnedgang-til-nat Bosporuskrydstogt** inkluderer en fuld tyrkisk middag — 10 varianter mezze, varm forret, valgfri hovedret, dessert — serveret, mens byen tænder sine lys. Når desserten ankommer, sejler du under den oplyste Bosporus-bro med 30 millioner lys reflekteret i det mørke vand. Overgangen fra tusmørke til fuld nat, alt sammen i ét krydstogt på 3 timer, er hele pointen.',
      'Uanset om du er fotograf, der jagter det sidste lys, et par på jagt efter det perfekte "Istanbul-minde", eller førstegangsbesøgende, der vil have den klassiske aften på vandet — dette er **Bosporus solnedgangs-middagskrydstogtet**, som lokale anbefaler til besøgende. Fra €{p.dinnerStd}/person, bedømmelse 4,9★, licenseret af TÜRSAB, betaling om bord — ingen forudbetaling.'
    ],
    highlights: [
      ...
      { title: 'Fuld middag under krydstogtet', desc: '10 varianter tyrkiske mezze, varm forret, hovedret (laks, havbars, kyllingespyd, oksespyd, vegetarisk), speciel semuljedessert, ubegrænsede sodavand — serveret, mens byens lys tændes.' },
    ...
    faq: [
      { q: 'Hvornår afgår Bosporus solnedgangskrydstogtet?', a: 'Ombordstigning begynder kl. 20:00 ved Kabataş-anløbsbroen, båden afgår kl. 21:00 og vender tilbage omkring kl. 00:00. Om sommeren (maj–august) går solen ned mellem cirka 20:15–20:45 — den gyldne time udfolder sig, mens du går om bord, og selve solnedgangen sker lige omkring afgangen, set fra vandet.' },
      { q: 'Er Bosporus solnedgangskrydstogtet det samme som middagskrydstogtet?', a: 'Ja — det er ét krydstogt. Der er én daglig afgang kl. 21:00 med fuld middag og live shows om bord. I de lange sommeraftener fungerer det samtidig som solnedgangskrydstogt: du går om bord under den gyldne time og sejler gennem den blå time ind i den oplyste nat. Om vinteren er det samme krydstogt en ren natlys-oplevelse.' },
      { q: 'Hvad koster Bosporus solnedgangskrydstogtet?', a: 'Fra €{p.dinnerStd}/person for krydstogtet (3 timer, fuld middag, live underholdning). Betaling om bord — ingen forudbetaling. Børn 0-3 år gratis, 4-9 år med €5 rabat.' },
      { q: 'Hvornår på året er det bedst at tage på Bosporus solnedgangskrydstogt?', a: 'Fra maj til august. Istanbuls sene solnedgange (20:15–20:45) falder sammen med afgangen kl. 21:00, så du får den gyldne time, solnedgangen og de oplyste broer på én aften. Om efteråret og vinteren går solen tidligere ned, og det samme krydstogt bliver en fuld natlys-oplevelse — lige så fotogen, bare en anden stemning.' },
      { q: 'Hvad skal jeg tage med til et solnedgangskrydstogt?', a: 'En smartphone eller et kamera — den gyldne time og de oplyste broer kalder på det. En let jakke: brisen tager til på dækket efter solnedgang. Smart-casual påklædning — du spiser middag, men der er ingen streng påklædningskode.' },
      { q: 'Ser jeg de oplyste broer om natten på dette krydstogt?', a: 'Ja — det er aftenens anden halvdel. Krydstogtet sejler 21:00–00:00, så efter solnedgangen og den blå time sejler du under den fuldt oplyste Bosporus-bro, forbi oplyste paladser og Jomfrutårnet, og vender tilbage til Kabataş omkring kl. 00:00.' },
      { q: 'Hvornår går solen ned i Istanbul?', a: 'Om sommeren (juni–juli) går solen i Istanbul ned omkring 21:00–20:45. Om vinteren omkring 16:30–17:00. Vil du have både solnedgang og nat, fanger Bosporus om nattens middagskrydstogt kl. 21:00 fra Kabataş den sene gyldne time og den blå time om sommeren — og de oplyste vartegn hele året rundt.' },
      { q: 'Er Bosporus solnedgangskrydstogtet det værd?', a: 'Ja — solnedgangen over Bosporus-broen er en af Istanbuls mest ikoniske udsigter. Bosporus om nattens middagskrydstogt kl. 21:00 (€{p.dinnerStd}/person) fanger den blå time efter solnedgang samt de oplyste paladser, med fuld middag og live shows over 3 timer.' }
    ],
    cta: {
      primary: 'Book Solnedgangskrydstogtet · Betaling om Bord',
      secondary: 'Ombordstigning 20:00 · Afgang 21:00 · Middag inkluderet · Gratis afbestilling 2 timer før',
      tertiary: 'Se Alle Detaljer om Middagskrydstogtet'
    }
  },
  ...
  'bosphorus-night-tour': {
    meta: {
      ...
      description: 'Nattour på 3 timer på Bosporus med middag og live show. Afgang 21:00 fra Kabataş, oplyste broer. Gratis afbestilling, betaling om bord.'
    },
    hero: {
      h1: 'Bosporus Nattour',
    ...
    intro: [
      ...
      '**Vores Bosporus nattour med middag** pakker den komplette ikoniske aften ind: 3 timer på vandet (21:00-00:00), tyrkisk flerretters middag, et live folkloreprogram på otte numre (Oba Dombra, sema, anatolske og aserbajdsjanske folkedanse, orientalsk dans, kaukasisk knivdans), live musik og et saxofon-og-DJ-sæt, der holder dækket levende indtil aftenens slutning. Hver gæst får det samme program — ingen "basis"-mulighed, der springer de bedste dele over.',
      'Uanset om det er dit første besøg i Istanbul, og du leder efter "den ene ting, du skal gøre om natten", eller om du har været her før og vil have byens mest fotogeniske 3 timer, er dette **Bosporus nattouren** bedømt med 4,9★ af mere end 11.317 rejsende. Licenseret af TÜRSAB, betaling om bord, ingen forudbetaling.'
    ],
    highlights: [
      ...
      { title: 'Fuld flerretters middag', desc: '10 varianter tyrkiske mezze, varm forret (börek), hovedret (laks, havbars, kyllingespyd, oksespyd, vegetarisk — dit valg), dessert (speciel semuljedessert), ubegrænsede sodavand. Halal-certificeret.' },
    ...
    faq: [
      { q: 'Hvornår er Bosporus nattouren?', a: 'Ombordstigning fra kl. 20:00 ved Kabataş-anløbsbroen. Båden afgår kl. 21:00, vender tilbage omkring kl. 00:00. Vi anbefaler at ankomme 20 minutter tidligere for at installere dig og vælge plads.' },
      { q: 'Hvad koster Bosporus nattouren?', a: 'Nattour (3 timer, middag, show): €{p.dinnerStd}/person (tidligere €{p.dinnerStdOriginal}). 0-3 år gratis, 4-9 år med €5 rabat. Betaling om bord.' },
      ...
      { q: 'Bosporus nattour eller solnedgangskrydstogt — hvilket er mere værd?', a: 'Nattour = oplyst Istanbul, maksimalt lysdrama, fuldt underholdningsprogram, de mest ikoniske fotos af oplyste broer. Og det er ét krydstogt: om sommeren (maj–august) fanger ombordstigningen fra kl. 20:00 den gyldne time, og solen går ned lige omkring afgangen kl. 21:00 — så samme aften dækker både solnedgang og nat. Ingen grund til at vælge eller booke to gange.' },
      ...
      { q: 'Jeg taler ikke tyrkisk — er touren på engelsk?', a: 'Mandskabet taler engelsk. Underholdningen (sema, folkedanse, musik) kræver ikke sprog. Middagsmenuen er på engelsk. Reservation via WhatsApp / Telegram fungerer på flere sprog (engelsk, arabisk, russisk, tysk, fransk, spansk). Ingen tyrkisk nødvendig.' }
    ],
    cta: {
      primary: 'Book Nattouren · Betaling om Bord',
      secondary: 'Afgang 21:00 · 3 timer · Middag + show inkluderet · Gratis afbestilling 2 timer før',
      tertiary: 'Tilgængelighed i Aften'
    }
  },
  ...
  'dinner-cruise-istanbul': {
    meta: {
      ...
      description: 'Middagskrydstogt på 3 timer i Istanbul på Bosporus. Tyrkisk flerretters menu, live folklore, oplyste broer. Gratis afbestilling, betaling om bord. 11.317+ gæster.'
    },
    hero: {
      ...
      badge: '4,9★ · 11.317+ gæster · TÜRSAB A-17672'
    },
    intro: [
      'Leder du efter et **middagskrydstogt i Istanbul**? Du har fundet, hvad de fleste rejsende anbefaler. Vores 3-timers aften på Bosporus kombinerer en fuld tyrkisk flerretters middag, live folkedanse og byens mest fotogeniske udsigter — alt fra en komfortabel båd, der afgår kl. 21:00 fra Kabataş-anløbsbroen.',
      'Oplevelsen af **middagskrydstogtet i Istanbul**: gå om bord kl. 20:00, sæt dig, se Dolmabahçe-paladset, mens vi afgår, middagen starter, når vi nærmer os Ortaköy-moskeen, showet begynder (sema, folkedanse, orientalsk), og når desserten kommer, er du under den oplyste Bosporus-bro. Ved midnat vender du tilbage til Kabataş med en ikonisk fotokollage og en mæt mave.',
      '€{p.dinnerStd}/person (tidligere €{p.dinnerStdOriginal}). Betaling om bord — ingen forudbetaling, ingen risiko. Licenseret af TÜRSAB A-17672, bedømt med 4,9★ af mere end 11.317 rejsende.'
    ],
    highlights: [
      { title: 'Fuld tyrkisk flerretters middag', desc: '10 varianter mezze, varm forret, hovedret (laks/havbars/kylling/oksespyd/vegetarisk), speciel semuljedessert. Halal-certificeret. Ubegrænsede sodavand inkluderet.' },
      { title: 'Live tyrkisk folkedans-show', desc: 'Otte numre: Oba Dombra, sema-forestilling, Sarı Gelin, aserbajdsjansk potpourri, orientalsk dans, anatolsk potpourri, georgisk-kaukasisk knivdans, derefter live saxofon og DJ. 40 minutter show, kontinuerlig baggrundsmusik.' },
    ...
    faq: [
    {
      ...
      { q: 'Hvad koster middagskrydstogtet i Istanbul?', a: 'Vores middagskrydstogt koster €{p.dinnerStd}/person (normal pris €{p.dinnerStdOriginal}). 0-3 år gratis, 4-9 år €5 rabat. Betaling om bord — ingen forudbetaling.' },
      ...
      { q: 'Hvor lang er middagskrydstogtet — og hvornår starter det?', a: 'I alt 3 timer. Ombordstigning fra kl. 20:00, båden afgår præcis kl. 21:00, vender tilbage omkring kl. 00:00. Vi anbefaler at ankomme 15-20 minutter tidligere for at installere dig og vælge plads.' },
    ...
    cta: {
      ...
      secondary: '4,9★ · TÜRSAB-licenseret · Gratis afbestilling 2 timer før',
      tertiary: 'Tilgængelighed i Aften'
    }
  },
  ...
  'istanbul-night-tour': {
    meta: {
      ...
      description: 'Krydstogt på 3 timer på Bosporus med middag og live show. Afgang 21:00 fra Kabataş. Gratis afbestilling, betaling om bord. 11.317+ gæster. Hoteltransfer valgfri.'
    },
    hero: {
    ...
    intro: [
      ...
      'Middagen er inkluderet (tyrkisk flerretters menu), live tyrkisk folkedans-show, sema, orientalsk dans og DJ-sæt. Hvis du er i Istanbul i 2-3 dage, er dette den eneste aften, der giver det stærkeste slag. 4,9★ af mere end 11.317 rejsende, betaling om bord, ingen forudbetaling.'
    ],
    highlights: [
      ...
      { title: 'Fuld tyrkisk middag inkluderet', desc: '10 mezze, varm forret, hovedret (laks/havbars/kylling/oksespyd/vegetarisk), dessert, ubegrænsede sodavand. Halal-certificeret. Prissat til €{p.dinnerStd}/person — alt inkluderet.' },
      { title: 'Live folkedanse + sema + orientalsk', desc: 'Live program på otte numre: Oba Dombra, Mevlana sema-forestilling, Sarı Gelin, aserbajdsjansk potpourri, orientalsk dans, anatolsk potpourri, georgisk-kaukasisk knivdans, derefter live saxofon og DJ. 40 minutter show, baggrundsmusik hele aftenen.' },
    ...
    faq: [
      ...
      { q: 'Hvad koster touren gennem Istanbul om natten?', a: 'Vores nattour med middag på Bosporus: €{p.dinnerStd}/person. Inkluderet touren, middagen, underholdningen, sodavand. Valgfrit: alkohol (2 glas) +€{p.alcohol2}/person, hoteltransfer +€{p.transfer}/person. Betaling om bord — ingen forudbetaling.' },
      ...
      { q: 'Hvad er det bedste tidspunkt for en nattour i Istanbul?', a: 'Vores middagstour på Bosporus er 21:00-00:00 (3 timer). Dette er top-belysningstidspunktet for alle Istanbuls vartegn — broer fuldt oplyst, paladser strålende, månen på vandet. Vil du også have den gyldne time, så kom om sommeren: ombordstigningen starter kl. 20:00, og fra maj til august går solen ned lige omkring afgangen kl. 21:00 — det samme krydstogt dækker begge dele.' },
  ...
  'istanbul-boat-tour': {
    meta: {
      ...
      description: 'Bådtour på 3 timer: Bosporuskrydstogt, fuld tyrkisk middag, live folklore, oplyste natudsigter. Gratis afbestilling, betaling om bord. 11.317+ gæster.'
    },
    hero: {
      ...
      badge: '4,9★ · TÜRSAB A-17672 · Betaling om Bord'
    },
    intro: [
      ...
      'I modsætning til de mange turistfærger på 1 time, der dækker mindre af Bosporus og springer middagen og underholdningen over, er **vores bådtour i Istanbul** en komplet aftenoplevelse: ombordstigning kl. 20:00 ved Kabataş-anløbsbroen, tour indtil midnat, 10 mezze, hovedret, dessert, sema, folkedanse, orientalsk dans og DJ. Du får også aftenudgangen som en del af touren.',
      'Uanset om du har en aften eller en hel uge i Istanbul, gør denne **bådtour i Istanbul** arbejdet. 4,9★ af mere end 11.317 rejsende, licenseret af TÜRSAB (A-17672), halal-certificeret menu og betaling om bord — ingen økonomisk forpligtelse, før du er tilfreds med oplevelsen.'
    ],
    highlights: [
      ...
      { title: 'Aftenafgang (bedste belysning)', desc: 'Afgangen kl. 21:00 fanger den oplyste Bosporus i fuld stråleglans — broer, paladser, moskeer alle oplyste. Mere dramatisk end dagsture, der viser de samme vartegn i fladt lys.' },
    ...
    faq: [
      ...
      { q: 'Hvor lang er bådtouren i Istanbul?', a: '3 timer. Ombordstigning fra kl. 20:00 ved Kabataş-anløbsbroen, afgang 21:00, retur ~00:00. Dækker hele Bosporus fra Dolmabahçe til Rumeli Hisarı og tilbage. Nok tid til fuld middag + show uden træthed.' },
      { q: 'Hvad koster bådtouren i Istanbul?', a: 'Vores bådtour med middag: €{p.dinnerStd}/person (tidligere €{p.dinnerStdOriginal}). 0-3 år gratis, 4-9 år med €5 rabat. Betaling om bord. Alkohol og hoteltransfer er valgfri tillæg.' },
      ...
      { q: 'Er denne bådtour passende for familier med børn?', a: 'Ja — meget familievenlig. Børn 0-3 år gratis, 4-9 år €5 rabat. Overdækket indendørs område, børnemenu på forespørgsel og underholdning (sema, folkedanse) fængslende for børn. Mange familier fra hele verden booker denne tour.' },
  ...
  'bosphorus-trip': {
    meta: {
      ...
      description: 'Tur på 3 timer på Bosporus: tyrkisk middag, live folklore, oplyste natudsigter. Afgang 21:00 fra Kabataş. Gratis afbestilling, betaling om bord.'
    },
    hero: {
      h1: 'Tur på Bosporus',
    ...
    intro: [
      ...
      'Uanset om du er i Istanbul i 24 timer eller en uge, er dette **Bosporusturen**, der giver dig mest på én aften. Bedømmelse 4,9★ af mere end 11.317 rejsende, licenseret af TÜRSAB A-17672, halal-venlig menu, betaling om bord — ingen risiko for forudbetaling.'
    ],
    highlights: [
      ...
      { title: 'Fra €{p.dinnerStd} — betaling om bord', desc: 'Ingen forudbetaling krævet. Betaling om bord (kontant eller kort). Gratis afbestilling indtil 2 timer før afgang. 0-3 år gratis, 4-9 år med €5 rabat. Gennemsigtige priser.' }
    ],
    faq: [
      ...
      { q: 'Hvor lang er en Bosporustur?', a: 'Vores Bosporustur varer 3 timer i alt (afgang 21:00, retur 00:00). Der er kortere muligheder (turistfærger på 1 time, ture på 90 minutter), men de springer middagen og underholdningen over. For den komplette aftenoplevelse er 3 timer ideelt — nok til at se alt uden at blive træt.' },
      ...
      { q: 'Er Bosporusturen passende for børn?', a: 'Ja — meget børnevenlig. Børn 0-3 år gratis (transfer inkluderet), 4-9 år €5 rabat. Overdækket indendørs område, børnemenu på forespørgsel og delikat og fængslende underholdning. Mange familier booker denne tur som højdepunktet af deres rejse til Istanbul.' },
  ...
  'bosphorus-cruise-tickets': {
    meta: {
      ...
      description: 'Direkte Bosporuskrydstogt billetter fra €{p.dinnerStd}/person. Ingen forudbetaling, betaling om bord. Gratis afbestilling indtil 2t før.'
    },
    hero: {
    ...
    intro: [
      'Leder du efter **Bosporuskrydstogt billetter**? Køb direkte. Vores billet er €{p.dinnerStd}/person — 40% rabat på den normale pris (€{p.dinnerStdOriginal}). Tredjepartsbookingsider tilføjer normalt 20-40% kommission. Ved at booke direkte sparer du — og betaler stadig om bord.',
      'Vores **Bosporuskrydstogt billetter**-proces: udfyld formularen på denne side på mindre end 1 minut (dato, antal gæster, kontakt), vi bekræfter med det samme via WhatsApp / Telegram, du møder kl. 20:00 ved Kabataş-anløbsbroen, betaler om bord, nyder middagskrydstogtet på 3 timer. Ingen fysisk billet at printe, ingen voucher at modtage via e-mail — bekræftelsen er din billet.',
      'Uanset om du booker middagskrydstogtet for i aften eller booker for en specifik dato næste uge, er **direkte Bosporuskrydstogt billetter** den hurtigste måde. Bedømmelse 4,9★, licenseret af TÜRSAB (A-17672), halal-certificeret menu og understøtter hoteltransfer- og alkoholtillæg.'
    ],
    highlights: [
      { title: 'Direkte booking — ingen mellemmandsomkostninger', desc: '€{p.dinnerStd}/person — én gennemsigtig pris. Tredjepartssider opkræver €30-80+ for den samme tour. Spar ved at booke direkte hos os. Ingen skjulte omkostninger, intet kommissionstillæg.' },
      ...
      { title: 'Bekræftelse på mindre end 1 minut', desc: 'Udfyld formularen → vi bekræfter via WhatsApp / Telegram. Ingen PDF-vouchermail at printe. Vores besked er din billet. Kom til anløbsbroen kl. 20:00.' },
      { title: 'Nuværende lanceringspris 40% RABAT', desc: 'Tidligere €{p.dinnerStdOriginal}, nu €{p.dinnerStd}. 40% rabat, fordi du booker direkte. Intet tricks med tidsbegrænsning — det er vores standard direkte bookingpris.' }
    ],
    faq: [
      { q: 'Hvad koster Bosporuskrydstogt billetterne?', a: '€{p.dinnerStd}/person (normal €{p.dinnerStdOriginal}). Inkluderer turen på 3 timer, tyrkisk flerretters middag, live folkedans-show, ubegrænsede sodavand. 0-3 år gratis, 4-9 år €5 rabat. Betaling om bord — ingen forudbetaling.' },
      { q: 'Hvor kan jeg købe Bosporuskrydstogt billetter?', a: 'Direkte fra denne side — udfyld reservationsformularen, vi bekræfter med det samme via WhatsApp / Telegram. Betaling om bord. Tredjepartsplatforme (Viator, GetYourGuide, Klook) sælger også billetter, men opkræver normalt €30-80+ — dette er mellemmandstillægget. Direkte er det billigste og hurtigste.' },
      { q: 'Skal jeg printe Bosporuskrydstogt billetten?', a: 'Nej — ingen fysisk billet eller voucher nødvendig. Efter reservation sender vi dig en bekræftelse via WhatsApp (eller Telegram) med mødested, tid og reservationsnavn. Vis bare din telefon ved anløbsbroen. Færdig.' },
      ...
      { q: 'Er Bosporuskrydstogt billetter tilgængelige samme dag?', a: 'Ofte ja, især på hverdage. Weekender og ferier fyldes hurtigere op. Tjek tilgængelighed via reservationsformularen — den opdateres i realtid. Reservation samme dag er normalt mulig med få timer før afgangen kl. 21:00. For hastende forespørgsler, WhatsApp.' },
      { q: 'Er Bosporuskrydstogt billetter for børn gratis?', a: 'Børn **0-3 år helt gratis** (ingen omkostninger, ingen skjulte omkostninger, transfer inkluderet). **4-9 år €5 rabat** (€{p.dinnerStd} − €5 = €19.30). **10+ år fuld voksenpris.** Faste og gennemsigtige priser — ingen "babytillægs"-tricks.' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    meta: {
      ...
      description: 'Bosporuskrydstogt reservation samme dag. WhatsApp bekræftelse på minutter. Afgang 21:00 fra Kabataş. Gratis afbestilling, betaling om bord. 11.317+ gæster.'
    },
    hero: {
    ...
    intro: [
      'Landet i Istanbul i eftermiddag og vil have en dejlig aften i aften? **Bosporuskrydstogtet i sidste øjeblik** virker. Vi reserverer specielt pladser til reservationer samme dag, fordi vi ved, at mange rejsende beslutter sig om morgenen. Udfyld formularen her, vi bekræfter via WhatsApp på få minutter, du møder kl. 20:00 ved Kabataş-anløbsbroen, betaler om bord, nyder.',
      '**Vores Bosporuskrydstogt i sidste øjeblik** har det samme aftenprogram som forhåndsbookinger: 3 timer på vandet (21:00-00:00), tyrkisk flerretters middag, live folkedans-show, sema, orientalsk dans, DJ. Oplyst Dolmabahçe-palads, Ortaköy-moskeen, Bosporus-broen — de samme ikoniske udsigter. Samme pris: €{p.dinnerStd}/person.',
    ...
    highlights: [
      ...
      { title: 'Bekræftelse på mindre end 5 minutter', desc: 'Udfyld formularen → bekræftelsesbesked WhatsApp/Telegram → klar. Ingen e-mailvoucher at vente på, ingen QR-kode at printe. Vores besked er din billet.' },
      ...
      { title: 'Hoteltransfer samme dag ofte tilgængelig', desc: 'Hoteltransferen kræver normalt 24 timers varsel, men for reservationer samme dag mellem 14:00-18:30 kan vi ofte arrangere afhentning med +€{p.transfer}/person. For hastende transferforespørgsler, WhatsApp.' }
    ],
    faq: [
      { q: 'Kan jeg virkelig booke Bosporuskrydstogtet for i aften?', a: 'Ja — ofte. Vi reserverer pladser til reservationer samme dag. Tjek formularen ovenfor for tilgængelighed i aften. Hvis der er pladser tilgængelige, kan du booke indtil kl. 21:00. Weekender er mere travle — book tidligere på dagen, hvis muligt.' },
      { q: 'Hvor last minute kan jeg booke?', a: 'Booking er åben indtil kl. 21:00 — helt frem til afgang. Er det meget tæt på afgang, så skriv direkte til os på WhatsApp +90 532 244 29 22 — er der ledige pladser, bekræfter vi manuelt.' },
      { q: 'Er Bosporuskrydstogtet i sidste øjeblik dyrere?', a: 'Nej — samme pris som forhåndsbooking. €{p.dinnerStd}/person. Vi laver ikke "dynamiske priser" eller tillæg for sidste øjeblik. Samme båd, samme middag, samme show, samme pris.' },
      ...
      { q: 'Kan I arrangere hoteltransfer i sidste øjeblik?', a: 'Transfer samme dag er muligt indtil ~18:30 for turen kl. 21:00. Efter kl. 18:30 har vi muligvis ingen chauffør tilgængelig — i dette tilfælde kan du tage en taxa til Kabataş-anløbsbroen (15 min fra Taksim, 10 min fra Sultanahmet, ~€10-15). Centralt og let.' },
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Bosporus krydstogt priser Istanbul: €{p.dinnerStd}/person. Børn 0-3 gratis, 4-9 med €5 rabat. Gennemsigtige tillæg.'
    },
    hero: {
      h1: 'Istanbul Krydstogt Pris',
      subtitle: 'Gennemsigtige priser, ingen skjulte omkostninger. €{p.dinnerStd}/person — og du betaler om bord, ikke nu.',
      badge: 'Gennemsigtigt · 40% RABAT Direkte · 0-3 År Gratis'
    },
    intro: [
      '**Istanbul krydstogt priser** varierer meget — fra budget-færger på €15, der springer middagen over, til resortyachter på €150+. Vores pris er midt i mellem og tilbyder den bedste værdi: €{p.dinnerStd}/person for fuldt middagskrydstogt med show på 3 timer. Ingen skjulte omkostninger, ingen overraskelsestillæg.',
      'En detaljeret opdeling af **Istanbul krydstogt prisen**, fordi gennemsigtighed betyder noget:\n\n- **Middagskrydstogt**: €{p.dinnerStd}/person (tidligere €{p.dinnerStdOriginal}, 40% rabat). Inkluderer tour på 3 timer, 10 mezze, hovedret, dessert, ubegrænsede sodavand, live show.\n- **0-3 år**: Gratis. 4-9 år: €5 rabat. 10+ år: fuld pris.\n\nTillæg (valgfri):\n- 2 glas alkohol: +€{p.alcohol2}/person\n- Hoteltransfer tur-retur: +€{p.transfer}/person\n- Romantisk bordopsætning: +€{p.romantic}/bord',
    ...
    highlights: [
      { title: 'Middagskrydstogt: €{p.dinnerStd} (tidligere €{p.dinnerStdOriginal})', desc: '40% rabat på den normale pris. Tour på 3 timer, fuld tyrkisk middag, live show, ubegrænsede sodavand. Én gennemsigtig pris — dækker alt, hvad du har brug for til en dejlig aften.' },
      { title: 'Alt inkluderet i prisen', desc: 'Tour på 3 timer, 10 mezze, varm forret, hovedret, dessert, ubegrænsede sodavand, live show og alle skatter. Ingen skjulte omkostninger eller overraskelser om bord.' },
      { title: 'Pris for børn: 0-3 gratis, 4-9 med €5 rabat', desc: '0-3 helt gratis (ingen omkostninger). 4-9 med €5 rabat på voksenprisen. 10+ fuld voksenpris. Gennemsigtigt, ingen familieprisricks. Transferen er også gratis for 0-3.' },
      { title: 'Tillæg — kun når du vil have dem', desc: 'Alkohol (2 glas): +€{p.alcohol2}/person. Transfer: €{p.transfer}/person. Romantisk bord: €{p.romantic}/bord. Alt valgfrit, ikke pakket. Vælg kun, hvad du har brug for.' }
    ],
    faq: [
      { q: 'Hvad koster en tour i Istanbul?', a: 'Middagskrydstogt: €{p.dinnerStd}/person (normal €{p.dinnerStdOriginal}, 40% rabat). 0-3 år gratis, 4-9 år med €5 rabat. Betaling om bord — ingen forudbetaling. Gratis afbestilling indtil 2 timer før afgang.' },
      ...
      { q: 'Hvorfor er Istanbul-tourprisen 40% rabat — er det et trick?', a: 'Intet trick. Den normale pris €{p.dinnerStdOriginal} er, hvad tredjepartsbookingsider (Viator, GetYourGuide, Klook) opkræver — med deres kommissioner. Book direkte og få €{p.dinnerStd}. Dette er forskellen på 40%. Ingen tricks med begrænset eller dynamisk pris.' },
      { q: 'Hvordan sammenligner Istanbul-tourprisen med andre muligheder?', a: 'Loop-færger: €5-10, 1 time, ingen middag, ingen underholdning, kun turisme. Budget-ture med middag: €20-30, fyldte, gennemsnitlig mad, kort show. Vores krydstogt (€{p.dinnerStd}): 3 timer, fuld middag, fuldt show, privat bord, TÜRSAB-licenseret. Resortyachter: €100-150+, overdrevet for solo-rejsende/par.' },
      { q: 'Skal jeg betale Istanbul-tourprisen på forhånd?', a: 'Nej — **betaling om bord**. Book nu (formular på 1 minut), vi bekræfter via WhatsApp, kom kl. 20:00 og betal om bord (kontant eller kort). Gratis afbestilling indtil 2 timer før. Nul økonomisk forpligtelse, før du er tilfreds.' },
