...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    faq: [
      ...
      { q: 'Er alkohol inkluderet i middagskrydstogtet?', a: 'Ubegrænsede sodavand (vand, cola, juice) er inkluderet i prisen. Alkoholpakken er valgfri: 2 glas (vin, øl, rakı, vodka eller gin) +€{p.alcohol2}/person. Yderligere og importerede drikkevarer faktureres separat om bord.' },
      { q: 'Er der hoteltransfer?', a: 'Ja — afhentnings- og afleveringsservice er +€{p.transfer}/person. Betjente zoner: Beşiktaş, Taksim, Sultanahmet, Sirkeci, Eminönü, Ortaköy, Beyoğlu, Fatih, Laleli, Topkapı, Kağıthane, Sütlüce og Şişli. Du kan vælge denne mulighed i reservationsformularen.' },
  ...
  'bosphorus-with-kids': {
    ...
    highlights: [
      { title: '0-3 år helt gratis', desc: 'Ingen omkostninger for babyer og småbørn. 4-9 år betaler €5 af voksenprisen. Fra 9 år gæst med fuld pris. Gennemsigtigt, ingen overraskelser.' },
    ...
    faq: [
      ...
      { q: 'Hvad er prisen for børn på Bosporuskrydstogtet?', a: 'Børn **0-3 år: GRATIS** (ingen omkostninger, ingen skjulte omkostninger). **4-9 år: €5 rabat** på voksenprisen — det vil sige €12/barn på Standard (€{p.dinnerStd}/2). **10+ år: fuld voksenpris.** Hoteltransfer er gratis for 0-3 år, standard for 4+ (€{p.transfer}/person).' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Vin, champagne, premium pairings', desc: 'Tilføj 2-glas alkoholpakken (+€{p.alcohol2}/person) — lokal vin, øl eller rakı. Importeret champagne og premium pairings efter forespørgsel — spørg ved reservation.' }
    ],
    faq: [
  ...
  'bosphorus-for-couples': {
    ...
    highlights: [
      ...
      { title: 'Tillæg til specielle aftener', desc: 'Romantisk bordopsætning (stearinlys, roser): +€{p.romantic}. 2 glas alkohol (vin, øl eller rakı): +€{p.alcohol2}/person. Hoteltransfer (tur-retur): +€{p.transfer}/person. Vælg, hvad der passer til din aften.' }
    ],
    faq: [
      ...
      { q: 'Kan par medbringe deres egen vin eller champagne?', a: 'Vi tillader ikke ekstern alkohol (af licensgrunde). Men vi har 2-glas pakken med lokal vin eller øl (+€{p.alcohol2}/person) og kan arrangere importerede premiumvine eller champagne mod et gebyr — spørg ved reservation. Prosecco, Chianti og Cabernet er de populære premiumforespørgsler.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    highlights: [
      ...
      { title: 'Fuld middag under krydstogtet', desc: '10 varianter tyrkiske mezze, varm forret, hovedret (laks, havbars, kylling, kødboller, vegetarisk), iskage, ubegrænsede sodavand — serveret, mens byens lys tændes.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    faq: [
      ...
      { q: 'Er Bosporuskrydstogt billetter for børn gratis?', a: 'Børn **0-3 år helt gratis** (ingen omkostninger, ingen skjulte omkostninger, transfer inkluderet). **4-9 år €5 rabat** (€{p.dinnerStd}/2 = €12,15). **10+ år fuld voksenpris.** Faste og gennemsigtige priser — ingen "babytillægs"-tricks.' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    ...
    faq: [
      { q: 'Kan jeg virkelig booke Bosporuskrydstogtet for i aften?', a: 'Ja — ofte. Vi reserverer pladser til reservationer samme dag. Tjek formularen ovenfor for tilgængelighed i aften. Hvis der er pladser tilgængelige, kan du booke indtil kl. 20:00. Weekender er mere travle — book tidligere på dagen, hvis muligt.' },
      { q: 'Hvor last minute kan jeg booke?', a: 'Reservationerne forbliver åbne indtil kl. 20:00 for båden kl. 21:00. Efter kl. 20:00, skriv direkte til os via WhatsApp på +90 532 244 29 22 — hvis der er ledige pladser, kan vi bekræfte manuelt. Efter kl.' },
