...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    meta: {
      ...
      description: 'Rejs z kolacją 3 godziny po Bosforze: tureckie wielodaniowe menu i pokaz folklorystyczny na żywo. Wypłynięcie 20:30 z Kabataş.'
    },
    hero: {
    ...
    faq: [
      { q: 'O której zaczyna się rejs z kolacją po Bosforze?', a: 'Wejście na pokład przy przystani Kabataş rozpoczyna się o 19:30. Łódź wypływa o 20:30 i wraca około 23:30. Zalecamy przybycie 15-20 minut wcześniej, aby zająć miejsce i się rozgościć.' },
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      ...
      { q: 'Czy mogę modlić się na pokładzie?', a: 'Na łodzi nie ma dedykowanego pomieszczenia modlitewnego, ale zalecamy modlitwę przed wejściem na pokład o 19:30 (Maghrib zwykle mieści się w tym oknie). Na przystani Kabataş dostępne są udogodnienia modlitewne. Jeśli muszą Państwo modlić się podczas rejsu 20:30-23:30 (Isza), proszę porozmawiać z załogą — możemy zorganizować cichy kąt na pokładzie.' },
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Jak zarezerwować rejs VIP po Bosforze?', a: 'Proszę użyć kreatora rezerwacji na tej stronie — wybrać "VIP" w Kroku 1, określić datę, wpisać liczbę gości, a następnie dane kontaktowe. Państwa prośba trafia przez WhatsApp / Telegram i potwierdzamy natychmiast. Płatność na pokładzie, nie teraz.' },
  ...
  'bosphorus-for-couples': {
    ...
    faq: [
      ...
      { q: 'Kiedy jest najlepszy rejs po Bosforze dla par — zachód słońca czy noc?', a: 'Rejs wypływa codziennie o 20:30 — a latem (maj–sierpień) to jedno wypłynięcie łączy jedno i drugie: wejście na pokład od 19:30 podczas złotej godziny, zachód słońca tuż w okolicach wypłynięcia, a potem podświetlone mosty i rozświetlone pałace. Zimą to czysto nocny rejs wśród świateł. Tak czy inaczej, jedna rezerwacja daje parom najbardziej kultową wersję Bosforu.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      ...
      description: 'Złap zachód słońca nad Bosforem, potem kolacja pod podświetlonymi mostami. Wejście 19:30 w Kabataş, wypłynięcie 20:30. 3 godziny, pełna kolacja. Płatność na pokładzie.'
    },
    hero: {
      h1: 'Rejs o Zachodzie Słońca z Kolacją po Bosforze',
      subtitle: 'Wejdź na pokład o 19:30, gdy niebo nad minaretami złoci się — a potem zjedz kolację na wodzie, podczas gdy Dolmabahçe, Meczet Ortaköy i Most Bosforski rozświetlają się na noc.',
      badge: 'Wejście na Pokład 19:30 · Wypłynięcie 20:30 · Od Zachodu Słońca po Światła Miasta'
    },
    intro: [
      '**Rejs o zachodzie słońca po Bosforze** w Stambule to przede wszystkim jedno: moment przejścia. Wejście na pokład przy przystani Kabataş rozpoczyna się o 19:30 — a w długie wieczory od maja do sierpnia złota godzina rozgrywa się, gdy Państwo rozgaszczają się na pokładzie. Słońce zachodzi za minaretami europejskiej strony mniej więcej w porze wypłynięcia o 20:30, więc oglądają je Państwo z wody: Pałac Dolmabahçe skąpany w złocie, Meczet Ortaköy w sylwecie na tle rozżarzonego nieba.',
    ...
    faq: [
      { q: 'O której wypływa rejs o zachodzie słońca po Bosforze?', a: 'Wejście na pokład rozpoczyna się o 19:30 przy przystani Kabataş, łódź wypływa o 20:30 i wraca około 23:30. Latem (maj–sierpień) słońce zachodzi mniej więcej między 20:15–20:45 — złota godzina trwa, gdy Państwo wchodzą na pokład, a sam zachód słońca przypada dokładnie na porę wypłynięcia, oglądany z wody.' },
      { q: 'Czy rejs o zachodzie słońca po Bosforze to to samo co rejs z kolacją?', a: 'Tak — to jeden rejs. Jest jedno codzienne wypłynięcie o 20:30 z pełną kolacją i pokazami na żywo na pokładzie. W długie letnie wieczory pełni on również rolę rejsu o zachodzie słońca: wchodzą Państwo na pokład podczas złotej godziny i płyną przez niebieską godzinę w podświetloną noc. Zimą ten sam rejs to czyste doświadczenie nocnych świateł.' },
      { q: 'Jaka jest cena rejsu o zachodzie słońca po Bosforze?', a: 'Od €{p.dinnerStd}/osobę za rejs standardowy (3 godziny, pełna kolacja, rozrywka na żywo). Opcja VIP z miejscami przy scenie i mezze premium to €{p.dinnerVip}/osobę. Płatność na pokładzie — bez przedpłaty. Dzieci 0-3 lata bezpłatnie, 4-8 lat pół ceny.' },
      { q: 'Kiedy jest najlepsza pora roku na rejs o zachodzie słońca po Bosforze?', a: 'Od maja do sierpnia. Późne stambulskie zachody słońca (20:15–20:45) zbiegają się z wypłynięciem o 20:30, więc w jeden wieczór dostają Państwo złotą godzinę, zachód słońca i podświetlone mosty. Jesienią i zimą słońce zachodzi wcześniej i ten sam rejs staje się pełnym doświadczeniem nocnych świateł — równie fotogenicznym, w innym nastroju.' },
      ...
      { q: 'Czy na tym rejsie zobaczę podświetlone mosty nocą?', a: 'Tak — to druga połowa wieczoru. Rejs trwa 20:30–23:30, więc po zachodzie słońca i niebieskiej godzinie płyną Państwo pod w pełni podświetlonym Mostem Bosforskim, obok rozświetlonych pałaców i Wieży Panny, a do Kabataş wracają około 23:30.' },
      { q: 'O której zachodzi słońce w Stambule?', a: 'Latem (czerwiec–lipiec) słońce w Stambule zachodzi około 20:30–20:45. Zimą około 16:30–17:00. Na doświadczenie zachodu słońca i nocy rejs z kolacją Bosphorus Night o 20:30 z Kabataş łapie latem późną złotą godzinę i niebieską godzinę, a podświetlone zabytki przez cały rok.' },
      { q: 'Czy rejs o zachodzie słońca po Bosforze jest wart swojej ceny?', a: 'Tak — zachód słońca nad Mostem Bosforskim to jeden z najbardziej charakterystycznych widoków Stambułu. Rejs z kolacją Bosphorus Night o 20:30 (€{p.dinnerStd}/osobę) łapie niebieską godzinę po zachodzie słońca oraz podświetlone pałace, z pełną kolacją i pokazami na żywo przez 3 godziny.' }
    ],
    cta: {
      primary: 'Zarezerwuj Rejs o Zachodzie Słońca · Płatność na Pokładzie',
      secondary: 'Wejście na pokład 19:30 · Wypłynięcie 20:30 · Kolacja wliczona · Bezpłatna anulacja do 2 godzin',
  ...
  'bosphorus-night-tour': {
    meta: {
      ...
      description: 'Tour nocny 3 godziny po Bosforze z kolacją i pokazem na żywo. Wypłynięcie 20:30 z Kabataş, oświetlone mosty. Bezpłatne anulowanie, płatność na pokładzie.'
    },
    hero: {
    ...
    highlights: [
      { title: 'Podświetlony Bosfor w szczycie dramatyzmu', desc: 'Most Bosforski zmienia kolory (niebieski, fioletowy, złoty), pałace świecą żółto, Meczet Ortaköy odbija się w czarnej wodzie. 20:30-23:30 to szczytowe oświetlenie dla wszystkich stambulskich punktów orientacyjnych.' },
    ...
    faq: [
      { q: 'O której jest nocny rejs po Bosforze?', a: 'Wejście na pokład przy przystani Kabataş od 19:30. Łódź wypływa o 20:30, wraca około 23:30. Zalecamy przybycie 20 minut wcześniej, aby się rozgościć i wybrać miejsce.' },
      ...
      { q: 'Nocny rejs po Bosforze vs rejs o zachodzie słońca?', a: 'Nocny rejs = podświetlony Stambuł, szczytowy dramatyzm światła, pełny program rozrywki, najbardziej kultowe zdjęcia podświetlonych mostów. A to jeden rejs: latem (maj–sierpień) wejście na pokład od 19:30 łapie złotą godzinę, a słońce zachodzi tuż w okolicach wypłynięcia o 20:30 — ten sam wieczór obejmuje więc zachód słońca i noc. Nie trzeba wybierać ani rezerwować dwa razy.' },
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
      ...
      { q: 'Jak długo trwa rejs z kolacją — i kiedy się zaczyna?', a: '3 godziny łącznie. Wejście na pokład od 19:30, łódź wypływa dokładnie o 20:30, wraca około 23:30. Zalecamy przybycie 15-20 minut wcześniej, aby się rozgościć i wybrać miejsce.' },
  ...
  'istanbul-night-tour': {
    meta: {
      ...
      description: 'Rejs 3 godziny po Bosforze z kolacją i pokazem na żywo. Wypłynięcie 20:30 z Kabataş. Bezpłatne anulowanie, płatność na pokładzie. 11 317 opinii.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: 'Kiedy jest najlepszy czas na nocną wycieczkę po Stambule?', a: 'Nasz rejs z kolacją po Bosforze trwa 20:30-23:30 (3 godziny). To czas szczytowego oświetlenia wszystkich stambulskich zabytków — mosty w pełni podświetlone, pałace świecą, księżyc nad wodą. Jeśli zależy Państwu także na złotej godzinie, proszę przyjechać latem: wejście na pokład zaczyna się o 19:30, a od maja do sierpnia słońce zachodzi tuż w okolicach wypłynięcia o 20:30 — ten sam rejs obejmuje jedno i drugie.' },
  ...
  'istanbul-boat-tour': {
    ...
    faq: [
      ...
      { q: 'Jak długo trwa wycieczka łodzią po Stambule?', a: '3 godziny. Wejście na pokład przy przystani Kabataş od 19:30, wypłynięcie 20:30, powrót ~23:30. Obejmuje cały Bosfor od Dolmabahçe do Rumeli Hisarı i z powrotem. Wystarczający czas na pełną kolację + pokaz bez zmęczenia.' },
  ...
  'bosphorus-trip': {
    meta: {
      ...
      description: 'Wycieczka 3 godziny po Bosforze: turecka kolacja, folklor na żywo, oświetlone widoki nocne. Wypłynięcie 20:30 z Kabataş.'
    },
    hero: {
    ...
    faq: [
      ...
      { q: 'Jak długo trwa wycieczka po Bosforze?', a: 'Nasza wycieczka po Bosforze trwa 3 godziny łącznie (wypłynięcie 20:30, powrót 23:30). Istnieją krótsze opcje (1-godzinne promy widokowe, 90-minutowe wycieczki), ale pomijają kolację i rozrywkę. Na pełne wieczorne doświadczenie 3 godziny są idealne — wystarczy, aby zobaczyć wszystko bez zmęczenia.' },
  ...
  'bosphorus-cruise-tickets': {
    meta: {
      ...
      description: 'Bezpośrednie bilety na rejs Bosfor. Standard €{p.dinnerStd}, VIP €{p.dinnerVip}. Bez przedpłaty, płatność na pokładzie. Bezpłatne anulowanie do 2h przed.'
    },
    hero: {
    ...
    intro: [
      ...
      'Nasz proces **biletów na rejs po Bosforze**: wypełnić kreatora na tej stronie w mniej niż 1 minutę (data, liczba gości, pakiet, kontakt), potwierdzamy natychmiast przez WhatsApp / Telegram, zjawiają się Państwo o 19:30 przy przystani Kabataş, płacą na pokładzie, cieszą 3-godzinnym rejsem z kolacją. Bez fizycznego biletu do wydrukowania, bez kuponu do emaila — nasze potwierdzenie to Państwa bilet.',
    ...
    highlights: [
      ...
      { title: 'Potwierdzenie w mniej niż 1 minutę', desc: 'Wypełnij kreatora → potwierdzamy przez WhatsApp / Telegram. Bez PDF kuponu do wydrukowania. Nasza wiadomość to Państwa bilet. Zjawić się o 19:30 przy przystani.' },
  ...
  'last-minute-bosphorus': {
    ...
    faq: [
      ...
      { q: 'Czy możecie zorganizować transfer hotelowy na ostatnią chwilę?', a: 'Transfer tego samego dnia możliwy do ~18:00 dla rejsu 20:30. Po 18:00 możemy nie mieć dostępnego kierowcy — w takim przypadku mogą Państwo wziąć taksówkę do przystani Kabataş (15 min z Taksim, 10 min z Sultanahmet, ~€10-15). Centralnie i łatwo.' },
