...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    faq: [
      ...
      { q: 'Czy alkohol jest wliczony w cenę rejsu z kolacją?', a: 'Nieograniczone napoje bezalkoholowe (woda, cola, soki) są wliczone w cenę. Pakiet alkoholowy jest opcjonalny: 2 kieliszki (wino, piwo, rakı, wódka, whisky, gin i więcej) +€{p.alcohol2}/osobę. Dodatkowe napoje i alkohole importowane wyceniane są osobno na pokładzie.' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Wino, szampan, dobory premium', desc: 'Dodaj 2 kieliszki alkoholu — wino, piwo, rakı, wódka, whisky, gin i więcej (+€{p.alcohol2}/osobę). Szampan importowany i dobory premium na życzenie — prosimy pytać przy rezerwacji.' }
    ],
    faq: [
  ...
  'bosphorus-vip': {
    ...
    hero: {
      ...
      subtitle: 'Jedno menu, jeden standard: premium dla każdego. Trzygodzinny wieczór na Bosforze na pokładzie Bosphorus Night — obfita turecka kolacja, pokazy na scenie na żywo i opcjonalny prywatny stolik przy scenie. Nie sprzedajemy osobnej "klasy VIP" — to, co mamy najlepsze, podajemy każdemu gościowi.',
      badge: '40% RABATU · Jedno menu, standard premium · Płatność na pokładzie'
    },
    intro: [
      'Wiele statków na Bosforze dzieli gości na "Standard" i "VIP". My nie. Na pokładzie **Bosphorus Night** jest jedno menu kolacyjne, przygotowywane z taką samą starannością dla wszystkich: 10 rodzajów tureckich meze, ciepła przystawka, danie główne do wyboru (łosoś, labraks, szaszłyk z kurczaka lub szaszłyk wołowy), specjalny deser z kaszy manny z semoliny i napoje bezalkoholowe bez ograniczeń. Cały ośmioczęściowy program rozrywkowy również jest wliczony — Oba Dombra, ceremonia wirujących derwiszy, anatolijskie i azerbejdżańskie tańce ludowe, taniec brzucha, kaukaski taniec z nożami, muzyka na żywo i finał z saksofonem i DJ-em — wszystko w cenie €{p.dinnerStd}/osobę.',
  ...
  'bosphorus-for-couples': {
    ...
    faq: [
      ...
      { q: 'Czy pary mogą przynieść własne wino lub szampana?', a: 'Nie zezwalamy na alkohol z zewnątrz (z powodów licencji operacyjnej). Ale mamy pakiet 2 kieliszków (wino, piwo, rakı, wódka, whisky, gin i więcej) (+€{p.alcohol2}/osobę) i możemy zorganizować premium wina importowane lub szampana za dodatkową opłatą — prosimy pytać przy rezerwacji. Prosecco, Chianti i Cabernet to popularne prośby premium.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Jaka jest cena rejsu o zachodzie słońca po Bosforze?', a: 'Od €{p.dinnerStd}/osobę za rejs (3 godziny, pełna kolacja, rozrywka na żywo). Płatność na pokładzie — bez przedpłaty. Dzieci 0-3 lata bezpłatnie, 4-9 lat €5 zniżki.' },
  ...
  'bosphorus-night-tour': {
    ...
    faq: [
      ...
      { q: 'Ile kosztuje nocny rejs po Bosforze?', a: 'Rejs nocny (3 godziny, kolacja, pokaz): €{p.dinnerStd}/osobę (dawniej €{p.dinnerStdOriginal}). Dzieci 0-3 lata bezpłatnie, 4-9 lat €5 zniżki. Płatność na pokładzie.' },
  ...
  'dinner-cruise-istanbul': {
    ...
    faq: [
    {
      ...
      { q: 'Ile kosztuje rejs z kolacją w Stambule?', a: 'Nasz rejs z kolacją €{p.dinnerStd}/osobę (cena regularna €{p.dinnerStdOriginal}). Dzieci 0-3 lata bezpłatnie, 4-9 lat €5 zniżki. Płatność na pokładzie — bez przedpłaty.' },
  ...
  'istanbul-night-tour': {
    ...
    highlights: [
      ...
      { title: 'Pełna turecka kolacja wliczona', desc: '10 mezze, ciepła przystawka, danie główne (łosoś/labraks/szaszłyk z kurczaka/szaszłyk wołowy/wegetariańskie), deser, nieograniczone napoje bezalkoholowe. Certyfikat halal. W cenie €{p.dinnerStd}/osobę — wszystko wliczone.' },
  ...
  'istanbul-boat-tour': {
    ...
    faq: [
      ...
      { q: 'Ile kosztuje wycieczka łodzią po Stambule?', a: 'Nasza wycieczka łodzią z kolacją: €{p.dinnerStd}/osobę (dawniej €{p.dinnerStdOriginal}). Dzieci 0-3 lata bezpłatnie, 4-9 lat €5 zniżki. Płatność na pokładzie. Alkohol i transfer hotelowy to opcjonalne dodatki.' },
      ...
      { q: 'Czy ta wycieczka łodzią nadaje się dla rodzin z dziećmi?', a: 'Tak — bardzo przyjazna rodzinom. Dzieci 0-3 lata bezpłatnie, 4-9 lat €5 zniżki. Zadaszone siedzenia wewnętrzne, menu dla dzieci na życzenie, rozrywka (sema, tańce ludowe) angażująca dla dzieci. Wiele rodzin z całego świata rezerwuje ten rejs.' },
  ...
  'bosphorus-trip': {
    ...
    highlights: [
      ...
      { title: 'Od €{p.dinnerStd} — płatność na pokładzie', desc: 'Nie wymagana przedpłata. Płatność na pokładzie (gotówka lub karta). Bezpłatna anulacja do 2 godzin przed odpłynięciem. Dzieci 0-3 lata bezpłatnie, 4-9 lat €5 zniżki. Przejrzyste ceny.' }
    ],
    faq: [
      ...
      { q: 'Czy wycieczka po Bosforze jest odpowiednia dla dzieci?', a: 'Tak — bardzo przyjazna dzieciom. Dzieci 0-3 lata bezpłatnie (transfer wliczony), 4-9 lat €5 zniżki. Zadaszone siedzenia wewnętrzne, menu dla dzieci na życzenie, rozrywka delikatna i angażująca. Wiele rodzin rezerwuje to jako główny element swojej podróży do Stambułu.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    faq: [
      { q: 'Ile kosztują bilety na rejs po Bosforze?', a: 'Bilet €{p.dinnerStd}/osobę (regularnie €{p.dinnerStdOriginal}). 3-godzinny rejs, bogata turecka kolacja, pokaz tańców ludowych na żywo, nieograniczone napoje bezalkoholowe wliczone. Dzieci 0-3 lata bezpłatnie, 4-9 lat €5 zniżki. Płatność na pokładzie — bez przedpłaty.' },
  ...
  'last-minute-bosphorus': {
    ...
    highlights: [
      ...
      { title: 'Transfer hotelowy tego samego dnia często dostępny', desc: 'Transfer hotelowy normalnie wymaga 24-godzinnego powiadomienia, ale dla rezerwacji tego samego dnia między 14:00-18:30 zazwyczaj możemy zorganizować odbiór za +€{p.transfer}/osobę. WhatsApp na pilne prośby transferowe.' }
    ],
    faq: [
      { q: 'Czy naprawdę mogę zarezerwować rejs po Bosforze na dziś wieczór?', a: 'Tak — często. Rezerwujemy miejsca na rezerwacje tego samego dnia. Sprawdź kreator powyżej pod kątem dostępności na dziś wieczór. Jeśli miejsca dostępne, mogą Państwo rezerwować do 21:00. Weekendy bardziej napięte — rezerwować wcześniej w ciągu dnia, jeśli możliwe.' },
      { q: 'Jak w ostatniej chwili mogę zarezerwować?', a: 'Rezerwacja pozostaje otwarta do 21:00 — aż do samego wypłynięcia. Jeśli do wypłynięcia zostało bardzo mało czasu, napisz do nas bezpośrednio na WhatsAppie +90 532 244 29 22 — jeśli są wolne miejsca, potwierdzimy ręcznie.' },
      ...
      { q: 'Czy możecie zorganizować transfer hotelowy na ostatnią chwilę?', a: 'Transfer tego samego dnia możliwy do ~18:30 dla rejsu 21:00. Po 18:30 możemy nie mieć dostępnego kierowcy — w takim przypadku mogą Państwo wziąć taksówkę do przystani Kabataş (15 min z Taksim, 10 min z Sultanahmet, ~€10-15). Centralnie i łatwo.' },
  ...
  'istanbul-cruise-price': {
    ...
    faq: [
      { q: 'Ile kosztuje rejs po Stambule?', a: 'Rejs z Kolacją: €{p.dinnerStd}/osobę (regularnie €{p.dinnerStdOriginal}, 40% zniżki). Dzieci 0-3 lata bezpłatnie, 4-9 lat €5 zniżki. Płatność na pokładzie — bez przedpłaty. Bezpłatna anulacja do 2 godzin przed odpłynięciem.' },
