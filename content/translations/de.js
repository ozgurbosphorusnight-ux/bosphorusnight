...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Wie buche ich die Bosporus VIP-Cruise?', a: 'Verwenden Sie den Buchungsassistenten auf dieser Seite — wählen Sie in Schritt 1 „VIP“, geben Sie Ihr Datum und die Anzahl der Gäste an und dann Kontaktdaten. Ihre Anfrage geht über WhatsApp / Telegram, und wir bestätigen sofort. Zahlung an Bord, nicht jetzt.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Was kostet die Bosporus-Sonnenuntergangscruise?', a: 'Ab €{p.dinnerStd}/Person für die Standardtour (3 Stunden, komplettes Dinner, Live-Unterhaltung). Die VIP-Option mit Plätzen nahe der Bühne und Premium-Mezze kostet €{p.dinnerVip}/Person. Zahlung an Bord — keine Vorauszahlung. 0–3 Jahre gratis, 4–8 Jahre halber Preis.' },
