...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    faq: [
      ...
      { q: 'Ist Alkohol in der Dinner-Cruise enthalten?', a: 'Unbegrenzte alkoholfreie Getränke (Wasser, Cola, Säfte) sind im Preis inbegriffen. Das Alkoholpaket ist optional: 2 Gläser (Wein, Bier, Rakı, Wodka, Whisky, Gin und mehr, Raki, Wein, Bier, Rakı, Wodka, Whisky, Gin und mehr) +€{p.alcohol2}/Person. Weitere Getränke und importierte Spirituosen werden an Bord separat berechnet.' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Wein, Champagner, Premium-Arrangements', desc: 'Fügen Sie 2 Gläser Alkohol hinzu — Wein, Bier, Rakı, Wodka, Whisky, Gin und mehr und mehr (+€{p.alcohol2}/Person). Importierter Champagner und Premium-Arrangements auf Anfrage — fragen Sie bei der Buchung.' }
    ],
    faq: [
  ...
  'bosphorus-vip': {
    ...
    hero: {
      ...
      subtitle: 'Ein Menü, ein Standard: Premium für alle. Ein 3-stündiger Bosporus-Abend an Bord der Bosphorus Night — reichhaltiges türkisches Dinner, Live-Bühnenshows und auf Wunsch ein privater Tisch nahe der Bühne. Wir verkaufen keine separate "VIP-Klasse" — wir servieren jedem Gast unser Bestes.',
      badge: '40% RABATT · Ein Menü, Premium-Standard · Zahlung an Bord'
    },
    intro: [
      'Viele Bosporus-Boote teilen ihre Gäste in "Standard" und "VIP". Wir nicht. An Bord der **Bosphorus Night** gibt es ein Dinner-Menü, für alle mit der gleichen Sorgfalt zubereitet: 10 Sorten türkische Meze, eine warme Vorspeise, Hauptgang nach Wahl (Lachs, Wolfsbarsch, Hähnchenspieß oder Rindspieß), spezielles Grießdessert und unbegrenzt alkoholfreie Getränke. Das komplette achtteilige Unterhaltungsprogramm ist inklusive — Oba Dombra, Derwisch-Zeremonie, anatolische und aserbaidschanische Volkstänze, Bauchtanz, kaukasischer Messertanz, Live-Musik und ein Saxofon-und-DJ-Finale — alles im Preis von €{p.dinnerStd}/Person.',
