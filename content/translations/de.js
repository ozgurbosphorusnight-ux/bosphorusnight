...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    faq: [
      { q: 'Wann beginnt die Bosporus-Dinner-Cruise?', a: 'Das Einsteigen beginnt um 19:30 Uhr am Kabataş-Pier. Das Schiff legt um 20:30 Uhr ab und kehrt gegen 23:30 Uhr zurück. Wir empfehlen, 15–20 Minuten früher einzutreffen, um Ihren Platz einzunehmen und sich einzurichten.' },
      { q: 'Wie viel kostet die Bosporus-Dinner-Cruise?', a: 'Die Dinner-Cruise kostet €{p.dinnerStd}/Person (regulärer Preis €{p.dinnerStdOriginal}). Kinder 0–3 Jahre gratis, 4–8 Jahre 50% Ermäßigung. Die Zahlung erfolgt an Bord — keine Vorauszahlung.' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Wein, Champagner, Premium-Arrangements', desc: 'Fügen Sie 2 Gläser Alkohol hinzu — lokaler Wein, Bier, Raki (+€{p.alcohol2}/Person). Importierter Champagner und Premium-Arrangements auf Anfrage — fragen Sie bei der Buchung.' }
    ],
    faq: [
  ...
  'halal-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Respekt vor Gebetszeiten', desc: 'Wenn die Maghrib- oder Isha-Zeit mit dem Einsteigen (19:30–20:30) zusammenfällt, kann unser Personal Sie vor der Abfahrt zum ruhigen Gebetsbereich am Kabataş-Pier weisen. Teilen Sie es einfach bei der Buchung mit.' }
    ],
    faq: [
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Was steht auf dem Menü?', a: '10 Sorten türkische Meze, eine warme Vorspeise, Hauptgang nach Wahl (Lachs, Wolfsbarsch, Hähnchen oder Köfte) und Eistorte als Dessert, dazu unbegrenzt alkoholfreie Getränke. Das Unterhaltungsprogramm ist inklusive: Derwisch-Zeremonie, 5 Volkstänze, Bauchtanz, Live-Musik und DJ.' },
      { q: 'Ist Alkohol inbegriffen?', a: 'Nein — Alkohol ist ein separates Extra: 2 Gläser lokaler Wein oder Bier für +€{p.alcohol2}/Person. Alkoholfreie Getränke sind unbegrenzt und kostenlos inklusive. Premium-Importspirituosen werden an Bord separat abgerechnet.' },
  ...
  'private-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Flexible Dauer und Abfahrt', desc: 'Die Standarddauer von 3 Stunden kann auf 4–5 Stunden verlängert werden. Wählen Sie Abfahrt 12:00 tagsüber, 17:30 Sonnenuntergang oder 20:30 nachts. Wochentag statt Wochenende? Kein Problem — wir arbeiten mit Ihrem Zeitplan.' },
  ...
  'bosphorus-for-couples': {
    ...
    faq: [
      ...
      { q: 'Wann ist die Bosporus-Tour für Paare am besten — Sonnenuntergang oder Nacht?', a: 'Die Cruise legt jeden Abend um 20:30 ab — und im Sommer (Mai–August) deckt diese eine Abfahrt beides ab: Boarding ab 19:30 während der goldenen Stunde, der Sonnenuntergang direkt zur Abfahrt, danach die beleuchteten Brücken und angestrahlten Paläste. Im Winter ist es eine reine Nachtlichter-Cruise. So oder so erleben Paare mit einer einzigen Buchung die ikonischste Version des Bosporus.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      ...
      description: 'Erleben Sie den Sonnenuntergang auf dem Bosporus, dann Dinner unter beleuchteten Brücken. Einsteigen 19:30 am Kabataş, Abfahrt 20:30. 3 Stunden, komplettes Dinner. Zahlung an Bord.'
    },
    hero: {
      h1: 'Bosporus Sonnenuntergangs- & Dinner-Cruise',
      subtitle: 'Steigen Sie um 19:30 ein, während sich der Himmel über den Minaretten golden färbt — dann dinieren Sie auf dem Wasser, während Dolmabahçe, die Ortaköy-Moschee und die Bosporus-Brücke ihre Lichter für die Nacht einschalten.',
      badge: 'Einsteigen 19:30 · Abfahrt 20:30 · Vom Sonnenuntergang zu den Stadtlichtern'
    },
    intro: [
      'Bei der **Bosporus-Sonnenuntergangscruise** in Istanbul geht es um eines: den Übergang. Das Einsteigen am Kabataş-Pier beginnt um 19:30 — und an den langen Abenden von Mai bis August entfaltet sich die goldene Stunde, während Sie es sich an Deck bequem machen. Die Sonne geht genau um die 20:30-Abfahrt hinter den Minaretten der europäischen Seite unter, und Sie erleben sie vom Wasser aus: der Dolmabahçe-Palast in Gold getaucht, die Ortaköy-Moschee als Silhouette vor einem glühenden Himmel.',
    ...
    highlights: [
      { title: 'Sommer-Sonnenuntergänge genau zur Abfahrt', desc: 'Von Mai bis August geht die Sonne in Istanbul etwa zwischen 20:15 und 20:45 unter — beim Einsteigen um 19:30 erleben Sie die goldene Stunde an Deck, und die Abfahrt um 20:30 bringt Sie zum Sonnenuntergang selbst aufs Wasser. Kamera bereit — das ist der Shot.' },
    ...
    faq: [
      { q: 'Wann legt die Bosporus-Sonnenuntergangscruise ab?', a: 'Das Einsteigen beginnt um 19:30 am Kabataş-Pier, das Schiff legt um 20:30 ab und kehrt gegen 23:30 zurück. Im Sommer (Mai–August) geht die Sonne etwa zwischen 20:15 und 20:45 unter — die goldene Stunde findet während des Einsteigens statt, und den Sonnenuntergang selbst erleben Sie rund um die Abfahrt, vom Wasser aus.' },
      { q: 'Ist die Bosporus-Sonnenuntergangscruise dasselbe wie die Dinner-Cruise?', a: 'Ja — es ist ein und dieselbe Tour. Es gibt eine einzige tägliche Abfahrt um 20:30 mit komplettem Dinner und Live-Shows an Bord. An den langen Sommerabenden ist sie zugleich eine Sonnenuntergangscruise: Sie steigen während der goldenen Stunde ein und fahren durch die blaue Stunde in die beleuchtete Nacht. Im Winter ist dieselbe Tour ein reines Nachtlichter-Erlebnis.' },
      { q: 'Was kostet die Bosporus-Sonnenuntergangscruise?', a: 'Ab €{p.dinnerStd}/Person für die Tour (3 Stunden, komplettes Dinner, Live-Unterhaltung). Zahlung an Bord — keine Vorauszahlung. 0–3 Jahre gratis, 4–8 Jahre halber Preis.' },
      { q: 'Wann ist die beste Jahreszeit für eine Bosporus-Sonnenuntergangscruise?', a: 'Mai bis August. Istanbuls späte Sonnenuntergänge (20:15–20:45) fallen genau mit der Abfahrt um 20:30 zusammen, sodass Sie goldene Stunde, Sonnenuntergang und beleuchtete Brücken an einem Abend erleben. Im Herbst und Winter geht die Sonne früher unter und dieselbe Tour wird zu einem vollen Nachtlichter-Erlebnis — genauso fotogen, nur mit anderer Stimmung.' },
      ...
      { q: 'Sehe ich auf dieser Tour die beleuchteten Brücken bei Nacht?', a: 'Ja — das ist die zweite Hälfte des Abends. Die Tour läuft von 20:30–23:30, sodass Sie nach Sonnenuntergang und blauer Stunde unter der voll beleuchteten Bosporus-Brücke hindurchfahren, an angestrahlten Palästen und dem Mädchenturm vorbei, und gegen 23:30 nach Kabataş zurückkehren.' },
      { q: 'Wann geht die Sonne in Istanbul unter?', a: 'Im Sommer (Juni–Juli) geht die Sonne in Istanbul gegen 20:30–20:45 unter. Im Winter gegen 16:30–17:00. Für ein Sonnenuntergangs-und-Nacht-Erlebnis fängt die 20:30-Dinner-Cruise von Bosphorus Night ab Kabataş im Sommer die späte goldene Stunde und die blaue Stunde ein — und die beleuchteten Wahrzeichen das ganze Jahr über.' },
      { q: 'Lohnt sich die Bosporus-Sonnenuntergangscruise?', a: 'Ja — der Sonnenuntergang über der Bosporus-Brücke gehört zu Istanbuls unverwechselbaren Ausblicken. Die 20:30-Dinner-Cruise von Bosphorus Night (€{p.dinnerStd}/Person) fängt die blaue Stunde nach Sonnenuntergang und die angestrahlten Paläste ein — mit komplettem Dinner und Live-Shows über 3 Stunden.' }
    ],
    cta: {
      primary: 'Sonnenuntergangscruise buchen · Zahlung an Bord',
      secondary: 'Einsteigen 19:30 · Abfahrt 20:30 · Dinner inklusive · Kostenlose Stornierung bis 2 Stunden vorher',
  ...
  'bosphorus-night-tour': {
    ...
    intro: [
      ...
      'Unsere **Bosporus-Nachttour mit Dinner** packt den kompletten ikonischen Abend: 3 Stunden auf dem Wasser (20:30–23:30), ein mehrgängiges türkisches Festmahl, Live-Folklore (Sema, 5 Volkstänze, orientalischer Tanz), Livemusik und ein DJ-Set, das das Deck bis zum Ende des Abends lebendig hält. Jeder Gast erhält das gleiche Programm — keine „Basic“-Option, die die besten Teile auslässt.',
    ...
    highlights: [
      { title: 'Bosporus auf dem Höhepunkt dramatisch beleuchtet', desc: 'Die Bosporus-Brücke wechselt die Farben (blau, violett, gold), Paläste leuchten gelb, die Ortaköy-Moschee spiegelt sich auf schwarzem Wasser. 20:30–23:30 ist die Spitzenbeleuchtungszeit für alle Istanbuler Wahrzeichen.' },
    ...
    faq: [
      { q: 'Wann findet die Bosporus-Nachttour statt?', a: 'Einsteigen ab 19:30 Uhr am Kabataş-Pier. Das Schiff legt um 20:30 ab und kehrt gegen 23:30 zurück. Wir empfehlen, 20 Minuten früher einzutreffen, um sich einzurichten und einen Sitzplatz zu wählen.' },
      { q: 'Wie viel kostet die Bosporus-Nachttour?', a: 'Nachttour (3 Stunden, Dinner, Show): €{p.dinnerStd}/Person (vorher €{p.dinnerStdOriginal}). 0–3 Jahre gratis, 4–8 Jahre halber Preis. Zahlung an Bord.' },
      ...
      { q: 'Ist die Bosporus-Nachttour die Sonnenuntergangstour wert?', a: 'Nachttour = beleuchtetes Istanbul, dramatischer Höhepunkt der Beleuchtung, komplettes Unterhaltungsprogramm, ikonischste Fotos der beleuchteten Brücken. Und es ist eine einzige Cruise: Im Sommer (Mai–August) fängt das Einsteigen ab 19:30 die goldene Stunde ein, und die Sonne geht direkt rund um die Abfahrt um 20:30 unter — derselbe Abend deckt also Sonnenuntergang und Nacht ab. Kein Entweder-oder, keine zweite Buchung nötig.' },
    ...
    cta: {
      ...
      secondary: 'Abfahrt 20:30 · 3 Stunden · Dinner + Show inklusive · Kostenlose Stornierung bis 2 Stunden vorher',
      tertiary: 'Verfügbarkeit heute Abend'
    }
  },
  ...
  'dinner-cruise-istanbul': {
    ...
    intro: [
      'Suchen Sie eine **Dinner-Cruise in Istanbul**? Sie haben gefunden, was die meisten Reisenden empfehlen. Unser 3-stündiger Abend auf dem Bosporus vereint ein komplettes mehrgängiges türkisches Essen, Live-Folklore und die fotogensten Ausblicke der Stadt — alles von einem entspannten Schiff, das um 20:30 Uhr vom Kabataş-Pier ablegt.',
      'Das **Dinner-Cruise Istanbul**-Erlebnis: Einsteigen um 19:30, einrichten, beobachten, wie Sie am Dolmabahçe-Palast vorbeifahren, Dinner beginnt bei der Annäherung an die Ortaköy-Moschee, Show startet (Sema, Volkstänze, orientalisch), beim Dessert sind Sie unter der beleuchteten Bosporus-Brücke. Kehren Sie um Mitternacht mit einer ikonischen Foto-Collage und einem vollen Magen nach Kabataş zurück.',
    ...
    faq: [
      ...
      { q: 'Wie lange dauert die Dinner-Cruise — und wann beginnt sie?', a: 'Insgesamt 3 Stunden. Einsteigen ab 19:30, Schiff legt pünktlich um 20:30 ab, Rückkehr gegen 23:30. Wir empfehlen, 15–20 Minuten früher einzutreffen, um sich einzurichten und Ihren Sitzplatz zu wählen.' },
  ...
  'istanbul-night-tour': {
    ...
    faq: [
      ...
      { q: 'Was ist die beste Zeit für eine Nachttour in Istanbul?', a: 'Unsere Bosporus-Dinner-Cruise findet von 20:30–23:30 statt (3 Stunden). Das ist die Spitzenbeleuchtungszeit für alle Istanbuler Wahrzeichen — Brücken voll beleuchtet, Paläste leuchtend, Mond auf dem Wasser. Wenn Sie auch die goldene Stunde erleben möchten, kommen Sie im Sommer: Das Boarding beginnt um 19:30, und von Mai bis August geht die Sonne genau zur Abfahrt um 20:30 unter — dieselbe Cruise deckt beides ab.' },
  ...
  'istanbul-boat-tour': {
    ...
    highlights: [
      ...
      { title: 'Abendabfahrt (beste Beleuchtung)', desc: 'Abfahrt 20:30 erfasst den Bosporus voll beleuchtet — Brücken, Paläste, Moscheen alle erleuchtet. Dramatischer als Tagestouren, die dieselben Wahrzeichen bei flachem Licht zeigen.' },
    ...
    faq: [
      ...
      { q: 'Wie lange dauert die Istanbul-Bootstour?', a: '3 Stunden. Einsteigen ab 19:30 am Kabataş-Pier, Abfahrt 20:30, Rückkehr ~23:30. Deckt den kompletten Bosporus von Dolmabahçe nach Rumeli Hisarı und zurück ab. Genug Zeit für ein komplettes Dinner + Show, ohne müde zu werden.' },
      { q: 'Wie viel kostet eine Istanbul-Bootstour?', a: 'Unsere Dinner-Bootstour: €{p.dinnerStd}/Person (vorher €{p.dinnerStdOriginal}). 0–3 Jahre gratis, 4–8 Jahre halber Preis. Zahlung an Bord. Alkohol und Hoteltransfer sind optionale Extras.' },
  ...
  'bosphorus-trip': {
    ...
    faq: [
      ...
      { q: 'Wie lange dauert ein Bosporus-Ausflug?', a: 'Unser Bosporus-Ausflug dauert insgesamt 3 Stunden (Abfahrt 20:30, Rückkehr 23:30). Es gibt kürzere Optionen (1-stündige Sightseeing-Fähren, 90-minütige Touren), aber sie lassen Dinner und Unterhaltung aus. Für das komplette Abenderlebnis sind 3 Stunden ideal — genug, um alles zu sehen, ohne müde zu werden.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    highlights: [
      ...
      { title: 'Bestätigung in weniger als 1 Minute', desc: 'Assistent ausfüllen → wir bestätigen per WhatsApp / Telegram. Kein E-Mail-PDF-Gutschein zum Drucken. Unsere Nachricht ist Ihr Ticket. Kommen Sie um 19:30 zum Pier.' },
    ...
    faq: [
      { q: 'Wie viel kosten Bosporus-Cruise-Tickets?', a: '€{p.dinnerStd}/Person (regulär €{p.dinnerStdOriginal}). 3-stündige Tour, mehrgängiges türkisches Dinner, Live-Folkloreshow, unbegrenzte alkoholfreie Getränke inklusive. 0–3 Jahre gratis, 4–8 Jahre 50 % Ermäßigung. Zahlung an Bord — keine Vorauszahlung.' },
      ...
      { q: 'Sind Bosporus-Cruise-Tickets am selben Tag verfügbar?', a: 'Oft ja, besonders an Wochentagen. Wochenenden und Feiertage füllen sich schneller. Überprüfen Sie die Verfügbarkeit über den Buchungsassistenten — er wird in Echtzeit aktualisiert. Gleichtagsbuchungen sind typischerweise bis ein paar Stunden vor der 20:30-Abfahrt möglich. WhatsApp für dringende Anfragen.' },
      { q: 'Sind Kinder-Bosporus-Cruise-Tickets gratis?', a: 'Kinder **0–3 Jahre komplett gratis** (keine Gebühr, keine versteckten Kosten, Transfer inklusive). **4–8 Jahre 50 % Ermäßigung** (€{p.dinnerStd}/2 = €12.15). **Ab 9 Jahren voller Erwachsenenpreis.** Preise sind nach oben begrenzt und transparent — keine „Säuglingsaufschlag“-Tricks.' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    ...
    intro: [
      'Sind Sie heute Nachmittag in Istanbul gelandet und möchten heute Abend einen tollen Abend? Eine **Last-Minute Bosporus-Cruise** funktioniert. Wir wissen, dass viele Reisende morgens entscheiden, daher reservieren wir speziell Plätze für Gleichtagsbuchungen. Füllen Sie den Assistenten hier aus, wir bestätigen innerhalb von Minuten per WhatsApp, Sie erscheinen um 19:30 am Kabataş-Pier, Sie zahlen an Bord, Sie genießen.',
      'Unsere **Last-Minute Bosporus-Cruise** hat das gleiche Abendprogramm wie Vorausbuchungen: 3 Stunden auf dem Wasser (20:30–23:30), mehrgängiges türkisches Dinner, Live-Folkloreshow, Sema, orientalischer Tanz, DJ. Beleuchteter Dolmabahçe-Palast, Ortaköy-Moschee, Bosporus-Brücke — dieselben ikonischen Ansichten. Gleicher Preis: €{p.dinnerStd}/Person.',
    ...
    highlights: [
      ...
      { title: 'Gleichtags-Hoteltransfer oft verfügbar', desc: 'Hoteltransfer erfordert normalerweise 24-stündige Vorankündigung, aber für Gleichtagsbuchungen zwischen 14:00 und 18:00 können wir typischerweise eine Abholung für +€{p.transfer}/Person arrangieren. WhatsApp für dringende Transferanfragen.' }
    ],
    faq: [
      ...
      { q: 'Können Sie Last-Minute-Hoteltransfer arrangieren?', a: 'Gleichtagstransfer ist typischerweise möglich bis ~18:00 für die 20:30-Tour. Nach 18:00 haben wir möglicherweise keinen Fahrer verfügbar — in diesem Fall können Sie ein Taxi zum Kabataş-Pier nehmen (15 Min. vom Taksim, 10 Min. vom Sultanahmet, ~€10–15). Zentral und einfach.' },
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Istanbul Bosporus-Kreuzfahrt-Preise: Dinner-Cruise €{p.dinnerStd}/Person. Kinder 0-3 frei, 4-8 halber Preis. Add-ons transparent.'
    },
    hero: {
    ...
    faq: [
      { q: 'Wie viel kostet eine Istanbul-Cruise?', a: 'Dinner-Cruise: €{p.dinnerStd}/Person (regulär €{p.dinnerStdOriginal}, 40 % Rabatt). 0–3 Jahre gratis, 4–8 Jahre halber Preis. Zahlung an Bord — keine Vorauszahlung. Kostenlose Stornierung bis 2 Stunden vor Abfahrt.' },
