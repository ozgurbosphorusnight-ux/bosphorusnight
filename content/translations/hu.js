...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Hogyan foglalhatom a VIP Boszporusz hajóutat?', a: 'Használja a foglalási űrlapot ezen az oldalon — válassza a "VIP"-t az 1. lépésben, állítsa be a dátumot, írja be a vendégek számát, majd a kapcsolati adatokat. Kérése WhatsAppon / Telegramon érkezik, és azonnal megerősítjük. Fizetés a fedélzeten, nem most.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    intro: [
      ...
      'A **Boszporusz hajóút jegyek** folyamatunk: töltse ki az űrlapot ezen az oldalon kevesebb mint 1 perc alatt (dátum, vendégek száma, csomag, kapcsolat), azonnal megerősítjük WhatsApp / Telegram-en, megjelenik a Kabataş kikötőnél 19:30-kor, fizet a fedélzeten, élvezi a 3 órás vacsorás hajóutat. Nincs nyomtatandó fizikai jegy, nincs e-mailben kapott kupon — a megerősítés az Ön jegye.',
    ...
    highlights: [
      ...
      { title: 'Megerősítés kevesebb mint 1 perc alatt', desc: 'Töltse ki az űrlapot → megerősítjük WhatsApp / Telegram-en. Nincs PDF kuponmail nyomtatáshoz. Az üzenetünk az Ön jegye. Jöjjön a kikötőhöz 19:30-ra.' },
