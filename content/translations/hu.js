...
module.exports = {
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      ...
      { q: 'Mennyibe kerül egy 4 fős muszlim családnak (2 felnőtt, 2 gyerek)?', a: 'Vacsorás hajóút: 2 × €{p.dinnerStd} + 2 × €12.15 (fél ár 4-8 év) = €72.90. Ha a gyerekek 3 év alattiak, ingyenes: 2 × €{p.dinnerStd} = €48.60. Adjon hozzá €{p.transfer} szállodai transzfert felnőttenként. Összesen: €48.60–€92.90 a 4 fős családnak, nincs előzetes fizetés, fizetés a fedélzeten.' },
  ...
  'last-minute-bosphorus': {
    ...
    faq: [
      { q: 'Valóban lefoglalhatom a Boszporusz hajóutat ma estére?', a: 'Igen — gyakran. Aznapi foglalásokhoz helyeket tartunk fenn. Ellenőrizze a fenti űrlapot a ma esti elérhetőségért. Ha vannak elérhető helyek, 20:00-ig foglalhat. A hétvégék mozgalmasabbak — foglaljon korábban a nap folyamán, ha lehet.' },
      { q: 'Mennyire last minute foglalhatok?', a: 'A foglalások 20:00-ig nyitva maradnak a 21:00-as hajóra. 20:00 után írjon nekünk közvetlenül WhatsApp-on a +90 532 244 29 22-es számon — ha vannak szabad helyek, manuálisan megerősíthetünk.' },
