...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    ...
    faq: [
      ...
      { q: 'Mennyibe kerül a Boszporusz vacsorás hajóút?', a: 'Vacsorás hajóút €{p.dinnerStd}/fő (normál ár €{p.dinnerStdOriginal}). 0-3 év ingyenes, 4-8 év 50% kedvezmény. Fizetés a fedélzeten — nincs előzetes fizetés.' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Bor, pezsgő, prémium párosítások', desc: 'Adja hozzá a 2 pohár alkohol csomagot (+€{p.alcohol2}/fő) — helyi bor, sör vagy rakı. Importált pezsgő és prémium párosítások kérésre — kérdezzen a foglaláskor.' }
    ],
    faq: [
      ...
      { q: 'Mennyibe kerül a romantikus hajóút 2 főre?', a: '2 fő: 2 × €{p.dinnerStd} = €48.60,60. Adja hozzá a romantikus elrendezést +€{p.romantic} = €63,60. Nincs előzetes fizetés — fizetés a fedélzeten. 2 pohár alkohol csomag kettőnek: további 2 × €{p.alcohol2} = €20.' },
  ...
  'halal-bosphorus-cruise': {
    ...
    faq: [
      ...
      { q: 'Mennyibe kerül egy 4 fős muszlim családnak (2 felnőtt, 2 gyerek)?', a: 'Vacsorás hajóút: 2 × €{p.dinnerStd} + 2 × €12.15 (fél ár 4-8 év) = €72.90,60. Ha a gyerekek 3 év alattiak, ingyenes: 2 × €{p.dinnerStd} = €48.60,60. Adjon hozzá €{p.transfer} szállodai transzfert felnőttenként. Összesen: €48.60–€92.90 a 4 fős családnak, nincs előzetes fizetés, fizetés a fedélzeten.' },
  ...
  'bosphorus-vip': {
    ...
    hero: {
      ...
      subtitle: 'Egy menü, egy színvonal: prémium mindenkinek. Háromórás boszporuszi este az AMOR fedélzetén — bőséges török vacsora, élő színpadi műsor, és igény szerint privát asztal a színpad mellett. Nem árulunk külön „VIP osztályt“ — a legjobbat adjuk minden vendégnek.',
      badge: '40% KEDVEZMÉNY · Egy menü, prémium színvonal · Fizetés a hajón'
    },
    intro: [
      'A Boszporuszon sok hajó „standard“ és „VIP“ kategóriára osztja a vendégeit. Mi nem. Az **AMOR** fedélzetén egyetlen vacsoramenü van, amelyet mindenkinek ugyanolyan gondossággal készítünk el: 10 fajta török meze, meleg előétel, választható főétel (lazac, tengeri sügér, csirke vagy köfte), fagylalttorta és korlátlan üdítő. A teljes műsor is benne van — kerengő dervisek szertartása, 5 néptánc, hastánc, élő zene és DJ — mindez a €{p.dinnerStd}/fő árban.',
      ...
      'Az AMOR modern hajó: 42 méter hosszú, 3 fedélzetes, akár 400 vendéget fogad, télen fűtött, nyáron légkondicionált. A háromórás útvonal Kabataşból indul (beszállás 19:30-tól, indulás 20:30, visszaérkezés 23:30), elhalad a Dolmabahçe, az Ortaköy mecset, a Rumeli erőd és a Boszporusz híd fényei mellett. TÜRSAB engedéllyel (A-17672), 4,9★ a Google-on. Nincs előre fizetés — a hajón fizet, és az indulás előtt 2 órával még ingyenesen lemondhat.'
    ],
    highlights: [
    ...
    faq: [
      ...
      { q: 'Mi van a menüben?', a: '10 fajta török meze, meleg előétel, választható főétel (lazac, tengeri sügér, csirke vagy köfte) és fagylalttorta desszertnek, korlátlan üdítővel. A műsor benne van: dervisek szertartása, 5 néptánc, hastánc, élő zene és DJ.' },
      { q: 'Az alkohol benne van az árban?', a: 'Nem — az alkohol külön kiegészítő: 2 pohár helyi bor vagy sör +€{p.alcohol2}/fő áron. Az üdítők korlátlanul és ingyenesen benne vannak. A prémium importitalokat a hajón külön számoljuk el.' },
      ...
      { q: 'Milyen hajó ez?', a: 'AMOR — modern személyszállító hajó, 42 méter hosszú, 3 fedélzetes, 400 fő befogadóképességgel, télen fűtött, nyáron légkondicionált. Indulás a kabataşi kikötőből: beszállás 19:30, indulás 20:30, visszaérkezés 23:30. Útvonal: Dolmabahçe, Ortaköy, Rumeli erőd, Beylerbeyi és a Boszporusz híd fényei.' }
    ],
    cta: {
  ...
  'bosphorus-for-couples': {
    ...
    highlights: [
      ...
      { title: 'Kiegészítők különleges estékhez', desc: 'Romantikus asztali elrendezés (gyertyák, rózsák): +€{p.romantic}. 2 pohár alkohol (bor, sör vagy rakı): +€{p.alcohol2}/fő. Szállodai transzfer (oda-vissza): +€{p.transfer}/fő. Válassza, ami illik az estéjéhez.' }
    ],
    faq: [
      ...
      { q: 'Mennyibe kerül a Boszporusz hajóút 2 főre?', a: '2 fő: 2 × €{p.dinnerStd} = €48.60,60. Adjon hozzá szállodai transzfert kettőnek: +€{p.transfer}×2 = €10. Adja hozzá a 2 pohár alkohol csomagot kettőnek: +€{p.alcohol2}×2 = €20. Nincs előzetes fizetés — fizetés a fedélzeten.' },
      { q: 'Hozhatnak a párok saját bort vagy pezsgőt?', a: 'Nem engedélyezünk külső alkoholt (működési engedélyezési okokból). De van 2 pohár helyi bor vagy sör csomagunk (+€{p.alcohol2}/fő) és tudunk importált prémium borokat vagy pezsgőt szervezni díjazás ellenében — kérdezzen a foglaláskor. A Prosecco, Chianti és Cabernet a népszerű prémium kérések.' },
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Mennyibe kerül a Boszporusz naplemente hajóút?', a: '€{p.dinnerStd}/főtől a hajóútnál (3 óra, teljes vacsora, élő szórakozás). Fizetés a fedélzeten — nincs előzetes fizetés. 0-3 év ingyenes, 4-8 év fél áron.' },
  ...
  'bosphorus-night-tour': {
    ...
    faq: [
      ...
      { q: 'Mennyibe kerül a Boszporusz éjszakai túra?', a: 'Éjszakai túra (3 óra, vacsora, show): €{p.dinnerStd}/fő (korábban €{p.dinnerStdOriginal}). 0-3 év ingyenes, 4-8 év fél áron. Fizetés a fedélzeten.' },
  ...
  'istanbul-boat-tour': {
    ...
    faq: [
      ...
      { q: 'Mennyibe kerül a hajós túra Isztambulban?', a: 'Hajós túránk vacsorával: €{p.dinnerStd}/fő (korábban €{p.dinnerStdOriginal}). 0-3 év ingyenes, 4-8 év fél áron. Fizetés a fedélzeten. Az alkohol és a szállodai transzfer opcionális kiegészítők.' },
  ...
  'bosphorus-cruise-tickets': {
    ...
    intro: [
      ...
      'A **Boszporusz hajóút jegyek** folyamatunk: töltse ki az űrlapot ezen az oldalon kevesebb mint 1 perc alatt (dátum, vendégek száma, kapcsolat), azonnal megerősítjük WhatsApp / Telegram-en, megjelenik a Kabataş kikötőnél 19:30-kor, fizet a fedélzeten, élvezi a 3 órás vacsorás hajóutat. Nincs nyomtatandó fizikai jegy, nincs e-mailben kapott kupon — a megerősítés az Ön jegye.',
    ...
    faq: [
      { q: 'Mennyibe kerülnek a Boszporusz hajóút jegyek?', a: '€{p.dinnerStd}/fő (normál €{p.dinnerStdOriginal}). Tartalmazza a 3 órás túrát, török többfogásos vacsorát, élő népi tánc show-t, korlátlan üdítőket. 0-3 év ingyenes, 4-8 év 50% kedvezmény. Fizetés a fedélzeten — nincs előzetes fizetés.' },
      ...
      { q: 'A Boszporusz hajóút jegyek gyerekeknek ingyenesek?', a: 'Gyerekek **0-3 év teljesen ingyenes** (nincs díj, nincs rejtett költség, transzfer beleértve). **4-8 év 50% kedvezmény** (€{p.dinnerStd}/2 = €12,15). **9+ év teljes felnőtt ár.** Fix és átlátható árak — nincsenek "baba felár" trükkök.' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    ...
    intro: [
      ...
      '**A Boszporusz hajóútunk last minute** ugyanazt az esti programot kínálja, mint az előzetes foglalások: 3 óra a vízen (20:30-23:30), török többfogásos vacsora, élő népi tánc show, sema, keleti tánc, DJ. Kivilágított Dolmabahçe-palota, Ortaköy-mecset, Boszporusz-híd — ugyanazok az ikonikus kilátások. Ugyanaz az ár: €{p.dinnerStd}/fő.',
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Boszporusz hajóút árak Isztambul: €{p.dinnerStd}/fő. Gyerekek 0-3 ingyenes, 4-8 fél áron. Átlátható kiegészítők.'
    },
    hero: {
    ...
    faq: [
      { q: 'Mennyibe kerül egy túra Isztambulban?', a: 'Vacsorás hajóút: €{p.dinnerStd}/fő (normál €{p.dinnerStdOriginal}, 40% kedvezmény). 0-3 év ingyenes, 4-8 év fél áron. Fizetés a fedélzeten — nincs előzetes fizetés. Ingyenes lemondás indulás előtt 2 óráig.' },
