...
module.exports = {
  ...
  'bosphorus-dinner-cruise': {
    meta: {
      ...
      description: 'Vacsorás hajóút 3 órán át a Boszporuszon: török többfogásos menü és élő folklór show. Indulás 20:30 Kabataşból. Ingyenes lemondás, fizetés a fedélzeten.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Élő népi táncok, keleti tánc és DJ', desc: 'Mevlana sema előadás, 5 hagyományos török népi tánc, klasszikus keleti tánc, élő török zenészek, ezt követi egy DJ szett az egész hajóút alatt.' },
      ...
      { title: '€{p.dinnerStd}-tól/fő — fizetés a fedélzeten', desc: 'Standard hajóút €{p.dinnerStd} (korábban €{p.dinnerStdOriginal}). VIP hajóút színpad előtti hellyel és prémium menüvel €{p.dinnerVip}. Nincs előzetes fizetés. Ingyenes lemondás indulás előtt 2 óráig.' }
    ],
    faq: [
      { q: 'Mikor kezdődik a Boszporusz vacsorás hajóút?', a: 'A beszállás 19:30-kor kezdődik a Kabataş kikötőnél. A hajó 20:30-kor indul és körülbelül 23:30-kor tér vissza. Ajánljuk, hogy 15-20 perccel korábban érkezzen, hogy elhelyezkedjen és pihenjen.' },
      { q: 'Mennyibe kerül a Boszporusz vacsorás hajóút?', a: 'Standard hajóút €{p.dinnerStd}/fő (normál ár €{p.dinnerStdOriginal}). VIP hajóút színpad előtti hellyel és prémium menüvel €{p.dinnerVip}/fő. 0-3 év ingyenes, 4-8 év 50% kedvezmény. Fizetés a fedélzeten — nincs előzetes fizetés.' },
      { q: 'Az alkohol benne van a vacsorás hajóútban?', a: 'A korlátlan üdítők (víz, kóla, gyümölcslé) benne vannak az árban. Az alkoholcsomagok opcionálisak: 2 pohár +€{p.alcohol2}/fő vagy korlátlan helyi alkohol (bor, sör, rakı, vodka, gin) +€{p.unlimited}/fő. Az importált italokat külön számoljuk a fedélzeten.' },
      { q: 'Van szállodai transzfer?', a: 'Igen — a felvétel és visszaszállítás szolgáltatás +€{p.transfer}/fő. Kiszolgált zónák: Beşiktaş, Taksim, Sultanahmet, Sirkeci, Eminönü, Ortaköy, Beyoğlu, Fatih, Laleli, Topkapı, Kağıthane és Sütlüce. Ezt az opciót a foglalási űrlapon választhatja ki.' },
  ...
  'bosphorus-with-kids': {
    meta: {
      ...
      description: 'Boszporusz vacsorás hajóút családbarát. Gyerekek 0-3 ingyenes, 4-8 fél áron. Biztonságos belső tér, gyerekmenü.'
    },
    hero: {
    ...
    highlights: [
      { title: '0-3 év teljesen ingyenes', desc: 'Nincs díj a csecsemőkért és kisgyermekekért. 4-8 év 50%-ot fizet a felnőtt árból. 9 éves kortól vendég teljes árral. Átlátható, meglepetés nélkül.' },
      ...
      { title: 'Biztonságos családi szórakozás', desc: 'Sema előadás (lenyűgöző a gyerekeknek), 5 hagyományos népi tánc, élő török zene és DJ szett. Minden családbarát — nincs felnőtt tartalom. A gyerekek gyakran csatlakoznak a tánchoz.' }
    ],
    faq: [
      ...
      { q: 'Mi az ár a gyerekeknek a Boszporusz hajóútra?', a: 'Gyerekek **0-3 év: INGYENES** (nincs díj, nincs rejtett költség). **4-8 év: 50% kedvezmény** a felnőtt árból — vagyis €12/gyerek Standardon (€{p.dinnerStd}/2). **9+ év: teljes felnőtt ár.** A szállodai transzfer ingyenes 0-3 évig, standard 4+ esetén (€{p.transfer}/fő).' },
  ...
  'romantic-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Bor, pezsgő, prémium párosítások', desc: 'Adjon hozzá 2 pohár alkoholt (+€{p.alcohol2}/fő) vagy korlátlan helyi bort, sört, rakıt (+€{p.unlimited}/fő). Importált pezsgő és prémium párosítások kérésre — kérdezzen a foglaláskor.' }
    ],
    faq: [
      ...
      { q: 'Mennyibe kerül a romantikus hajóút 2 főre?', a: '2 fő Standard: 2 × €{p.dinnerStd} = €48,60. Adja hozzá a romantikus elrendezést +€{p.romantic} = €63,60. 2 fő VIP: 2 × €{p.dinnerVip} = €110,40 + romantikus elrendezés €{p.romantic} = €125,40. Nincs előzetes fizetés — fizetés a fedélzeten. Korlátlan alkohol további 2 × €{p.unlimited} = €60.' },
  ...
  'halal-bosphorus-cruise': {
    ...
    highlights: [
      { title: '100% halal tanúsítvánnyal rendelkező menü', desc: 'Az összes hús (lazac, tengeri sügér, csirke, húsgombóc, marhahús, ribeye) halal tanúsítvánnyal rendelkezik jóváhagyott beszállítóktól. A konyha követi a halal elkészítést. Nincsenek sertéshústermékek vagy nem halal adalékanyagok. A vegetáriánus opciók mindig elérhetők.' },
      ...
      { title: 'Tisztelet az imaidők iránt', desc: 'Ha a beszállás egybeesik a maghribbal vagy ishával (19:30-20:30), a személyzetünk a csendes imazónába vezetheti Önt a Kabataş kikötőben az indulás előtt. Csak szóljon a foglaláskor.' }
    ],
    faq: [
      { q: 'A Boszporusz hajóút 100% halal?', a: 'Igen — minden hústermék a menüben (hal, csirke, húsgombóc, marhabélszín, ribeye, bárány) halal tanúsítvánnyal rendelkezik jóváhagyott beszállítóktól. A konyha követi a halal elkészítési szabványokat. Sehol nem szolgálnak fel sertéshúst a fedélzeten. Ez nem egy "halal opció" — az egész menü halal.' },
      { q: 'Más vendégek alkoholt isznak a fedélzeten?', a: 'Néhány vendég hozzáadja az opcionális alkoholcsomagot (+€{p.unlimited}/fő). Az asztalok természetesen el vannak választva — kérhet alkoholmentes zónát. A személyzet nem hoz alkoholt, hacsak egy vendég kifejezetten meg nem rendeli. Az üdítők (korlátlanok) mindenki számára benne vannak.' },
      { q: 'Ez a hajóút alkalmas muszlim családoknak gyerekekkel?', a: 'Igen — ez Isztambul egyik legtiszteltebb hajóútja a családok számára. A szórakozás szerény (népi táncok, sema, török zene), a 3 év alatti gyerekek ingyenesek, 4-8 év 50% kedvezményt kap. Nincs éjszakai klub légkör. Az Öbölből, Indonéziából, Malajziából, Pakisztánból és Marokkóból származó családok rendszeresen foglalják ezt a hajóutat.' },
      { q: 'Imádkozhatok a fedélzeten?', a: 'A fedélzeten nincs dedikált imahelyiség, de javasoljuk, hogy a 19:30-as beszállás előtt imádkozzon (a maghrib ima gyakran egybeesik ezzel az időtartammal). A Kabataş kikötőben vannak imaeszközök. Ha a 20:30-23:30 közötti vitorlázás során kell imádkoznia (isha), beszéljen a személyzettel — el tudunk rendezni egy csendes sarkot a fedélzeten.' },
      { q: 'Mennyibe kerül egy 4 fős muszlim családnak (2 felnőtt, 2 gyerek)?', a: 'Standard hajóút: 2 × €{p.dinnerStd} + 2 × €12 (fél ár 4-8 év) = €72,60. Ha a gyerekek 3 év alattiak, ingyenes: 2 × €{p.dinnerStd} = €48,60. Adjon hozzá €{p.transfer} szállodai transzfert felnőttenként. Összesen: €48-92 a 4 fős családnak, nincs előzetes fizetés, fizetés a fedélzeten.' },
      { q: 'A szállodai transzfer is halal?', a: 'A szállodai transzfer csak egy autóút — nincs étel vagy ital, tehát nincs halal aggodalom. Sofőrjeink professzionálisak, tisztelettudóak és pontosak. A transzferzónák lefedik a Sultanahmetet, Taksimot, Beşiktaşt, Lalelit, Fatihot és 8 másik központi negyedet, ahol a muszlim utazók általában megszállnak.' }
    ],
    cta: {
  ...
  'bosphorus-vip': {
    meta: {
      title: 'VIP Boszporusz Hajóút €{p.dinnerVip}-tól — Prémium Vacsora, VIP Hely',
      description: 'VIP Boszporusz vacsorás hajóút: prémium mezze, steak opciók, asztal a színpad előtt, prioritásos kiszolgálás. Korábban €{p.dinnerVipOriginal}, most €{p.dinnerVip}.'
    },
    hero: {
      h1: 'VIP Boszporusz Hajóút',
      subtitle: 'Színpad előtti helyek, prémium török menü steak opciókkal és prioritásos kiszolgálás — egy este a Boszporuszon magasabb szinten az utazóknak, akik a legjobb étkezést szeretnék a fedélzeten.',
      badge: 'Legnépszerűbb · 40% KEDVEZMÉNY · Helyek Elöl'
    },
    intro: [
      '**A VIP Boszporusz hajóút** a legjobb helyekre helyezi Önt a fedélzeten: asztalok a színpad előtt közvetlen kilátással a sema előadásra, a népi táncokra, a keleti táncra és az élő zenére. A prémium menü hozzáadja a marhabélszínt és a ribeye-t a főétel választásokhoz (a Standardnál csirke/lazac helyett), plusz 15+ fajta hagyományos török mezzét, bőséges elrendezésben felszolgálva.',
      '**A VIP Boszporusz vacsorás hajóutat** a vendégeink Legnépszerűbbnek nevezték — mert €{p.dinnerVip}/főnél (korábban €{p.dinnerVipOriginal}, 40% kedvezmény) az élmény inkább egy fine dining étterem, mint egy turisztikai túra. Privát asztal, figyelmes pincér kiszolgálás és ugyanazok a látványos kilátások a Dolmabahçe-re, az Ortaköy-mecsetre és a kivilágított Boszporusz-hídra.',
      'Akár üzleti utazó, akár fontos eseményt ünnepel, akár arra gondol, hogy "egyszer vagyunk Isztambulban — csináljunk mindent rendesen", ez **a VIP Boszporusz hajóút**, amelyet visszatérő látogatók foglalnak. TÜRSAB engedéllyel, 4,8★ 11.317+ értékeléssel, fizetés a fedélzeten, ingyenes lemondás indulás előtt 2 óráig.'
    ],
    highlights: [
      { title: 'Privát asztal a színpad előtt', desc: 'Közvetlenül a show színpadja előtt fenntartott helyek — a legjobb kilátás a sema előadásra, a népi táncokra és a keleti táncra. Az Ön asztala, nem megosztva. A fotósok szeretik ezeket a helyeket.' },
      { title: '15+ mezze + prémium főételek', desc: '15+ fajta török mezze hagyományos elrendezésben felszolgálva. A főétel választások közé tartozik a marhabélszín és a ribeye (a Standardon csak csirke/lazac). Ugyanaz a desszert és korlátlan üdítők.' },
      { title: 'Prioritásos pincér kiszolgálás', desc: 'Egy dedikált pincér szolgálja ki először az Ön asztalát — utántöltések, menü útmutatás, alkohol kiegészítők koordinálása, különleges kérések. Ne küzdjön a figyelemért egy zsúfolt szobában.' },
      { title: '40% KEDVEZMÉNY — korábban €{p.dinnerVipOriginal}, most €{p.dinnerVip}', desc: 'Normál ár €{p.dinnerVipOriginal}/fő. Jelenlegi bevezető ár €{p.dinnerVip}/fő — 40% kedvezmény. Fizetés a fedélzeten, nincs előzetes fizetés. Ingyenes lemondás indulás előtt 2 óráig.' }
    ],
    faq: [
      { q: 'Mi a különbség a VIP és a Standard Boszporusz hajóút között?', a: 'A VIP a következőket kapja: (1) színpad előtti helyek a legjobb kilátással, (2) 15+ mezze a Standardon lévő 10 helyett, (3) marhabélszín + ribeye hozzáadva a főétel opciókhoz, (4) prioritásos pincér kiszolgálás. Ugyanaz a 3 órás túra, ugyanaz a szórakozás, ugyanaz az útvonal. €{p.dinnerVip} szemben €{p.dinnerStd}.' },
      { q: 'A VIP ár €{p.dinnerVip} valóban 40% kedvezmény?', a: 'Igen — a normál ár €{p.dinnerVipOriginal}/fő (ellenőrizze bármely foglalási oldalon). Mi €{p.dinnerVip}-t alkalmazunk közvetlen foglalási árként, csökkentve a közvetítői díjakat. VIP-t kap kevesebbért, mint amennyit a legtöbb hely a Standardért kér.' },
      { q: 'Az alkohol benne van a VIP hajóútban?', a: 'Nem — az alkohol külön kiegészítő (mint a Standardnál is). 2 pohár: +€{p.alcohol2}/fő. Korlátlan helyi alkohol (bor, sör, rakı, vodka, gin): +€{p.unlimited}/fő. Az importált prémium italokat külön számoljuk. A korlátlan üdítők benne vannak és ingyenesek.' },
      { q: 'Frissíthetek VIP-re, miután felszálltam a Standard hajóra?', a: 'Az elérhetőségtől függ — ha a VIP asztalok szabadok, igen. Fizesse a különbséget (€{p.dinnerVip} - €{p.dinnerStd}) a fedélzeten. De javasoljuk, hogy a VIP-t előre foglalja: a legjobb színpad előtti helyek az előzetes foglalásokhoz mennek.' },
      { q: 'Hogyan foglalhatom a VIP Boszporusz hajóutat?', a: 'Használja a foglalási űrlapot ezen az oldalon — válassza a "VIP"-t az 1. lépésben, állítsa be a dátumot, írja be a vendégek számát, majd a kapcsolati adatokat. Kérése WhatsAppon / Telegramon / WeChaton érkezik, és azonnal megerősítjük. Fizetés a fedélzeten, nem most.' },
      { q: 'A VIP hajóút alkalmas üzleti vacsorához ügyfelekkel?', a: 'Igen — a VIP a leggyakoribb választás üzleti vacsorákhoz Isztambulban. Privát asztal, eléggé csendes a beszélgetéshez, lenyűgöző menü és kilátások. Sok vendég foglal VIP + korlátlan alkoholt az ügyfelek fogadásához. Halal tanúsítvánnyal (jó az Öbölből érkező üzleti utazóknak). Szóljon a foglaláskor, csendesebb VIP asztalt rendezünk be hátul.' }
    ],
    cta: {
      primary: 'Foglalja a VIP-t · Fizetés a Fedélzeten',
      secondary: 'Korábban €{p.dinnerVipOriginal}, most €{p.dinnerVip} · Ingyenes lemondás 2 órával előtte',
      tertiary: 'Lásd a Standard Opciót (€{p.dinnerStd})'
    }
  },
  ...
  'private-bosphorus-cruise': {
    ...
    highlights: [
      ...
      { title: 'Rugalmas időtartam és indulás', desc: 'A 3 standard órát 4-5 órára lehet meghosszabbítani. Válasszon nappali indulást 12:00-kor, naplementét 17:30-kor vagy estét 20:30-kor. Hétköznapot szeretne hétvége helyett? Nem probléma — alkalmazkodunk a programjához.' },
    ...
    faq: [
      { q: 'Mennyibe kerül egy privát Boszporusz hajóút?', a: '25+ csoportoknak általában €{p.dinnerStd}-€{p.dinnerVip}/fő + hajóbérlési díj a csoport méretétől, dátumától és időtartamától függően. Írjon nekünk WhatsAppon a csoport méretével, dátumával és követelményeivel — egy órán belül árat adunk. A legtöbb esemény az összesen €2.000-€6.000 tartományba esik.' },
      { q: 'Mi a minimális csoportméret egy privát Boszporusz hajóúthoz?', a: 'Technikailag 25 vendég teszi gazdaságilag megvalósíthatóvá a privát hajóutat. A kisebb csoportok (10-24) privát bérelhetnek, de ~25 főnek megfelelő minimális árat fizetnek. Igazán kis csoportoknak (2-10) vegye figyelembe a szokásos Standard vagy VIP hajóutat — az Ön asztala már privát, csak a hajó megosztott.' },
  ...
  'bosphorus-for-couples': {
    ...
    highlights: [
      ...
      { title: 'Kiegészítők különleges estékhez', desc: 'Romantikus asztali elrendezés (gyertyák, rózsák): +€{p.romantic}. Korlátlan helyi alkohol (bor, rakı): +€{p.unlimited}/fő. Szállodai transzfer (oda-vissza): +€{p.transfer}/fő. Válassza, ami illik az estéjéhez.' }
    ],
    faq: [
      ...
      { q: 'Mennyibe kerül a Boszporusz hajóút 2 főre?', a: '2 fő Standard: 2 × €{p.dinnerStd} = €48,60. 2 fő VIP: 2 × €{p.dinnerVip} = €110,40. Adjon hozzá szállodai transzfert kettőnek: +€{p.transfer}×2 = €20. Adjon hozzá korlátlan alkoholt kettőnek: +€{p.unlimited}×2 = €60. Nincs előzetes fizetés — fizetés a fedélzeten.' },
      { q: 'Hozhatnak a párok saját bort vagy pezsgőt?', a: 'Nem engedélyezünk külső alkoholt (működési engedélyezési okokból). De van korlátlan helyi borunk (+€{p.unlimited}/fő) és tudunk importált prémium borokat vagy pezsgőt szervezni díjazás ellenében — kérdezzen a foglaláskor. A Prosecco, Chianti és Cabernet a népszerű prémium kérések.' },
      ...
      { q: 'Mikor a legjobb a Boszporusz hajóút pároknak — naplemente vagy este?', a: 'Az este (indulás 20:30) a legikonikusabb — kivilágított hidak, tükröződések a vízen, kivilágított paloták. A naplemente (indulás 17:30) korábbi és aranyórás szépséget kínál, de a vacsorás hajóút kifejezetten 20:30-kor van. Ha mindkettőt szeretné, a legtöbb pár különböző napokon foglalja a naplemente és esti hajóutakat.' },
  ...
  'bosphorus-sunset-cruise': {
    meta: {
      title: 'Boszporusz Naplemente Hajóút €35-től — Aranyóra + Vacsora',
      description: 'Boszporusz naplemente hajóút Kabataşból, indulás 17:30. Paloták arany fényben, folytatott vacsora a kivilágított éjszakában. 3 óra. Ingyenes lemondás, fizetés a fedélzeten.'
    },
    hero: {
      h1: 'Naplemente Hajóút a Boszporuszon',
      subtitle: 'A varázslatos óra a Boszporuszon — nézze, ahogy a nap lemegy a minaretek sziluettje mögött, miközben elhalad a Dolmabahçe, az Ortaköy-mecset és a Boszporusz-híd mellett, amely az éjszakára kigyúl.',
      badge: 'Aranyóra · Indulás 17:30 · Legjobb Fotók'
    },
    intro: [
      '**A Boszporusz naplemente hajóút** Isztambult a legfotogénebb pózában fogja meg. Szálljon fel 17:30-kor és 20 percen belül a nap elkezd lemenni az európai part minaretei mögött — aranyszínűre festve a Dolmabahçe-palotát, rézzé változtatva a Boszporusz vizét és az Ortaköy-mecsetet sziluetté téve a ragyogó ég ellen. Minden okostelefon fotó ezen a hajóúton professzionális filmnek tűnik.',
      '**A Boszporusz naplemente hajóutunk** teljes török vacsorát tartalmaz, amely az aranyóra alatt kezdődik és folytatódik, miközben a hidak az éjszakára kigyúlnak. A desszertig a kivilágított Boszporusz-híd alatt hajózik — 30 millió fény tükröződik a sötét vízben. A nappali-éjszakai átmenet, 3 órába csomagolva, minden.',
      'Akár az aranyórát üldöző fotós, akár a nap és éjszaka legjobbját akaró utazó, akár "az isztambuli pillanat fotóját" kereső pár — ez **a Boszporusz naplemente vacsorás hajóút** ajánlott a látogatóknak. 4,8★ értékelés, TÜRSAB engedéllyel, fizetés a fedélzeten, nincs előzetes fizetés.'
    ],
    highlights: [
      { title: 'Csúcs aranyóra — indulás 17:30', desc: 'Szálljon fel 17:30-kor, a naplemente nyáron 18:30 körül / télen 17:00 körül történik. A hajóút első 40 perce az aranyóra, amit üldöz. Kamera készen — ez a fotó.' },
      { title: 'Nappal-éjszaka átmenet beleértve', desc: 'Nem csak naplemente — alkonyatban hajózunk, majd a kivilágított Boszporuszon. Lássa a 3 különböző fényfázist egyetlen hajóúton: arany, kék óra és teljesen kivilágított éjszaka.' },
      { title: 'Teljes vacsora a hajóút alatt', desc: '10 fajta török mezze, meleg előétel, főétel (lazac, tengeri sügér, csirke, húsgombóc, vegetáriánus), fagylalttorta. Ugyanaz a minőségi menü, mint az esti hajóútnál, naplemente alatt felszolgálva.' },
      { title: 'Dolmabahçe, Ortaköy, Boszporusz-híd — minden ragyog', desc: 'Az útvonal elhalad a Dolmabahçe-palota (naplementekor arany), az Ortaköy-mecset (sziluettben kupola), a Boszporusz-híd (kigyúl), Rumeli Hisarı, Beylerbeyi-palota mellett. Minden nevezetesség a legjobb fényben.' }
    ],
    faq: [
      { q: 'Mikor indul a Boszporusz naplemente hajóút?', a: 'A beszállás 17:00-kor kezdődik, a hajó 17:30-kor indul, körülbelül 20:30-kor tér vissza. Ezt úgy rendezzük, hogy pontosan akkor történjen, amikor a nap lemegy a vízen — kissé változik a szezonnal (nyár 18:30, tél 17:00). Az indulást szezonálisan 15-30 perccel állítjuk be.' },
      { q: 'A Boszporusz naplemente hajóút ugyanaz, mint a vacsorás hajóút?', a: 'Hasonló, de különböző időpontokban. A naplemente hajóút 17:30-kor indul, a vacsorát a hajóút alatt szolgálják fel (aranyóra + kora este). A vacsorás hajóút 20:30-kor van — sötétedés után, tiszta éjszakai kilátások. Ugyanaz a hajó, ugyanaz a menü, ugyanaz a szórakozás — csak más megvilágítás. Néhány vendég mindkettőt elvégzi különböző napokon.' },
      { q: 'Mennyibe kerül a Boszporusz naplemente hajóút?', a: 'Standard naplemente hajóút €35/főtől (3 óra, teljes vacsora, élő szórakozás). VIP opció színpad előtti hellyel és prémium mezzével €55/fő. Fizetés a fedélzeten — nincs előzetes fizetés. 0-3 év ingyenes, 4-8 év fél áron.' },
      { q: 'A naplemente hajóút jobb, mint a vacsorás hajóút (esti)?', a: 'A "jobb" attól függ, mit szeretne. Naplemente = legjobb fotók, arany fény, lassabb tempó, korábbi este. Este = legikonikusabb fények (kivilágított hidak), legjobb szórakozás, későbbi vacsora. A fotósok a naplementét választják. Romantikus estére induló párok az estét választják. A gyerekes családok általában a naplementét választják (korán véget ér).' },
      { q: 'Mit vigyek a naplemente hajóútra?', a: 'Okostelefon vagy kamera a fotókhoz (az aranyóra könyörög). Könnyű kabát — a szél növekszik naplementekor és a fedélzet gyorsan hideggé válhat kora este. Napszemüveg az első 30 percben. Smart-casual öltözet — vacsorázik, de szigorú öltözködési kód nélkül.' },
      { q: 'Maradhatok a hajóúton, hogy lássam a kivilágított hidakat éjjel?', a: 'A naplemente hajóút 3 órás (17:30-20:30), tehát a végén látni fogja a teljesen kivilágított Boszporusz-hidat és a Leánytornyot. Ha a CSÚCS éjszakai kilátásokat szeretné (20:30-23:30, az összes étterem és emlékmű teljesen kivilágítva), foglalja a 20:30-as vacsorás hajóutat. A legjobb megoldás: foglalja mindkettőt különböző estékre.' }
    ],
    cta: {
      primary: 'Foglalja a Naplemente Hajóutat · Fizetés a Fedélzeten',
      secondary: 'Indulás 17:30 · Naplemente + vacsora beleértve · Ingyenes lemondás 2 órával előtte',
      tertiary: 'Lásd az Esti Vacsorás Hajóutat (20:30)'
    }
  },
  ...
  'bosphorus-night-tour': {
    meta: {
      ...
      description: 'Éjszakai túra 3 órán át a Boszporuszon vacsorával és élő show-val. Indulás 20:30 Kabataşból, kivilágított hidak. Ingyenes lemondás, fizetés a fedélzeten.'
    },
    hero: {
    ...
    intro: [
      ...
      '**A Boszporusz éjszakai túránk vacsorával** csomagolja a teljes ikonikus estét: 3 óra a vízen (20:30-23:30), török többfogásos vacsora, élő népi táncok (sema, 5 népi tánc, keleti tánc), élő zene és DJ szett, amely az éjszaka végéig életben tartja a fedélzetet. Minden vendég ugyanazt a programot kapja — nincs "alap" opció, amely kihagyja a legjobb részeket.',
    ...
    highlights: [
      { title: 'A kivilágított Boszporusz drámai csúcson', desc: 'A Boszporusz-híd színt változtat (kék, lila, arany), a paloták sárgán ragyognak, az Ortaköy-mecset tükröződik a sötét vízben. 20:30-23:30 maximális megvilágítás az összes isztambuli nevezetességhez.' },
      { title: 'Hagyományos török show a fedélzeten', desc: 'Sema előadás, 5 hagyományos népi tánc (Törökország különböző régióiból), keleti tánc, élő török zene, majd DJ szett. 40 perc show, majd folytatódik a zene + vacsora.' },
    ...
    faq: [
      { q: 'Mikor van a Boszporusz éjszakai túra?', a: 'Beszállás 19:30-tól a Kabataş kikötőben. A hajó 20:30-kor indul, körülbelül 23:30-kor tér vissza. Ajánljuk, hogy 20 perccel korábban érkezzen, hogy elhelyezkedjen és helyet válasszon.' },
      { q: 'Mennyibe kerül a Boszporusz éjszakai túra?', a: 'Standard éjszakai túra (3 óra, vacsora, show): €{p.dinnerStd}/fő (korábban €{p.dinnerStdOriginal}). VIP színpad előtti hellyel és prémium menüvel: €{p.dinnerVip}/fő (korábban €{p.dinnerVipOriginal}). 0-3 év ingyenes, 4-8 év fél áron. Fizetés a fedélzeten.' },
      ...
      { q: 'Boszporusz éjszakai túra vagy naplemente hajóút — melyik ér többet?', a: 'Éjszakai túra = kivilágított Isztambul, maximális fénydráma, teljes szórakozási program, a legikonikusabb fotók a kivilágított hidakról. Naplemente = aranyóra, lassabb tempó, 20:30-kor véget ér. Ha csak egyet csinál: az éjszakai túra ikonikusabb. Sokan mindkettőt csinálják különböző napokon.' },
      ...
      { q: 'Nem beszélek törökül — a túra angol?', a: 'A személyzet beszél angolul. A szórakozás (sema, népi táncok, zene) nem igényel nyelvet. A vacsora menüje angol. A foglalás WhatsApp / Telegram / WeChat-en több nyelven működik (angol, arab, orosz, német, francia, spanyol). Nincs szükség törökre.' }
    ],
    cta: {
      primary: 'Foglalja az Éjszakai Túrát · Fizetés a Fedélzeten',
      secondary: 'Indulás 20:30 · 3 óra · Vacsora + show beleértve · Ingyenes lemondás 2 órával előtte',
      tertiary: 'Elérhetőség Ma Este'
    }
  },
  ...
  'dinner-cruise-istanbul': {
    ...
    intro: [
      'Keres egy **vacsorás hajóutat Isztambulban**? Megtalálta, amit a legtöbb utazó ajánl. A 3 órás esténk a Boszporuszon teljes török többfogásos vacsorát, élő népi táncokat és a város legfotogénebb kilátásait egyesíti — mindezt egy kényelmes hajóról, amely 20:30-kor indul a Kabataş kikötőből.',
      'A **vacsorás hajóút Isztambulban** élménye: szálljon fel 19:30-kor, üljön le, nézze a Dolmabahçe-palotát, miközben indulunk, a vacsora elkezdődik, amikor megközelítjük az Ortaköy-mecsetet, a show elkezdődik (sema, népi táncok, keleti), és a desszertre a kivilágított Boszporusz-híd alatt van. Éjfélkor visszatér Kabataşba egy ikonikus fotókollázzsal és tele hassal.',
      '€{p.dinnerStd}/fő a standard hajóútért (korábban €{p.dinnerStdOriginal}) vagy €{p.dinnerVip}/fő a VIP-ért színpad előtti helyekkel (korábban €{p.dinnerVipOriginal}). Fizetés a fedélzeten — nincs előzetes fizetés, nincs kockázat. TÜRSAB A-17672 engedéllyel, 4,8★ értékeléssel több mint 11.317 utazótól.'
    ],
    highlights: [
      ...
      { title: 'Élő török népi tánc show', desc: 'Sema előadás, 5 hagyományos népi tánc, keleti tánc, élő török zene, DJ. 40 perc show, folyamatos háttérzene.' },
      ...
      { title: '€{p.dinnerStd}-tól — fizetés a fedélzeten', desc: 'Standard: €{p.dinnerStd} (korábban €{p.dinnerStdOriginal}). VIP prémium menüvel: €{p.dinnerVip} (korábban €{p.dinnerVipOriginal}). Nincs előzetes fizetés. Ingyenes lemondás indulás előtt 2 óráig.' }
    ],
    faq: [
      { q: 'Mennyibe kerül a vacsorás hajóút Isztambulban?', a: 'Standard vacsorás hajóútunk €{p.dinnerStd}/fő (normál ár €{p.dinnerStdOriginal}). VIP színpad előtti hellyel és prémium menüvel €{p.dinnerVip}/fő (normál ár €{p.dinnerVipOriginal}). 0-3 év ingyenes, 4-8 év 50% kedvezmény. Fizetés a fedélzeten — nincs előzetes fizetés.' },
      ...
      { q: 'Honnan indul az isztambuli vacsorás hajóút?', a: 'Kabataş kikötő, Isztambul — az európai parton, a Dolmabahçe-palota közelében. A pontos találkozási helyet foglalás után WhatsApp / Telegram / WeChat-en közöljük. A Dolmabahçe villamosmegállóból és a Kabataş villamosmegállóból induló gyalogos videók a fenti találkozási hely szakaszban találhatók.' },
      { q: 'Meddig tart a vacsorás hajóút — és mikor kezdődik?', a: 'Összesen 3 óra. Beszállás 19:30-tól, a hajó pontosan 20:30-kor indul, körülbelül 23:30-kor tér vissza. Ajánljuk, hogy 15-20 perccel korábban érkezzen, hogy elhelyezkedjen és helyet válasszon.' },
  ...
  'istanbul-night-tour': {
    meta: {
      ...
      description: 'Hajóút 3 órán át a Boszporuszon vacsorával és élő show-val. Indulás 20:30 Kabataşból. Ingyenes lemondás, fizetés a fedélzeten. 11.317 értékelés. Szállodai transzfer opcionális.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: 'Élő népi táncok + sema + keleti', desc: 'Hagyományos török szórakozás: Mevlana sema előadás, 5 regionális népi tánc, keleti tánc, élő zene, DJ. 40 perc show, háttérzene egész este.' },
    ...
    faq: [
      ...
      { q: 'Mennyibe kerül a túra Isztambulban éjjel?', a: 'Éjszakai túránk vacsorával a Boszporuszon: Standard €{p.dinnerStd}/fő, VIP €{p.dinnerVip}/fő. Beleértve a túrát, a vacsorát, a szórakozást, az üdítőket. Opcionális: alkohol +€{p.unlimited}/fő, szállodai transzfer +€{p.transfer}/fő. Fizetés a fedélzeten — nincs előzetes fizetés.' },
      ...
      { q: 'Mi a legjobb idő egy éjszakai túrához Isztambulban?', a: 'A Boszporuszi vacsorás túránk 20:30-23:30 (3 óra). Ez a csúcs megvilágítási idő Isztambul összes nevezetességéhez — hidak teljesen kivilágítva, paloták ragyognak, hold a vízen. Ha korábbit szeretne (aranyóra), vegye figyelembe a 17:30-as naplemente túrát.' },
  ...
  'istanbul-boat-tour': {
    ...
    highlights: [
      ...
      { title: 'Esti indulás (legjobb megvilágítás)', desc: 'A 20:30-as indulás teljes ragyogásban fogja meg a kivilágított Boszporuszt — hidak, paloták, mecsetek mind kivilágítva. Drámaibb, mint a nappali túrák, amelyek ugyanazokat a nevezetességeket sík fényben mutatják.' },
    ...
    faq: [
      ...
      { q: 'Meddig tart a hajós túra Isztambulban?', a: '3 óra. Beszállás 19:30-tól a Kabataş kikötőnél, indulás 20:30, visszatérés ~23:30. Lefedi a teljes Boszporuszt Dolmabahçe-tól Rumeli Hisarı-ig és vissza. Elég idő a teljes vacsorához + show-hoz fáradtság nélkül.' },
      { q: 'Mennyibe kerül a hajós túra Isztambulban?', a: 'Hajós túránk vacsorával: Standard €{p.dinnerStd}/fő (korábban €{p.dinnerStdOriginal}), VIP prémium menüvel €{p.dinnerVip}/fő (korábban €{p.dinnerVipOriginal}). 0-3 év ingyenes, 4-8 év fél áron. Fizetés a fedélzeten. Az alkohol és a szállodai transzfer opcionális kiegészítők.' },
      ...
      { q: 'Ez a hajós túra alkalmas családoknak gyerekekkel?', a: 'Igen — nagyon családbarát. Gyerekek 0-3 év ingyenes, 4-8 év 50% kedvezmény. Fedett belső tér, gyerekmenü kérésre és szórakozás (sema, népi táncok), amely lebilincselő a gyerekeknek. Sok család a világ minden tájáról foglalja ezt a túrát.' },
  ...
  'bosphorus-trip': {
    meta: {
      ...
      description: 'Kirándulás 3 órán át a Boszporuszon: török vacsora, élő folklór, kivilágított éjszakai tájak. Indulás 20:30 Kabataşból. Ingyenes lemondás, fizetés a fedélzeten.'
    },
    hero: {
    ...
    highlights: [
      ...
      { title: '€{p.dinnerStd}-tól — fizetés a fedélzeten', desc: 'Nincs szükség előzetes fizetésre. Fizetés a fedélzeten (készpénz vagy kártya). Ingyenes lemondás indulás előtt 2 óráig. 0-3 év ingyenes, 4-8 év fél áron. Átlátható árak.' }
    ],
    faq: [
      ...
      { q: 'A Boszporusz kirándulás alkalmas gyerekeknek?', a: 'Igen — nagyon gyerekbarát. Gyerekek 0-3 év ingyenes (transzfer beleértve), 4-8 év 50% kedvezmény. Fedett belső tér, gyerekmenü kérésre és finom és lebilincselő szórakozás. Sok család foglalja ezt a kirándulást az isztambuli utazásuk csúcspontjaként.' },
  ...
  'bosphorus-cruise-tickets': {
    meta: {
      ...
      description: 'Közvetlen Boszporusz hajóút jegyek. Standard €{p.dinnerStd}, VIP €{p.dinnerVip}. Nincs előzetes fizetés, fizetés a fedélzeten. Ingyenes lemondás 2 óráig előtte.'
    },
    hero: {
    ...
    intro: [
      'Keres **Boszporusz hajóút jegyeket**? Vásároljon közvetlenül. A jegyeink €{p.dinnerStd} (Standard) vagy €{p.dinnerVip} (VIP) — 40% kedvezmény a normál árhoz képest (€{p.dinnerStdOriginal} és €{p.dinnerVipOriginal}). A harmadik fél foglalási oldalak általában 20-40% jutalékot adnak hozzá. Közvetlen foglalással spórol — és még mindig a fedélzeten fizet.',
      'A **Boszporusz hajóút jegyek** folyamatunk: töltse ki az űrlapot ezen az oldalon kevesebb mint 1 perc alatt (dátum, vendégek száma, csomag, kapcsolat), azonnal megerősítjük WhatsApp / Telegram / WeChat-en, megjelenik a Kabataş kikötőnél 19:30-kor, fizet a fedélzeten, élvezi a 3 órás vacsorás hajóutat. Nincs nyomtatandó fizikai jegy, nincs e-mailben kapott kupon — a megerősítés az Ön jegye.',
    ...
    highlights: [
      { title: 'Közvetlen foglalás — nincs közvetítői díj', desc: '€{p.dinnerStd} Standard, €{p.dinnerVip} VIP. A harmadik fél oldalak €30-80+-t kérnek ugyanazért a túráért. Spóroljon közvetlen foglalással. Nincsenek rejtett díjak, nincs jutalékfelár.' },
      ...
      { title: 'Megerősítés kevesebb mint 1 perc alatt', desc: 'Töltse ki az űrlapot → megerősítjük WhatsApp / Telegram / WeChat-en. Nincs PDF kuponmail nyomtatáshoz. Az üzenetünk az Ön jegye. Jöjjön a kikötőhöz 19:30-ra.' },
      { title: 'Jelenlegi bevezető ár 40% KEDVEZMÉNY', desc: 'Standard korábban €{p.dinnerStdOriginal}, most €{p.dinnerStd}. VIP korábban €{p.dinnerVipOriginal}, most €{p.dinnerVip}. 40% kedvezmény, mert közvetlenül foglal. Nem időkorlátos trükk — ez a standard közvetlen foglalási árunk.' }
    ],
    faq: [
      { q: 'Mennyibe kerülnek a Boszporusz hajóút jegyek?', a: 'Standard: €{p.dinnerStd}/fő (normál €{p.dinnerStdOriginal}). VIP: €{p.dinnerVip}/fő (normál €{p.dinnerVipOriginal}). Tartalmazza a 3 órás túrát, török többfogásos vacsorát, élő népi tánc show-t, korlátlan üdítőket. 0-3 év ingyenes, 4-8 év 50% kedvezmény. Fizetés a fedélzeten — nincs előzetes fizetés.' },
      { q: 'Hol vásárolhatok Boszporusz hajóút jegyeket?', a: 'Közvetlenül ezen az oldalon — töltse ki a foglalási űrlapot, azonnal megerősítjük WhatsApp / Telegram / WeChat-en. Fizetés a fedélzeten. A harmadik fél platformok (Viator, GetYourGuide, Klook) is árulnak jegyeket, de általában €30-80+-t kérnek — ez a közvetítői felár. A közvetlen a legolcsóbb és a leggyorsabb.' },
      { q: 'Nyomtatnom kell a Boszporusz hajóút jegyet?', a: 'Nem — nincs szükség fizikai jegyre vagy kuponra. Foglalás után megerősítést küldünk WhatsApp-on (vagy Telegram/WeChat-en) a találkozási hellyel, idővel és a foglalás nevével. Csak mutassa a telefonját a kikötőnél. Kész.' },
      ...
      { q: 'Elérhetők a Boszporusz hajóút jegyek aznapra?', a: 'Gyakran igen, különösen hétköznapokon. A hétvégék és ünnepek gyorsabban megtelnek. Ellenőrizze az elérhetőséget a foglalási űrlapon — valós időben frissül. Az aznapi foglalás általában néhány órával a 20:30-as indulás előtt lehetséges. Sürgős kérésekért WhatsApp.' },
      { q: 'A Boszporusz hajóút jegyek gyerekeknek ingyenesek?', a: 'Gyerekek **0-3 év teljesen ingyenes** (nincs díj, nincs rejtett költség, transzfer beleértve). **4-8 év 50% kedvezmény** (€{p.dinnerStd}/2 = €12 Standardon). **9+ év teljes felnőtt ár.** Fix és átlátható árak — nincsenek "baba felár" trükkök.' }
    ],
    cta: {
  ...
  'last-minute-bosphorus': {
    meta: {
      ...
      description: 'Boszporusz hajóút foglalás aznap. WhatsApp megerősítés percek alatt. Indulás 20:30 Kabataşból. Ingyenes lemondás, fizetés a fedélzeten. 11.317 értékelés.'
    },
    hero: {
    ...
    intro: [
      'Ma délután szállt le Isztambulban és szép estét szeretne ma este? **A Boszporusz hajóút last minute** működik. Külön helyeket tartunk fenn aznapi foglalásokhoz, mert tudjuk, hogy sok utazó reggel dönt. Töltse ki az űrlapot itt, percek alatt megerősítjük WhatsApp-on, megjelenik a Kabataş kikötőnél 19:30-kor, fizet a fedélzeten, élvez.',
      '**A Boszporusz hajóútunk last minute** ugyanazt az esti programot kínálja, mint az előzetes foglalások: 3 óra a vízen (20:30-23:30), török többfogásos vacsora, élő népi tánc show, sema, keleti tánc, DJ. Kivilágított Dolmabahçe-palota, Ortaköy-mecset, Boszporusz-híd — ugyanazok az ikonikus kilátások. Ugyanaz az ár €{p.dinnerStd} Standard vagy €{p.dinnerVip} VIP.',
    ...
    highlights: [
      ...
      { title: 'Megerősítés kevesebb mint 5 perc alatt', desc: 'Töltse ki az űrlapot → megerősítő üzenet WhatsApp/Telegram/WeChat → kész. Nincs várnivaló e-mail kupon, nincs nyomtatandó QR kód. Az üzenetünk az Ön jegye.' },
      ...
      { title: 'Szállodai transzfer aznap gyakran elérhető', desc: 'A szállodai transzfer normál esetben 24 órás értesítést igényel, de aznapi foglalásokhoz 14:00-18:00 között gyakran tudunk felvételt szervezni +€{p.transfer}/fővel. Sürgős transzfer kérésekért WhatsApp.' }
    ],
    faq: [
      { q: 'Valóban lefoglalhatom a Boszporusz hajóutat ma estére?', a: 'Igen — gyakran. Aznapi foglalásokhoz helyeket tartunk fenn. Ellenőrizze a fenti űrlapot a ma esti elérhetőségért. Ha vannak elérhető helyek, 18:00-ig foglalhat (3 óra az indulás előtt). A hétvégék mozgalmasabbak — foglaljon korábban a nap folyamán, ha lehet.' },
      { q: 'Mennyire last minute foglalhatok?', a: 'A foglalások 18:00-ig nyitva maradnak a 20:30-as hajóra. 18:00 után írjon nekünk közvetlenül WhatsApp-on a +90 532 244 29 22-es számon — ha vannak szabad helyek, manuálisan megerősíthetünk. 19:30 után nagyon szoros, hacsak már nem a Kabataş kikötőnél van és gyorsan fel tud szállni.' },
      { q: 'Drágább a Boszporusz hajóút last minute?', a: 'Nem — ugyanaz az ár, mint az előzetes foglalás. €{p.dinnerStd} Standard, €{p.dinnerVip} VIP. Nem alkalmazunk "dinamikus árakat" vagy last minute felárakat. Ugyanaz a hajó, ugyanaz a vacsora, ugyanaz a show, ugyanaz az ár.' },
      ...
      { q: 'Tudnak last minute szállodai transzfert szervezni?', a: 'Aznapi transzfer ~18:00-ig lehetséges a 20:30-as túrához. 18:00 után lehet, hogy nincs elérhető sofőrünk — ebben az esetben taxit vehet a Kabataş kikötőhöz (15 perc Taksimból, 10 perc Sultanahmetből, ~€10-15). Központi és könnyű.' },
  ...
  'istanbul-cruise-price': {
    meta: {
      ...
      description: 'Boszporusz hajóút árak Isztambul: Standard €{p.dinnerStd}, VIP €{p.dinnerVip}. Gyerekek 0-3 ingyenes, 4-8 fél áron. Átlátható kiegészítők.'
    },
    hero: {
      h1: 'Isztambul Hajóút Ár',
      subtitle: 'Átlátható árak, nincsenek rejtett díjak. Standard €{p.dinnerStd}/fő, VIP €{p.dinnerVip}/fő — és a fedélzeten fizet, nem most.',
      badge: 'Átlátható · 40% KEDVEZMÉNY Közvetlen · 0-3 Év Ingyenes'
    },
    intro: [
      '**Az isztambuli hajóút árak** nagyon változatosak — a vacsorát kihagyó €15-os költségvetésű kompoktól az €150+-os üdülő jachtokig. A mi árunk középen van és a legjobb értéket kínálja: €{p.dinnerStd} a Standardért teljes vacsorás hajóúttal és show-val 3 órán át, €{p.dinnerVip} a VIP-ért prémium élménnyel a színpad előtt. Nincsenek rejtett díjak, nincsenek meglepetés felárak.',
      'Az **isztambuli hajóút ár** részletes bontása, mert az átláthatóság számít:\n\n- **Standard Vacsorás Hajóút**: €{p.dinnerStd}/fő (korábban €{p.dinnerStdOriginal}, 40% kedvezmény). Tartalmazza a 3 órás túrát, 10 mezzét, főételt, desszertet, korlátlan üdítőket, élő show-t.\n- **VIP Vacsorás Hajóút**: €{p.dinnerVip}/fő (korábban €{p.dinnerVipOriginal}). Hozzáadja a színpad előtti helyeket, 15+ mezzét, marhabélszín/ribeye opciókat, prioritásos kiszolgálást.\n- **0-3 év**: Ingyenes. 4-8 év: 50% kedvezmény. 9+ év: teljes ár.\n\nKiegészítők (opcionálisak):\n- 2 pohár alkohol: +€{p.alcohol2}/fő\n- Korlátlan helyi alkohol: +€{p.unlimited}/fő\n- Szállodai transzfer oda-vissza: +€{p.transfer}/fő\n- Romantikus asztali elrendezés: +€{p.romantic}/asztal',
    ...
    highlights: [
      { title: 'Standard: €{p.dinnerStd} (korábban €{p.dinnerStdOriginal})', desc: '40% kedvezmény a normál árhoz képest. 3 órás túra, teljes török vacsora, élő show, korlátlan üdítők. A legnépszerűbb csomag — mindent fedez, ami egy szép estéhez kell.' },
      { title: 'VIP: €{p.dinnerVip} (korábban €{p.dinnerVipOriginal})', desc: '40% kedvezmény a normál árhoz képest. Hozzáadja a színpad előtti helyeket, 15+ mezzét, prémium főételt (marhabélszín, ribeye), prioritásos pincér kiszolgálást. Különleges alkalmakra vagy prémium utazóknak.' },
      { title: 'Ár gyerekeknek: 0-3 ingyenes, 4-8 fél áron', desc: '0-3 teljesen ingyenes (nincs díj). 4-8 50% kedvezménnyel a felnőtt árból. 9+ teljes felnőtt ár. Átlátható, nincsenek családi ártrükkök. A transzfer is ingyenes 0-3-nak.' },
      { title: 'Kiegészítők — csak amikor szeretné', desc: 'Alkohol: €{p.alcohol2} vagy €{p.unlimited}/fő. Transzfer: €{p.transfer}/fő. Romantikus asztal: €{p.romantic}/asztal. Minden opcionális, nem csomagolt. Csak azt válassza, amire szüksége van.' }
    ],
    faq: [
      { q: 'Mennyibe kerül egy túra Isztambulban?', a: 'Standard Vacsorás Hajóút: €{p.dinnerStd}/fő (normál €{p.dinnerStdOriginal}, 40% kedvezmény). VIP: €{p.dinnerVip}/fő (normál €{p.dinnerVipOriginal}, 40% kedvezmény). 0-3 év ingyenes, 4-8 év fél áron. Fizetés a fedélzeten — nincs előzetes fizetés. Ingyenes lemondás indulás előtt 2 óráig.' },
      ...
      { q: 'Miért 40% kedvezmény az isztambuli túra ára — trükk?', a: 'Nincs trükk. A normál ár €{p.dinnerStdOriginal}/€{p.dinnerVipOriginal} az, amit a harmadik fél foglalási oldalak (Viator, GetYourGuide, Klook) kérnek — a jutalékaikkal. Foglaljon közvetlenül és kapjon €{p.dinnerStd}/€{p.dinnerVip}-t. Ez a 40%-os különbség. Nincsenek időkorlátos vagy dinamikus ár trükkök.' },
      { q: 'Hogyan hasonlítható össze az isztambuli túra ára más opciókkal?', a: 'Hurok kompok: €5-10, 1 óra, nincs vacsora, nincs szórakozás, csak turizmus. Költségvetésű túrák vacsorával: €20-30, zsúfoltak, átlagos étel, rövid show. A mi Standardunk (€{p.dinnerStd}): 3 óra, teljes vacsora, teljes show, privát asztal, TÜRSAB engedéllyel. VIP (€{p.dinnerVip}): színpad előtt, prémium menü. Üdülő jachtok: €100-150+, túlzott egyedülálló utazóknak/pároknak.' },
      { q: 'Előre kell fizetnem az isztambuli túra árát?', a: 'Nem — **fizetés a fedélzeten**. Foglaljon most (1 perces űrlap), megerősítjük WhatsApp-on, jöjjön 19:30-ra és fizessen a fedélzeten (készpénz vagy kártya). Ingyenes lemondás 2 órával előtte. Nulla anyagi elkötelezettség, amíg nem elégedett.' },
