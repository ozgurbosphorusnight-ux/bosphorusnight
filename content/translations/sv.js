...
module.exports = {
  ...
  'bosphorus-sunset-cruise': {
    ...
    faq: [
      ...
      { q: 'Vad kostar Bosporen solnedgångskryssning?', a: 'Från €{p.dinnerStd}/person för standardkryssningen (3 timmar, full middag, live underhållning). VIP-alternativet med plats framför scenen och premiummezzer kostar €{p.dinnerVip}/person. Betalning ombord — ingen förskottsbetalning. Barn 0-3 år gratis, 4-8 år halva priset.' },
