...
module.exports = {
  ...
  'romantic-bosphorus-cruise': {
    ...
    faq: [
      ...
      { q: 'Vad kostar den romantiska kryssningen för 2 personer?', a: '2 personer: 2 × €{p.dinnerStd} = €48.60,60. Lägg till romantiska uppställningen +€{p.romantic} = €63,60. Ingen förskottsbetalning — betalning ombord. 2-glas alkoholpaket för två: ytterligare 2 × €{p.alcohol2} = €20.' },
