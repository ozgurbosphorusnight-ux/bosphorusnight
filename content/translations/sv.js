...
module.exports = {
  ...
  'bosphorus-vip': {
    ...
    faq: [
      ...
      { q: 'Hur bokar jag VIP Bosporenkryssningen?', a: 'Använd bokningsformuläret på denna sida — välj "VIP" i Steg 1, ställ in datum, ange antal gäster, sedan kontaktuppgifter. Din förfrågan kommer via WhatsApp / Telegram / WeChat och vi bekräftar direkt. Betalning ombord, inte nu.' },
  ...
  'bosphorus-night-tour': {
    ...
    faq: [
      ...
      { q: 'Jag talar inte turkiska — är turen på engelska?', a: 'Besättningen talar engelska. Underhållningen (sema, folkdanser, musik) kräver inget språk. Middagsmenyn är på engelska. Bokning via WhatsApp / Telegram / WeChat fungerar på flera språk (engelska, arabiska, ryska, tyska, franska, spanska). Inget turkiska behövs.' }
    ],
    cta: {
  ...
  'bosphorus-cruise-tickets': {
    ...
    intro: [
      ...
      'Vår **Bosporenkryssning biljetter**-process: fyll i formuläret på denna sida på mindre än 1 minut (datum, antal gäster, paket, kontakt), vi bekräftar direkt via WhatsApp / Telegram / WeChat, du dyker upp vid Kabataş-bryggan 19:30, betalar ombord, njuter av 3-timmars middagskryssningen. Ingen fysisk biljett att skriva ut, ingen kupong att ta emot via e-post — bekräftelsen är din biljett.',
    ...
    highlights: [
      ...
      { title: 'Bekräftelse på mindre än 1 minut', desc: 'Fyll i formuläret → vi bekräftar via WhatsApp / Telegram / WeChat. Ingen PDF-kupongmail att skriva ut. Vårt meddelande är din biljett. Kom till bryggan 19:30.' },
    ...
    faq: [
      ...
      { q: 'Var kan jag köpa Bosporenkryssning biljetter?', a: 'Direkt från denna sida — fyll i bokningsformuläret, vi bekräftar direkt via WhatsApp / Telegram / WeChat. Betalning ombord. Tredjepartsplattformar (Viator, GetYourGuide, Klook) säljer också biljetter, men tar vanligtvis ut €30-80+ — detta är mellanhandstillägget. Direkt är billigast och snabbast.' },
      { q: 'Måste jag skriva ut Bosporenkryssning biljetten?', a: 'Nej — ingen fysisk biljett eller kupong behövs. Efter bokning skickar vi dig en bekräftelse via WhatsApp (eller Telegram/WeChat) med mötesplats, tid och bokningsnamn. Visa bara din telefon vid bryggan. Klart.' },
  ...
  'last-minute-bosphorus': {
    ...
    highlights: [
      ...
      { title: 'Bekräftelse på mindre än 5 minuter', desc: 'Fyll i formuläret → bekräftelsemeddelande WhatsApp/Telegram/WeChat → klar. Ingen e-postkupong att vänta på, ingen QR-kod att skriva ut. Vårt meddelande är din biljett.' },
