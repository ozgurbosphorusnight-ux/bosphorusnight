...
module.exports = {
  ...
  meta: {
    ...
    description: '3-hour Istanbul night tour: Bosphorus cruise, dinner, live show. 21:00 from Kabataş. Hotel transfer optional. Pay on boat. 11K+ reviews.'
  },
  ...
  highlights: [
    ...
    },
    {
      ...
      desc: '10 mezes, warm appetizer, main course (salmon/sea bass/chicken skewer/beef skewer/vegetarian), dessert, unlimited soft drinks. Halal-certified. Priced at €{p.dinnerStd}/person — includes everything.'
    },
    {
      icon: 'show',
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Our Bosphorus dinner cruise is 21:00-00:00 (3 hours). That\'s peak illumination time for all Istanbul landmarks — bridges fully lit, palaces glowing, moon over the water. If you also want golden hour, come in summer: boarding starts 20:00, and in May–August the sun sets during boarding, just before the 21:00 departure — the same cruise covers both.'
    },
    {
