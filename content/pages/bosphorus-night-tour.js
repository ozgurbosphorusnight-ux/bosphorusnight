...
module.exports = {
  ...
  meta: {
    ...
    description: '3-hour Bosphorus night tour with dinner & live show. 21:00 from Kabataş, illuminated bridges. Pay on boat, free cancellation. Book today.'
  },
  ...
  faq: [
    {
      ...
      a: 'Boarding from 20:00 at Kabataş Pier. Boat departs 21:00 sharp, returns around 00:00. We recommend arriving 20 minutes before boarding to get settled and choose seats.'
    },
    {
    ...
    },
    {
      ...
      a: 'Night tour = illuminated Istanbul, peak light drama, full entertainment program, most iconic photos of lit bridges. And it\'s one cruise: in summer (May–August), boarding from 20:00 catches golden hour, the sun sets while you settle in on deck, and the 21:00 departure sails you straight into the illuminated city — so the same evening covers sunset and night. No need to choose or book twice.'
    },
    {
