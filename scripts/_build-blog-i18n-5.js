  ...
  id: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['p', 'Kami merekomendasikan tiba di area dermaga paling lambat pukul 20:00. Ini memberi Anda waktu untuk menemukan titik pertemuan, bertemu anggota tim kami yang akan memandu Anda ke kapal, dan menetap di meja Anda sebelum keberangkatan.'],
    ...
    'bosphorus-sunset-cruise-guide': {
      ...
      body: [
        ...
        ['p', 'Istanbul terletak di sekitar lintang 41 derajat utara, yang berarti waktu matahari terbenam bervariasi secara signifikan sepanjang tahun. Di musim panas, matahari terbenam sekitar pukul 21:00, melemparkan golden hour panjang yang membentang di atas air. Di musim semi dan musim gugur, matahari terbenam datang lebih awal — sekitar pukul 18:00 hingga 19:00 — menciptakan transisi yang lebih dramatis dan lebih cepat dari siang ke malam. Bagaimanapun, Bosphorus bertindak sebagai cermin alami, memantulkan warna langit dan memperbesar tontonan.'],
        ...
        ['p', 'Perbedaan utama adalah waktu dan suasana. Pelayaran matahari terbenam berangkat di sore hari dan memberi Anda pengalaman golden hour ditambah transisi ke malam. Pelayaran makan malam standar berangkat lebih lambat (sekitar 20:00-21:00) dan sepenuhnya merupakan pengalaman malam — lampu kota, jembatan yang diterangi, dan suasana yang lebih gelap dan lebih romantis.'],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">Pertimbangkan pelayaran matahari terbenam</strong> — Berangkat lebih awal (sekitar 17:30) dan kembali pada 21:00, yang bekerja lebih baik untuk jadwal tidur anak-anak yang lebih muda daripada pelayaran makan malam yang kembali sekitar 00:00.'],
  ...
  ms: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['h2', 'Tur Mana yang Berjalan Malam Ini?'],
        ['p', 'Pelayaran makan malam standard bertolak setiap hari dari jeti Kabataş. Jadual biasa berfungsi seperti ini: menaiki kapal bermula sekitar 20:00 hingga 20:00, kapal bertolak kira-kira pukul 21:00, dan pelayaran berlangsung kira-kira tiga jam, kembali ke jeti sekitar pukul 00:00. Sesetengah pengendali juga menawarkan pelayaran matahari terbenam yang bertolak sekitar 17:30 dan kembali pada 21:00 — walaupun untuk keputusan saat akhir pada petang hari, pelayaran makan malam adalah pilihan yang lebih praktikal.'],
        ...
        ['p', 'Kami mengesyorkan tiba di kawasan jeti selewat-lewatnya 20:00. Ini memberi anda masa untuk mencari titik perjumpaan, bertemu ahli pasukan kami yang akan memandu anda ke kapal, dan menetap di meja anda sebelum berlepas.'],
    ...
    'bosphorus-sunset-cruise-guide': {
      ...
      body: [
        ...
        ['p', 'Istanbul terletak pada kira-kira latitud 41 darjah utara, bermakna masa matahari terbenam berbeza dengan ketara sepanjang tahun. Pada musim panas, matahari terbenam kira-kira pukul 21:00, melontarkan golden hour panjang yang merentangi air. Pada musim bunga dan musim luruh, matahari terbenam datang lebih awal — sekitar 18:00 hingga 19:00 — mencipta peralihan yang lebih dramatik dan lebih pantas dari siang ke malam. Walau apa pun, Bosphorus bertindak sebagai cermin semula jadi, memantulkan warna langit dan memperbesar tontonan.'],
        ...
        ['p', 'Perbezaan utama ialah masa dan suasana. Pelayaran matahari terbenam bertolak pada lewat petang dan memberi anda pengalaman golden hour ditambah peralihan ke malam. Pelayaran makan malam standard bertolak lebih lewat (sekitar 20:00-21:00) dan sepenuhnya pengalaman malam — lampu bandar, jambatan diterangi, dan suasana yang lebih gelap dan lebih romantis.'],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">Pertimbangkan pelayaran matahari terbenam</strong> — Ia bertolak lebih awal (sekitar 17:30) dan kembali pada 21:00, yang berfungsi lebih baik untuk jadual tidur kanak-kanak yang lebih muda berbanding pelayaran makan malam yang kembali sekitar 00:00.'],
  ...
  pl: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['p', 'Zalecamy przybycie do strefy przystani najpóźniej o 20:00. Daje to czas na znalezienie miejsca spotkania, spotkanie z członkiem naszego zespołu, który poprowadzi Cię do łodzi, i osiedlenie się przy stoliku przed odlotem.'],
        ['h2', 'Co zabrać'],
    ...
    'bosphorus-sunset-cruise-guide': {
      ...
      body: [
        ...
        ['p', 'Stambuł leży na około 41 stopniach szerokości geograficznej północnej, co oznacza, że czasy zachodu słońca znacznie się różnią w ciągu roku. Latem słońce zachodzi około 21:00, rzucając długą złotą godzinę, która rozciąga się po wodzie. Wiosną i jesienią zachód słońca przychodzi wcześniej — około 18:00 do 19:00 — tworząc bardziej dramatyczne, szybsze przejście od dnia do nocy. Tak czy inaczej, Bosfor działa jak naturalne lustro, odbijając kolory nieba i wzmacniając widowisko.'],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">Rozważ rejs o zachodzie słońca</strong> — Wyrusza wcześniej (około 17:30) i wraca o 21:00, co lepiej pasuje do harmonogramu snu młodszych dzieci niż rejs z kolacją wracający około 00:00.'],
  ...
  bg: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['p', 'Препоръчваме да пристигнете в района на пристана най-късно до 20:00. Това ви дава време да намерите мястото за среща, да срещнете член на нашия екип, който ще ви заведе до лодката, и да се настаните на масата си преди отплаване.'],
    ...
    'bosphorus-sunset-cruise-guide': {
      ...
      body: [
        ...
        ['p', 'Основната разлика е времето и атмосферата. Круизът при залез тръгва късно следобед и ви дава преживяването на златния час плюс прехода към нощ. Стандартният круиз с вечеря тръгва по-късно (около 20:00-21:00) и е изцяло нощно преживяване — светлини на града, осветени мостове и по-тъмно, по-романтично настроение.'],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">Помислете за круиза при залез</strong> — Той тръгва по-рано (около 17:30) и се връща до 21:00, което работи по-добре за разписанието за лягане на по-малките деца от круиза с вечеря, който се връща около 00:00.'],
  ...
  ro: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['p', 'Croaziera standard cu cină pleacă zilnic de la debarcaderul Kabataş. Programul tipic funcționează astfel: îmbarcarea începe în jurul orei 20:00 până la 20:00, barca pleacă la aproximativ 21:00, iar croaziera durează aproximativ trei ore, întorcându-se la debarcader în jurul orei 00:00. Unii operatori oferă, de asemenea, o croazieră la apus care pleacă în jurul orei 17:30 și se întoarce până la 21:00 — deși pentru o decizie last minute după-amiază, croaziera de seară cu cină este opțiunea mai practică.'],
        ...
        ['p', 'Vă recomandăm să ajungeți în zona debarcaderului cel târziu până la 20:00. Aceasta vă dă timp să găsiți punctul de întâlnire, să întâlniți un membru al echipei noastre care vă va ghida la barcă și să vă așezați la masa voastră înainte de plecare.'],
    ...
    'things-to-know-istanbul-boat-tour': {
      ...
      body: [
        ...
        ['p', 'De obicei, există două opțiuni de croazieră: croaziera la apus (plecare în jurul orei 17:30) și croaziera cu cină (plecare în jurul orelor 20:00-21:00). Croaziera la apus vă oferă experiența orei de aur și tranziția de la zi la noapte — ideal pentru fotografi și cei care preferă o seară mai devreme. Croaziera cu cină este experiența nocturnă clasică cu orașul complet iluminat. Ambele includ o cină completă și programul de divertisment. Dacă este prima dată, croaziera cu cină este cea mai populară alegere.'],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">Luați în considerare croaziera la apus</strong> — Pleacă mai devreme (în jurul orei 17:30) și se întoarce până la 21:00, ceea ce funcționează mai bine pentru programul de culcare al copiilor mai mici decât croaziera cu cină care se întoarce în jurul orei 00:00.'],
