  ...
  tr: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['p', "Standart akşam yemekli tur, her gün Kabataş iskelesinden hareket eder. Tipik program şöyle işler: biniş 20:00 ile 20:00 civarında başlar, tekne yaklaşık 21:00'da kalkar ve tur yaklaşık üç saat sürer, yaklaşık 00:00'da iskeleye döner. Bazı operatörler ayrıca 17:30 civarında kalkan ve 21:00'a kadar dönen bir gün batımı turu sunar — ancak öğleden sonra son dakika kararı için akşam yemekli tur daha pratik bir seçenektir."],
        ...
        ['p', "İskele alanına en geç 20:00'a kadar varmanızı öneririz. Bu size buluşma noktasını bulmak, sizi tekneye yönlendirecek ekip üyemizle tanışmak ve kalkıştan önce masanıza yerleşmek için zaman verir."],
        ['h2', 'Ne Getirmeli'],
    ...
    'bosphorus-sunset-cruise-guide': {
      ...
      body: [
        ...
        ['p', "Ana fark zaman ve atmosferdir. Gün batımı turu öğleden sonra geç saatlerde kalkar ve size o altın saat deneyimini artı geceye geçişi verir. Standart akşam yemekli tur daha geç kalkar (yaklaşık 20:00-21:00) ve tamamen gece deneyimidir — şehir ışıkları, aydınlatılmış köprüler ve daha karanlık, daha romantik bir ruh hali."],
    ...
    'things-to-know-istanbul-boat-tour': {
      ...
      body: [
        ...
        ['p', "Genellikle iki tur seçeneği vardır: gün batımı turu (yaklaşık 17:30 kalkış) ve akşam yemekli tur (yaklaşık 20:00-21:00 kalkış). Gün batımı turu size altın saat deneyimini ve gündüzden geceye geçişi verir — fotoğrafçılar ve daha erken bir akşam tercih edenler için ideal. Akşam yemekli tur, şehir tamamen aydınlatılmış klasik gece deneyimidir. Her ikisi de tam bir akşam yemeği ve eğlence programı içerir. İlk kez geliyorsanız, akşam yemekli tur en popüler seçimdir."],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">Gün batımı turunu düşünün</strong> — Daha erken kalkar (yaklaşık 17:30) ve 21:00\'da döner, bu da yaklaşık 00:00\'da dönen akşam yemekli turdan daha küçük çocukların yatma programları için daha iyi çalışır.'],
  ...
  de: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['p', 'Die Standard-Dinner-Bootsfahrt startet täglich vom Pier Kabataş. Der typische Zeitplan funktioniert so: Die Einschiffung beginnt gegen 20:00 bis 20:00 Uhr, das Boot fährt etwa um 21:00 Uhr ab, und die Bootsfahrt dauert etwa drei Stunden und kehrt gegen 00:00 Uhr zum Pier zurück. Einige Betreiber bieten auch eine Sonnenuntergangs-Bootsfahrt an, die gegen 17:30 Uhr abfährt und um 21:00 Uhr zurückkehrt — obwohl für eine Last-Minute-Entscheidung am Nachmittag die abendliche Dinner-Bootsfahrt die praktischere Option ist.'],
        ...
        ['p', 'Wir empfehlen, spätestens um 20:00 Uhr am Pier zu sein. Dies gibt Ihnen Zeit, den Treffpunkt zu finden, unser Teammitglied zu treffen, das Sie zum Boot führen wird, und sich vor der Abfahrt an Ihrem Tisch niederzulassen.'],
        ['h2', 'Was mitbringen'],
    ...
    'things-to-know-istanbul-boat-tour': {
      ...
      body: [
        ...
        ['p', 'Es gibt normalerweise zwei Bootsfahrt-Optionen: die Sonnenuntergangs-Bootsfahrt (Abfahrt gegen 17:30 Uhr) und die Dinner-Bootsfahrt (Abfahrt gegen 20:00-21:00 Uhr). Die Sonnenuntergangs-Bootsfahrt bietet Ihnen das Goldene-Stunden-Erlebnis und den Übergang von Tag zu Nacht — ideal für Fotografen und diejenigen, die einen früheren Abend bevorzugen. Die Dinner-Bootsfahrt ist das klassische Nachterlebnis mit der vollständig beleuchteten Stadt. Beide beinhalten ein komplettes Abendessen und Unterhaltungsprogramm. Wenn dies Ihr erstes Mal ist, ist die Dinner-Bootsfahrt die beliebteste Wahl.'],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">Erwägen Sie die Sonnenuntergangs-Bootsfahrt</strong> — Sie startet früher (gegen 17:30 Uhr) und kehrt um 21:00 Uhr zurück, was besser für die Schlafenszeitpläne jüngerer Kinder funktioniert als die Dinner-Bootsfahrt, die gegen 00:00 Uhr zurückkehrt.'],
  ...
  es: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['p', 'El crucero estándar con cena sale diariamente del muelle de Kabataş. El horario típico funciona así: el embarque comienza alrededor de las 20:00 a 20:00, el barco sale aproximadamente a las 21:00, y el crucero dura unas tres horas, regresando al muelle alrededor de las 00:00. Algunos operadores también ofrecen un crucero al atardecer que sale alrededor de las 17:30 y regresa antes de las 21:00 — aunque para una decisión de última hora por la tarde, el crucero nocturno con cena es la opción más práctica.'],
        ...
        ['p', 'Recomendamos llegar al área del muelle a más tardar a las 20:00. Esto le da tiempo para encontrar el punto de encuentro, conocer al miembro de nuestro equipo que le guiará al barco y acomodarse en su mesa antes de la salida.'],
        ['h2', 'Qué Llevar'],
    ...
    'things-to-know-istanbul-boat-tour': {
      ...
      body: [
        ...
        ['p', 'Generalmente hay dos opciones de crucero: el crucero al atardecer (saliendo alrededor de las 17:30) y el crucero con cena (saliendo alrededor de las 20:00-21:00). El crucero al atardecer le da la experiencia de la hora dorada y la transición del día a la noche — ideal para fotógrafos y quienes prefieren una noche más temprana. El crucero con cena es la experiencia nocturna clásica con la ciudad completamente iluminada. Ambos incluyen una cena completa y programa de entretenimiento. Si es su primera vez, el crucero con cena es la opción más popular.'],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">Considere el crucero al atardecer</strong> — Sale antes (alrededor de las 17:30) y regresa antes de las 21:00, lo que funciona mejor para los horarios de sueño de los niños más pequeños que el crucero con cena que regresa alrededor de las 00:00.'],
  ...
  ru: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['p', 'Стандартный ужин-круиз отправляется ежедневно с пристани Кабаташ. Типичное расписание работает так: посадка начинается около 20:00–20:00, корабль отправляется примерно в 21:00, а круиз длится около трёх часов, возвращаясь к пристани около 00:00. Некоторые операторы также предлагают закатный круиз, отправляющийся около 17:30 и возвращающийся к 21:00 — хотя для решения в последнюю минуту во второй половине дня вечерний ужин-круиз — более практичный вариант.'],
        ...
        ['p', 'Мы рекомендуем прибыть в район пристани не позднее 20:00. Это даёт вам время найти место встречи, познакомиться с членом нашей команды, который проводит вас к лодке, и устроиться за столиком до отправления.'],
    ...
    'bosphorus-sunset-cruise-guide': {
      ...
      body: [
        ...
        ['p', 'Стамбул расположен примерно на 41 градусе северной широты, что означает, что время заката значительно меняется в течение года. Летом солнце садится около 21:00, отбрасывая длинный золотой час, который простирается по воде. Весной и осенью закат приходит раньше — около 18:00 до 19:00 — создавая более драматичный, быстрый переход от дня к ночи. В любом случае Босфор действует как естественное зеркало, отражая цвета неба и усиливая зрелище.'],
        ...
        ['p', 'Основная разница — время и атмосфера. Закатный круиз отправляется поздним днём и даёт вам это впечатление золотого часа плюс переход к ночи. Стандартный ужин-круиз отправляется позже (около 20:00–21:00) и полностью является ночным впечатлением — городские огни, освещённые мосты и более тёмное, более романтическое настроение.'],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">Рассмотрите закатный круиз</strong> — Он отправляется раньше (около 17:30) и возвращается к 21:00, что лучше подходит для расписания сна младших детей, чем ужин-круиз, возвращающийся около 00:00.'],
  ...
  ar: {
    ...
    'istanbul-cruise-tonight-last-minute': {
      ...
      body: [
        ...
        ['p', 'تنطلق رحلة العشاء العادية يومياً من رصيف كاباتاش. الجدول النموذجي يعمل بهذه الطريقة: يبدأ الصعود حوالي 20:00 إلى 20:00، ينطلق القارب حوالي 21:00، وتستمر الرحلة حوالي ثلاث ساعات، عائدة إلى الرصيف حوالي 00:00. يقدم بعض المشغلين أيضاً رحلة غروب الشمس التي تنطلق حوالي 17:30 وتعود بحلول 21:00 — على الرغم من أنه بالنسبة لقرار اللحظة الأخيرة بعد الظهر، فإن رحلة عشاء المساء هي الخيار الأكثر عملية.'],
        ...
        ['p', 'نوصي بالوصول إلى منطقة الرصيف بحلول 20:00 على الأكثر. هذا يمنحك الوقت للعثور على نقطة الالتقاء، ومقابلة عضو فريقنا الذي سيرشدك إلى القارب، والاستقرار في طاولتك قبل المغادرة.'],
        ['h2', 'ماذا تحضر'],
    ...
    'bosphorus-sunset-cruise-guide': {
      ...
      body: [
        ...
        ['p', 'الفرق الرئيسي هو التوقيت والأجواء. تنطلق رحلة الغروب في وقت متأخر من بعد الظهر وتمنحك تجربة الساعة الذهبية بالإضافة إلى الانتقال إلى الليل. تنطلق رحلة العشاء العادية لاحقاً (حوالي 20:00-21:00) وهي تجربة ليلية بالكامل — أضواء المدينة والجسور المضاءة ومزاج أكثر إعتاماً ورومانسية.'],
    ...
    'things-to-know-istanbul-boat-tour': {
      ...
      body: [
        ...
        ['p', 'عادة ما يكون هناك خياران للرحلة: رحلة الغروب (تنطلق حوالي 17:30) ورحلة العشاء (تنطلق حوالي 20:00-21:00). تمنحك رحلة الغروب تجربة الساعة الذهبية والانتقال من النهار إلى الليل — مثالية للمصورين وأولئك الذين يفضلون أمسية أبكر. رحلة العشاء هي التجربة الليلية الكلاسيكية مع المدينة مضاءة بالكامل. كلاهما يشمل عشاء كامل وبرنامج ترفيه. إذا كانت هذه هي المرة الأولى لك، فإن رحلة العشاء هي الخيار الأكثر شعبية.'],
    ...
    'bosphorus-cruise-with-kids-family': {
      ...
      body: [
        ...
        ['ul', [
          ...
          ['<strong class="text-white/80">فكر في رحلة الغروب</strong> — تنطلق في وقت أبكر (حوالي 17:30) وتعود بحلول 21:00، مما يعمل بشكل أفضل لجداول نوم الأطفال الأصغر سناً من رحلة العشاء التي تعود حوالي 00:00.'],
