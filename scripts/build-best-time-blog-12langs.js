...
const T = {
  cs: {
    ...
    summerText: 'Nejdelší dny roku připadají na konec června a červenec, se západem slunce po 21:00. To je pro plavby při západu slunce skutečně kouzelné, ale také nejrušnější doba, což znamená, že plavby se rychle plní, víkendové večery jsou spolehlivě vyprodané a samotné město je horké a přeplněné. Přes den může teplota dosáhnout 30 až 35 °C, i když vánek na vodě udržuje plavbu pohodlnou. Pokud cestujete v létě, rezervujte si pár dní dopředu na všední dny a alespoň týden dopředu na pátek nebo sobotu.',
    ...
    sunsetText1: 'Plavba při západu slunce vám dává obojí: zlatou hodinu nad paláci a mešitami, následovanou raným přechodem do osvětlené noční krajiny. Fotografie je v prvních 40 minutách absolutně nejlepší. Tempo je pomalejší a kontemplativnější, večeře se podává, zatímco obloha ještě má barvu, a vrátíte se na břeh kolem 21:00 — dostatečně brzy, abyste mohli pokračovat ve svém večeru, pokud chcete.',
    ...
    h3_night: 'Večerní plavba s večeří (odjezd 21:00)',
    nightText1: 'Toto je ikonický istanbulský večer — Most přes Bospor procházející barvami, palácové fasády zářící žlutě, kopule mešit odrážející se v černé vodě. Nalodění začíná v 20:00, odjezd je v 21:00 přesně, návrat je kolem 00:00. Zábavní program je v plné síle: úvod s tančícími derviši Mevlana, pět tradičních tureckých lidových tanců, orientální tanec, živí hudebníci a DJ set, který udržuje palubu v pohybu až do připlutí.',
  ...
  da: {
    ...
    h3_night: 'Nat-middagskrydstogt (21:00 afgang)',
    nightText1: 'Dette er den ikoniske Istanbul-aften — Bosporus-broen cykler gennem farver, paladsfacader gløder gult, moskekupler reflekteres på sort vand. Ombordstigning starter 20:00, afgang er præcis 21:00, retur er omkring 00:00. Underholdningsprogrammet er på sit fyldigste: Mevlana hvirvlende dervish-åbner, fem traditionelle tyrkiske folkedans, mavedans, levende musikere og et DJ-sæt, der holder dækket i live indtil dokningen.',
    ...
    advanceFooter: 'En vigtig detalje: bookingtidspunktet betyder mere end kalenderdatoen. Operatører i Istanbul stopper typisk med at acceptere samme-dag-reservationer en til to timer før afgang (omkring 20:00 for natkrydstogter). Derefter, selvom der er tomme pladser, har køkkenet afsluttet portioner, og passagerlisten er låst.',
  ...
  el: {
    ...
    h3_night: 'Νυχτερινή κρουαζιέρα με δείπνο (αναχώρηση 21:00)',
    nightText1: 'Αυτό είναι το εμβληματικό βράδυ της Κωνσταντινούπολης — η Γέφυρα του Βοσπόρου να εναλλάσσει χρώματα, οι όψεις των παλατιών να λάμπουν κίτρινες, οι θόλοι των τζαμιών να αντικατοπτρίζονται στο μαύρο νερό. Η επιβίβαση ξεκινά στις 20:00, η αναχώρηση είναι ακριβώς στις 21:00, η επιστροφή είναι γύρω στις 00:00. Το πρόγραμμα ψυχαγωγίας είναι στο πληρέστερο: εναρκτήρια εμφάνιση Μεβλανά με τους περιστρεφόμενους δερβίσηδες, πέντε παραδοσιακούς τουρκικούς λαϊκούς χορούς, χορό της κοιλιάς, ζωντανούς μουσικούς και ένα σετ DJ που κρατά το κατάστρωμα ζωντανό μέχρι την προσάραξη.',
